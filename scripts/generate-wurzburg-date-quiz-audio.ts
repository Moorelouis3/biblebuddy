...
const outputPath = join(process.cwd(), "exports", "wurzburg-residence-tour", "Würzburg Date Quiz.mp3");
const scriptPath = join(process.cwd(), "exports", "wurzburg-residence-tour", "wurzburg-date-quiz-script.md");
