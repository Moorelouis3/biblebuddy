...
const psalmChapters = Array.from({ length: 30 }, (_, index) => index + 97);
...
async function main() {
  ...
  writeFileSync(
    "lib/psalmsNinetySevenToOneTwentySixPersonalNotes.ts",
...
export const PSALMS_97_126_PERSONAL_SECTIONS = [
