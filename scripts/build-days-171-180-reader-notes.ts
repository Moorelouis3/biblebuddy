...
type BookName = "Job" | "Psalms" | "Proverbs";
...
const psalmChapters = Array.from({ length: 24 }, (_, index) => index + 127);
const proverbChapters = Array.from({ length: 6 }, (_, index) => index + 1);
...
async function main() {
  ...
  writeFileSync(
    "lib/psalmsOneTwentySevenToOneFiftyPersonalNotes.ts",
...
export const PSALMS_127_150_PERSONAL_SECTIONS = [
