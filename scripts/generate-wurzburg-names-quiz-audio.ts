...
const outputPath = join(process.cwd(), "exports", "wurzburg-residence-tour", "Würzburg Residence Names Quiz.mp3");
const scriptPath = join(process.cwd(), "exports", "wurzburg-residence-tour", "wurzburg-names-quiz-script.md");
