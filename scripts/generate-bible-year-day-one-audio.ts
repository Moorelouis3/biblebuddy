...
import { BIBLE_YEAR_AUDIO_BUCKET, BIBLE_YEAR_DAY_EIGHT_AUDIO, BIBLE_YEAR_DAY_EIGHTEEN_AUDIO, BIBLE_YEAR_DAY_ELEVEN_AUDIO, BIBLE_YEAR_DAY_FIFTEEN_AUDIO, BIBLE_YEAR_DAY_FIFTY_AUDIO, BIBLE_YEAR_DAY_FIFTY_EIGHT_AUDIO, BIBLE_YEAR_DAY_FIFTY_FIVE_AUDIO, BIBLE_YEAR_DAY_FIFTY_FOUR_AUDIO, BIBLE_YEAR_DAY_FIFTY_NINE_AUDIO, BIBLE_YEAR_DAY_FIFTY_ONE_AUDIO, BIBLE_YEAR_DAY_FIFTY_SEVEN_AUDIO, BIBLE_YEAR_DAY_FIFTY_SIX_AUDIO, BIBLE_YEAR_DAY_FIFTY_THREE_AUDIO, BIBLE_YEAR_DAY_FIFTY_TWO_AUDIO, BIBLE_YEAR_DAY_FIVE_AUDIO, BIBLE_YEAR_DAY_FORTY_AUDIO, BIBLE_YEAR_DAY_FORTY_EIGHT_AUDIO, BIBLE_YEAR_DAY_FORTY_FIVE_AUDIO, BIBLE_YEAR_DAY_FORTY_FOUR_AUDIO, BIBLE_YEAR_DAY_FORTY_NINE_AUDIO, BIBLE_YEAR_DAY_FORTY_ONE_AUDIO, BIBLE_YEAR_DAY_FORTY_SEVEN_AUDIO, BIBLE_YEAR_DAY_FORTY_SIX_AUDIO, BIBLE_YEAR_DAY_FORTY_THREE_AUDIO, BIBLE_YEAR_DAY_FORTY_TWO_AUDIO, BIBLE_YEAR_DAY_FOUR_AUDIO, BIBLE_YEAR_DAY_FOURTEEN_AUDIO, BIBLE_YEAR_DAY_NINE_AUDIO, BIBLE_YEAR_DAY_NINETEEN_AUDIO, BIBLE_YEAR_DAY_ONE_AUDIO, BIBLE_YEAR_DAY_SEVEN_AUDIO, BIBLE_YEAR_DAY_SEVENTEEN_AUDIO, BIBLE_YEAR_DAY_SIX_AUDIO, BIBLE_YEAR_DAY_SIXTEEN_AUDIO, BIBLE_YEAR_DAY_SIXTY_AUDIO, BIBLE_YEAR_DAY_SIXTY_FIVE_AUDIO, BIBLE_YEAR_DAY_SIXTY_FOUR_AUDIO, BIBLE_YEAR_DAY_SIXTY_ONE_AUDIO, BIBLE_YEAR_DAY_SIXTY_THREE_AUDIO, BIBLE_YEAR_DAY_SIXTY_TWO_AUDIO, BIBLE_YEAR_DAY_TEN_AUDIO, BIBLE_YEAR_DAY_THIRTEEN_AUDIO, BIBLE_YEAR_DAY_THIRTY_AUDIO, BIBLE_YEAR_DAY_THIRTY_EIGHT_AUDIO, BIBLE_YEAR_DAY_THIRTY_FIVE_AUDIO, BIBLE_YEAR_DAY_THIRTY_FOUR_AUDIO, BIBLE_YEAR_DAY_THIRTY_NINE_AUDIO, BIBLE_YEAR_DAY_THIRTY_ONE_AUDIO, BIBLE_YEAR_DAY_THIRTY_SEVEN_AUDIO, BIBLE_YEAR_DAY_THIRTY_SIX_AUDIO, BIBLE_YEAR_DAY_THIRTY_THREE_AUDIO, BIBLE_YEAR_DAY_THIRTY_TWO_AUDIO, BIBLE_YEAR_DAY_THREE_AUDIO, BIBLE_YEAR_DAY_TWELVE_AUDIO, BIBLE_YEAR_DAY_TWENTY_AUDIO, BIBLE_YEAR_DAY_TWENTY_EIGHT_AUDIO, BIBLE_YEAR_DAY_TWENTY_FIVE_AUDIO, BIBLE_YEAR_DAY_TWENTY_FOUR_AUDIO, BIBLE_YEAR_DAY_TWENTY_NINE_AUDIO, BIBLE_YEAR_DAY_TWENTY_ONE_AUDIO, BIBLE_YEAR_DAY_TWENTY_SEVEN_AUDIO, BIBLE_YEAR_DAY_TWENTY_SIX_AUDIO, BIBLE_YEAR_DAY_TWENTY_THREE_AUDIO, BIBLE_YEAR_DAY_TWENTY_TWO_AUDIO, BIBLE_YEAR_DAY_TWO_AUDIO } from "../lib/bibleYearAudio";
import { BIBLE_YEAR_DAY_SEVENTY_AUDIO, BIBLE_YEAR_DAY_SEVENTY_FIVE_AUDIO, BIBLE_YEAR_DAY_SEVENTY_FOUR_AUDIO, BIBLE_YEAR_DAY_SEVENTY_ONE_AUDIO, BIBLE_YEAR_DAY_SEVENTY_THREE_AUDIO, BIBLE_YEAR_DAY_SEVENTY_TWO_AUDIO, BIBLE_YEAR_DAY_SIXTY_EIGHT_AUDIO, BIBLE_YEAR_DAY_SIXTY_NINE_AUDIO, BIBLE_YEAR_DAY_SIXTY_SEVEN_AUDIO, BIBLE_YEAR_DAY_SIXTY_SIX_AUDIO } from "../lib/bibleYearAudio";
...
import { EXODUS_DAY_TWENTY_FOUR_PASSOVER_AND_DELIVERANCE_LESSON } from "../lib/bibleYearDayTwentyFourDeepNotes";
import { EXODUS_DAY_TWENTY_FIVE_THROUGH_THE_SEA_LESSON } from "../lib/bibleYearDayTwentyFiveDeepNotes";
...
import { LEVITICUS_DAY_THIRTY_THREE_GUILT_CONSECRATION_AND_PRIESTS_LESSON } from "../lib/bibleYearDayThirtyThreeDeepNotes";
import { LEVITICUS_DAY_THIRTY_FOUR_WORSHIP_HOLINESS_AND_CLEAN_LIVING_LESSON } from "../lib/bibleYearDayThirtyFourDeepNotes";
import { LEVITICUS_DAY_THIRTY_FIVE_CLEANSING_AND_DAY_OF_ATONEMENT_LESSON } from "../lib/bibleYearDayThirtyFiveDeepNotes";
import { LEVITICUS_DAY_THIRTY_SIX_HOLY_LIVING_BEFORE_A_HOLY_GOD_LESSON } from "../lib/bibleYearDayThirtySixDeepNotes";
import { LEVITICUS_DAY_THIRTY_SEVEN_PRIESTS_FEASTS_AND_SACRED_ORDER_LESSON, LEVITICUS_NUMBERS_DAY_THIRTY_EIGHT_JUBILEE_COVENANT_AND_ISRAEL_COUNTED_LESSON, NUMBERS_DAY_FORTY_BLESSING_DEDICATION_AND_PASSOVER_LESSON, NUMBERS_DAY_THIRTY_NINE_CAMP_ORDER_AND_PURITY_LESSON } from "../lib/bibleYearDaysThirtySevenToFortyDeepNotes";
import { NUMBERS_DAY_FORTY_FOUR_BALAAM_BLESSING_AND_COMPROMISE_LESSON, NUMBERS_DAY_FORTY_ONE_JOURNEY_COMPLAINTS_AND_SPIES_LESSON, NUMBERS_DAY_FORTY_THREE_PROVISION_JUDGMENT_AND_BRONZE_SERPENT_LESSON, NUMBERS_DAY_FORTY_TWO_REBELLION_AND_CHOSEN_PRIESTHOOD_LESSON } from "../lib/bibleYearDaysFortyOneToFortyFourDeepNotes";
import { DEUTERONOMY_DAY_FIFTY_COVENANT_LOYALTY_FROM_THE_HEART_LESSON, DEUTERONOMY_DAY_FORTY_EIGHT_REMEMBERING_JOURNEY_AND_COVENANT_LESSON, DEUTERONOMY_DAY_FORTY_NINE_LOVE_GOD_AND_REMEMBER_GRACE_LESSON, NUMBERS_DAY_FORTY_FIVE_NEW_GENERATION_COUNTED_LESSON, NUMBERS_DAY_FORTY_SIX_VOWS_VICTORY_AND_JOURNEY_REVIEWED_LESSON, NUMBERS_DEUTERONOMY_DAY_FORTY_SEVEN_LAND_BOUNDARIES_AND_MOSES_LOOKS_BACK_LESSON } from "../lib/bibleYearDaysFortyFiveToFiftyDeepNotes";
import { DEUTERONOMY_DAY_FIFTY_FOUR_BLESSING_CURSE_AND_COVENANT_RENEWAL_LESSON, DEUTERONOMY_DAY_FIFTY_ONE_WORSHIP_JUSTICE_AND_LEADERSHIP_LESSON, DEUTERONOMY_DAY_FIFTY_THREE_EVERYDAY_FAITHFULNESS_LESSON, DEUTERONOMY_DAY_FIFTY_TWO_PROPHETS_CITIES_AND_JUSTICE_LESSON } from "../lib/bibleYearDaysFiftyOneToFiftyFourDeepNotes";
import { DEUTERONOMY_DAY_FIFTY_FIVE_CHOOSE_LIFE_AND_MOSES_BLESSING_LESSON, DEUTERONOMY_JOSHUA_DAY_FIFTY_SIX_MOSES_DIES_AND_JOSHUA_LEADS_LESSON, JOSHUA_DAY_FIFTY_EIGHT_CONQUEST_AND_COVENANT_OBEDIENCE_LESSON, JOSHUA_DAY_FIFTY_SEVEN_MEMORIAL_STONES_JERICHO_AND_ACHAN_LESSON } from "../lib/bibleYearDaysFiftyFiveToFiftyEightDeepNotes";
import { JOSHUA_DAY_FIFTY_NINE_LAND_IS_DISTRIBUTED_LESSON, JOSHUA_DAY_SIXTY_INHERITANCE_FOR_THE_TRIBES_LESSON } from "../lib/bibleYearDaysFiftyNineToSixtyDeepNotes";
...
const DAY_TWENTY_FOUR_APPROVED_SCRIPT_PATH = join(process.cwd(), "docs", "bible-in-one-year-day-24-narrator-script.md");
const DAY_TWENTY_FIVE_APPROVED_SCRIPT_PATH = join(process.cwd(), "docs", "bible-in-one-year-day-25-narrator-script.md");
...
const DAY_THIRTY_THREE_APPROVED_SCRIPT_PATH = join(process.cwd(), "docs", "bible-in-one-year-day-33-narrator-script.md");
const DAY_THIRTY_FOUR_APPROVED_SCRIPT_PATH = join(process.cwd(), "docs", "bible-in-one-year-day-34-narrator-script.md");
const DAY_THIRTY_FIVE_APPROVED_SCRIPT_PATH = join(process.cwd(), "docs", "bible-in-one-year-day-35-narrator-script.md");
const DAY_THIRTY_SIX_APPROVED_SCRIPT_PATH = join(process.cwd(), "docs", "bible-in-one-year-day-36-narrator-script.md");
const DAY_THIRTY_SEVEN_APPROVED_SCRIPT_PATH = join(process.cwd(), "docs", "bible-in-one-year-day-37-narrator-script.md");
const DAY_THIRTY_EIGHT_APPROVED_SCRIPT_PATH = join(process.cwd(), "docs", "bible-in-one-year-day-38-narrator-script.md");
const DAY_THIRTY_NINE_APPROVED_SCRIPT_PATH = join(process.cwd(), "docs", "bible-in-one-year-day-39-narrator-script.md");
const DAY_FORTY_APPROVED_SCRIPT_PATH = join(process.cwd(), "docs", "bible-in-one-year-day-40-narrator-script.md");
const DAY_FORTY_ONE_APPROVED_SCRIPT_PATH = join(process.cwd(), "docs", "bible-in-one-year-day-41-narrator-script.md");
const DAY_FORTY_TWO_APPROVED_SCRIPT_PATH = join(process.cwd(), "docs", "bible-in-one-year-day-42-narrator-script.md");
const DAY_FORTY_THREE_APPROVED_SCRIPT_PATH = join(process.cwd(), "docs", "bible-in-one-year-day-43-narrator-script.md");
const DAY_FORTY_FOUR_APPROVED_SCRIPT_PATH = join(process.cwd(), "docs", "bible-in-one-year-day-44-narrator-script.md");
const DAY_FORTY_FIVE_APPROVED_SCRIPT_PATH = join(process.cwd(), "docs", "bible-in-one-year-day-45-narrator-script.md");
const DAY_FORTY_SIX_APPROVED_SCRIPT_PATH = join(process.cwd(), "docs", "bible-in-one-year-day-46-narrator-script.md");
const DAY_FORTY_SEVEN_APPROVED_SCRIPT_PATH = join(process.cwd(), "docs", "bible-in-one-year-day-47-narrator-script.md");
...
function speakBlockReference(reference: string, chapter: number, startVerse: number, endVerse: number) {
  const bookMatch = reference.match(/^(.+?)\s+\d+:/);
  const book = bookMatch?.[1] || "Genesis";
  if (startVerse === endVerse) return `${book} ${chapter} verse ${startVerse}.`;
  return `${book} ${chapter} verses ${startVerse} through ${endVerse}.`;
}
...
function buildBibleYearSpeechText(lesson: BibleYearDailyLesson) {
  ...
  for (const section of lesson.sections) {
    const block = section.verseBlock;
    const isGenesisSection = block.reference.startsWith("Genesis ");
    const verses = isGenesisSection ? getVerses(block.chapter, block.startVerse, block.endVerse) : [];
    const scripture = verses.map((verse) => verse.text).join(" ");
    parts.push([speakBlockReference(block.reference, block.chapter, block.startVerse, block.endVerse), scripture].filter(Boolean).join(" "));
...
function getApprovedBibleYearScriptPath(dayNumber: number) {
  if (dayNumber >= 51) {
    const generatedPath = join(process.cwd(), "docs", `bible-in-one-year-day-${dayNumber}-narrator-script.md`);
  ...
  if (dayNumber === 24) return DAY_TWENTY_FOUR_APPROVED_SCRIPT_PATH;
  if (dayNumber === 25) return DAY_TWENTY_FIVE_APPROVED_SCRIPT_PATH;
  ...
  if (dayNumber === 33) return DAY_THIRTY_THREE_APPROVED_SCRIPT_PATH;
  if (dayNumber === 34) return DAY_THIRTY_FOUR_APPROVED_SCRIPT_PATH;
  if (dayNumber === 35) return DAY_THIRTY_FIVE_APPROVED_SCRIPT_PATH;
  if (dayNumber === 36) return DAY_THIRTY_SIX_APPROVED_SCRIPT_PATH;
  if (dayNumber === 37) return DAY_THIRTY_SEVEN_APPROVED_SCRIPT_PATH;
  if (dayNumber === 38) return DAY_THIRTY_EIGHT_APPROVED_SCRIPT_PATH;
  if (dayNumber === 39) return DAY_THIRTY_NINE_APPROVED_SCRIPT_PATH;
  if (dayNumber === 40) return DAY_FORTY_APPROVED_SCRIPT_PATH;
  if (dayNumber === 41) return DAY_FORTY_ONE_APPROVED_SCRIPT_PATH;
  if (dayNumber === 42) return DAY_FORTY_TWO_APPROVED_SCRIPT_PATH;
  if (dayNumber === 43) return DAY_FORTY_THREE_APPROVED_SCRIPT_PATH;
  if (dayNumber === 44) return DAY_FORTY_FOUR_APPROVED_SCRIPT_PATH;
  if (dayNumber === 45) return DAY_FORTY_FIVE_APPROVED_SCRIPT_PATH;
  if (dayNumber === 46) return DAY_FORTY_SIX_APPROVED_SCRIPT_PATH;
  if (dayNumber === 47) return DAY_FORTY_SEVEN_APPROVED_SCRIPT_PATH;
