...
// Script to seed "Women of the Bible" devotional with all 21 days
// Run with: npx tsx scripts/seed-women-of-the-bible.ts
console.log("🔍 Executing: scripts/seed-women-of-the-bible.ts");
...
const devotionalDays: DevotionalDay[] = [
  ...
  {
    day_number: 1,
    day_title: "How Women Shaped God's Story",
    devotional_text: `Before we begin this journey, we need to do something important.
...
Pay attention. Every day of this matters.`,
    bible_reading_reference: "Genesis 1:26-31",
    reflection_question: "Before beginning this study, what is your honest picture of how women fit into the biblical story? Is there a woman from Scripture whose story you've always wanted to understand more deeply?",
  },
  {
    day_number: 2,
    day_title: "How Women Were Treated Before Jesus",
    devotional_text: `To understand what Jesus did for women, you need to understand what the world looked like before He did it.
...
The women in this devotional didn't just survive a hard world. They shaped history inside it. And the God who met them is still the same God — the one who goes looking for people the world has discarded and finds them worth everything.`,
    bible_reading_reference: "Proverbs 31:10-31",
    reflection_question: "How does understanding the historical treatment of women in the ancient world change the way you read the women's stories in the Bible? Does it make their faith feel more costly to you?",
  },
  {
    day_number: 3,
    day_title: "How Jesus Changed Everything",
    devotional_text: `There is a case to be made — and I think it's a strong one — that Jesus of Nazareth was the most countercultural figure in human history when it came to how He treated women.
...
In any century, it is the shape of the kingdom.`,
    bible_reading_reference: "John 20:11-18",
    reflection_question: "Which moment in Jesus' interaction with women strikes you most powerfully? What does it say to you personally about how God sees you?",
  },

  // ─────────────────────────────────────────────
  // PART 2 — WOMEN OF THE BIBLE
  // ─────────────────────────────────────────────
  {
    day_number: 4,
    day_title: "Eve — The First Woman",
    devotional_text: `She has no mother. No childhood. No memory of being young.
...
The same women whose act introduced death into the world became the channel through which life returned to it.
...
That is still His way.`,
    bible_reading_reference: "Genesis 3:1-21",
    reflection_question: "The protoevangelium in Genesis 3:15 is God's first gospel announcement, made in the moment of greatest failure. How does knowing that redemption was promised at the very beginning of the story change how you think about God's response to human failure — including your own?",
  },
  {
    day_number: 5,
    day_title: "Sarah — Laughing at the Impossible",
    devotional_text: `Sarah is ninety years old when the most important thing in her life happens.
...
Because He wants you to remember forever that He is the God who does the impossible.`,
    bible_reading_reference: "Genesis 18:1-15",
    reflection_question: "Sarah laughed at the impossible, then denied it, and God named her son after the moment of her doubt as a permanent memorial to His faithfulness. Is there a promise God has given you that you have privately laughed at? What would it mean to trust Him with that specific thing?",
  },
  {
    day_number: 6,
    day_title: "Hagar — The God Who Sees",
    devotional_text: `Nobody chose Hagar's life for her.
...
He still is.`,
    bible_reading_reference: "Genesis 16:1-13",
    reflection_question: "Hagar named God 'El Roi' — the God who sees — in the moment she felt most abandoned and invisible. Is there an area of your life right now where you need to know that God sees what's happening? What would it mean for you to trust El Roi with that specific pain?",
  },
  {
    day_number: 7,
    day_title: "Rebekah — The Woman Who Chose",
    devotional_text: `She is asked one question, and everything depends on her answer.
...
That's enough.`,
    bible_reading_reference: "Genesis 24:10-27",
    reflection_question: "Rebekah left her entire world — family, home, community — on the basis of one story about a prayer answered at a well. What is a decision you are facing that requires trusting a word God has already spoken, even when the full picture isn't clear?",
  },
  {
    day_number: 8,
    day_title: "Rachel and Leah — Loved and Unloved",
    devotional_text: `This story is painful to read if you're paying attention. It should be.
...
He always does.`,
    bible_reading_reference: "Genesis 29:16-35",
    reflection_question: "Leah's heart shift — from naming her sons after her longing for Jacob's love to simply praising God — is one of the quietest transformations in the Bible. Is there something you have been pursuing as a substitute for God's love that He might be asking you to let go of?",
  },
  {
    day_number: 9,
    day_title: "Miriam — The Prophet Sister",
    devotional_text: `Miriam is on the scene before Moses is even named.
...
And the people waited for her to come back.`,
    bible_reading_reference: "Exodus 15:19-21",
    reflection_question: "Miriam's pride came from comparing her gift to Moses' gift — 'Has God spoken only through Moses?' Where in your life are you prone to measuring your calling against someone else's and letting that comparison become a source of bitterness or entitlement?",
  },
  {
    day_number: 10,
    day_title: "Rahab — The Unlikely Ancestor",
    devotional_text: `Rahab lives in a house built into the city wall of Jericho.
...
She is exactly the person Jesus came for.`,
    bible_reading_reference: "Joshua 2:1-21",
    reflection_question: "Rahab recognized God's power before she was officially part of His people, and she acted on what she believed before she had any guarantee of the outcome. What do you know about God right now that you have not yet acted on?",
  },
  {
    day_number: 11,
    day_title: "Deborah — The Judge Who Led a Nation",
    devotional_text: `Judges is a difficult book.
...
Forty years. An entire generation of peace, secured through a woman sitting under a palm tree, listening to God, and then going to war.`,
    bible_reading_reference: "Judges 4:1-16",
    reflection_question: "Deborah stepped into a leadership gap because no one else would — not out of ambition, but out of faithfulness. Is there a place in your community, church, or family where you have been waiting for someone else to step up, when God might be asking you to be the one who acts?",
  },
  {
    day_number: 12,
    day_title: "Ruth — Loyalty Beyond Loss",
    devotional_text: `The book of Ruth is only four chapters long. You can read it in twenty minutes.
...
That is the shape of God's redemption.`,
    bible_reading_reference: "Ruth 1:1-22",
    reflection_question: "Ruth's covenant loyalty to Naomi — 'where you go I will go' — was made at her own expense, with no guarantee of how it would turn out. Is there a relationship in your life right now where God is calling you to show that kind of unconditional faithfulness, even at personal cost?",
  },
  {
    day_number: 13,
    day_title: "Hannah — The Woman Who Prayed",
    devotional_text: `Hannah is in pain every single year.
...
That is the shape of faith that moves the world.`,
    bible_reading_reference: "1 Samuel 1:1-20",
    reflection_question: "Hannah gave back to God the very thing she had asked Him for — the deepest desire of her heart. Is there something God has given you that He might be asking you to hold more loosely, to keep open-handed rather than gripping tightly?",
  },
  {
    day_number: 14,
    day_title: "Bathsheba — From Tragedy to the Throne",
    devotional_text: `The story of Bathsheba is almost always told as a story about David.
...
The woman the world used becomes the mother of the builder.`,
    bible_reading_reference: "2 Samuel 12:13-25",
    reflection_question: "Bathsheba experienced profound injustice and loss — things that were done to her, not chosen by her — and yet God built something significant through her life and her son. Is there damage done to you that you have been waiting for God to address? What would it mean to trust that He is not finished with that part of your story?",
  },
  {
    day_number: 15,
    day_title: "Esther — For Such a Time as This",
    devotional_text: `The book of Esther never mentions God.
...
Who knows but that you have come to where you are for such a time as this?`,
    bible_reading_reference: "Esther 4:1-17",
    reflection_question: "Esther's courage was not the absence of fear — she was clearly afraid — but she went anyway. Where in your life right now is God asking you to act despite fear, and what is the 'such a time as this' He may have been preparing you for?",
  },
  {
    day_number: 16,
    day_title: "Mary — The Unlikely Mother",
    devotional_text: `She is probably about fourteen years old.
...
That is all God ever asks.`,
    bible_reading_reference: "Luke 1:26-56",
    reflection_question: "Mary said yes to something she could not fully understand, with no guarantee of how it would affect her reputation or her future. What is God asking of you that you have been hesitating to say yes to because you can't see the full picture?",
  },
  {
    day_number: 17,
    day_title: "Mary Magdalene — The First Witness",
    devotional_text: `She has been described as a reformed prostitute for most of church history.
...
Yours is one of them.`,
    bible_reading_reference: "John 20:1-18",
    reflection_question: "Mary Magdalene refused to leave the tomb even when everyone else did — and her refusal to stop looking is what positioned her to encounter the risen Jesus first. Is there something in your faith that you have given up on too quickly, that God might be asking you to stay with a little longer?",
  },
  {
    day_number: 18,
    day_title: "The Woman at the Well",
    devotional_text: `Jesus doesn't end up at this well by accident.
...
He still does.`,
    bible_reading_reference: "John 4:1-42",
    reflection_question: "The woman at the well had a past she had been hiding from — and the encounter with Jesus who knew everything about her, and offered her living water anyway, freed her to stop hiding. Is there something in your story you are protecting or concealing from God that He already knows about and is already offering living water for?",
  },
  {
    day_number: 19,
    day_title: "The Woman Who Touched His Robe",
    devotional_text: `Twelve years.
...
It still does.`,
    bible_reading_reference: "Mark 5:24-34",
    reflection_question: "The woman with the bleeding reached out in desperate, anonymous, slightly transgressive faith — and Jesus called her forward publicly and named her daughter. Where are you reaching for Jesus right now from a place of desperation, and have you been afraid to let that be seen?",
  },
  {
    day_number: 20,
    day_title: "Priscilla — The Teacher",
    devotional_text: `She is mentioned six times in the New Testament.
...
He has never stopped.`,
    bible_reading_reference: "Acts 18:24-28",
    reflection_question: "Priscilla used her home, her knowledge, and her relationship to disciple one of the most gifted teachers in the early church — without publicity or prominence, just faithfulness. What knowledge, skill, or relational access has God given you that could build up someone else in their faith right now?",
  },
  ...
  {
    day_number: 21,
    day_title: "What These Women's Lives Mean for You",
    devotional_text: `We have been in this story for twenty days.
...
Your part is waiting.`,
    bible_reading_reference: "Galatians 3:26-29",
    reflection_question: "Looking back over these 21 days — which of these women's stories resonated most with your own? What is the one thing you are going to carry forward from this study, and what is the one step you are going to take in response to it?",
  },
];

async function seedDevotional() {
  console.log("Starting to seed 'Women of the Bible' devotional...\n");

  // Check if devotional already exists
  const { data: existingDevotional } = await supabase
    .from("devotionals")
    .select("id")
    .eq("title", "Women of the Bible")
    .single();
  ...
  if (existingDevotional) {
    ...
    const { data: devotional, error: devotionalError } = await supabase
      ...
      .insert({
        ...
        description: `From Eve in the garden to Priscilla in the house church, women have been at the center of what God was doing — not on the margins, not as footnotes, but as central figures whose faith, courage, and choices shaped the entire biblical story.

This 21-day devotional walks through twenty women of Scripture — their real stories, their real world, their real faith. Part 1 builds the foundation: how central women were to God's plan, what life actually looked like for women in the ancient world, and how Jesus changed everything. Part 2 spends a day with each woman — from Eve to Priscilla. Part 3 lands the question on you.

This is not a study about gender. It's a study about the God who has always worked through the people the world overlooked — and what that means for your life right now.`,
        total_days: 21,
        cover_image: "womenofthebible.png",
      })
      .select()
      .single();
