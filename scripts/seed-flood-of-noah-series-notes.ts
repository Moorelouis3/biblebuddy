...
async function main() {
  ...
  if (error) {
    console.error("Failed to upsert Flood of Noah series notes:", error);
    process.exit(1);
  }
  ...
  console.log("Seeded Flood of Noah week notes 1-6 into series_week_notes and Genesis 5-10 into bible_notes.");
}
