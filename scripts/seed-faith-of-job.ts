...
// Script to seed "The Faith of Job" devotional with all 21 days
...
const devotionalDays: DevotionalDay[] = [
  // ─────────────────────────────────────────────
  // PART 1 — THE MAN AND THE MOMENT
  // ─────────────────────────────────────────────
  {
    day_number: 1,
    day_title: "Who Was Job?",
    devotional_text: `The book of Job begins with a statement that is almost jarring in its clarity.
...
Let's go in.`,
    bible_reading_reference: "Job 1:1-5",
    reflection_question: "Job is described as 'blameless and upright' before any of his suffering begins. Have you ever experienced suffering that you couldn't connect to any failure or sin on your part? How did that affect your understanding of who God is?",
  },
  {
    day_number: 2,
    day_title: "The Meeting in Heaven",
    devotional_text: `Job 1:6 contains one of the most startling scene changes in all of Scripture.
...
He will only know the loss. And what he does with it will be one of the most profound things any human being has ever done.`,
    bible_reading_reference: "Job 1:6-12",
    reflection_question: "Satan's accusation was that Job's faith was only as deep as his blessings — that he worshipped God because God had been good to him. Be honest: how much of your own faith is tied to God being good to you in the way you want? What would your faith look like if the blessings were removed?",
  },
  {
    day_number: 3,
    day_title: "One Day",
    devotional_text: `It all happens in one day.
...
Job didn't understand why. He wouldn't understand why for a very long time. But he trusted anyway. And in the courts of heaven, the accusation had already started to fail.`,
    bible_reading_reference: "Job 1:13-22",
    reflection_question: "'The LORD gave and the LORD has taken away; may the name of the LORD be praised.' Job said this on the worst day of his life. Is there something in your life right now that God has 'taken away' — and have you been able to worship Him in the middle of that, or are you still in the grief? Both are honest places to be.",
  },
  {
    day_number: 4,
    day_title: "The Second Test",
    devotional_text: `Satan comes back.
...
The accusation in heaven was already losing.`,
    bible_reading_reference: "Job 2:1-10",
    reflection_question: "Job asked: 'Shall we accept good from God, and not trouble?' That is one of the hardest questions in the Bible. What does your honest answer to that question reveal about what you actually believe about God — and about what you think your relationship with Him is supposed to look like?",
  },

  // ─────────────────────────────────────────────
  // PART 2 — THE LONG DARKNESS
  // ─────────────────────────────────────────────
  {
    day_number: 5,
    day_title: "The Friends Who Came",
    devotional_text: `Three men hear what has happened to Job and they come.
...
But Job speaks first — after seven days of silence, he opens his mouth and curses the day he was born. "May the day of my birth perish," he says. "May that night be turned to darkness." He does not curse God. But he curses his own existence. He would rather never have been born than to have lived through this. He asks why — "Why did I not perish at birth, and die as I came from the womb?"
...
Before you speak — learn from the friends. Sit down first. Stay.`,
    bible_reading_reference: "Job 2:11-13",
    reflection_question: "The friends' finest hour was the seven days of silence — before they spoke. Think about someone in your life who is suffering right now. Are you more tempted to try to explain their pain or to simply be present in it? What would showing up and sitting in the dirt with them actually look like?",
  },
  {
    day_number: 6,
    day_title: "What Job's Friends Got Wrong",
    devotional_text: `Eliphaz speaks first. He begins with a question that sounds almost gentle: "If someone ventures a word with you, will you be impatient? For who can keep from speaking?"
...
Bildad is less gentle than Eliphaz. He suggests that Job's children may have gotten what they deserved: "When your children sinned against him, he gave them over to the penalty of their sin." Then he doubles down on the principle: "Does God pervert justice? Does the Almighty pervert what is right? When your children sinned against him, he gave them over to the penalty of their sin." He is saying, essentially: the system worked correctly. You and your family are getting what you deserve.
...
God is not honored by explanations that protect a neat system at the expense of the truth. He is honored by people who will sit in the complexity and refuse to lie about it.`,
    bible_reading_reference: "Job 4:1-9",
    reflection_question: "Job's friends used real theology to reach the wrong conclusion about a specific person. Have you ever applied a general principle to someone's suffering in a way that was more about defending your worldview than about actually helping them? What would it have looked like to stay in the complexity instead?",
  },
  {
    day_number: 7,
    day_title: "Job Argues with God",
    devotional_text: `Here is something most people do not realize about the book of Job: Job argues with God.
...
Job 13:3: "But I desire to speak to the Almighty and to argue my case with God." And verse 15, one of the most remarkable sentences in the Old Testament: "Though he slay me, yet will I hope in him; I will surely defend my ways to his face."
...
Bring it to Him. That is what faith looks like in the dark.`,
    bible_reading_reference: "Job 13:1-18",
    reflection_question: "Have you ever been afraid to be completely honest with God about your pain, doubt, or anger — as if it would damage your relationship with Him or prove you lack faith? What would it look like to bring your real, unfiltered self before God, the way Job did?",
  },
  {
    day_number: 8,
    day_title: "\"I Know That My Redeemer Lives\"",
    devotional_text: `Job 19 is the emotional and theological center of the entire book.
...
I will see God. Not just after this life — not just in death — but bodily. In my flesh. I myself will see him with my own eyes.
...
Anyone can confess "my Redeemer lives" when life is good. Job did it when everything was gone.`,
    bible_reading_reference: "Job 19:23-27",
    reflection_question: "'I know that my Redeemer lives' — Job said this when he had nothing left. What do you actually know about God that is not dependent on your circumstances being good? If everything good in your life were stripped away, what would still be true?",
  },
  {
    day_number: 9,
    day_title: "When Darkness Has a Purpose",
    devotional_text: `Job does not know why he is suffering.
...
And it is exactly what faith looks like when it is stripped of everything comfortable and everything easy.`,
    bible_reading_reference: "Job 23:1-12",
    reflection_question: "Job could not find God in any direction — but still chose to believe 'he knows the way that I take.' Have you ever been in a season where God felt completely absent or hidden? What did you do with that? What does 'I cannot find Him but He knows where I am' actually mean to you?",
  },
  {
    day_number: 10,
    day_title: "The Silence of God",
    devotional_text: `One of the things people almost never talk about in Job — maybe because it is the most uncomfortable thing in the book — is how long God is silent.
...
It always is.`,
    bible_reading_reference: "Job 30:16-23",
    reflection_question: "Have you ever gone through a sustained season of praying and feeling like God wasn't answering or wasn't near? How did you handle it? What does it mean to keep trusting someone who is silent — and what does Job's story say about whether that silence is a sign of abandonment?",
  },
  {
    day_number: 11,
    day_title: "Elihu — The Young Man Who Waited",
    devotional_text: `In chapter 32, a new voice enters the conversation.
...
And everything changes.`,
    bible_reading_reference: "Job 32:1-10",
    reflection_question: "Elihu suggested that suffering can be a form of God speaking — not as punishment but as instruction or redirection. Looking back on the hardest seasons of your life, is there anything you came out of them knowing or becoming that you couldn't have gotten any other way?",
  },
  {
    day_number: 12,
    day_title: "Faith That Doesn't Demand Answers",
    devotional_text: `Before God speaks, it is worth pausing to look at what Job has been doing for the entire middle section of this book.
...
Job did. And it was enough.`,
    bible_reading_reference: "Job 31:35-40",
    reflection_question: "Is there something in your life that you have been waiting for God to explain before you fully trust Him? What would it mean to trust His character without the explanation — to hold on the way Job held on, without the information?",
  },
  ...
  {
    day_number: 13,
    day_title: "The Whirlwind",
    devotional_text: `Job 38:1: "Then the LORD spoke to Job out of the storm."
...
And that is enough.`,
    bible_reading_reference: "Job 38:1-18",
    reflection_question: "God answered Job's questions not with explanations but with His own questions — pointing to the scope of what He holds and governs. How does the size of God — the same God who manages the cosmos — change how you think about the things in your life that are out of your control?",
  },
  {
    day_number: 14,
    day_title: "\"Where Were You?\" — The Answer You Didn't Expect",
    devotional_text: `Let's be honest about the questions God asks Job.
...
And Job, to his credit, heard it.`,
    bible_reading_reference: "Job 38:31-41",
    reflection_question: "God pointed to His attention to ravens and mountain goats as evidence of His care. What would it mean for you — in whatever you're facing right now — to trust that the same God who watches a raven's nest has not stopped watching you? How does that change what you do with your fear?",
  },
  {
    day_number: 15,
    day_title: "Job's Response — \"Now My Eyes Have Seen You\"",
    devotional_text: `Job 40:3-5: After two full chapters of God's questions, Job speaks. "I am unworthy — how can I reply to you? I put my hand over my mouth. I spoke once, but I have no answer — twice, but I will say no more."
...
That changes a person in ways that nothing else can.`,
    bible_reading_reference: "Job 42:1-6",
    reflection_question: "'My ears had heard of you but now my eyes have seen you.' Is your faith primarily inherited — based on what you've been taught — or have you had your own encounter with God that made it personal and unshakeable? What would it take to go from ears to eyes?",
  },
  ...
  {
    day_number: 16,
    day_title: "God Vindicates Job",
    devotional_text: `After the whirlwind. After Job's response. There is a verdict.
...
Job, who has just been through everything the friends helped put him through — their accusations, their pressure, their insistence that he was guilty — is asked to pray for them. And he does. Job 42:10: "After Job had prayed for his friends, the LORD restored his fortunes."
...
And the restoration is coming.`,
    bible_reading_reference: "Job 42:7-10",
    reflection_question: "God vindicated Job's honest wrestling and was angry at the friends' tidy explanations. Are there ways in which you have been more like the friends — defending a theological system about God instead of being honest about what you're actually experiencing? What would it look like to be more like Job — honest about the complexity, while still holding on?",
  },
  {
    day_number: 17,
    day_title: "The Restoration of Job",
    devotional_text: `Job 42:10-17 is one of the most stunning endings in all of literature.
...
And that God does not change.`,
    bible_reading_reference: "Job 42:10-17",
    reflection_question: "Job's restoration is real — but it's not promised as a formula for everyone. What do you do with the reality that some faithful people suffer and don't see restoration in this lifetime? How does the resurrection change what you believe about the final word God has over suffering?",
  },
  {
    day_number: 18,
    day_title: "What Job Teaches Us About Suffering",
    devotional_text: `We are near the end of Job's story. Before we move to the final days of this devotional, let's name directly what this book has taught us.
...
You were made for this kind of faith. Not for the easy version. For the real one.`,
    bible_reading_reference: "Job 1:20-22",
    reflection_question: "Of the six things Job teaches about suffering, which one hits closest to where you are right now? Which one do you most need to let sink in? Take time with your answer — don't rush past it.",
  },
  {
    day_number: 19,
    day_title: "Praying for the People Who Hurt You",
    devotional_text: `Before Job's restoration begins, God asks him to do something remarkable.
...
Job prayed for his friends. And his life came back.`,
    bible_reading_reference: "Job 42:7-10",
    reflection_question: "Is there someone who hurt you — especially during a time of suffering — that you have been holding a grievance against? What would it cost you to genuinely pray for them? And what might it open up in your own life if you did?",
  },
  {
    day_number: 20,
    day_title: "The God Who Was There the Whole Time",
    devotional_text: `Here is the thing about the book of Job that can change the way you read every hard season of your life.
...
You are not sitting in your ashes alone.`,
    bible_reading_reference: "Romans 8:28-39",
    reflection_question: "Looking back at the hardest season of your life — even if you didn't feel God's presence in it — can you see evidence now that He was there? What did He hold back? What did He ultimately do? And how does that change how you face whatever is hard right now?",
  },
  {
    day_number: 21,
    day_title: "The Faith of Job",
    devotional_text: `We've spent 21 days with Job. Let's end where it all began.
...
That is worth everything.`,
    bible_reading_reference: "Job 42:1-17",
    reflection_question: "What is the one thing from Job's story — one verse, one moment, one truth — that you are taking away from these 21 days? Write it down. Say it out loud. It's yours. Now live it.",
  },
];

async function main() {
  console.log("Starting to seed 'The Faith of Job' devotional...");
  ...
  try {
    const { data, error } = await supabase
      ...
      .insert({
        ...
        description:
          "A 21-day journey through one of the most honest books in the Bible. Follow Job through devastating loss, the silence of God, and a face-to-face encounter with the Almighty — and discover what it means to trust God when you have no answers.",
        total_days: 21,
        cover_image: "/faithofjob.png",
      })
      .select("id")
      .single();
  ...
  console.log("\n🎉 Done! 'The Faith of Job' devotional is ready.");
}
