...
const DAY_10: DayBlueprint = {
  ...
  opening: [
    "Genesis 26-27 follows Isaac's household as the covenant promise continues through a very imperfect family.",
    "Isaac faces famine, repeats some of Abraham's fear, digs wells, and receives God's promise.",
  ...
  closing: [
    "Day 10 shows that the covenant promise continues through Isaac's household.",
