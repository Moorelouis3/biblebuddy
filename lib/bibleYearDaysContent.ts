...
import {
  BIBLE_YEAR_DAY_76_DEEP_NOTES,
  BIBLE_YEAR_DAY_76_DEEP_STUDY_SECTIONS,
  BIBLE_YEAR_DAY_77_DEEP_NOTES,
  BIBLE_YEAR_DAY_77_DEEP_STUDY_SECTIONS,
  BIBLE_YEAR_DAY_78_DEEP_NOTES,
  BIBLE_YEAR_DAY_78_DEEP_STUDY_SECTIONS,
  BIBLE_YEAR_DAY_79_DEEP_NOTES,
  BIBLE_YEAR_DAY_79_DEEP_STUDY_SECTIONS,
  BIBLE_YEAR_DAY_80_DEEP_NOTES,
  BIBLE_YEAR_DAY_80_DEEP_STUDY_SECTIONS,
  BIBLE_YEAR_DAY_81_DEEP_NOTES,
  BIBLE_YEAR_DAY_81_DEEP_STUDY_SECTIONS,
  BIBLE_YEAR_DAY_82_DEEP_NOTES,
  BIBLE_YEAR_DAY_82_DEEP_STUDY_SECTIONS,
  BIBLE_YEAR_DAY_83_DEEP_NOTES,
  BIBLE_YEAR_DAY_83_DEEP_STUDY_SECTIONS,
  BIBLE_YEAR_DAY_84_DEEP_NOTES,
  BIBLE_YEAR_DAY_84_DEEP_STUDY_SECTIONS,
  BIBLE_YEAR_DAY_85_DEEP_NOTES,
  BIBLE_YEAR_DAY_85_DEEP_STUDY_SECTIONS,
...
} from "./bibleYearDaysSeventySixToEightyFiveDeepNotes";
import {
  BIBLE_YEAR_DAY_86_DEEP_NOTES,
  BIBLE_YEAR_DAY_86_DEEP_STUDY_SECTIONS,
  BIBLE_YEAR_DAY_87_DEEP_NOTES,
  BIBLE_YEAR_DAY_87_DEEP_STUDY_SECTIONS,
  BIBLE_YEAR_DAY_88_DEEP_NOTES,
  BIBLE_YEAR_DAY_88_DEEP_STUDY_SECTIONS,
  BIBLE_YEAR_DAY_89_DEEP_NOTES,
  BIBLE_YEAR_DAY_89_DEEP_STUDY_SECTIONS,
  BIBLE_YEAR_DAY_90_DEEP_NOTES,
  BIBLE_YEAR_DAY_90_DEEP_STUDY_SECTIONS,
  BIBLE_YEAR_DAY_91_DEEP_NOTES,
  BIBLE_YEAR_DAY_91_DEEP_STUDY_SECTIONS,
  BIBLE_YEAR_DAY_92_DEEP_NOTES,
  BIBLE_YEAR_DAY_92_DEEP_STUDY_SECTIONS,
  BIBLE_YEAR_DAY_93_DEEP_NOTES,
  BIBLE_YEAR_DAY_93_DEEP_STUDY_SECTIONS,
  BIBLE_YEAR_DAY_94_DEEP_NOTES,
  BIBLE_YEAR_DAY_94_DEEP_STUDY_SECTIONS,
  BIBLE_YEAR_DAY_95_DEEP_NOTES,
  BIBLE_YEAR_DAY_95_DEEP_STUDY_SECTIONS,
...
} from "./bibleYearDaysEightySixToNinetyFiveDeepNotes";
import {
  BIBLE_YEAR_DAY_100_DEEP_NOTES,
  BIBLE_YEAR_DAY_100_DEEP_STUDY_SECTIONS,
  BIBLE_YEAR_DAY_101_DEEP_NOTES,
  BIBLE_YEAR_DAY_101_DEEP_STUDY_SECTIONS,
  BIBLE_YEAR_DAY_102_DEEP_NOTES,
  BIBLE_YEAR_DAY_102_DEEP_STUDY_SECTIONS,
  BIBLE_YEAR_DAY_103_DEEP_NOTES,
  BIBLE_YEAR_DAY_103_DEEP_STUDY_SECTIONS,
  BIBLE_YEAR_DAY_104_DEEP_NOTES,
  BIBLE_YEAR_DAY_104_DEEP_STUDY_SECTIONS,
  BIBLE_YEAR_DAY_105_DEEP_NOTES,
  BIBLE_YEAR_DAY_105_DEEP_STUDY_SECTIONS,
  BIBLE_YEAR_DAY_96_DEEP_NOTES,
  BIBLE_YEAR_DAY_96_DEEP_STUDY_SECTIONS,
  BIBLE_YEAR_DAY_97_DEEP_NOTES,
  BIBLE_YEAR_DAY_97_DEEP_STUDY_SECTIONS,
  BIBLE_YEAR_DAY_98_DEEP_NOTES,
  BIBLE_YEAR_DAY_98_DEEP_STUDY_SECTIONS,
  BIBLE_YEAR_DAY_99_DEEP_NOTES,
  BIBLE_YEAR_DAY_99_DEEP_STUDY_SECTIONS,
...
} from "./bibleYearDaysNinetySixToOneHundredFiveDeepNotes";
...
function getReaderAlignedStudySections(day: GenesisBibleYearDay, fallback: BibleYearDeepStudySection[] | null | undefined) {
  if (day.dayNumber < 1 || day.dayNumber > 260) return fallback ?? null;
...
export const BIBLE_YEAR_DAY_CONTENT: Partial<Record<number, Omit<BibleYearDayContent, "summary"> & { summary?: BibleYearSummaryContent }>> = {
  ...
  76: {
    lesson: SAMUEL_KINGS_DAY_SEVENTY_SIX_SAUL_FALLS_AND_DAVIDS_KINGDOM_BEGINS_LESSON,
    audio: BIBLE_YEAR_DAY_SEVENTY_SIX_AUDIO,
    studyNotesMarkdown: BIBLE_YEAR_DAY_76_DEEP_NOTES,
    studyNotesSections: BIBLE_YEAR_DAY_76_DEEP_STUDY_SECTIONS,
    discussionPrompt: "What does Saul's fall teach you about leadership, grief, and God's timing?",
  },
  77: {
    lesson: SAMUEL_KINGS_DAY_SEVENTY_SEVEN_DAVIDS_THRONE_AND_GODS_PROMISE_LESSON,
    audio: BIBLE_YEAR_DAY_SEVENTY_SEVEN_AUDIO,
    studyNotesMarkdown: BIBLE_YEAR_DAY_77_DEEP_NOTES,
    studyNotesSections: BIBLE_YEAR_DAY_77_DEEP_STUDY_SECTIONS,
    discussionPrompt: "What does God's promise to David teach you about covenant faithfulness?",
  },
  78: {
    lesson: SAMUEL_KINGS_DAY_SEVENTY_EIGHT_DAVIDS_VICTORIES_AND_DAVIDS_SIN_LESSON,
    audio: BIBLE_YEAR_DAY_SEVENTY_EIGHT_AUDIO,
    studyNotesMarkdown: BIBLE_YEAR_DAY_78_DEEP_NOTES,
    studyNotesSections: BIBLE_YEAR_DAY_78_DEEP_STUDY_SECTIONS,
    discussionPrompt: "Where do you see the danger of success without watchfulness?",
  },
  79: {
    lesson: SAMUEL_KINGS_DAY_SEVENTY_NINE_CONSEQUENCES_IN_DAVIDS_HOUSE_LESSON,
    audio: BIBLE_YEAR_DAY_SEVENTY_NINE_AUDIO,
    studyNotesMarkdown: BIBLE_YEAR_DAY_79_DEEP_NOTES,
    studyNotesSections: BIBLE_YEAR_DAY_79_DEEP_STUDY_SECTIONS,
    discussionPrompt: "What does David's house teach you about forgiveness and consequences?",
  },
  80: {
    lesson: SAMUEL_KINGS_DAY_EIGHTY_ABSALOMS_REBELLION_AND_DAVIDS_GRIEF_LESSON,
    audio: BIBLE_YEAR_DAY_EIGHTY_AUDIO,
    studyNotesMarkdown: BIBLE_YEAR_DAY_80_DEEP_NOTES,
    studyNotesSections: BIBLE_YEAR_DAY_80_DEEP_STUDY_SECTIONS,
    discussionPrompt: "What do David's grief and Absalom's rebellion reveal about broken leadership?",
  },
  81: {
    lesson: SAMUEL_KINGS_DAY_EIGHTY_ONE_DAVIDS_LATER_REIGN_AND_MIGHTY_MEN_LESSON,
    audio: BIBLE_YEAR_DAY_EIGHTY_ONE_AUDIO,
    studyNotesMarkdown: BIBLE_YEAR_DAY_81_DEEP_NOTES,
    studyNotesSections: BIBLE_YEAR_DAY_81_DEEP_STUDY_SECTIONS,
    discussionPrompt: "What does David's later reign teach you about courage, weakness, and worship?",
  },
  82: {
    lesson: SAMUEL_KINGS_DAY_EIGHTY_TWO_DAVIDS_CENSUS_AND_SOLOMONS_WISDOM_LESSON,
    audio: BIBLE_YEAR_DAY_EIGHTY_TWO_AUDIO,
    studyNotesMarkdown: BIBLE_YEAR_DAY_82_DEEP_NOTES,
    studyNotesSections: BIBLE_YEAR_DAY_82_DEEP_STUDY_SECTIONS,
    discussionPrompt: "Why does the story move from David's failure to Solomon's need for wisdom?",
  },
  83: {
    lesson: SAMUEL_KINGS_DAY_EIGHTY_THREE_SOLOMONS_WISDOM_AND_TEMPLE_PREPARATIONS_LESSON,
    audio: BIBLE_YEAR_DAY_EIGHTY_THREE_AUDIO,
    studyNotesMarkdown: BIBLE_YEAR_DAY_83_DEEP_NOTES,
    studyNotesSections: BIBLE_YEAR_DAY_83_DEEP_STUDY_SECTIONS,
    discussionPrompt: "What does Solomon's wisdom teach you about leadership before building?",
  },
  84: {
    lesson: SAMUEL_KINGS_DAY_EIGHTY_FOUR_TEMPLE_GLORY_AND_SOLOMONS_FALL_LESSON,
    audio: BIBLE_YEAR_DAY_EIGHTY_FOUR_AUDIO,
    studyNotesMarkdown: BIBLE_YEAR_DAY_84_DEEP_NOTES,
    studyNotesSections: BIBLE_YEAR_DAY_84_DEEP_STUDY_SECTIONS,
    discussionPrompt: "How can the same life hold both worship and warning?",
  },
  85: {
    lesson: SAMUEL_KINGS_DAY_EIGHTY_FIVE_THE_KINGDOM_DIVIDES_LESSON,
    audio: BIBLE_YEAR_DAY_EIGHTY_FIVE_AUDIO,
    studyNotesMarkdown: BIBLE_YEAR_DAY_85_DEEP_NOTES,
    studyNotesSections: BIBLE_YEAR_DAY_85_DEEP_STUDY_SECTIONS,
    discussionPrompt: "What does the divided kingdom teach you about pride, counsel, and worship?",
  },
  86: {
    lesson: KINGS_CHRONICLES_DAY_EIGHTY_SIX_ELIJAH_CONFRONTS_IDOLATRY_LESSON,
    audio: BIBLE_YEAR_DAY_EIGHTY_SIX_AUDIO,
    studyNotesMarkdown: BIBLE_YEAR_DAY_86_DEEP_NOTES,
    studyNotesSections: BIBLE_YEAR_DAY_86_DEEP_STUDY_SECTIONS,
    discussionPrompt: "What does Elijah's confrontation teach you about worship when idolatry is normal?",
  },
  87: {
    lesson: KINGS_CHRONICLES_DAY_EIGHTY_SEVEN_AHABS_FALL_AND_ELIJAHS_FINAL_WARNINGS_LESSON,
    audio: BIBLE_YEAR_DAY_EIGHTY_SEVEN_AUDIO,
    studyNotesMarkdown: BIBLE_YEAR_DAY_87_DEEP_NOTES,
    studyNotesSections: BIBLE_YEAR_DAY_87_DEEP_STUDY_SECTIONS,
    discussionPrompt: "How do Ahab's choices warn you about ignoring God's word?",
  },
  88: {
    lesson: KINGS_CHRONICLES_DAY_EIGHTY_EIGHT_ELISHAS_MINISTRY_BEGINS_LESSON,
    audio: BIBLE_YEAR_DAY_EIGHTY_EIGHT_AUDIO,
    studyNotesMarkdown: BIBLE_YEAR_DAY_88_DEEP_NOTES,
    studyNotesSections: BIBLE_YEAR_DAY_88_DEEP_STUDY_SECTIONS,
    discussionPrompt: "What does Elisha's ministry show about God's power in ordinary needs?",
  },
  89: {
    lesson: KINGS_CHRONICLES_DAY_EIGHTY_NINE_RESCUE_SIEGE_AND_JEHUS_JUDGMENT_LESSON,
    audio: BIBLE_YEAR_DAY_EIGHTY_NINE_AUDIO,
    studyNotesMarkdown: BIBLE_YEAR_DAY_89_DEEP_NOTES,
    studyNotesSections: BIBLE_YEAR_DAY_89_DEEP_STUDY_SECTIONS,
    discussionPrompt: "Where do you see both mercy and judgment in these chapters?",
  },
  90: {
    lesson: KINGS_CHRONICLES_DAY_NINETY_JEHUS_REFORM_AND_ISRAELS_DECLINE_LESSON,
    audio: BIBLE_YEAR_DAY_NINETY_AUDIO,
    studyNotesMarkdown: BIBLE_YEAR_DAY_90_DEEP_NOTES,
    studyNotesSections: BIBLE_YEAR_DAY_90_DEEP_STUDY_SECTIONS,
    discussionPrompt: "What does Jehu's story teach about reform without a fully faithful heart?",
  },
  91: {
    lesson: KINGS_CHRONICLES_DAY_NINETY_ONE_ISRAEL_FALLS_TO_ASSYRIA_LESSON,
    audio: BIBLE_YEAR_DAY_NINETY_ONE_AUDIO,
    studyNotesMarkdown: BIBLE_YEAR_DAY_91_DEEP_NOTES,
    studyNotesSections: BIBLE_YEAR_DAY_91_DEEP_STUDY_SECTIONS,
    discussionPrompt: "What does Israel's fall teach about long-term refusal to listen to God?",
  },
  92: {
    lesson: KINGS_CHRONICLES_DAY_NINETY_TWO_HEZEKIAHS_FAITH_AND_MANASSEHS_EVIL_LESSON,
    audio: BIBLE_YEAR_DAY_NINETY_TWO_AUDIO,
    studyNotesMarkdown: BIBLE_YEAR_DAY_92_DEEP_NOTES,
    studyNotesSections: BIBLE_YEAR_DAY_92_DEEP_STUDY_SECTIONS,
    discussionPrompt: "How do Hezekiah and Manasseh show two very different responses to the LORD?",
  },
  93: {
    lesson: KINGS_CHRONICLES_DAY_NINETY_THREE_JOSIAHS_REFORM_AND_JUDAHS_FALL_LESSON,
    audio: BIBLE_YEAR_DAY_NINETY_THREE_AUDIO,
    studyNotesMarkdown: BIBLE_YEAR_DAY_93_DEEP_NOTES,
    studyNotesSections: BIBLE_YEAR_DAY_93_DEEP_STUDY_SECTIONS,
    discussionPrompt: "What does Josiah's reform teach about hearing Scripture and responding quickly?",
  },
  94: {
    lesson: KINGS_CHRONICLES_DAY_NINETY_FOUR_THE_FAMILY_LINE_OF_GODS_PEOPLE_LESSON,
    audio: BIBLE_YEAR_DAY_NINETY_FOUR_AUDIO,
    studyNotesMarkdown: BIBLE_YEAR_DAY_94_DEEP_NOTES,
    studyNotesSections: BIBLE_YEAR_DAY_94_DEEP_STUDY_SECTIONS,
    discussionPrompt: "Why do genealogies matter for remembering God's people and promises?",
  },
  95: {
    lesson: KINGS_CHRONICLES_DAY_NINETY_FIVE_TRIBES_GENEALOGIES_AND_IDENTITY_LESSON,
    audio: BIBLE_YEAR_DAY_NINETY_FIVE_AUDIO,
    studyNotesMarkdown: BIBLE_YEAR_DAY_95_DEEP_NOTES,
    studyNotesSections: BIBLE_YEAR_DAY_95_DEEP_STUDY_SECTIONS,
    discussionPrompt: "What do these tribal records teach about identity, memory, and belonging to God's people?",
  },
  96: {
    lesson: CHRONICLES_DAY_NINETY_SIX_RETURN_SAUL_AND_DAVIDS_SUPPORTERS_LESSON,
    audio: BIBLE_YEAR_DAY_NINETY_SIX_AUDIO,
    studyNotesMarkdown: BIBLE_YEAR_DAY_96_DEEP_NOTES,
    studyNotesSections: BIBLE_YEAR_DAY_96_DEEP_STUDY_SECTIONS,
    discussionPrompt: "What does Chronicles help you notice about return, memory, and faithful support around David?",
  },
  97: {
    lesson: CHRONICLES_DAY_NINETY_SEVEN_THE_ARK_COMES_TO_JERUSALEM_LESSON,
    audio: BIBLE_YEAR_DAY_NINETY_SEVEN_AUDIO,
    studyNotesMarkdown: BIBLE_YEAR_DAY_97_DEEP_NOTES,
    studyNotesSections: BIBLE_YEAR_DAY_97_DEEP_STUDY_SECTIONS,
    discussionPrompt: "What does the ark's journey teach you about worship, joy, and reverence?",
  },
  98: {
    lesson: CHRONICLES_DAY_NINETY_EIGHT_DAVIDS_COVENANT_AND_VICTORIES_LESSON,
    audio: BIBLE_YEAR_DAY_NINETY_EIGHT_AUDIO,
    studyNotesMarkdown: BIBLE_YEAR_DAY_98_DEEP_NOTES,
    studyNotesSections: BIBLE_YEAR_DAY_98_DEEP_STUDY_SECTIONS,
    discussionPrompt: "How does God's covenant with David shape the way you read the victories that follow?",
  },
  99: {
    lesson: CHRONICLES_DAY_NINETY_NINE_THE_TEMPLE_SITE_AND_PRIESTLY_ORDER_LESSON,
    audio: BIBLE_YEAR_DAY_NINETY_NINE_AUDIO,
    studyNotesMarkdown: BIBLE_YEAR_DAY_99_DEEP_NOTES,
    studyNotesSections: BIBLE_YEAR_DAY_99_DEEP_STUDY_SECTIONS,
    discussionPrompt: "What does David's preparation teach about repentance, worship, and ordering God's house?",
  },
  100: {
    lesson: CHRONICLES_DAY_ONE_HUNDRED_WORSHIP_TEAMS_AND_TEMPLE_PLANS_LESSON,
    audio: BIBLE_YEAR_DAY_ONE_HUNDRED_AUDIO,
    studyNotesMarkdown: BIBLE_YEAR_DAY_100_DEEP_NOTES,
    studyNotesSections: BIBLE_YEAR_DAY_100_DEEP_STUDY_SECTIONS,
    discussionPrompt: "Why does Chronicles spend so much time on worship teams, gatekeepers, and temple plans?",
  },
  101: {
    lesson: CHRONICLES_DAY_ONE_HUNDRED_ONE_DAVIDS_OFFERING_AND_SOLOMONS_TEMPLE_LESSON,
    audio: BIBLE_YEAR_DAY_ONE_HUNDRED_ONE_AUDIO,
    studyNotesMarkdown: BIBLE_YEAR_DAY_101_DEEP_NOTES,
    studyNotesSections: BIBLE_YEAR_DAY_101_DEEP_STUDY_SECTIONS,
    discussionPrompt: "What does David's offering teach about giving freely before the LORD?",
  },
  102: {
    lesson: CHRONICLES_DAY_ONE_HUNDRED_TWO_TEMPLE_DEDICATION_AND_GODS_GLORY_LESSON,
    audio: BIBLE_YEAR_DAY_ONE_HUNDRED_TWO_AUDIO,
    studyNotesMarkdown: BIBLE_YEAR_DAY_102_DEEP_NOTES,
    studyNotesSections: BIBLE_YEAR_DAY_102_DEEP_STUDY_SECTIONS,
    discussionPrompt: "What does the temple dedication teach about God's glory and prayer?",
  },
  103: {
    lesson: CHRONICLES_DAY_ONE_HUNDRED_THREE_SOLOMONS_REIGN_AND_THE_DIVIDED_KINGDOM_LESSON,
    audio: BIBLE_YEAR_DAY_ONE_HUNDRED_THREE_AUDIO,
    studyNotesMarkdown: BIBLE_YEAR_DAY_103_DEEP_NOTES,
    studyNotesSections: BIBLE_YEAR_DAY_103_DEEP_STUDY_SECTIONS,
    discussionPrompt: "What warnings appear as Solomon's reign gives way to division?",
  },
  104: {
    lesson: CHRONICLES_DAY_ONE_HUNDRED_FOUR_KINGS_REFORM_AND_RETURNING_TO_GOD_LESSON,
    audio: BIBLE_YEAR_DAY_ONE_HUNDRED_FOUR_AUDIO,
    studyNotesMarkdown: BIBLE_YEAR_DAY_104_DEEP_NOTES,
    studyNotesSections: BIBLE_YEAR_DAY_104_DEEP_STUDY_SECTIONS,
    discussionPrompt: "What does returning to God look like in these reform chapters?",
  },
  105: {
    lesson: CHRONICLES_DAY_ONE_HUNDRED_FIVE_ASA_JEHOSHAPHAT_AND_TRUST_LESSON,
    audio: BIBLE_YEAR_DAY_ONE_HUNDRED_FIVE_AUDIO,
    studyNotesMarkdown: BIBLE_YEAR_DAY_105_DEEP_NOTES,
    studyNotesSections: BIBLE_YEAR_DAY_105_DEEP_STUDY_SECTIONS,
    discussionPrompt: "Where do Asa and Jehoshaphat teach you to trust the LORD instead of appearances?",
  },
};
