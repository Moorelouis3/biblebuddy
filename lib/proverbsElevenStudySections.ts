...
/**
 * Proverbs 11's study sections, built from Proverbs 11's own notes.
 *
 ...
 * directly. lib/proverbsElevenSource holds only this chapter, so reading from
 * it directly keeps this chapter's data small.
 */
export function getProverbsElevenStudySections(): BibleReaderStudySection[] {
  return PROVERBS_ELEVEN_PERSONAL_SECTIONS.map((section) => ({
    book: "proverbs",
