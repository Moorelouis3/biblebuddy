...
/**
 * Proverbs 14's study sections, built from Proverbs 14's own notes.
 *
 ...
 * directly. lib/proverbsFourteenSource holds only this chapter, so reading from
 * it directly keeps this chapter's data small.
 */
export function getProverbsFourteenStudySections(): BibleReaderStudySection[] {
  return PROVERBS_FOURTEEN_PERSONAL_SECTIONS.map((section) => ({
    book: "proverbs",
