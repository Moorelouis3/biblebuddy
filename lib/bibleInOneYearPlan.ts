...
export const GENESIS_BIBLE_IN_ONE_YEAR_SERIES: GenesisBibleYearDay[] = [
  ...
  },
  {
    ...
    estimatedTime: "about 16 min",
    summary: "Follow Abram rescuing Lot, meeting Melchizedek, receiving covenant promise, and struggling through waiting with Hagar.",
    readings: buildGenesisReadings("The Obedience of Abraham", 14, 16, 4),
  },
  {
    dayNumber: 7,
    title: "Obedience of Abraham",
    ...
    estimatedTime: "about 16 min",
    summary: "Study covenant identity, new names, Isaac's promise, Abraham's intercession, and Sodom's judgment.",
    readings: buildGenesisReadings("The Obedience of Abraham", 17, 19, 7),
  },
  {
    dayNumber: 8,
    title: "Obedience of Abraham",
    ...
    estimatedTime: "about 16 min",
    summary: "Move through Abraham's repeated fear, Isaac's birth, Hagar and Ishmael, and the test on Mount Moriah.",
    readings: buildGenesisReadings("The Obedience of Abraham", 20, 22, 10),
  },
  {
    dayNumber: 9,
    title: "Obedience of Abraham",
