...
export const GENESIS_BIBLE_IN_ONE_YEAR_SERIES: GenesisBibleYearDay[] = [
  ...
  {
    dayNumber: 7,
    title: "The Waiting of Abraham",
    reference: "Genesis 16-18",
    estimatedTime: "about 16 min",
    summary: "Study Hagar, covenant identity, new names, Isaac's promise, and Abraham's intercession.",
    readings: buildGenesisReadings("The Obedience of Abraham", 16, 18, 6),
  },
  {
    dayNumber: 8,
    title: "Promise and Judgment",
    reference: "Genesis 19-21",
    estimatedTime: "about 16 min",
    summary: "Move through Sodom's judgment, Abraham's repeated fear, Isaac's birth, and Hagar and Ishmael.",
    readings: buildGenesisReadings("The Obedience of Abraham", 19, 21, 9),
  },
  {
    dayNumber: 9,
    title: "Abraham's Test and Legacy",
    reference: "Genesis 22-25",
    estimatedTime: "about 16 min",
    summary: "Close Abraham's journey with the test on Mount Moriah, burial, Isaac's bride, and the covenant family moving forward.",
    readings: buildGenesisReadings("The Obedience of Abraham", 22, 25, 12),
  },
  {
    dayNumber: 10,
