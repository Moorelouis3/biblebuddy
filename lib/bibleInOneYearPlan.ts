...
const BIBLE_YEAR_DAY_AUDIO_SUMMARIES: Record<number, string> = {
  1: "God creates the world and forms humanity in His image. Eden shows life, purpose, and rest before sin enters the story.",
  2: "Sin enters through temptation and disobedience. Cain and Abel show how quickly shame and violence spread.",
  3: "Noah's family line leads into a world filled with corruption. God warns Noah and tells him to build the ark.",
  4: "The flood ends and Noah steps into a changed world. God gives covenant mercy, yet human weakness remains.",
  5: "Babel shows human pride before Abram's call begins. God starts forming Abraham's story through obedience and departure.",
  6: "Abraham rescues Lot and refuses Sodom's reward. God then strengthens him with covenant promise.",
  7: "Hagar and Sarah show what happens when people try to force God's promise. God renews the covenant and sets Isaac apart.",
  8: "God visits Abraham, judges Sodom and Gomorrah, and rescues Lot. This day holds both mercy and judgment.",
  9: "Isaac is born, Abraham is tested, and Sarah dies. The story closes with God's promise moving into the next generation.",
  10: "Isaac's family story centers on Jacob and Esau. Blessing, tension, and deception shape the covenant line.",
  11: "Jacob leaves home and meets God at Bethel. His new life begins with promise, love, and hard labor.",
  12: "Jacob's household grows under pressure and conflict. At last he leaves Laban and starts returning by faith.",
  13: "Jacob faces Esau with fear and wrestles through the night with God. He comes out changed and moves toward reconciliation.",
  14: "This part of Genesis closes Jacob's wider family section with grief, violence, and renewal. Esau's descendants are also traced as the nations keep spreading.",
  15: "Joseph's dreams stir jealousy, and his brothers betray him. Judah's story with Tamar shows more brokenness inside the family.",
  16: "Joseph stays faithful in Egypt through temptation, accusation, and prison. God is preparing him in hidden places.",
  17: "Joseph rises from prison to power through God's wisdom. Famine begins, and his brothers stand before him without knowing it.",
  18: "The brothers return to Egypt with Benjamin under pressure and fear. Judah steps forward and shows how much he has changed.",
  19: "Joseph finally reveals himself to his brothers. Forgiveness and reunion begin to heal what betrayal tore apart.",
  20: "Jacob's family settles in Egypt while blessing is passed to the next generation. Even far from Canaan, God's promise is still moving.",
  21: "Jacob blesses his sons, dies, and is buried. Genesis closes with Joseph's forgiveness and hope for what God will do next.",
  22: "Israel suffers in Egypt while God raises up Moses. The story begins turning from slavery toward deliverance.",
  23: "Pharaoh resists God's command and the first plagues fall on Egypt. The conflict sharpens between human pride and God's word.",
  24: "God prepares Israel for Passover and final judgment on Egypt. Rescue comes through the blood of the lamb and the night of deliverance.",
  25: "Israel leaves Egypt and begins learning how to trust God in the wilderness. The journey after rescue becomes part of the lesson.",
  26: "God provides water, defeats enemies, and brings Israel to Sinai. The Ten Commandments show how a rescued people are to live.",
  27: "God's covenant law begins shaping Israel's daily life and relationships. These commands show what holiness and justice look like in community.",
  28: "God gives instructions for the tabernacle, priestly garments, and sacred worship. Israel is being taught how to live near God's presence.",
  29: "While Moses is on the mountain, Israel turns to the golden calf. This day shows how quickly people forget God and how serious idolatry is.",
  30: "Moses pleads for the people, and God speaks again about His presence. The story moves from failure toward mercy and renewed obedience.",
};
...
const RAW_GENESIS_BIBLE_IN_ONE_YEAR_SERIES: GenesisBibleYearDay[] = [
  {
    ...
    summary: BIBLE_YEAR_DAY_AUDIO_SUMMARIES[1],
  ...
  },
  {
    ...
    summary: BIBLE_YEAR_DAY_AUDIO_SUMMARIES[2],
  ...
  },
  {
    ...
    summary: BIBLE_YEAR_DAY_AUDIO_SUMMARIES[4],
  ...
  },
  {
    ...
    estimatedTime: "about 16 min",
    summary: BIBLE_YEAR_DAY_AUDIO_SUMMARIES[5],
  ...
  },
  {
    ...
    estimatedTime: "about 16 min",
    summary: BIBLE_YEAR_DAY_AUDIO_SUMMARIES[6],
  ...
  },
  {
    ...
    summary: BIBLE_YEAR_DAY_AUDIO_SUMMARIES[7],
  ...
  },
  {
    ...
    summary: BIBLE_YEAR_DAY_AUDIO_SUMMARIES[8],
  ...
  },
  {
    ...
    estimatedTime: "about 16 min",
    summary: BIBLE_YEAR_DAY_AUDIO_SUMMARIES[9],
  ...
  },
  {
    ...
    summary: BIBLE_YEAR_DAY_AUDIO_SUMMARIES[10],
  ...
  },
  {
    ...
    estimatedTime: "about 35 min",
    summary: BIBLE_YEAR_DAY_AUDIO_SUMMARIES[11],
  ...
  },
  {
    ...
    summary: BIBLE_YEAR_DAY_AUDIO_SUMMARIES[12],
  ...
  },
  {
    ...
    summary: BIBLE_YEAR_DAY_AUDIO_SUMMARIES[13],
  ...
  },
  {
    ...
    summary: BIBLE_YEAR_DAY_AUDIO_SUMMARIES[14],
  ...
  },
  {
    ...
    estimatedTime: "30-35 min",
    summary: BIBLE_YEAR_DAY_AUDIO_SUMMARIES[15],
  ...
  },
  {
    ...
    estimatedTime: "30-35 min",
    summary: BIBLE_YEAR_DAY_AUDIO_SUMMARIES[16],
  ...
  },
  {
    ...
    estimatedTime: "30-35 min",
    summary: BIBLE_YEAR_DAY_AUDIO_SUMMARIES[17],
  ...
  },
  {
    ...
    estimatedTime: "30-35 min",
    summary: BIBLE_YEAR_DAY_AUDIO_SUMMARIES[18],
  ...
  },
  {
    ...
    estimatedTime: "30-35 min",
    summary: BIBLE_YEAR_DAY_AUDIO_SUMMARIES[19],
  ...
  },
  {
    ...
    estimatedTime: "30-35 min",
    summary: BIBLE_YEAR_DAY_AUDIO_SUMMARIES[20],
  ...
  },
  {
    ...
    estimatedTime: "30-35 min",
    summary: BIBLE_YEAR_DAY_AUDIO_SUMMARIES[21],
  ...
  ...ADDITIONAL_BIBLE_YEAR_SCHEDULE.map((entry) => ({
    ...
    estimatedTime: "30-35 min",
    summary: BIBLE_YEAR_DAY_AUDIO_SUMMARIES[entry.dayNumber] || `Read ${entry.reference}: ${entry.title}.`,
