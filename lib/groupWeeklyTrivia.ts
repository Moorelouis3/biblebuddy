...
const THEMES: WeeklyGroupTriviaTheme[] = [
  {
    key: "life_of_david",
    subjectTitle: "The Life of David",
    subjectLine: "This week's trivia is about the life of David.",
    intro: "Ten questions on the shepherd, the warrior, the king, and the man after God's own heart.",
    questions: [
      { id: "david-1", question: "What was the name of David's father?", options: [{ label: "A", text: "Saul" }, { label: "B", text: "Jesse" }, { label: "C", text: "Boaz" }, { label: "D", text: "Samuel" }], correctAnswer: "B", explanation: "David was the son of Jesse from Bethlehem." },
      { id: "david-2", question: "What was David's job before he became king?", options: [{ label: "A", text: "Carpenter" }, { label: "B", text: "Fisherman" }, { label: "C", text: "Shepherd" }, { label: "D", text: "Tax collector" }], correctAnswer: "C", explanation: "David was a shepherd who watched his father's flocks." },
      { id: "david-3", question: "Which giant did David defeat with a sling and stone?", options: [{ label: "A", text: "Og" }, { label: "B", text: "Goliath" }, { label: "C", text: "Lahmi" }, { label: "D", text: "Ishbi-Benob" }], correctAnswer: "B", explanation: "David defeated the Philistine giant Goliath." },
      { id: "david-4", question: "Who was David's closest and most loyal friend?", options: [{ label: "A", text: "Samuel" }, { label: "B", text: "Abner" }, { label: "C", text: "Jonathan" }, { label: "D", text: "Nathan" }], correctAnswer: "C", explanation: "Jonathan, Saul's son, had a covenant friendship with David." },
      { id: "david-5", question: "What instrument was David known for playing?", options: [{ label: "A", text: "Trumpet" }, { label: "B", text: "Harp" }, { label: "C", text: "Flute" }, { label: "D", text: "Cymbals" }], correctAnswer: "B", explanation: "David played the harp and wrote many of the Psalms." },
      { id: "david-6", question: "Which prophet anointed David as king?", options: [{ label: "A", text: "Elijah" }, { label: "B", text: "Isaiah" }, { label: "C", text: "Nathan" }, { label: "D", text: "Samuel" }], correctAnswer: "D", explanation: "The prophet Samuel anointed David at God's direction." },
      { id: "david-7", question: "What city became known as the City of David?", options: [{ label: "A", text: "Hebron" }, { label: "B", text: "Bethlehem" }, { label: "C", text: "Jerusalem" }, { label: "D", text: "Jericho" }], correctAnswer: "C", explanation: "David captured Jerusalem and it became the City of David." },
      { id: "david-8", question: "Who was Bathsheba's husband before David took her?", options: [{ label: "A", text: "Joab" }, { label: "B", text: "Uriah the Hittite" }, { label: "C", text: "Abner" }, { label: "D", text: "Ish-Bosheth" }], correctAnswer: "B", explanation: "Bathsheba was married to Uriah the Hittite." },
      { id: "david-9", question: "Which son of David became king after him?", options: [{ label: "A", text: "Absalom" }, { label: "B", text: "Amnon" }, { label: "C", text: "Adonijah" }, { label: "D", text: "Solomon" }], correctAnswer: "D", explanation: "Solomon, David's son, became king after him." },
      { id: "david-10", question: "How does Scripture describe David's relationship with God?", options: [{ label: "A", text: "A man of great wisdom" }, { label: "B", text: "A man after God's own heart" }, { label: "C", text: "A man of perfect obedience" }, { label: "D", text: "A man without sin" }], correctAnswer: "B", explanation: "God called David a man after His own heart in 1 Samuel 13:14." },
    ],
  },
  {
    key: "paul",
