...
/**
 * Proverbs 10's study sections, built from Proverbs 10's own notes.
 *
 ...
 * directly. lib/proverbsTenSource holds only this chapter, so reading from
 * it directly keeps this chapter's data small.
 */
export function getProverbsTenStudySections(): BibleReaderStudySection[] {
  return PROVERBS_TEN_PERSONAL_SECTIONS.map((section) => ({
    book: "proverbs",
