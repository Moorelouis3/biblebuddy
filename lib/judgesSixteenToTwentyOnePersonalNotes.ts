...
export const JUDGES_16_21_PERSONAL_SECTIONS: PersonalLeviticusPhraseSectionInput[] = [
  ...
  section(16, 15, 17, "Samson Reveals His Secret", I.razor, [
    phrase(I.broken, "How Canst Thou Say, I Love Thee", "Delilah uses emotional pressure to wear Samson down.", [`${I.broken} Love language`, `${I.question} Pressure`, `${I.warning} Manipulation`], "The phrase shows how words about love can be twisted into control."),
  ...
  section(17, 7, 10, "A Levite Comes To Micah", I.priest, [
    ...
    phrase(I.priest, "Be Unto Me A Father And A Priest", "Micah wants religious legitimacy for his shrine.", [`${I.priest} Priestly role`, `${I.house} Private house`, `${I.warning} Wrong foundation`], "The phrase shows how people can seek religious approval without true obedience."),
  ]),
  ...
  section(18, 7, 10, "Laish Looks Easy To Take", I.city, [
    ...
    phrase(I.hand, "There Was No Magistrate In The Land", "Laish lacks nearby authority or protection.", [`${I.hand} No ruler nearby`, `${I.city} Isolated city`, `${I.battle} Easy target`], "The phrase explains why Dan thinks the city can be taken."),
  ...
  section(18, 11, 15, "Dan Approaches Micah's House", I.house, [
    ...
    phrase(I.eye, "Know Ye That There Is In These Houses", "the spies reveal what they found earlier.", [`${I.eye} Remembered discovery`, `${I.idol} Religious objects`, `${I.battle} Planned theft`], "The phrase shows the theft is deliberate."),
  ]),
  section(18, 16, 20, "Dan Steals Micah's Worship", I.idol, [
    ...
    phrase(I.idol, "Took The Graven Image", "Dan steals the idol Micah wrongly made.", [`${I.idol} Stolen image`, `${I.hand} Taking`, `${I.warning} Corrupt worship copied`], "The phrase shows false worship moving from one house to a tribe."),
  ...
  section(18, 27, 31, "Dan Sets Up The Image", I.idol, [
    ...
    phrase(I.altar, "All The Time That The House Of God Was In Shiloh", "the false shrine exists while the true worship center remains at Shiloh.", [`${I.altar} Shiloh`, `${I.idol} Rival worship`, `${I.warning} Divided loyalty`], "The phrase shows how far Dan has drifted from the LORD's appointed worship."),
  ]),
  ...
  section(19, 13, 18, "No One Takes Them In", I.house, [
    ...
    phrase(I.house, "There Was No Man That Took Them Into His House", "no one offers the protection expected in ancient hospitality.", [`${I.house} No host`, `${I.broken} Community failure`, `${I.warning} Danger growing`], "The phrase shows a city without compassion."),
  ...
  section(19, 19, 24, "Gibeah Shows Its Evil", I.warning, [
    ...
    phrase(I.warning, "Do Not This Folly", "the old man names the act as shameful wickedness.", [`${I.warning} Folly`, `${I.judge} Moral judgment`, `${I.broken} Evil named`], "The phrase shows the story itself condemns what is happening."),
  ]),
  section(19, 25, 30, "Israel Is Shocked", I.sorrow, [
    phrase(I.sorrow, "The Men Would Not Hearken To Him", "the crowd refuses correction.", [`${I.sorrow} Refusal`, `${I.warning} Hardened evil`, `${I.broken} No restraint`], "The phrase shows wickedness pushing past warning."),
  ...
  section(20, 1, 6, "Israel Gathers Against Gibeah", I.judge, [
    phrase(I.map, "From Dan Even To Beersheba", "the whole land is represented from north to south.", [`${I.map} Whole land`, `${I.hand} Gathering`, `${I.judge} National response`], "The phrase shows that Gibeah's sin affects all Israel."),
    phrase(I.hand, "The Congregation Was Gathered Together As One Man", "Israel stands united to judge the evil.", [`${I.hand} Unity`, `${I.judge} Assembly`, `${I.warning} Serious moment`], "The people finally act together, though the situation is tragic."),
    phrase(I.question, "Tell Us, How Was This Wickedness", "the assembly asks for testimony about the crime.", [`${I.question} Testimony`, `${I.judge} Judgment`, `${I.broken} Evil examined`], "The phrase shows that justice must hear what happened."),
    phrase(I.fire, "They Have Committed Lewdness And Folly In Israel", "the crime is named as shameful wickedness among God's people.", [`${I.fire} Evil named`, `${I.city} In Israel`, `${I.judge} Accountability`], "The phrase makes clear that covenant people must not excuse such sin."),
  ]),
  section(20, 7, 12, "Israel Demands Justice", I.scroll, [
    phrase(I.hand, "Ye Are All Children Of Israel", "the speaker appeals to shared covenant identity.", [`${I.hand} One people`, `${I.book} Shared identity`, `${I.judge} Shared responsibility`], "Israel cannot treat the evil as someone else's problem."),
    phrase(I.battle, "We Will Go Up By Lot Against It", "Israel prepares a military response through ordered selection.", [`${I.battle} War plan`, `${I.question} Lot`, `${I.judge} Collective action`], "The phrase shows the crisis moving from assembly to battle."),
    phrase(I.scroll, "What Wickedness Is This", "Israel sends a message naming Gibeah's evil.", [`${I.scroll} Message`, `${I.warning} Wickedness`, `${I.judge} Demand for justice`], "The phrase confronts Benjamin with the moral issue."),
    phrase(I.hand, "Deliver Us The Men", "Israel demands that Benjamin surrender the guilty men.", [`${I.hand} Surrender`, `${I.judge} Justice`, `${I.warning} Test for Benjamin`], "The phrase gives Benjamin a chance to choose righteousness over tribal loyalty."),
  ]),
  section(20, 13, 18, "Benjamin Chooses War", I.battle, [
    phrase(I.warning, "Benjamin Would Not Hearken", "Benjamin refuses to listen to the demand for justice.", [`${I.warning} Refusal`, `${I.hand} Tribal loyalty`, `${I.broken} Hardened response`], "Protecting evil becomes part of the evil."),
    phrase(I.battle, "Went Out To Battle Against The Children Of Israel", "Benjamin chooses war against the other tribes.", [`${I.battle} Civil war`, `${I.broken} Brother against brother`, `${I.sorrow} National fracture`], "The phrase marks the tragedy of Israel fighting itself."),
    phrase(I.strength, "Seven Hundred Chosen Men Lefthanded", "Benjamin has skilled fighters, even in a doomed cause.", [`${I.strength} Elite warriors`, `${I.eye} Left-handed skill`, `${I.battle} Dangerous force`], "Skill and strength do not make a wrong cause right."),
    phrase(I.prayer, "Which Of Us Shall Go Up First", "Israel asks God how to begin the battle.", [`${I.prayer} Inquiry`, `${I.battle} Battle order`, `${I.judge} Seeking direction`], "The question shows that even judgment must not be treated casually."),
  ]),
  section(20, 19, 23, "Israel Suffers Heavy Loss", I.sorrow, [
    phrase(I.battle, "The Children Of Benjamin Came Forth Out Of Gibeah", "Benjamin attacks from the city being judged.", [`${I.battle} Benjamin attacks`, `${I.city} Gibeah`, `${I.sorrow} Civil bloodshed`], "The guilty city becomes the center of tribal war."),
    phrase(I.sorrow, "Destroyed Down To The Ground Of The Israelites", "Israel suffers a devastating defeat.", [`${I.sorrow} Heavy loss`, `${I.battle} Defeat`, `${I.question} Hard providence`], "A just cause does not make war painless."),
    phrase(I.prayer, "Encouraged Themselves", "Israel regroups after loss.", [`${I.prayer} Courage renewed`, `${I.battle} Return to battle`, `${I.sorrow} Grief remains`], "The phrase shows endurance in a painful judgment scene."),
    phrase(I.sorrow, "Destroyed Down To The Ground Again", "the second battle brings another severe loss.", [`${I.sorrow} More death`, `${I.battle} Civil war cost`, `${I.warning} Sobering judgment`], "The repetition makes the reader feel the cost of Israel's collapse."),
  ]),
  section(20, 24, 29, "Israel Weeps Before The LORD", I.prayer, [
    ...
    phrase(I.prayer, "Fasted That Day Until Even", "Israel humbles itself before God.", [`${I.prayer} Fasting`, `${I.sorrow} Mourning`, `${I.judge} Serious judgment`], "The phrase shows grief, not celebration."),
    phrase(I.priest, "Phinehas, The Son Of Eleazar", "the priestly line is named at the place of inquiry.", [`${I.priest} Priest`, `${I.book} Covenant memory`, `${I.prayer} Seeking the LORD`], "The detail ties this dark scene back to worship and covenant order."),
    phrase(I.battle, "I Will Deliver Them Into Thine Hand", "the LORD gives assurance of Benjamin's defeat.", [`${I.battle} Coming victory`, `${I.hand} Delivered into hand`, `${I.judge} God judges`], "The outcome belongs to the LORD, not Israel's raw strength."),
  ]),
  section(20, 30, 35, "The LORD Smites Benjamin", I.battle, [
    ...
    phrase(I.hand, "Let Us Flee", "Israel uses retreat as a strategy.", [`${I.hand} Planned retreat`, `${I.map} Away from city`, `${I.battle} Ambush setup`], "The phrase shows that weakness can be part of a wise battle plan."),
    phrase(I.battle, "The LORD Smote Benjamin Before Israel", "the victory is finally described as the LORD's action.", [`${I.battle} Benjamin defeated`, `${I.hand} The LORD's hand`, `${I.judge} Judgment`], "The phrase keeps the outcome under God's authority."),
  ]),
  section(20, 36, 38, "The Ambush Is Set", I.eye, [
    phrase(I.eye, "Let Us Flee, And Draw Them From The City", "Israel uses a planned retreat to lure Benjamin away.", [`${I.eye} Strategy`, `${I.city} City exposed`, `${I.battle} Ambush`], "The phrase shows the battle turning through wisdom and timing."),
    phrase(I.battle, "The Liars In Wait Hasted", "the ambush force moves quickly.", [`${I.battle} Hidden fighters`, `${I.hand} Sudden movement`, `${I.warning} Judgment closing in`], "Benjamin does not see the danger forming behind them."),
    phrase(I.fire, "A Great Flame With Smoke", "smoke from the city becomes the signal.", [`${I.fire} Smoke`, `${I.city} City burning`, `${I.eye} Sign seen`], "The phrase marks the moment the trap is revealed."),
  ...
  section(20, 39, 43, "Benjamin Is Surrounded", I.sorrow, [
    ...
    phrase(I.shield, "Six Hundred Men Turned And Fled", "only a remnant escapes to the wilderness rock.", [`${I.shield} Remnant`, `${I.map} Rock of Rimmon`, `${I.sorrow} Near destruction`], "The number shows how close Benjamin comes to being wiped out."),
    phrase(I.fire, "Set On Fire All The Cities", "Israel destroys Benjamin's cities after the battle.", [`${I.fire} Cities burned`, `${I.sorrow} Civil ruin`, `${I.warning} Bitter ending`], "Judgment has happened, but the nation is wounded."),
  ]),
  section(20, 44, 48, "Benjamin Is Nearly Destroyed", I.fire, [
    phrase(I.sorrow, "There Fell Of Benjamin Eighteen Thousand Men", "Benjamin suffers terrible losses in the civil war.", [`${I.sorrow} Heavy loss`, `${I.battle} Civil war`, `${I.warning} Cost of sin`], "The number makes the national tragedy impossible to ignore."),
    phrase(I.shield, "Six Hundred Men Turned And Fled", "only a small remnant escapes from the tribe.", [`${I.shield} Remnant`, `${I.map} Wilderness`, `${I.sorrow} Tribe nearly gone`], "The phrase shows Benjamin on the edge of disappearance."),
    phrase(I.map, "Unto The Rock Rimmon", "the survivors hide at a wilderness rock.", [`${I.map} Rock Rimmon`, `${I.shield} Refuge`, `${I.sorrow} Exile-like hiding`], "The place becomes a shelter after devastating judgment."),
    phrase(I.fire, "Set On Fire All The Cities", "Israel destroys Benjamin's cities after the battle.", [`${I.fire} Cities burned`, `${I.sorrow} Civil ruin`, `${I.warning} Bitter ending`], "Judgment has happened, but the nation is wounded."),
  ]),
  section(21, 1, 4, "Israel Weeps For Benjamin", I.sorrow, [
    ...
    phrase(I.question, "Why Is This Come To Pass In Israel", "the people ask why a tribe is nearly gone.", [`${I.question} Lament`, `${I.sorrow} Confusion`, `${I.prayer} Before God`], "The question shows grief over national fracture."),
    phrase(I.altar, "Built There An Altar", "Israel responds to the crisis with worship and offerings.", [`${I.altar} Altar`, `${I.prayer} Seeking God`, `${I.sorrow} Grief brought to worship`], "The phrase shows sorrow turning toward the LORD."),
  ]),
  section(21, 5, 7, "Israel Searches For A Missing City", I.question, [
    ...
    phrase(I.city, "There Came None To The Camp From Jabeshgilead", "Jabeshgilead had not joined the gathered assembly.", [`${I.city} Jabeshgilead`, `${I.warning} Missing tribe-city`, `${I.judge} Consequence`], "The city becomes part of Israel's attempt to solve Benjamin's future."),
    phrase(I.battle, "Go And Smite The Inhabitants", "Israel chooses violence again as a solution.", [`${I.battle} Sword`, `${I.sorrow} More death`, `${I.warning} Broken wisdom`], "The attempt to repair one disaster creates another painful scene."),
    phrase(I.baby, "Four Hundred Young Virgins", "women from Jabeshgilead are taken for Benjamin's survival.", [`${I.baby} Young women`, `${I.hand} Taken`, `${I.sorrow} Human cost`], "The phrase shows how vulnerable people suffer in Israel's disorder."),
  ]),
  section(21, 8, 12, "Jabeshgilead Becomes Part Of The Crisis", I.city, [
    phrase(I.city, "There Came None To The Camp From Jabeshgilead", "Jabeshgilead had not joined the gathered assembly.", [`${I.city} Jabeshgilead`, `${I.warning} Missing city`, `${I.judge} Oath enforced`], "The city becomes part of Israel's attempt to solve Benjamin's future."),
    phrase(I.battle, "Go And Smite The Inhabitants", "Israel chooses violence again as a solution.", [`${I.battle} Sword`, `${I.sorrow} More death`, `${I.warning} Broken wisdom`], "The attempt to repair one disaster creates another painful scene."),
    phrase(I.baby, "Four Hundred Young Virgins", "women from Jabeshgilead are taken for Benjamin's survival.", [`${I.baby} Young women`, `${I.hand} Taken`, `${I.sorrow} Human cost`], "The phrase shows how vulnerable people suffer in Israel's disorder."),
    phrase(I.hand, "Brought Them Unto The Camp To Shiloh", "the women are brought to the place where Israel is gathered.", [`${I.hand} Brought to camp`, `${I.altar} Shiloh`, `${I.broken} Painful solution`], "The phrase keeps the human cost of Israel's plan in view."),
  ]),
  section(21, 13, 18, "Benjamin Is Preserved", I.hand, [
    ...
    phrase(I.sorrow, "The People Repented Them For Benjamin", "Israel feels grief and regret over Benjamin's near destruction.", [`${I.sorrow} Regret`, `${I.broken} Brother tribe`, `${I.prayer} Mercy needed`], "The phrase shows the nation recognizing the wound inside itself."),
  ...
  section(21, 19, 22, "A Troubling Plan At Shiloh", I.altar, [
    phrase(I.altar, "A Feast Of The LORD In Shiloh", "a worship feast becomes part of Israel's troubling plan.", [`${I.altar} Shiloh`, `${I.prayer} Feast`, `${I.warning} Misused setting`], "The holy setting makes the moral confusion even more painful."),
    phrase(I.eye, "Catch You Every Man His Wife", "Benjamin is told to take women during the feast.", [`${I.eye} Ambush-like plan`, `${I.baby} Women affected`, `${I.warning} Disorder`], "The phrase shows Israel trying to solve covenant problems with human schemes."),
  ...
  section(21, 23, 25, "Judges Ends Without A King", I.crown, [
    phrase(I.hand, "The Children Of Benjamin Did So", "Benjamin follows the troubling plan Israel has made.", [`${I.hand} Action taken`, `${I.people} Benjamin preserved`, `${I.warning} Troubled method`], "The tribe survives, but the way forward still feels morally broken."),
    phrase(I.house, "Returned Unto Their Inheritance", "Benjamin goes back to rebuild life in its tribal land.", [`${I.house} Inheritance`, `${I.seedling} Survival`, `${I.sorrow} After civil war`], "The phrase shows preservation after near destruction."),
    phrase(I.crown, "In Those Days There Was No King In Israel", "the book closes by naming the lack of righteous leadership.", [`${I.crown} No king`, `${I.warning} No order`, `${I.book} Book summary`], "The phrase prepares the reader to long for better leadership."),
    phrase(I.eye, "Every Man Did That Which Was Right In His Own Eyes", "everyone follows personal judgment instead of God's word.", [`${I.eye} Own eyes`, `${I.broken} Moral collapse`, `${I.prayer} Need for God's rule`], "Judges ends by diagnosing the heart problem behind the whole book."),
  ]),
];
