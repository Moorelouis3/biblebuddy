...
BIBLE_READER_STUDY_SECTIONS.push(
  ...[
    ...
    makeCompactGenesisStudySection({
      ...
      startVerse: 4,
      endVerse: 8,
      reference: "Genesis 45:4-8",
      title: "God Sent Me Before You",
      icon: "🧭",
      summary: "Joseph names the betrayal honestly while also seeing God's preserving purpose.",
      movement: ["🤲 Joseph invites the brothers to come near.", "⚖️ He says plainly that they sold him into Egypt.", "🧭 He says God sent him ahead to preserve life.", "🌾 Five years of famine still remain, so Joseph's position will save the family."],
      phrases: [["🤲 Come Near To Me", "Joseph moves the brothers from distance toward closeness. Fear pulls back, but mercy invites near."], ["⚖️ Whom Ye Sold Into Egypt", "Joseph does not erase responsibility. Forgiveness does not require pretending evil was harmless."], ["🧭 God Did Send Me Before You", "This is providence. Joseph sees God's purpose working above human sin without calling the sin good."]],
      truths: [["⚖️ Forgiveness can tell the truth.", "Joseph names what happened instead of rewriting the past."], ["🧭 God can work above evil.", "Human betrayal did not become good, but God was not defeated by it."], ["🌾 God's purpose often reaches beyond one person's pain.", "Joseph's suffering becomes part of preserving many lives."]],
      application: ["⚖️ Do not heal by denying what happened.", "🧭 Ask God to help you see His hand without excusing evil.", "🌾 Remember that God's work may be larger than what you could see in the painful moment."],
    }),
    makeCompactGenesisStudySection({
      chapter: 45,
      startVerse: 9,
      endVerse: 15,
      reference: "Genesis 45:9-15",
      title: "Forgiveness Gets Practical",
      icon: "🤲",
    ...
    makeCompactGenesisStudySection({
      ...
      title: "God Goes Down With Jacob",
      icon: "🔥",
      summary: "Jacob stops at Beersheba, worships, and hears God promise to go with him into Egypt.",
      movement: ["🧭 Jacob begins the journey with everything he has.", "🔥 He stops at Beersheba and offers sacrifices.", "🌙 God speaks in visions of the night.", "🤲 God says not to fear because He will go down with Jacob."],
      phrases: [["🔥 Beersheba", "Beersheba is full of family memory from Abraham and Isaac. Jacob stops at a meaningful place before entering an unfamiliar future."], ["🌙 Jacob, Jacob", "The repeated name sounds personal and tender. God meets Jacob directly at the edge of a major transition."], ["🤲 I Will Go Down With Thee", "This is the heart of the passage. God does not merely send Jacob to Egypt; He promises His presence there."]],
      truths: [["🔥 Worship belongs at transition points.", "Jacob worships before moving fully into the unknown."], ["😨 Good news can still come with fear.", "Joseph is alive, but Egypt is still a huge move away from Canaan."], ["🤲 God's presence is better than familiar geography.", "Canaan is the promised land, but God will be with Jacob in Egypt."]],
      application: ["🔥 Pause to worship before major transitions.", "😨 Do not feel ashamed when blessing still feels scary.", "🤲 Ask what God has promised about His presence, not only how unfamiliar the place feels."],
    }),
    makeCompactGenesisStudySection({
      chapter: 46,
      startVerse: 8,
    ...
    makeCompactGenesisStudySection({
      ...
      title: "Joseph And Jacob Reunite",
      icon: "🫂",
      summary: "Judah leads the way to Goshen, Joseph meets Jacob, and father and son are reunited.",
      movement: ["🧭 Judah goes ahead to guide the family.", "🐎 Joseph rides out in his chariot.", "🫂 Joseph falls on Jacob's neck and weeps a long time.", "🏡 Joseph prepares the family to settle in Goshen."],
      phrases: [["🧭 Judah Before Him", "Judah now helps lead the family forward. The brother once tied to betrayal is becoming a guide in restoration."], ["🫂 Wept On His Neck A Good While", "Scripture lets the reunion breathe. Years of grief meet one long embrace."], ["🐑 Every Shepherd Is An Abomination Unto The Egyptians", "This cultural detail explains why Goshen matters. The family can live distinct from Egyptian society while still being preserved by Egypt's provision."]],
      truths: [["🫂 God can restore sight after years of grief.", "Jacob sees the son he thought was dead."], ["🧭 Repentance can turn a person into a guide.", "Judah's role keeps developing after his change in Genesis 44."], ["🏡 Distinction can protect identity.", "Goshen will help the family survive without being swallowed by Egypt."]],
      application: ["🫂 Let restoration have emotional weight.", "🧭 Believe God can turn former failure into useful leadership.", "🏡 Ask God for provision that also protects identity and calling."],
    }),
  ],
);
...
BIBLE_READER_STUDY_SECTIONS.push(
  ...[
    makeCompactGenesisStudySection({
      ...
      icon: "🏡",
      summary: "Joseph brings his family before Pharaoh, and they receive a place to live during the famine.",
      movement: ["🏛️ Joseph presents his brothers before Pharaoh.", "🐑 They openly identify themselves as shepherds.", "🏡 Pharaoh gives them the land of Goshen.", "🙌 Jacob blesses Pharaoh, and Joseph nourishes the whole household."],
      phrases: [["🏡 The Best Of The Land", "Goshen is more than a comfortable address. It gives Jacob's family pasture, food access, and enough separation to remain distinct inside Egypt."], ["🙌 Jacob Blessed Pharaoh", "This is a quiet reversal. Pharaoh has political power, but Jacob carries the covenant blessing God promised to Abraham."], ["⏳ Few And Evil Have The Days Been", "Jacob is honestly naming a hard life: exile, deception, family conflict, Rachel's death, Joseph's loss, and years of grief. Faith does not require pretending the journey was easy."]],
      truths: [["🏡 Provision can come in a foreign place.", "Egypt is not the promised land, but God uses it to preserve the family."], ["🙌 Covenant blessing outranks worldly status.", "Jacob can bless Pharaoh because God's promise rests on him."], ["🕯️ Honest faith can name painful years.", "Jacob's words are not unbelief. They are truthful reflection from an old man who has suffered and still belongs to God."]],
      application: ["🏡 Receive God's provision without forgetting your identity.", "🙌 Do not measure spiritual weight only by public status.", "🕯️ You can be honest about hard years and still trust God's promise."],
    }),
    makeCompactGenesisStudySection({
      chapter: 47,
      startVerse: 13,
      ...
      icon: "🌾",
      summary: "The famine becomes severe, and Joseph administers food, livestock, land, and seed to preserve life.",
      movement: ["🌾 The famine empties Egypt and Canaan of food.", "💰 People buy grain until their money is gone.", "🐄 Livestock and land are exchanged as the crisis deepens.", "🌱 Joseph gives seed so the people can plant again."],
      phrases: [["🌾 There Was No Bread", "This phrase shows total crisis. The famine is not background scenery; it is crushing the entire region and forcing hard decisions."], ["🏛️ Buy Us And Our Land For Bread", "The people are desperate enough to trade land and labor for survival. Genesis is showing how famine collapses normal life and reshapes society."], ["🌱 Here Is Seed For You", "Joseph does not only distribute emergency grain. He gives seed, which means he is thinking about future harvest, not just today's hunger."]],
      truths: [["🧠 Wisdom matters in crisis.", "Joseph's leadership requires planning, stages, storage, and administration."], ["🌾 Preservation can be complicated.", "The passage has tension, but the people themselves say Joseph saved their lives."], ["🌱 Godly leadership looks beyond the emergency.", "Seed for planting shows concern for tomorrow, not only relief for today."]],
      application: ["🧠 Ask God for wisdom, not panic, in crisis.", "🌾 Remember that preserving life can require hard stewardship.", "🌱 Look for ways to help people recover, not only survive."],
    }),
    makeCompactGenesisStudySection({
      chapter: 47,
      startVerse: 27,
      ...
      title: "Jacob Looks Toward The Promise",
      icon: "🪦",
      summary: "Israel grows in Egypt, but Jacob asks Joseph to bury him in the promised land.",
      movement: ["🌱 Jacob's family gains possessions and multiplies in Goshen.", "🛏️ Jacob knows his death is near.", "🪦 He asks not to be buried in Egypt.", "🙇 Jacob worships as Joseph swears to honor the request."],
      phrases: [["🌱 They Grew And Multiplied Exceedingly", "This echoes God's promise to make Jacob a great nation in Egypt. Growth in Goshen is not random success; it is covenant promise beginning to take visible shape."], ["🪦 Bury Me Not In Egypt", "Jacob's burial request is a faith statement. His body will testify that Egypt is not the family's final home."], ["🙇 Israel Bowed Himself Upon The Bed's Head", "Jacob responds with worship at the edge of death. He is weak in body, but his faith is still facing God's promise."]],
      truths: [["🌱 God can grow His people in temporary places.", "Egypt is temporary, but growth there is real."], ["🪦 Faith looks past current comfort.", "Jacob has provision in Egypt, but his hope remains tied to God's promised land."], ["🙇 Worship belongs near the end too.", "Jacob's final season is marked by memory, request, and reverence."]],
      application: ["🌱 Do not despise growth in a place that is not permanent.", "🪦 Let your choices point toward God's promises.", "🙇 Keep worshiping even when life is nearing its final chapter."],
    }),
    makeCompactGenesisStudySection({
      chapter: 48,
      startVerse: 1,
      ...
      icon: "📜",
      summary: "Joseph brings his sons to Jacob, and Jacob remembers God's covenant promise at Luz.",
      movement: ["👴 Joseph hears Jacob is sick and brings his sons.", "📜 Jacob remembers God appearing at Luz, or Bethel.", "👦 Jacob receives Ephraim and Manasseh as his own.", "💔 Jacob remembers Rachel's death near Bethlehem."],
      phrases: [["📜 God Almighty Appeared Unto Me At Luz", "Jacob reaches back to Bethel, where God met him while he was fleeing and afraid. At the end of life, God's old promise is still his anchor."], ["👦 Ephraim And Manasseh Shall Be Mine", "Jacob adopts Joseph's sons into his own tribal inheritance. This is why Joseph receives a double portion through two sons."], ["💔 Rachel Died By Me", "Jacob's blessing speech includes grief. Rachel's death is still part of his memory, showing that promise and sorrow often sit together."]],
      truths: [["📜 Memory strengthens blessing.", "Jacob blesses the next generation by remembering what God already promised."], ["👦 Covenant identity is given forward.", "Ephraim and Manasseh are brought into the family story, not left as Egyptian outsiders."], ["💔 Grief is not erased by faith.", "Jacob still remembers Rachel while still trusting God's promise."]],
      application: ["📜 Tell the next generation what God has done.", "👦 Give people identity rooted in God's promise, not only culture around them.", "💔 Let grief and faith speak honestly in the same room."],
    }),
    makeCompactGenesisStudySection({
      chapter: 48,
      startVerse: 8,
      ...
      title: "The God Who Shepherded Jacob",
      icon: "🐑",
      summary: "Jacob embraces Joseph's sons and blesses them in the name of the God who carried him all his life.",
      movement: ["👀 Jacob's eyes are dim with age.", "🫂 He embraces and kisses Joseph's sons.", "😭 Jacob says God let him see Joseph's children too.", "🐑 He blesses them by the God who shepherded and redeemed him."],
      phrases: [["😭 I Had Not Thought To See Thy Face", "Jacob thought Joseph was dead for years. Now he sees Joseph's sons too, which is grace beyond what he imagined."], ["🐑 The God Which Fed Me All My Life Long", "The word has the sense of shepherding. Jacob looks back and sees God guiding, feeding, and carrying him through the whole uneven journey."], ["🛡️ The Angel Which Redeemed Me From All Evil", "Jacob remembers rescue. His life had real danger, but God repeatedly delivered him from harm and brought him to this moment."]],
      truths: [["😭 God can give more mercy than we expected.", "Jacob hoped only to see Joseph, but he also sees the next generation."], ["🐑 God shepherds imperfect people.", "Jacob's life was messy, but God still fed and guided him."], ["🛡️ Redemption is personal.", "Jacob can speak of the God who redeemed him, not only the God of his fathers."]],
      application: ["😭 Leave room for God to surprise you with mercy.", "🐑 Look back and name how God has shepherded you.", "🛡️ Let the next generation hear your rescue stories."],
    }),
    makeCompactGenesisStudySection({
      chapter: 48,
      startVerse: 17,
      ...
      title: "Jacob Crosses His Hands",
      icon: "✋",
      summary: "Jacob gives Ephraim the greater blessing and points Joseph toward God's promised return.",
      movement: ["✋ Jacob places his right hand on Ephraim, the younger son.", "😟 Joseph tries to correct him because Manasseh is firstborn.", "👴 Jacob says he knows what he is doing.", "🏞️ Jacob promises that God will bring the family back to the land."],
      phrases: [["✋ Guiding His Hands Wittingly", "Jacob crosses his hands intentionally. This is not old-age confusion; it is a visible lesson that God's blessing is not controlled by normal birth order."], ["👦 His Younger Brother Shall Be Greater", "Genesis keeps repeating this pattern. God often chooses in ways that challenge custom: Isaac, Jacob, Joseph, and now Ephraim."], ["🏞️ God Shall Bring You Again Unto The Land", "Jacob ends with future hope. Egypt is where they are, but the promised land is where God's story is still pointing."]],
      truths: [["✋ Grace does not always follow expected order.", "God's choice can overturn family custom and human assumption."], ["👦 Blessing is God's to give.", "Joseph has a preference, but Jacob understands that the promise moves by God's will."], ["🏞️ Hope keeps looking toward return.", "Jacob's faith is still aimed at the land God promised."]],
      application: ["✋ Do not assume God must bless according to your preferred order.", "👦 Trust God's wisdom when His choice surprises you.", "🏞️ Keep your hope pointed toward what God has promised, not only where you currently live."],
    }),
  ],
);
...
BIBLE_READER_STUDY_SECTIONS.push(
  ...[
    makeCompactGenesisStudySection({
      ...
      title: "Legacy, Instability, And Violence",
      icon: "⚖️",
      summary: "Jacob begins his final words by exposing Reuben's instability and Simeon and Levi's violence.",
      movement: ["👥 Jacob gathers his sons to speak about the days ahead.", "🌊 Reuben loses firstborn privilege because he was unstable and dishonored his father.", "⚔️ Simeon and Levi are remembered for violent anger.", "🧭 The future tribes are being shaped by character and consequence."],
      phrases: [["👥 Gather Yourselves Together", "This is not only a family goodbye. Jacob is speaking over the future tribes of Israel, so personal history becomes national direction."], ["🌊 Unstable As Water", "Reuben had firstborn position, but instability made him unable to carry firstborn leadership. Genesis teaches that privilege without character is fragile."], ["⚔️ Instruments Of Cruelty", "Simeon and Levi's violence at Shechem is still remembered. Their anger responded to real wrong, but their method multiplied evil."]],
      truths: [["🧬 Legacy is shaped by character.", "Jacob's words show that future impact is connected to present patterns."], ["⚠️ Position cannot replace faithfulness.", "Reuben had rank, but his choices damaged his inheritance."], ["🔥 Anger must be governed by righteousness.", "Simeon and Levi show that intense anger over real injustice can still become sinful violence."]],
      application: ["🧬 Ask what pattern your life is building.", "⚠️ Do not trust privilege more than character.", "🔥 Let God rule anger before anger starts ruling your future."],
    }),
    makeCompactGenesisStudySection({
      chapter: 49,
      startVerse: 8,
    ...
    makeCompactGenesisStudySection({
      ...
      title: "Brief Words Over The Tribes",
      icon: "🗺️",
      summary: "Jacob gives poetic words over Zebulun, Issachar, Dan, Gad, Asher, and Naphtali.",
      movement: ["🗺️ The sayings move quickly through several sons.", "🐴 The images include coastlands, burdens, judgment, attack, food, and freedom.", "🙏 Jacob pauses to wait for the Lord's salvation.", "🌱 The future tribes are being framed through memorable pictures."],
      phrases: [["🗺️ Zebulun Shall Dwell At The Haven", "These poetic words point ahead to tribal placement and identity. Genesis is starting to look beyond one family into Israel's future map."], ["⚖️ Dan Shall Judge His People", "Dan's name is connected with judgment. The tribe will have a role, but the serpent imagery also gives a warning edge."], ["🙏 I Have Waited For Thy Salvation", "This prayer interrupts the tribal sayings. Jacob knows the future cannot rest only on tribal strength; it depends on the Lord's rescue."]],
      truths: [["🧩 Short sections can still carry meaning.", "The brief sayings are compact, poetic windows into future identity."], ["🙏 God's salvation is the deepest need.", "Jacob pauses in the middle of family words to wait on the Lord."], ["🗺️ God sees the future of ordinary names.", "These sons become tribes with place, pressure, and purpose."]],
      application: ["🧩 Slow down even when a passage feels brief or poetic.", "🙏 Make waiting for God's salvation part of your family story.", "🗺️ Trust that God sees more future than you can."],
    }),
    makeCompactGenesisStudySection({
      chapter: 49,
      startVerse: 22,
      ...
      title: "Joseph Is Fruitful Though Attacked",
      icon: "🌿",
    ...
    makeCompactGenesisStudySection({
      ...
      title: "Jacob Dies Holding The Promise",
      icon: "🪦",
      summary: "Jacob gives burial instructions and dies with Canaan still in view.",
      movement: ["🪦 Jacob asks to be buried with his fathers.", "📍 He names the cave of Machpelah.", "🧬 The family burial place connects him to Abraham, Sarah, Isaac, Rebekah, and Leah.", "🛏️ Jacob gathers his feet into the bed and dies."],
      phrases: [["🪦 Bury Me With My Fathers", "Jacob's burial request is covenant hope in action. He is dying in Egypt, but he wants his body placed in the land tied to God's promise."], ["📍 The Cave That Is In The Field Of Machpelah", "This cave was the burial plot Abraham bought in Genesis 23. It is a small but real foothold in the promised land."], ["🛏️ Gathered Up His Feet Into The Bed", "The line is quiet and human. Jacob's life ends, but the promise he trusted does not end with him."]],
      truths: [["🪦 Faith can speak through burial choices.", "Jacob's final instructions point the family back to God's promise."], ["📍 Small signs can carry big hope.", "Machpelah is only a burial plot, but it witnesses to the land promise."], ["🛏️ God's promise outlives His servants.", "Jacob dies, but God's covenant story continues."]],
      application: ["🪦 Let your life point people toward God's promises.", "📍 Remember the markers of faith God has already given.", "🛏️ Trust that God's story continues beyond one lifetime."],
    }),
    makeCompactGenesisStudySection({
      chapter: 50,
      startVerse: 1,
      ...
      title: "Jacob Is Mourned And Buried",
      icon: "😭",
    ...
    makeCompactGenesisStudySection({
      ...
      title: "Joseph Dies With Hope",
      icon: "🌅",
      summary: "Joseph dies in Egypt, but his final words point forward to God's future visit and the promised land.",
      movement: ["👴 Joseph lives to see generations after him.", "🌅 He says God will surely visit His people.", "🦴 He makes Israel swear to carry up his bones.", "⚰️ Genesis ends with Joseph in a coffin in Egypt."],
      phrases: [["🌅 God Will Surely Visit You", "This phrase points forward to Exodus. Joseph believes God will come, act, and bring His people out of Egypt."], ["🦴 Carry Up My Bones", "Joseph's bones become a witness of faith. Even after death, his body points toward the promised land."], ["⚰️ A Coffin In Egypt", "Genesis ends with a coffin, but not with hopelessness. The coffin waits for God's future deliverance."]],
      truths: [["🌅 God's promise outlives death.", "Joseph dies, but God's word continues."], ["🦴 Faith can point forward beyond one's lifetime.", "Joseph wants future generations to remember where they are going."], ["⚰️ Genesis ends unfinished on purpose.", "The ending makes readers wait for Exodus and for the God who will surely visit."]],
      application: ["🌅 Build hope on what God has promised, not what you can finish yourself.", "🦴 Leave reminders that point others toward God's future.", "⚰️ Trust God in unfinished endings."],
    }),
  ],
);
...
BIBLE_READER_STUDY_SECTIONS.push(
  ...[
    makeCompactExodusStudySection({
      ...
      title: "The Family Becomes A People",
      icon: "🌱",
      summary: "Exodus begins by showing Jacob's family multiplying in Egypt after Joseph's generation dies.",
      movement: ["📜 Exodus names the sons of Israel who came into Egypt.", "⚰️ Joseph and his generation die.", "🌱 Israel multiplies and becomes exceedingly strong.", "🧬 God's promise keeps moving after Genesis ends."],
      phrases: [["📜 These Are The Names", "Exodus opens by connecting directly to Genesis. The story of deliverance begins with the same family God promised to bless."], ["⚰️ Joseph Died", "Joseph's death does not end the promise. God's word continues after the people who first carried it are gone."], ["🌱 Fruitful And Increased Abundantly", "This echoes Genesis language. Israel's growth is covenant promise becoming visible in Egypt."]],
      truths: [["🧬 Exodus continues Genesis.", "The Bible is one connected story, not disconnected books."], ["🌱 God's promise can grow in foreign soil.", "Egypt is not the promised land, but Israel multiplies there."], ["⏳ Generations pass, but God's word remains.", "Joseph dies, but the covenant promise keeps living."]],
      application: ["🧬 Read Exodus as promise continuing, not a brand-new story.", "🌱 Do not assume growth can only happen in comfortable places.", "⏳ Trust God's word beyond one generation."],
    }),
    makeCompactExodusStudySection({
      chapter: 1,
      startVerse: 8,
      ...
      title: "Fear Turns Into Oppression",
      icon: "🧱",
    ...
    makeCompactExodusStudySection({
      ...
      icon: "🕊️",
      summary: "Pharaoh commands death, but Shiphrah and Puah fear God and preserve Hebrew sons.",
      movement: ["👶 Pharaoh targets Hebrew baby boys.", "🕊️ The midwives fear God and refuse the command.", "📛 Shiphrah and Puah are named and remembered.", "🌊 Pharaoh orders all Hebrew sons thrown into the river."],
      phrases: [["📛 Shiphrah And Puah", "The midwives are named while Pharaoh is not named here. Scripture honors women whose quiet courage preserved life."], ["🕊️ Feared God", "Fearing God means His authority weighs more than Pharaoh's order. Their courage is rooted in worship."], ["🌊 Cast Into The River", "Pharaoh turns the Nile into an instrument of death. Exodus 2 will show God preserving Moses in the very place Pharaoh meant for destruction."]],
      truths: [["🕊️ Hidden courage matters.", "The midwives are not famous rulers, but their obedience changes history."], ["👶 God's people protect life.", "When power commands death, fear of God resists."], ["🌊 Evil often escalates when control is challenged.", "Pharaoh moves from forced labor to targeted death."]],
      application: ["🕊️ Let God's authority weigh more than human pressure.", "👶 Protect life where God has placed you.", "📛 Do not underestimate quiet obedience."],
    }),
    makeCompactExodusStudySection({
      chapter: 2,
      startVerse: 1,
      ...
      icon: "🧺",
      summary: "Moses is born under a death sentence, hidden, placed in the river, and rescued by Pharaoh's daughter.",
      movement: ["👶 Moses is born under Pharaoh's command of death.", "🧺 His mother places him in a basket among the reeds.", "👸 Pharaoh's daughter finds him and has compassion.", "🏠 Moses' own mother nurses him before he grows up in Pharaoh's house."],
      phrases: [["🧺 An Ark Of Bulrushes", "The basket is like a tiny ark. Just as Noah was preserved through waters of judgment, Moses is preserved through waters meant for death."], ["👸 She Had Compassion On Him", "Compassion comes from Pharaoh's own household. God uses unexpected people inside enemy structures to preserve His purpose."], ["🌊 Drew Him Out Of The Water", "Moses' name points to his rescue. Later, Israel will also be drawn through water when God delivers them at the Red Sea."]],
      truths: [["🧺 God can preserve life under death's shadow.", "Moses is protected even when Pharaoh's command is active."], ["🔄 God can overturn evil with irony.", "Pharaoh's house helps raise the deliverer Pharaoh tried to kill."], ["🌊 Personal rescue can preview larger deliverance.", "Moses being drawn from water points ahead to Israel's rescue."]],
      application: ["🧺 Trust God in fragile beginnings.", "🔄 Notice how God can use unexpected people and places.", "🌊 Let past rescue build faith for future deliverance."],
    }),
    makeCompactExodusStudySection({
      chapter: 2,
      startVerse: 11,
      ...
      icon: "👂",
      summary: "Moses flees to Midian, while Israel groans under bondage and God hears their cry.",
      movement: ["👀 Moses sees the burdens of his Hebrew brothers.", "⚠️ He kills an Egyptian and flees when the act becomes known.", "🏜️ Moses lives in Midian as a stranger.", "👂 God hears Israel's groaning and remembers His covenant."],
      phrases: [["👀 He Looked On Their Burdens", "Moses begins to identify with Israel's suffering. He does not stay emotionally detached from oppression."], ["🏜️ A Stranger In A Strange Land", "Moses' wilderness season forms him outside Egypt's palace. Delay is not always wasted time."], ["👂 God Heard Their Groaning", "This is the turning point. Before Moses is called, God hears, remembers, sees, and knows."]],
      truths: [["⚠️ Zeal needs God's timing and wisdom.", "Moses cares about injustice, but his first rescue attempt is impulsive."], ["🏜️ Hidden seasons can prepare people.", "Midian looks like exile, but it becomes preparation."], ["👂 God hears before people see deliverance.", "Israel's cry reaches God before Pharaoh is confronted."]],
      application: ["⚠️ Bring your desire for justice under God's wisdom.", "🏜️ Do not despise hidden preparation.", "👂 Believe that God hears groaning that people overlook."],
    }),
    makeCompactExodusStudySection({
      chapter: 3,
      startVerse: 1,
      ...
      icon: "🔥",
      summary: "God meets Moses in the wilderness, reveals holy ground, and calls him to deliver Israel.",
      movement: ["🐑 Moses is shepherding in the wilderness.", "🔥 He sees a bush burning but not consumed.", "👣 God tells him to remove his sandals.", "🧭 God says He has come down to deliver Israel and sends Moses."],
      phrases: [["🔥 The Bush Burned With Fire And Was Not Consumed", "The sign catches Moses' attention and reveals God's holy presence. Fire is present, but the bush is not destroyed."], ["👣 Holy Ground", "The ground is holy because God is there. Ordinary wilderness dirt becomes holy by God's presence."], ["🧭 I Am Come Down To Deliver Them", "Deliverance begins in God's decision. Moses is being sent into a rescue God has already committed to do."]],
      truths: [["🐑 God meets people in ordinary work.", "Moses is keeping sheep when the call comes."], ["🔥 God's holiness draws attention and demands reverence.", "Moses cannot approach casually."], ["🧭 Calling begins with God's compassion.", "God sends Moses because He has seen, heard, and known Israel's suffering."]],
      application: ["🐑 Stay faithful in ordinary work.", "🔥 Approach God's presence with reverence.", "🧭 Remember the mission rests on God's compassion before your ability."],
    }),
    makeCompactExodusStudySection({
      chapter: 3,
      startVerse: 13,
      ...
      icon: "✨",
      summary: "God reveals His name and promises that Pharaoh's resistance will not stop deliverance.",
      movement: ["❓ Moses asks what name he should give Israel.", "✨ God says, I AM THAT I AM.", "📜 God ties His name to Abraham, Isaac, and Jacob.", "💪 God says Pharaoh will only release Israel by a mighty hand."],
      phrases: [["✨ I AM THAT I AM", "God reveals Himself as the One who is. He depends on nothing outside Himself and cannot be controlled by Pharaoh, Egypt, or Moses' weakness."], ["📜 The God Of Abraham, Isaac, And Jacob", "The name of God is tied to covenant history. Exodus deliverance is God keeping Genesis promises."], ["💪 A Mighty Hand", "God tells Moses resistance is coming. Pharaoh will not cooperate easily, but resistance will not defeat God's power."]],
      truths: [["✨ God's name gives courage.", "The mission is grounded in who God is, not who Moses is."], ["📜 God remembers old promises.", "The Exodus is covenant faithfulness, not random rescue."], ["💪 God is not surprised by resistance.", "Pharaoh's stubbornness is known before Moses ever returns."]],
      application: ["✨ Anchor courage in God's character.", "📜 Remember that God keeps promises over long stretches of time.", "💪 Do not confuse resistance with God losing control."],
    }),
    makeCompactExodusStudySection({
      chapter: 4,
      startVerse: 1,
      ...
      title: "Moses Objects, God Provides",
      icon: "🗣️",
      summary: "Moses raises fears about belief and speech, but God gives signs, promises help, and provides Aaron.",
      movement: ["❓ Moses fears Israel will not believe him.", "🐍 God gives signs through the staff, hand, and water.", "🗣️ Moses says he is not eloquent.", "🤝 God provides Aaron as a helper."],
      phrases: [["❓ They Will Not Believe Me", "Moses is not only afraid of Pharaoh. He is afraid of being rejected by his own people."], ["🗣️ Who Hath Made Man's Mouth", "God's question puts Moses' weakness under God's authority. The Creator of the mouth can help the mouth He made."], ["🤝 Aaron Thy Brother", "God provides help without canceling the call. Aaron supports Moses, but Moses is still sent."]],
      truths: [["❓ Calling can expose insecurity.", "Moses' objections show how fear rises when obedience becomes concrete."], ["🗣️ God's presence matters more than natural confidence.", "God promises to be with Moses' mouth."], ["🤝 Help is grace, not failure.", "Aaron's role shows that God can provide partnership for difficult obedience."]],
      application: ["❓ Be honest with God about fear, but do not let fear become your final answer.", "🗣️ Trust the Maker of your mouth with your weakness.", "🤝 Receive help without abandoning obedience."],
    }),
    makeCompactExodusStudySection({
      chapter: 4,
      startVerse: 18,
      ...
      title: "Israel Believes And Worships",
      icon: "🙇",
...
BIBLE_READER_STUDY_SECTIONS.push(
  ...[
    makeCompactExodusStudySection({
      ...
      movement: ["📣 Moses and Aaron say, Let my people go.", "👑 Pharaoh asks, Who is the LORD?", "🧱 Pharaoh removes straw but demands the same bricks.", "😣 Obedience leads into harder pressure before deliverance appears."],
      phrases: [["📣 Thus Saith The LORD", "Moses is not bringing a personal opinion to Pharaoh. He is carrying the word of Israel's covenant God into Egypt's throne room."], ["👑 Who Is The LORD", "This question frames the plagues. Pharaoh does not recognize God's authority, so Egypt is about to learn who the LORD is."], ["🧱 Ye Shall No More Give The People Straw", "Straw helped hold bricks together. Pharaoh creates impossible labor conditions, then blames Israel for not keeping up."]],
      truths: [["📣 God's word confronts human control.", "Pharaoh does not get to define Israel's identity or worship."], ["😣 Obedience can make things harder first.", "Exodus 5 is not failure; it is resistance being exposed."], ["👑 Defiance often sounds confident before it is humbled.", "Pharaoh's question will be answered by God's power."]],
      application: ["📣 Let God's word define freedom and worship.", "😣 Do not assume difficulty means you obeyed wrong.", "👑 Remember that proud resistance does not intimidate God."],
    }),
    makeCompactExodusStudySection({
      chapter: 5,
      startVerse: 10,
      ...
      icon: "😣",
      summary: "Israel suffers under impossible demands, blames Moses, and Moses brings his confusion to God.",
      movement: ["🧱 Israel scatters to gather stubble for bricks.", "🥀 Hebrew officers are beaten for failing impossible quotas.", "⚠️ The officers blame Moses and Aaron.", "🙏 Moses asks God why the people are suffering more."],
      phrases: [["🥀 The Officers Of The Children Of Israel Were Beaten", "Pharaoh's system turns Israel's own leaders into the pressure point. Oppression often creates pain inside the oppressed community."], ["⚠️ Ye Have Made Our Savour To Be Abhorred", "The officers feel Moses has made their situation worse. Their pain is real, even though their conclusion is incomplete."], ["🙏 Lord, Wherefore Hast Thou So Evil Entreated This People", "Moses brings his confusion to God instead of walking away from God. That is an honest form of faith."]],
      truths: [["😣 Increased suffering can confuse faithful people.", "Moses obeyed, and the situation got worse."], ["🙏 Lament belongs in real faith.", "Exodus lets Moses ask God hard questions."], ["🧭 God can be working before relief is visible.", "The chapter ends unresolved, but God's answer is coming."]],
      application: ["😣 Be gentle with people whose pain makes hope hard to hear.", "🙏 Bring confusion to God honestly.", "🧭 Do not judge the whole story by the hardest chapter."],
    }),
    makeCompactExodusStudySection({
      chapter: 6,
      startVerse: 1,
      ...
      title: "God Repeats The Promise",
      icon: "📜",
      summary: "God answers Moses with His name, covenant memory, and promises to redeem Israel.",
      movement: ["📜 God says, I am the LORD.", "👂 God says He has heard Israel's groaning.", "💪 God promises to bring, redeem, take, and give.", "🥀 Israel cannot listen because of anguish and cruel bondage."],
      phrases: [["📜 I Am The LORD", "This repeated phrase anchors the speech. God's identity is stronger than Moses' discouragement and Pharaoh's cruelty."], ["👂 I Have Also Heard The Groaning", "God repeats that Israel's suffering has reached Him. Their pain is not invisible, even while bondage continues."], ["🥀 Anguish Of Spirit", "The people cannot absorb hope because suffering has crushed their breath. The Bible is honest about how trauma can make promise hard to hear."]],
      truths: [["📜 God's character anchors discouraged servants.", "God answers Moses by revealing who He is."], ["💪 Redemption is God's action first.", "The repeated I will statements show deliverance depends on God's commitment."], ["🥀 Pain can make true words hard to receive.", "Israel's inability to listen is treated with realism, not contempt."]],
      application: ["📜 Return to who God is when circumstances get worse.", "💪 Let God's I will carry more weight than Pharaoh's I will not.", "🥀 Be patient with people too crushed to receive hope quickly."],
    }),
    makeCompactExodusStudySection({
      chapter: 6,
      startVerse: 14,
      ...
      icon: "🧬",
      summary: "A genealogy locates Moses and Aaron inside Israel's family before the confrontation continues.",
      movement: ["🧬 Exodus pauses for family names.", "📍 Moses and Aaron are located in Levi's line.", "👥 God knows Israel as people, not just labor.", "🗣️ Moses still feels weak in speech."],
      phrases: [["🧬 These Be The Heads Of Their Fathers' Houses", "The genealogy tells readers that Moses and Aaron come from real covenant families. God's rescue works through named people."], ["📍 The Sons Of Levi", "Moses and Aaron are connected to Levi. This matters later because the Levites will have a major worship role in Israel."], ["🗣️ Uncircumcised Lips", "Moses still feels unfit to speak. The mission continues with weakness still present."]],
      truths: [["🧬 God remembers names under oppression.", "Pharaoh sees labor units, but God sees households and generations."], ["📜 Covenant history grounds public ministry.", "Moses and Aaron are not detached spiritual celebrities; they belong to the people God promised to redeem."], ["🗣️ Weakness does not cancel calling.", "Moses' speech concern remains, but God's command remains too."]],
      application: ["🧬 Remember that God knows people by name.", "📜 Stay rooted in God's larger story.", "🗣️ Do not wait for every weakness to disappear before obeying."],
    }),
    makeCompactExodusStudySection({
      chapter: 7,
      startVerse: 1,
      ...
      title: "The Staff Swallows The Staffs",
      icon: "🐍",
    ...
    makeCompactExodusStudySection({
      ...
      icon: "🩸",
      summary: "The first plague strikes Egypt's river, turning its source of life into judgment.",
      movement: ["🌊 Moses meets Pharaoh by the river.", "🩸 The Nile turns to blood.", "🐟 Fish die and the river stinks.", "🔒 Pharaoh's heart remains hard."],
      phrases: [["🌊 The River's Brink", "The Nile was Egypt's lifeline. Meeting Pharaoh there brings God's word to the place Egypt trusted for life and stability."], ["🩸 The Waters Shall Be Turned To Blood", "God strikes the river Pharaoh used as a place of death for Hebrew sons. The source of life becomes a sign of judgment."], ["🐟 The Fish That Is In The River Shall Die", "The plague disrupts daily life, food, smell, and drinking water. Judgment is no longer theoretical."]],
      truths: [["🌊 God can confront what a culture trusts most.", "The Nile cannot protect Egypt from the LORD."], ["🩸 Violence comes back into judgment.", "The river used against Hebrew babies is now struck."], ["🔒 Imitation cannot heal.", "The magicians imitate the sign, but they do not restore clean water."]],
      application: ["🌊 Ask what you treat as untouchable security.", "🩸 Remember that God sees violent systems.", "🔒 Do not confuse copying power with saving power."],
    }),
    makeCompactExodusStudySection({
      chapter: 8,
      startVerse: 1,
      ...
      title: "Frogs Fill Egypt",
      icon: "🐸",
      summary: "Frogs invade Egypt, Pharaoh asks for prayer, but hardens his heart after relief comes.",
      movement: ["🐸 Frogs cover homes, beds, ovens, and kneading bowls.", "🎭 The magicians can bring frogs too.", "🙏 Pharaoh asks Moses to pray for removal.", "🔒 Pharaoh hardens his heart when relief arrives."],
      phrases: [["🐸 Frogs", "The plague is invasive and almost absurd. It enters private spaces, showing Egypt cannot keep God's judgment outside its doors."], ["🙏 Intreat The LORD", "Pharaoh asks for prayer because he wants relief. But wanting relief is not the same thing as surrendering to God."], ["🔒 When Pharaoh Saw That There Was Respite", "The moment pressure lifts, Pharaoh's heart shows itself again. Relief reveals whether repentance was real."]],
      truths: [["🐸 God can disturb ordinary life.", "The plague reaches bedrooms, kitchens, and daily routines."], ["🙏 Crisis prayer can be shallow.", "Pharaoh wants the frogs gone more than he wants to obey God."], ["🔒 Comfort can expose the heart.", "When the pain stops, Pharaoh returns to resistance."]],
      application: ["🐸 Notice when God is getting your attention through disruption.", "🙏 Seek surrender, not just relief.", "🔒 Pay attention to who you become when pressure lifts."],
    }),
    makeCompactExodusStudySection({
      chapter: 8,
      startVerse: 16,
    ...
    makeCompactExodusStudySection({
      ...
      title: "God Makes A Difference In Goshen",
      icon: "🛡️",
      summary: "Swarms strike Egypt, but God protects Goshen and exposes Pharaoh's compromise.",
      movement: ["🌅 Moses meets Pharaoh early in the morning.", "🪰 Swarms fill Egypt.", "🛡️ God protects Goshen from the plague.", "🤏 Pharaoh bargains but will not fully obey."],
      phrases: [["🛡️ I Will Sever In That Day The Land Of Goshen", "God makes a distinction between Egypt and His people. The plague is precise, not random."], ["🌍 That Thou Mayest Know That I Am The LORD In The Midst Of The Earth", "God is not a local tribal deity. He reveals authority in the land Pharaoh claims to rule."], ["🤏 Only Ye Shall Not Go Very Far Away", "Pharaoh offers controlled obedience. He wants relief from judgment while keeping Israel close enough to manage."]],
      truths: [["🛡️ God knows how to protect His people.", "Goshen is spared because God rules with precision."], ["🌍 The LORD rules in Pharaoh's territory.", "Egypt is not outside God's authority."], ["🤏 Partial obedience can be disguised resistance.", "Pharaoh's compromise still refuses God's command."]],
      application: ["🛡️ Trust God's ability to distinguish and protect.", "🌍 Remember God is Lord even in places ruled by proud people.", "🤏 Do not bargain with God when He has called for obedience."],
    }),
  ],
);
...
BIBLE_READER_STUDY_SECTIONS.push(
  ...[
    makeCompactExodusStudySection({
      ...
      title: "God Makes A Distinction",
      icon: "🐄",
      summary: "The livestock plague strikes Egypt, but Israel's livestock are protected.",
      movement: ["🐄 Egypt's livestock are struck by disease.", "🛡️ Israel's livestock are spared.", "🔎 Pharaoh checks the report.", "🔒 Pharaoh's heart remains hard."],
      phrases: [["🐄 A Very Grievous Murrain", "This plague strikes livestock, which touched Egypt's food, farming, travel, wealth, and military strength. God is not only confronting temples and rituals; He is touching Egypt's everyday survival systems."], ["🛡️ The LORD Shall Sever", "Sever means God makes a clear distinction. The plague is not random disaster spreading everywhere; it is targeted judgment that proves the LORD knows exactly who belongs to Him."], ["🔎 Pharaoh Sent", "Pharaoh investigates and finds that Israel's animals are alive. This means his hardness is not from lack of evidence, but from refusal to bow to what the evidence shows."]],
      truths: [["🛡️ God can protect with precision.", "The same land experiences judgment and mercy at the same time."], ["🔎 Evidence does not automatically soften the heart.", "Pharaoh sees the distinction and still refuses."], ["🐄 God rules ordinary resources.", "Livestock, food, work, and wealth are all under His authority."]],
      application: ["🛡️ Trust that God knows how to distinguish His people.", "🔎 Ask God for a soft heart that responds to truth.", "🐄 Do not treat daily provision as outside God's rule."],
    }),
    makeCompactExodusStudySection({
      chapter: 9,
      startVerse: 8,
      ...
      title: "The Magicians Cannot Stand",
      icon: "🔥",
      summary: "Soot becomes boils, and Egypt's spiritual experts are powerless before Moses.",
      movement: ["🔥 Moses throws soot toward heaven.", "🩹 Boils break out on people and animals.", "🎭 The magicians cannot stand before Moses.", "🔒 Pharaoh still refuses to listen."],
      phrases: [["🔥 Ashes Of The Furnace", "The furnace connects this sign to forced labor and oppression. Egypt used furnaces and brickwork to crush Israel, and now something tied to that place of suffering becomes a sign of judgment."], ["🩹 A Boil Breaking Forth", "This plague touches the body directly. Egypt cannot keep judgment at a distance anymore; pain is now carried in their own skin."], ["🎭 The Magicians Could Not Stand", "Earlier the magicians tried to imitate God's signs. Now they cannot even remain upright before Moses, showing the collapse of Egypt's spiritual confidence."]],
      truths: [["🔥 God can turn symbols of oppression into judgment.", "The furnace that served Egypt's power becomes part of Egypt's humiliation."], ["🎭 Counterfeit power has limits.", "The magicians reach a point where imitation fails completely."], ["🩹 God confronts pride personally.", "Judgment moves from the land to the body."]],
      application: ["🔥 Remember that God sees places of suffering.", "🎭 Do not trust impressive power that cannot save.", "🩹 Let discomfort humble you instead of hardening you."],
    }),
    makeCompactExodusStudySection({
      chapter: 9,
      startVerse: 13,
      ...
      movement: ["📣 God explains why Pharaoh has been raised up.", "🏠 Some Egyptians bring servants and animals inside.", "⛈️ Hail and fire devastate the field.", "😔 Pharaoh says he sinned, then hardens again."],
      phrases: [["🌍 That My Name May Be Declared Throughout All The Earth", "God's purpose is bigger than Egypt. The Exodus will become testimony for Israel, surrounding nations, and later generations who hear what the LORD did."], ["🏠 He That Feared The Word Of The LORD", "Some Egyptians begin responding to God's warning. That is a major detail because mercy is present even while judgment is coming."], ["😔 I Have Sinned This Time", "Pharaoh uses spiritual language, but his change does not last. He wants the storm to stop more than he wants to surrender to the LORD."]],
      truths: [["🌍 God can use resistance to reveal His name.", "Pharaoh's pride becomes a stage for God's glory."], ["🏠 True fear of God obeys warning.", "The Egyptians who believe God's word act before the hail falls."], ["😔 Regret is not the same as repentance.", "Pharaoh is sorry for consequences, but he returns to control."]],
      application: ["🌍 Let God's reputation matter more than your control.", "🏠 Respond to God's warnings while there is mercy.", "😔 Ask whether you want change or only relief."],
    }),
    makeCompactExodusStudySection({
      chapter: 10,
      startVerse: 1,
      ...
      movement: ["👪 God says the signs must be told to future generations.", "🦗 Locusts eat what the hail left.", "⚠️ Pharaoh's servants warn him.", "🌬️ The locusts are removed, and Pharaoh hardens again."],
      phrases: [["👪 That Thou Mayest Tell In The Ears Of Thy Son", "The plagues are meant to become family memory. God wants Israel's children to know that their freedom came from the LORD, not from luck or human strength."], ["🦗 The Locusts Went Up Over All The Land", "Locusts were terrifying in an agricultural world because they could erase food security in hours. This plague attacks what remains after the hail."], ["⚠️ How Long Shall This Man Be A Snare Unto Us?", "Pharaoh's own servants can see the danger before Pharaoh will admit it. Pride often makes a leader the last person to recognize the damage he is causing."]],
      truths: [["👪 Deliverance must be taught to the next generation.", "God's works are meant to become testimony."], ["🦗 God can dismantle false security layer by layer.", "Egypt's food supply is stripped after Pharaoh refuses again."], ["⚠️ Pride can ignore wise warning.", "Pharaoh's servants see what his heart refuses to receive."]],
      application: ["👪 Tell the next generation what God has done.", "🦗 Do not wait for every support to collapse before listening.", "⚠️ Receive correction before pride makes the damage worse."],
    }),
    makeCompactExodusStudySection({
      chapter: 10,
      startVerse: 21,
      ...
      movement: ["🌑 Darkness covers Egypt for three days.", "🏠 Israel has light in their homes.", "🐑 Pharaoh tries to keep the livestock.", "🧭 Moses refuses partial obedience."],
      phrases: [["🌑 Darkness Which May Be Felt", "This is not ordinary nighttime. It is oppressive darkness that stops movement and exposes the weakness of Egypt's sun-centered religion."], ["🏠 All The Children Of Israel Had Light", "The contrast is beautiful and sharp. The same land contains darkness and light because the LORD is making a distinction."], ["🐑 Let Your Flocks And Your Herds Be Stayed", "Pharaoh offers worship with strings attached. Moses refuses because Israel's worship must be shaped by God, not negotiated by Pharaoh."]],
      truths: [["🌑 God can darken what a culture worships.", "Egypt's light fails before the LORD."], ["🏠 God gives light to His people in dark places.", "Israel's homes become signs of God's protection."], ["🐑 Partial surrender is still resistance.", "Pharaoh wants the people to go without giving up leverage."]],
      application: ["🌑 Do not trust created lights more than the Creator.", "🏠 Look for God's light even when the larger culture feels dark.", "🐑 Do not let old bondage define the terms of worship."],
    }),
    makeCompactExodusStudySection({
      chapter: 11,
      startVerse: 1,
      ...
      movement: ["📣 God announces one final plague.", "💍 Israel asks Egypt for silver and gold.", "🌙 Judgment will come at midnight.", "🛡️ God will make a difference between Egypt and Israel."],
      phrases: [["🌙 About Midnight", "The final plague comes at a specific time. Egypt will learn that the LORD rules not only nature, but the timing of judgment itself."], ["👑 From The Firstborn Of Pharaoh", "Judgment reaches the throne and the household. Pharaoh attacked Israel's sons earlier in Exodus, and now Egypt's own firstborn face judgment."], ["🛡️ The LORD Doth Put A Difference", "Israel's rescue is not because they are stronger or more impressive. God marks out His people by covenant mercy and provided protection."]],
      truths: [["📣 God announces judgment before it falls.", "The final plague is not surprise chaos; it is declared by God's word."], ["👑 No throne is above God's justice.", "Pharaoh's house is not untouchable."], ["🛡️ Deliverance rests on God's distinction.", "God knows who belongs to Him."]],
      application: ["📣 Take God's word seriously before consequences arrive.", "👑 Remember that power does not place anyone above God.", "🛡️ Rest in God's mercy, not your own strength."],
    }),
    makeCompactExodusStudySection({
      chapter: 12,
      startVerse: 1,
      ...
      movement: ["📅 God gives Israel a new beginning of months.", "🐑 Each household takes an unblemished lamb.", "🩸 Blood is placed on the doorway.", "🍞 The meal is eaten with unleavened bread and bitter herbs."],
      phrases: [["📅 The Beginning Of Months", "God starts Israel's calendar with redemption. Their time will now be organized around the night God brought them out of bondage."], ["🐑 A Lamb Without Blemish", "The lamb is whole, clean, and set apart. Israel does not give God leftovers; the sacrifice represents a life given under God's instruction."], ["🍞 Unleavened Bread With Bitter Herbs", "The meal teaches through taste. Unleavened bread remembers haste, and bitter herbs remember the bitterness of slavery."]],
      truths: [["📅 Redemption reshapes identity.", "Israel's year begins with God's rescue."], ["🐑 God provides a way of shelter through sacrifice.", "The lamb stands at the center of the Passover night."], ["🍞 Worship helps people remember honestly.", "The meal remembers both suffering and deliverance."]],
      application: ["📅 Let God's rescue define your story.", "🐑 Receive God's provided way instead of inventing your own.", "🍞 Remember what God brought you from without living trapped there."],
    }),
    makeCompactExodusStudySection({
      chapter: 12,
      startVerse: 21,
      ...
      movement: ["🩸 Israel marks the doorposts with blood.", "🚪 The people stay inside until morning.", "😭 Egypt cries out at midnight.", "🏃 Pharaoh finally sends Israel away."],
      phrases: [["🚪 Strike The Lintel And The Two Side Posts", "The doorway becomes the boundary of shelter. The family is not protected by status, wealth, or strength, but by God's appointed sign."], ["🩸 When I See The Blood, I Will Pass Over You", "This is one of the clearest rescue statements in Exodus. God promises to honor the blood as the sign of protection from judgment."], ["🏃 Rise Up, And Get You Forth", "The command Pharaoh resisted finally comes from Pharaoh's own mouth. The oppressor is forced to release the people God claimed."]],
      truths: [["🩸 God's rescue comes through His provided sign.", "The blood marks the place of safety."], ["🚪 Faith obeys by staying under God's shelter.", "Israel must trust the word and remain inside."], ["🏃 God can make resistance release what it held.", "Pharaoh finally sends them out."]],
      application: ["🩸 Trust God's way of rescue.", "🚪 Stay where God has told you safety is found.", "🏃 Believe that bondage does not get the final word."],
    }),
    makeCompactExodusStudySection({
      chapter: 12,
      startVerse: 33,
      ...
      movement: ["⚡ Egypt urges Israel to leave quickly.", "🎒 Israel carries unleavened dough and possessions.", "👥 A mixed multitude leaves with them.", "🌙 The night becomes a night to be remembered."],
      phrases: [["⚡ They Were Thrust Out Of Egypt", "Israel does not sneak out like criminals. Egypt itself pushes them out because God's judgment has broken Pharaoh's grip."], ["👥 A Mixed Multitude", "Non-Israelites leave with Israel. This is an early hint that God's saving work draws outsiders near to His covenant people."], ["🌙 A Night To Be Much Observed", "The night of deliverance becomes a holy memory. Israel is commanded to remember because freedom without memory quickly forgets the Rescuer."]],
      truths: [["⚡ God can turn oppression into release.", "Egypt goes from holding Israel to urging them out."], ["👥 God's deliverance can draw outsiders.", "The Exodus already has a wider witness."], ["🌙 Memory protects worship.", "God's people must remember the night He watched over them."]],
      application: ["⚡ Do not assume bondage is permanent.", "👥 Notice who God may be drawing through your story.", "🌙 Build rhythms that help you remember God's rescue."],
    }),
    makeCompactExodusStudySection({
      chapter: 12,
      startVerse: 43,
      ...
      title: "A Covenant Meal For A Redeemed People",
      icon: "🍽️",
      summary: "God gives Passover rules that show the meal belongs to the covenant community.",
      movement: ["🍽️ God gives rules for the Passover meal.", "✂️ Circumcision marks covenant belonging.", "🌍 The same law applies to native-born and sojourner.", "🧭 Israel leaves Egypt by their hosts."],
      phrases: [["🍽️ This Is The Ordinance Of The Passover", "After the dramatic rescue, God gives structure. Passover is not a random celebration; it is ordered worship for a redeemed people."], ["✂️ Let All His Males Be Circumcised", "Circumcision marks covenant belonging. The meal is open to outsiders who join the covenant, but it is not detached from belonging to the LORD."], ["🧭 By Their Armies", "The slaves are now described like organized hosts. God is not only freeing them; He is forming them into His people under His command."]],
      truths: [["🍽️ Redemption creates worship.", "The rescued people receive a meal of remembrance."], ["🌍 Grace welcomes outsiders into covenant belonging.", "The sojourner can join, but he joins the LORD's people."], ["🧭 God forms freed people into ordered people.", "Israel leaves as the LORD's hosts."]],
      application: ["🍽️ Let worship grow out of rescue.", "🌍 Welcome people toward covenant belonging, not just religious interest.", "🧭 Let freedom become ordered obedience to God."],
    }),
  ],
);
...
BIBLE_READER_STUDY_SECTIONS.push(
  ...[
    makeCompactExodusStudySection({
      ...
      movement: ["🏜️ Israel camps where there is no water.", "😣 The people quarrel with Moses.", "🪨 Moses strikes the rock at Horeb.", "💧 Water comes out for the people to drink."],
      phrases: [["🏜️ No Water For The People To Drink", "This is a real wilderness crisis. Exodus is not pretending thirst is small, but it shows how fear can make people forget the God who has already provided."], ["🪨 Smite The Rock", "The staff that struck Egypt now touches the rock and brings provision. The symbol connected to judgment becomes connected to mercy for God's people."], ["❓ Is The LORD Among Us, Or Not?", "This question names the heart issue. Israel's thirst is real, but the deeper struggle is whether they trust God's presence when the next need appears."]],
      truths: [["💧 God provides in dry places.", "The wilderness has no water, but God is not limited by the wilderness."], ["🧠 Fear can shorten memory.", "Israel forgets recent deliverance when thirst presses in."], ["🪨 God can bring life from unlikely places.", "A rock becomes the source of water because God commands it."]],
      application: ["💧 Bring real needs to God without accusing His character.", "🧠 Remember past provision when new pressure comes.", "🪨 Do not assume the place looks too dry for God to work."],
    }),
    makeCompactExodusStudySection({
      chapter: 17,
      startVerse: 8,
      ...
      movement: ["⚔️ Amalek attacks Israel.", "🛡️ Joshua leads the battle below.", "🙌 Moses holds up the staff of God above.", "🏳️ Moses builds an altar called The LORD is my banner."],
      phrases: [["⚔️ Then Came Amalek", "The first battle after Egypt comes while Israel is still learning how to live free. Deliverance does not mean life becomes battle-free."], ["🙌 Moses' Hands Were Heavy", "Moses is called, but he is still human. Aaron and Hur holding his hands shows that faithful leadership often needs faithful support."], ["🏳️ The LORD Is My Banner", "A banner marked identity and rallying point in battle. Moses names the altar so Israel remembers the victory belongs under God's name."]],
      truths: [["⚔️ God's people may face battle after rescue.", "Freedom does not remove opposition."], ["🤝 Support is part of victory.", "Aaron and Hur matter in the story."], ["🏳️ Victory belongs under God's name.", "Israel fights, but the LORD is the banner."]],
      application: ["⚔️ Do not be shocked when obedience includes battle.", "🤝 Let others support you when your hands are heavy.", "🏳️ Give God the name over the victory."],
    }),
    makeCompactExodusStudySection({
      chapter: 18,
      startVerse: 1,
      ...
      movement: ["👨‍👩‍👦 Jethro brings Moses' family to him.", "🗣️ Moses tells what the LORD did in Egypt.", "🙌 Jethro rejoices and blesses the LORD.", "🍽️ Israel's leaders share a meal before God."],
      phrases: [["👂 Heard Of All That God Had Done", "The Exodus is becoming testimony beyond Israel. Jethro hears that the LORD rescued His people and judged Egypt."], ["🗣️ Moses Told His Father In Law All", "Moses tells both the deliverance and the trouble along the way. Testimony is strongest when it tells the truth about hardship and God's help."], ["🙌 Now I Know That The LORD Is Greater Than All Gods", "Jethro recognizes the LORD's supremacy. Egypt's defeat becomes evidence that the LORD is not one local god among many."]],
      truths: [["👂 God's works are meant to be heard.", "Deliverance becomes testimony."], ["🗣️ Honest testimony includes hardship.", "Moses does not hide the difficult parts."], ["🌍 God's rescue reaches watching outsiders.", "Jethro responds with worship."]],
      application: ["👂 Share what God has done, not just what you survived.", "🗣️ Tell the story honestly.", "🌍 Remember your deliverance can help someone else see God."],
    }),
    makeCompactExodusStudySection({
      chapter: 18,
      startVerse: 13,
      ...
      title: "Shared Wisdom And Shared Burden",
      icon: "⚖️",
      summary: "Jethro sees Moses overwhelmed by judging every case and advises him to appoint trustworthy leaders.",
      movement: ["⏳ Moses judges the people from morning to evening.", "😓 Jethro sees the burden is too heavy.", "⚖️ He tells Moses to appoint capable leaders.", "🤝 Moses shares the work and keeps the hardest cases."],
      phrases: [["⏳ From The Morning Unto The Evening", "Moses is doing good work in an unsustainable way. The problem is not laziness; it is a structure that will wear him and the people out."], ["😓 The Thing That Thou Doest Is Not Good", "Jethro says this with care, not contempt. Sometimes wisdom comes through someone outside the pressure who can see clearly."], ["⚖️ Able Men, Such As Fear God", "The leaders must be capable, reverent, truthful, and resistant to dishonest gain. Skill matters, but character matters too."]],
      truths: [["😓 Burnout is not proof of faithfulness.", "Moses needs wisdom, not just effort."], ["🤝 Shared burden is biblical.", "Leadership is not meant to crush one person."], ["⚖️ Character matters in leadership.", "The people need leaders who fear God and love truth."]],
      application: ["😓 Notice when good work is being carried in an unhealthy way.", "🤝 Receive wise help without pride.", "⚖️ Value character as much as ability."],
    }),
    makeCompactExodusStudySection({
      chapter: 19,
      startVerse: 1,
      ...
      movement: ["⛰️ Israel arrives at Mount Sinai.", "🦅 God says He carried them on eagles' wings.", "💎 He calls them His treasured possession.", "👑 He calls them a kingdom of priests and holy nation."],
      phrases: [["⛰️ The Wilderness Of Sinai", "Sinai is not random. God told Moses at the burning bush that Israel would worship Him on this mountain, and now that promise is being fulfilled."], ["🦅 I Bare You On Eagles' Wings", "This is tender rescue language. God is reminding Israel that they did not escape Egypt by their own strength; He carried them."], ["👑 A Kingdom Of Priests, And An Holy Nation", "Israel is rescued for a calling. They are meant to live before the nations as a people who display God's holiness and represent His ways."]],
      truths: [["🦅 Grace comes before law.", "God carries Israel before He commands Israel."], ["💎 Identity comes from belonging to God.", "Israel is His treasured possession by covenant mercy."], ["👑 Rescue creates calling.", "They are saved to become a holy people."]],
      application: ["🦅 Remember that God carried you before He corrected you.", "💎 Let belonging to God define you.", "👑 See obedience as part of your calling, not punishment."],
    }),
    makeCompactExodusStudySection({
      chapter: 19,
      startVerse: 9,
      ...
      title: "The Mountain Is Set Apart",
      icon: "⛰️",
      summary: "God prepares Israel to meet Him at Sinai with washing, boundaries, thunder, smoke, and holy fear.",
      movement: ["🧼 The people wash and prepare.", "🚧 Boundaries are placed around the mountain.", "🌩️ Thunder, lightning, smoke, and trumpet sound fill Sinai.", "🔥 The LORD descends on the mountain in fire."],
      phrases: [["🧼 Sanctify Them", "The people prepare because meeting God is not casual. Washing clothes becomes an outward sign that they are approaching holy presence."], ["🚧 Set Bounds Unto The People", "The boundaries teach reverence. God is near, but sinful people cannot approach Him on their own terms."], ["🌩️ Thunders And Lightnings", "Sinai is meant to feel weighty. Israel is encountering the living God, not simply receiving religious advice."]],
      truths: [["🧼 God's presence calls for preparation.", "Grace does not make holiness casual."], ["🚧 Boundaries can be mercy.", "They protect the people from treating God lightly."], ["🌩️ God is not tame.", "The mountain scene teaches reverent awe."]],
      application: ["🧼 Approach God with humility and attention.", "🚧 Do not resent every boundary God gives.", "🌩️ Let worship recover reverence."],
    }),
    makeCompactExodusStudySection({
      chapter: 20,
      startVerse: 1,
      ...
      movement: ["🗣️ God speaks His commandments.", "🏠 He reminds Israel He brought them out of bondage.", "☝️ He commands exclusive loyalty.", "🧭 Obedience begins from redemption."],
      phrases: [["🗣️ God Spake All These Words", "The Ten Commandments are not Moses' private leadership ideas. They come from the God who has just rescued Israel."], ["🏠 Out Of The House Of Bondage", "God begins with deliverance. The law is given to freed people, not as a ladder to earn freedom."], ["☝️ No Other Gods Before Me", "Israel has left Egypt's world of many gods. Now they must learn covenant loyalty to the LORD alone."]],
      truths: [["🧭 Obedience responds to rescue.", "God saves first, then commands."], ["☝️ The LORD requires exclusive worship.", "He is not one option among many."], ["🏠 Freedom needs a new Master.", "Israel is not free to drift; they belong to God."]],
      application: ["🧭 Do not treat obedience as earning rescue.", "☝️ Identify rival loyalties in your life.", "🏠 Let freedom become belonging to God."],
    }),
    makeCompactExodusStudySection({
      chapter: 20,
      startVerse: 4,
      ...
      title: "Images, Name, And Sabbath",
      icon: "🕯️",
      summary: "God commands Israel not to make idols, misuse His name, or forget the Sabbath day.",
      movement: ["🪵 God forbids making images for worship.", "🕊️ He commands His name to be honored.", "🛑 He commands Sabbath rest.", "🌍 The Sabbath points back to creation."],
      phrases: [["🪵 Graven Image", "An idol tries to make the divine manageable and visible on human terms. Israel must not worship the LORD as if He can be reduced to something they control."], ["🕊️ Take The Name Of The LORD Thy God In Vain", "This is bigger than careless speech. It means carrying God's name lightly, falsely, or emptily while claiming to belong to Him."], ["🛑 Remember The Sabbath Day", "Former slaves are commanded to rest. Pharaoh demanded endless production, but the LORD builds rest into covenant life."]],
      truths: [["🪵 God cannot be controlled by human images.", "True worship receives God as He reveals Himself."], ["🕊️ God's name must be carried with weight.", "His people represent Him."], ["🛑 Rest is holy resistance to endless labor.", "The Sabbath teaches trust."]],
      application: ["🪵 Do not shrink God into something manageable.", "🕊️ Honor God's name in speech and lifestyle.", "🛑 Practice rest as trust, not laziness."],
    }),
    makeCompactExodusStudySection({
      chapter: 20,
      startVerse: 12,
      ...
      title: "Life With Our Neighbor",
      icon: "🤝",
      summary: "God gives commands about parents, life, marriage, property, truth, and desire.",
      movement: ["👪 God commands honor for father and mother.", "🩸 He protects life.", "💍 He protects marriage and property.", "🧠 He addresses truth and desire."],
      phrases: [["👪 Honour Thy Father And Thy Mother", "This command protects family order and generational faithfulness. A redeemed community must learn how to honor those who gave them life."], ["🗣️ Thou Shalt Not Bear False Witness", "Truth matters because community cannot survive when words become weapons. False witness can destroy justice and relationships."], ["🧠 Thou Shalt Not Covet", "The final command reaches beneath behavior into desire. God cares not only what we take, but what we secretly rehearse wanting."]],
      truths: [["🤝 Love of neighbor has concrete shape.", "God protects family, life, marriage, property, and truth."], ["🧠 God's law reaches the heart.", "Coveting exposes inward disorder."], ["⚖️ Freedom needs justice.", "A redeemed people must not treat one another like Egypt treated them."]],
      application: ["🤝 Let love become specific behavior.", "🧠 Bring hidden desires before God.", "⚖️ Refuse to use freedom to harm your neighbor."],
    }),
    makeCompactExodusStudySection({
      chapter: 20,
      startVerse: 18,
      ...
      title: "Holy Fear And Simple Worship",
      icon: "🔥",
...
BIBLE_READER_STUDY_SECTIONS.push(
  ...[
    makeCompactExodusStudySection({
      ...
      movement: ["📜 God begins giving covenant case laws.", "⏳ Hebrew servants receive limits and release.", "🏠 Family situations are addressed.", "🛡️ Vulnerable women receive legal protection."],
      phrases: [["📜 These Are The Judgments", "These are case laws applying the Ten Commandments to daily life. God is showing Israel how covenant holiness works in real situations."], ["⏳ Six Years He Shall Serve", "Servitude is limited, not endless. Israel has come out of Egypt, so their society must not copy Pharaoh's permanent oppression."], ["🛡️ She Shall Not Go Out As The Menservants Do", "The law recognizes that a vulnerable woman in a household needs specific protection. God is regulating power where abuse could easily happen."]],
      truths: [["⏳ God limits human power.", "No Israelite is allowed to become another Pharaoh."], ["🛡️ Covenant law protects vulnerable people.", "The weak are not invisible to God."], ["📜 Redemption reshapes social life.", "Freedom from Egypt must change how Israel treats people."]],
      application: ["⏳ Do not use power without limits.", "🛡️ Pay attention to people who could be overlooked.", "📜 Let God's rescue shape how you treat others."],
    }),
    makeCompactExodusStudySection({
      chapter: 21,
      startVerse: 12,
      ...
      movement: ["🩸 God addresses murder and accidental death.", "🤕 Injuries require justice.", "🐂 Negligence with animals is treated seriously.", "⚖️ Justice must be careful and proportional."],
      phrases: [["🩸 He That Smiteth A Man, So That He Die", "Human life matters because people bear God's image. Violence cannot be shrugged off as a private issue."], ["⚖️ Eye For Eye, Tooth For Tooth", "This phrase limits revenge. The punishment must fit the harm, so justice does not become uncontrolled retaliation."], ["🐂 If The Ox Were Wont To Push", "Negligence matters. If someone knows danger exists and ignores it, they are responsible for the harm that follows."]],
      truths: [["🩸 Life is sacred.", "God's law protects people from violence."], ["⚖️ Justice must be proportional.", "God does not permit endless revenge."], ["🐂 Responsibility includes preventable harm.", "Neglect can become guilt."]],
      application: ["🩸 Treat human life as sacred.", "⚖️ Seek justice without revenge.", "🐂 Take responsibility for dangers you know about."],
    }),
    makeCompactExodusStudySection({
      chapter: 22,
      startVerse: 1,
      ...
      movement: ["🐂 Theft must be repaid.", "🔥 Damage to fields must be answered.", "🤲 Entrusted property matters.", "🧾 Borrowing carries responsibility."],
      phrases: [["🧾 He Shall Restore", "Restitution means the wrongdoer must repair the loss as much as possible. Biblical justice cares about the injured person, not only the guilty person."], ["🔥 If Fire Break Out", "Even accidental damage can require responsibility. The law teaches people to care about how their actions affect neighbors."], ["🤲 Delivered Unto His Neighbour To Keep", "Trust is treated as sacred. If someone entrusts property to another person, that responsibility cannot be handled carelessly."]],
      truths: [["🧾 Repentance should move toward repair.", "Wrongdoing creates real loss that should be addressed."], ["🔥 Holiness reaches ordinary property.", "Fields, animals, and tools matter because neighbors matter."], ["🤲 Trust must be protected.", "God cares about honesty in everyday arrangements."]],
      application: ["🧾 Make wrongs right where you can.", "🔥 Consider how your choices affect your neighbor's life.", "🤲 Handle entrusted things faithfully."],
    }),
    makeCompactExodusStudySection({
      chapter: 22,
      startVerse: 16,
      ...
      movement: ["💍 Sexual responsibility is addressed.", "🚫 Israel must reject corrupt spiritual practices.", "🛡️ Strangers, widows, and orphans are protected.", "🤲 The poor must not be exploited."],
      phrases: [["🌍 Ye Were Strangers In The Land Of Egypt", "God turns Israel's memory into compassion. They know what oppression feels like, so they must not become oppressors."], ["👂 I Will Surely Hear Their Cry", "This reaches back to Exodus 2. The God who heard Israel's cry now warns Israel that He hears the cries of the vulnerable too."], ["🤲 Thou Shalt Not Be To Him As An Usurer", "God forbids heartless exploitation of the poor. Need is not an opportunity to crush someone with profit."]],
      truths: [["🌍 Memory should produce mercy.", "Former strangers must not mistreat strangers."], ["👂 God hears vulnerable people.", "Their cries reach Him."], ["🤲 Holiness rejects exploitation.", "God's people must not profit from another person's desperation."]],
      application: ["🌍 Let your past pain make you compassionate.", "👂 Take vulnerable people's cries seriously.", "🤲 Do not use someone's need as leverage."],
    }),
    makeCompactExodusStudySection({
      chapter: 23,
      startVerse: 1,
      ...
      movement: ["🗣️ False reports are forbidden.", "👥 Israel must not follow a crowd into evil.", "⚖️ Justice must not be twisted.", "🐴 Enemy animals must still be helped."],
      phrases: [["👥 Thou Shalt Not Follow A Multitude To Do Evil", "A crowd can make wrong feel normal. God tells Israel not to let social pressure replace truth."], ["⚖️ Neither Shalt Thou Countenance A Poor Man In His Cause", "Biblical justice is not favoritism in any direction. The poor must not be oppressed, but truth still matters."], ["💰 A Gift Blindeth The Wise", "Bribes distort judgment. Money can make even wise people stop seeing clearly."]],
      truths: [["🗣️ Truth matters to God.", "False reports damage justice and community."], ["👥 Crowds can normalize evil.", "God's people must resist pressure."], ["⚖️ Justice must be impartial.", "Neither wealth nor poverty should bend truth."]],
      application: ["🗣️ Refuse to spread what you do not know is true.", "👥 Do not let the crowd become your conscience.", "⚖️ Care about truth even when emotions are strong."],
    }),
    makeCompactExodusStudySection({
      chapter: 23,
      startVerse: 10,
      ...
      title: "Sabbath, Feasts, And Holy Time",
      icon: "🕯️",
      summary: "God gives rhythms of rest, land care, worship, and yearly feasts.",
      movement: ["🌾 The land rests in the seventh year.", "🛑 Workers and animals rest on the seventh day.", "🍞 Israel keeps the Feast of Unleavened Bread.", "🎉 Harvest and ingathering shape worship."],
      phrases: [["🌾 The Seventh Year Thou Shalt Let It Rest", "Even the land receives rest. God's law resists endless extraction and makes room for the poor and animals."], ["🛑 On The Seventh Day Thou Shalt Rest", "Former slaves are commanded to rest. Pharaoh demanded endless bricks, but the LORD builds rest into covenant life."], ["🎉 Three Times Thou Shalt Keep A Feast", "Israel's calendar becomes a teacher. Their year tells the story of deliverance, provision, and gratitude."]],
      truths: [["🌾 God cares about creation and the poor.", "The resting land provides for vulnerable people and animals."], ["🛑 Rest is covenant trust.", "Israel stops because God is provider."], ["🎉 Worship shapes memory.", "The feasts help Israel remember what God has done."]],
      application: ["🌾 Do not treat people, land, or resources as endless machines.", "🛑 Practice rest as trust.", "🎉 Build rhythms that help you remember God."],
    }),
    makeCompactExodusStudySection({
      chapter: 23,
      startVerse: 20,
      ...
      title: "The Angel And The Promised Land",
      icon: "🧭",
      summary: "God promises to send His angel before Israel and warns them not to covenant with the land's idols.",
      movement: ["👼 God promises to send His angel before Israel.", "👂 Israel must obey His voice.", "🛡️ God promises to oppose their enemies.", "🚫 Israel must not covenant with idols."],
      phrases: [["👼 Behold, I Send An Angel Before Thee", "God promises guidance and protection on the way. Israel is not being sent into the future alone."], ["✨ My Name Is In Him", "This is a mysterious and weighty phrase. The angel carries God's authority and presence in a unique way."], ["🌱 By Little And Little", "God says the land will not be taken all at once. Promise often unfolds through process, not instant possession."]],
      truths: [["👼 God goes before His people.", "The journey continues under divine guidance."], ["🚫 Promise requires loyalty.", "Israel must not mix covenant with idolatry."], ["🌱 God's timing can be gradual.", "Little by little is still faithfulness."]],
      application: ["👼 Trust God with the road ahead.", "🚫 Do not make peace with what will pull your heart from God.", "🌱 Be patient with promises that unfold gradually."],
    }),
    makeCompactExodusStudySection({
      chapter: 24,
      startVerse: 1,
      ...
      movement: ["📖 Moses writes and reads the words of the LORD.", "🗣️ The people agree to obey.", "🩸 Blood is sprinkled on the altar and people.", "📜 Moses calls it the blood of the covenant."],
      phrases: [["📖 The Book Of The Covenant", "The covenant is written and read aloud. Israel's relationship with God is shaped by God's spoken and written word."], ["🗣️ All That The LORD Hath Said Will We Do", "The people formally respond to God's covenant. Their words matter because covenant involves commitment."], ["🩸 The Blood Of The Covenant", "Blood represents life and covenant seriousness. This phrase will echo later when Jesus speaks of the new covenant in His blood."]],
      truths: [["📖 Covenant is shaped by God's word.", "Israel listens before agreeing."], ["🩸 Covenant with God is serious.", "Blood shows life-and-death weight."], ["🤲 Grace invites response.", "The rescued people answer the God who saved them."]],
      application: ["📖 Let God's word define relationship with Him.", "🩸 Do not treat covenant casually.", "🤲 Let your yes to God be more than words."],
    }),
    makeCompactExodusStudySection({
      chapter: 24,
      startVerse: 9,
      ...
      movement: ["⛰️ Moses and Israel's leaders go up the mountain.", "💎 They see a vision of the God of Israel.", "🍽️ They eat and drink before Him.", "☁️ Moses enters the cloud for forty days and nights."],
      phrases: [["💎 A Paved Work Of A Sapphire Stone", "The description is careful and reverent. The text focuses on what is under God's feet, showing a protected glimpse rather than a full explanation of God."], ["🍽️ They Saw God, And Did Eat And Drink", "This is covenant fellowship. The holy God who gave law also brings the leaders near in a protected meal before Him."], ["☁️ Moses Went Into The Midst Of The Cloud", "Moses goes deeper into God's presence to receive more instruction. The story is moving toward the tabernacle, where God will dwell among His people."]],
      truths: [["🍽️ God's covenant leads to fellowship.", "Law and table belong together here."], ["🔥 Holiness and nearness meet in God.", "The leaders are protected, but the scene remains reverent."], ["☁️ God will teach His people how He can dwell among them.", "The next section prepares for the tabernacle."]],
      application: ["🍽️ See obedience as part of relationship, not distance from God.", "🔥 Keep reverence and nearness together.", "☁️ Keep following God when He invites you deeper."],
    }),
  ],
);
...
BIBLE_READER_STUDY_SECTIONS.push(
  ...[
    makeCompactExodusStudySection({
      ...
      title: "A Willing Offering For God's Dwelling",
      icon: "🎁",
      summary: "God invites Israel to bring willing offerings so a sanctuary can be made among them.",
      movement: ["🎁 God asks for offerings from willing hearts.", "💎 Israel brings precious materials.", "🏕️ God gives the purpose of the sanctuary.", "✨ He wants to dwell among His people."],
      phrases: [["🎁 Of Every Man That Giveth It Willingly", "The tabernacle begins with willing hearts, not forced labor. That is a sharp contrast with Pharaoh, who built through oppression."], ["💎 Gold, And Silver, And Brass", "The materials are costly and beautiful. Much of this wealth likely came from Egypt, now redirected from empire into worship."], ["🏕️ That I May Dwell Among Them", "This is the heartbeat of the tabernacle. God does not only rescue Israel from Egypt; He makes a way to live among them."]],
      truths: [["🎁 Worship is willing, not coerced.", "God asks for gifts from moved hearts."], ["💎 Redemption redirects resources.", "Egypt's wealth becomes sanctuary material."], ["🏕️ God's goal is presence.", "The rescued people are invited to live with Him at the center."]],
      application: ["🎁 Give to God from a willing heart.", "💎 Let redeemed resources serve worship.", "🏕️ Remember that God wants presence, not distance."],
    }),
    makeCompactExodusStudySection({
      chapter: 25,
      startVerse: 10,
      ...
      movement: ["📦 The ark is made to hold the testimony.", "✨ Gold covers the ark inside and out.", "🪽 Cherubim overshadow the mercy seat.", "🗣️ God says He will meet and speak there."],
      phrases: [["📜 The Testimony Which I Shall Give Thee", "The ark holds the covenant words. God's presence is not separated from God's revealed word."], ["🪽 The Mercy Seat", "The mercy seat is the meeting place above the ark. It points to covering, atonement, and mercy at the center of worship."], ["🗣️ There I Will Meet With Thee", "God names a place of meeting. The holy God provides a way for Moses to hear His voice among the people."]],
      truths: [["📜 God's presence and God's word belong together.", "The testimony is placed at the center."], ["🪽 Mercy is central to approach.", "Israel does not meet God through achievement."], ["🗣️ God makes Himself known.", "He provides a place where He will speak."]],
      application: ["📜 Keep God's word central in worship.", "🪽 Come to God through mercy, not self-confidence.", "🗣️ Value the fact that God speaks."],
    }),
    makeCompactExodusStudySection({
      chapter: 25,
      startVerse: 23,
      ...
      movement: ["🍞 A table is made for the bread of the Presence.", "🕯️ A pure gold lampstand is formed.", "🌿 The lampstand has branches and almond blossoms.", "👀 Moses must make everything according to the pattern."],
      phrases: [["🍞 Shewbread Before Me Alway", "The bread sits before God's face as a sign of covenant fellowship and provision. Israel's life is sustained before the LORD."], ["🕯️ A Candlestick Of Pure Gold", "The lampstand gives light in the holy place. In God's dwelling, light is not optional; it is part of life near Him."], ["👀 After Their Pattern", "Moses is not free to invent worship however he wants. The tabernacle follows the pattern God reveals."]],
      truths: [["🍞 God provides fellowship and sustenance.", "Bread belongs in the holy place."], ["🕯️ God's presence brings light.", "The covered tent is not left dark."], ["👀 Worship follows revelation.", "The pattern comes from God."]],
      application: ["🍞 See provision as part of life before God.", "🕯️ Let God's light shape your inner life.", "👀 Let God define worship instead of personal taste alone."],
    }),
    makeCompactExodusStudySection({
      chapter: 26,
      startVerse: 1,
      ...
      title: "Curtains For A Holy Tent",
      icon: "🧵",
      summary: "God gives instructions for the layered curtains and coverings of the tabernacle.",
      movement: ["🧵 Fine curtains are made with blue, purple, scarlet, and cherubim.", "🐐 Goats' hair coverings are added.", "🛡️ Outer coverings protect the tent.", "✨ The inside is beautiful while the outside is durable."],
      phrases: [["🧵 Fine Twined Linen", "The tabernacle is made with skill and beauty. God's dwelling is not thrown together carelessly."], ["🪽 Cherubims Of Cunning Work", "Cherubim remind readers of Eden and guarded holy space. Access to God's presence is possible, but still reverent."], ["🛡️ A Covering For The Tent", "The tabernacle is both glorious and practical. God gives beauty inside and protection outside."]],
      truths: [["🧵 Beauty can serve worship.", "Craftsmanship matters in God's dwelling."], ["🪽 God's presence is holy space.", "Cherubim imagery reminds Israel not to approach casually."], ["🛡️ God cares about practical details too.", "The sanctuary is protected for wilderness life."]],
      application: ["🧵 Offer skill and beauty to God.", "🪽 Keep reverence in worship.", "🛡️ Do not separate spiritual beauty from practical faithfulness."],
    }),
    makeCompactExodusStudySection({
      chapter: 26,
      startVerse: 15,
      ...
      title: "Frames, Veil, And Holy Space",
      icon: "🚪",
      ...
      movement: ["🪵 Frames and sockets form the structure.", "🚪 The veil separates holy space.", "📦 The ark is placed behind the veil.", "🍞 The table and lampstand stand outside it."],
      phrases: [["🚪 The Vail Shall Divide", "The veil teaches both nearness and separation. God is dwelling among His people, but His holiness is not open to casual entry."], ["📦 Within The Vail", "The ark belongs in the Most Holy Place. The center of worship is hidden, holy, and approached only as God commands."], ["🧭 The Door Of The Tent", "There is an entrance, not random access from any direction. God provides a way to approach."]],
      truths: [["🚪 Holiness creates boundaries.", "Nearness to God does not erase reverence."], ["📦 God's presence is central.", "The whole structure is arranged around the ark and mercy seat."], ["🧭 Approach happens God's way.", "The entrance is provided, not invented."]],
      application: ["🚪 Respect holy boundaries.", "📦 Keep God's presence at the center.", "🧭 Come to God by the way He provides."],
    }),
    makeCompactExodusStudySection({
      chapter: 27,
      startVerse: 1,
      ...
      movement: ["🔥 A bronze altar is made for sacrifice.", "🩸 Offerings will be brought there.", "📍 The altar stands in the courtyard.", "🧭 Sacrifice comes before approach."],
      phrases: [["🔥 An Altar Of Shittim Wood", "The altar stands in the outer court where sacrifices are offered. It is the first major object encountered when approaching the tabernacle."], ["🩸 His Pans To Receive His Ashes", "The altar is not symbolic decoration only. Real sacrifices will burn here, leaving ashes and teaching the costliness of approach."], ["🧭 As It Was Shewed Thee In The Mount", "Even the altar follows God's revealed pattern. Atonement is provided by God, not invented by people."]],
      truths: [["🩸 Sin must be dealt with.", "The altar stands before entrance into holy space."], ["🔥 Sacrifice is central to approach.", "God provides a way through offerings."], ["🧭 Atonement follows God's pattern.", "People do not design their own access."]],
      application: ["🩸 Do not treat sin lightly.", "🔥 Be grateful God provides a way to approach.", "🧭 Trust God's way of atonement."],
    }),
    makeCompactExodusStudySection({
      chapter: 27,
      startVerse: 9,
      ...
      title: "The Courtyard And The Lamp Oil",
      icon: "🏕️",
      summary: "God gives instructions for the tabernacle courtyard and the oil that keeps the lamp burning.",
      movement: ["🏕️ Curtains form the courtyard.", "🚪 An entrance marks the way in.", "🫒 Pure oil is brought for the lamp.", "🕯️ Aaron and his sons tend the light continually."],
      phrases: [["🏕️ The Court Of The Tabernacle", "The courtyard creates a defined place of approach. Israel can come near, but not in a careless or random way."], ["🚪 The Gate Of The Court", "The gate reminds us that God provides an entrance. Holy space is guarded, but not unreachable."], ["🕯️ To Cause The Lamp To Burn Always", "The light is tended continually. God's dwelling is marked by ordered, ongoing service."]],
      truths: [["🏕️ God creates ordered space for approach.", "The courtyard teaches defined nearness."], ["🚪 Access is provided.", "There is a gate into the court."], ["🕯️ Worship requires faithful tending.", "The lamp does not maintain itself."]],
      application: ["🏕️ Approach God with ordered attention.", "🚪 Be thankful there is a way in.", "🕯️ Practice steady faithfulness, not only emotional moments."],
    }),
    makeCompactExodusStudySection({
      chapter: 28,
      startVerse: 1,
      ...
      title: "Priests Set Apart For Ministry",
      icon: "👑",
    ...
    makeCompactExodusStudySection({
      ...
      title: "The Breastpiece Over The Heart",
      icon: "💎",
      summary: "The high priest carries the names of Israel's tribes over his heart before the LORD.",
      movement: ["💎 Twelve stones are placed in the breastpiece.", "🧡 The tribe names are carried over Aaron's heart.", "⚖️ The breastpiece is connected to judgment.", "✨ The Urim and Thummim are placed inside."],
      phrases: [["💎 Twelve Stones", "Each tribe is represented by a precious stone. The people are distinct and valuable before God."], ["🧡 Upon His Heart", "This is tender representation. The priest carries Israel not only on his shoulders for strength, but over his heart for affection and care."], ["⚖️ The Breastplate Of Judgment", "Judgment here is connected with priestly discernment before the LORD. Israel needs guidance from God, not merely human opinion."]],
      truths: [["💎 God's people are precious and known.", "Each tribe has a place."], ["🧡 Representation includes care.", "The names are carried over the heart."], ["⚖️ God's people need divine guidance.", "Judgment belongs before the LORD."]],
      application: ["💎 Remember your value before God.", "🧡 Carry people with love, not just duty.", "⚖️ Seek God's wisdom, not only human instinct."],
    }),
    makeCompactExodusStudySection({
      chapter: 28,
      startVerse: 31,
      ...
      movement: ["🔔 Bells and pomegranates are placed on the robe.", "🕊️ A gold plate says Holy to the LORD.", "🧥 Linen garments cover the priests.", "⚠️ Priestly service must follow God's instruction."],
      phrases: [["🔔 His Sound Shall Be Heard", "The bells mark priestly movement in holy service. Approaching God is weighty, visible, and ordered."], ["🕊️ Holiness To The LORD", "This phrase marks Aaron as set apart to God. Priesthood is not personal branding; it is holy belonging."], ["⚠️ That They Bear Not Iniquity, And Die", "The warning is serious because God's presence is serious. Holy ministry cannot be handled carelessly."]],
      truths: [["🕊️ God marks His servants as holy.", "Priestly identity belongs to the LORD."], ["🧥 Covering matters before God.", "The garments teach reverence and purity."], ["⚠️ Holy service is serious.", "God's instructions are not decorative suggestions."]],
      application: ["🕊️ Let belonging to God shape your identity.", "🧥 Approach God with reverence, not casual exposure.", "⚠️ Do not treat holy things lightly."],
    }),
  ],
);
...
BIBLE_READER_STUDY_SECTIONS.push(
  ...[
    makeCompactExodusStudySection({
      ...
      title: "Aaron And His Sons Are Consecrated",
      icon: "🧼",
      summary: "God gives instructions for washing, clothing, anointing, and setting apart the priests.",
      movement: ["🧼 The priests are washed.", "👕 Aaron is clothed in holy garments.", "🫒 He is anointed with oil.", "👑 Aaron and his sons are set apart for priestly service."],
      phrases: [["🧼 Wash Them With Water", "Priestly service begins with cleansing. Aaron and his sons cannot enter holy work as if natural readiness is enough."], ["👕 Put Upon Aaron The Holy Garments", "The garments cover and identify the priest. He does not represent himself before God; he serves in the role God provides."], ["🫒 Anoint Him", "Anointing marks Aaron as set apart for God's service. The priesthood is not self-appointed."]],
      truths: [["🧼 Holy service requires cleansing.", "The priest must be washed before serving."], ["👕 God provides covering for approach.", "Aaron serves clothed as God commands."], ["🫒 Calling comes from God.", "Priestly ministry is appointed, not seized."]],
      application: ["🧼 Do not confuse giftedness with cleansing.", "👕 Receive the covering God provides.", "🫒 Let God define your calling."],
    }),
    makeCompactExodusStudySection({
      chapter: 29,
      startVerse: 10,
      ...
      title: "Blood, Sacrifice, And Priesthood",
      icon: "🩸",
    ...
    makeCompactExodusStudySection({
      ...
      title: "God Meets Israel At The Tent",
      icon: "🏕️",
      summary: "God gives instructions for ongoing offerings and promises to dwell among Israel as their God.",
      movement: ["📅 Consecration lasts seven days.", "🌅 Offerings are given morning and evening.", "🏕️ God promises to meet Israel at the tent.", "✨ He promises to dwell among them."],
      phrases: [["📅 Seven Days Shalt Thou Consecrate Them", "Priestly preparation is not rushed. Seven days signals completeness and seriousness before holy service begins."], ["🌅 Day By Day Continually", "The daily offerings create a rhythm of dependence. Worship is not only a crisis response; it is morning and evening life with God."], ["✨ I Will Dwell Among The Children Of Israel", "This is the purpose under the instructions. God wants to live among His redeemed people as their God."]],
      truths: [["📅 Holy formation takes time.", "Consecration is a process."], ["🌅 Worship needs rhythm.", "Daily offering trains steady dependence."], ["✨ God's goal is dwelling.", "The tabernacle exists for presence."]],
      application: ["📅 Let God form you patiently.", "🌅 Build daily rhythms of worship.", "✨ Remember that God wants relationship, not empty ritual."],
    }),
    makeCompactExodusStudySection({
      chapter: 30,
      startVerse: 1,
      ...
      movement: ["🌫️ An altar of incense is made.", "🌅 Incense burns morning and evening.", "🚫 Strange incense is forbidden.", "🩸 Atonement is made on its horns once a year."],
      phrases: [["🌫️ Sweet Incense Every Morning", "Incense rises near the veil, close to the Most Holy Place. Later Scripture connects incense with prayer rising before God."], ["🚫 Ye Shall Offer No Strange Incense", "Nearness to God does not mean people can invent worship however they want. Holy worship follows God's instruction."], ["🩸 Atonement Upon The Horns", "Even the altar of incense is connected to atonement. Prayer and nearness rest on mercy."]],
      truths: [["🌫️ Prayer rises before God.", "Incense becomes a beautiful picture of nearness."], ["🚫 Worship must not be self-invented.", "God defines holy approach."], ["🩸 Nearness rests on atonement.", "Mercy stands behind approach."]],
      application: ["🌫️ Let prayer become a steady rhythm.", "🚫 Do not personalize worship into disobedience.", "🩸 Come near through mercy."],
    }),
    makeCompactExodusStudySection({
      chapter: 30,
      startVerse: 11,
      ...
      title: "Ransom Money And The Bronze Laver",
      icon: "🪙",
      summary: "God gives instructions for census ransom money and priestly washing at the bronze basin.",
      movement: ["🪙 Each person gives ransom money when counted.", "⚖️ Rich and poor give the same amount.", "💧 A bronze laver is made for washing.", "🧼 Priests wash before serving."],
      phrases: [["🪙 A Ransom For His Soul", "The census money teaches that life belongs to God and needs covering. Being counted before God is not casual."], ["⚖️ The Rich Shall Not Give More, And The Poor Shall Not Give Less", "Every life needs ransom equally. Worth before God is not measured by wealth."], ["💧 Wash With Water, That They Die Not", "The priests must wash before serving. Holy work requires cleansing, not confidence in the uniform."]],
      truths: [["🪙 Every life needs ransom.", "No one stands before God on their own terms."], ["⚖️ Human worth is equal before God.", "Money does not change the ransom requirement."], ["💧 Cleansing is necessary for service.", "The priest must wash before approaching."]],
      application: ["🪙 Remember your life belongs to God.", "⚖️ Do not measure people by wealth.", "💧 Keep coming to God for cleansing."],
    }),
    makeCompactExodusStudySection({
      chapter: 30,
      startVerse: 22,
      ...
      movement: ["🫒 Sacred anointing oil is made.", "🏕️ The tabernacle and priests are anointed.", "🌿 Holy incense is prepared.", "🚫 The oil and incense must not be copied for common use."],
      phrases: [["🫒 An Holy Anointing Oil", "The oil marks people and objects as set apart for God's use. It is not ordinary fragrance for ordinary purposes."], ["🌿 A Perfume, Pure And Holy", "The incense belongs to worship before the LORD. Even scent becomes part of holy space."], ["🚫 Ye Shall Not Make To Yourselves", "God forbids turning holy things into personal products. What is set apart for Him must not be made common."]],
      truths: [["🫒 Holiness means set apart.", "The oil marks what belongs to God."], ["🌿 Worship involves embodied memory.", "Even smell can teach holiness."], ["🚫 Holy things should not be used casually.", "God guards what belongs to His presence."]],
      application: ["🫒 Treat what belongs to God as set apart.", "🌿 Let worship shape your senses and memory.", "🚫 Do not make holy things common for personal gain."],
    }),
    makeCompactExodusStudySection({
      chapter: 31,
      startVerse: 1,
      ...
      movement: ["🛠️ God names Bezalel for the work.", "🕊️ He fills him with the Spirit of God.", "🎨 Craftsmanship serves worship.", "🤝 Oholiab and other skilled workers join the work."],
      phrases: [["🕊️ Filled Him With The Spirit Of God", "This Spirit-filling is for craftsmanship. God values skilled making, design, and beauty in service to worship."], ["🎨 In Wisdom, And In Understanding, And In Knowledge", "Skill is described as wisdom from God. Art and construction can be holy service when offered to Him."], ["🤝 I Have Given With Him Aholiab", "The tabernacle is not one person's project. God provides a team of gifted workers."]],
      truths: [["🛠️ Skill can be spiritual service.", "Craftsmanship matters to God."], ["🎨 Beauty belongs in worship.", "God gifts people to make holy things well."], ["🤝 God's work is shared work.", "Bezalel is gifted, but not alone."]],
      application: ["🛠️ Offer practical skill to God.", "🎨 Do not dismiss creativity as unspiritual.", "🤝 Value the team God gives."],
    }),
    makeCompactExodusStudySection({
      chapter: 31,
      startVerse: 12,
      ...
      movement: ["🛑 God repeats the Sabbath command.", "📍 Sabbath is a sign between God and Israel.", "🧱 Moses receives two tablets.", "☝️ The tablets are written by the finger of God."],
      phrases: [["🛑 My Sabbaths Ye Shall Keep", "Even tabernacle work must stop for Sabbath. Holy work is not an excuse to ignore God's rhythm."], ["📍 A Sign Between Me And You", "Sabbath marks Israel as belonging to the LORD. Their identity is not endless production."], ["☝️ Written With The Finger Of God", "The tablets carry divine authority. These are covenant words from God Himself."]],
      truths: [["🛑 Rest remains holy.", "Even important work bows to God's rhythm."], ["📍 Sabbath marks belonging.", "Israel's time belongs to the LORD."], ["☝️ God's word carries divine authority.", "The tablets are not human invention."]],
      application: ["🛑 Do not let good work erase holy rest.", "📍 Let your schedule show who you belong to.", "☝️ Receive God's word as weighty."],
    }),
    makeCompactExodusStudySection({
      chapter: 32,
      startVerse: 1,
      ...
      movement: ["⏳ The people see that Moses delays.", "🐂 Aaron makes a golden calf.", "🗣️ The people connect the calf to their Exodus rescue.", "🎉 They feast and worship before the idol."],
      phrases: [["⏳ Moses Delayed", "Delay exposes the heart. Israel's impatience turns waiting into rebellion."], ["🐂 Make Us Gods", "The people want visible control. They would rather have something manageable than wait for the unseen God who rescued them."], ["🗣️ These Be Thy Gods, O Israel", "This is the deep corruption: they attach God's rescue to an idol. False worship can use true religious language."]],
      truths: [["⏳ Impatience can corrupt worship.", "Waiting becomes dangerous when trust disappears."], ["🐂 Idolatry tries to manage God.", "The calf gives them something visible and controllable."], ["🗣️ Religious language can hide rebellion.", "They speak of rescue while worshiping falsely."]],
      application: ["⏳ Watch your heart when God seems delayed.", "🐂 Do not shrink God into something manageable.", "🗣️ Do not attach God's name to what He has not commanded."],
    }),
    makeCompactExodusStudySection({
      chapter: 32,
      startVerse: 7,
      ...
      movement: ["⚠️ God tells Moses the people corrupted themselves.", "🔥 God's anger burns against the sin.", "🙏 Moses pleads for mercy.", "📜 He appeals to God's promises to Abraham, Isaac, and Israel."],
      phrases: [["⚠️ Thy People Have Corrupted Themselves", "Idolatry is not a small mistake. It corrupts the covenant relationship at the root."], ["📣 Wherefore Should The Egyptians Speak", "Moses appeals to God's name among the nations. He cares about how God's rescue will be understood."], ["📜 Remember Abraham, Isaac, And Israel", "Moses appeals to covenant promise, not Israel's innocence. Mercy rests on God's faithfulness."]],
      truths: [["⚠️ Sin must be named truthfully.", "Moses does not minimize idolatry."], ["🙏 Intercession appeals to God's character.", "Moses pleads from covenant truth."], ["📜 God's promises matter in crisis.", "The patriarchal covenant remains part of the argument for mercy."]],
      application: ["⚠️ Do not call sin small when God calls it corruption.", "🙏 Pray by appealing to who God is.", "📜 Remember God's promises when judgment feels deserved."],
    }),
    makeCompactExodusStudySection({
      chapter: 32,
      startVerse: 15,
      ...
      movement: ["🧱 Moses carries the tablets down the mountain.", "💔 He breaks them when he sees the calf.", "🔥 He destroys the idol.", "⚖️ Judgment falls in the camp."],
      phrases: [["🧱 Tables Written On Both Their Sides", "The tablets are God's covenant testimony. Moses carries divine words into a camp already breaking them."], ["💔 He Cast The Tables Out Of His Hands", "The broken tablets visually show the broken covenant. Israel has shattered the relationship they just agreed to keep."], ["🔥 Ground It To Powder", "Moses humiliates the idol. What Israel worshiped is reduced to dust and bitterness."]],
      truths: [["💔 Idolatry breaks covenant.", "The tablets shatter because the relationship has been violated."], ["🔥 False gods must be destroyed, not managed.", "Moses does not preserve the calf as a souvenir."], ["⚖️ Sin brings real consequences.", "The golden calf is not harmless confusion."]],
      application: ["💔 Let brokenness over sin be honest.", "🔥 Do not keep pieces of idols around.", "⚖️ Take consequences seriously."],
    }),
    makeCompactExodusStudySection({
      chapter: 32,
      startVerse: 30,
      ...
      title: "Moses Offers Himself",
      icon: "🧎",
      summary: "Moses returns to the LORD, confesses Israel's sin, and offers to be blotted out for the people.",
      movement: ["🧎 Moses returns to the LORD.", "🗣️ He confesses Israel's great sin.", "📖 He offers to be blotted out for them.", "⚖️ God answers with justice and continued consequence."],
      phrases: [["🗣️ This People Have Sinned A Great Sin", "Moses intercedes honestly. He does not excuse the idol or soften the confession."], ["📖 Blot Me, I Pray Thee, Out Of Thy Book", "Moses offers himself for the people. God does not accept him as the final substitute, but the scene points toward the need for a greater mediator."], ["⚖️ In The Day When I Visit I Will Visit Their Sin", "Mercy does not mean sin was imaginary. God continues the story, but judgment remains serious."]],
      truths: [["🧎 True intercession tells the truth.", "Moses confesses the sin plainly."], ["📖 God's people need a greater mediator.", "Moses can plead, but he cannot finally atone."], ["⚖️ Mercy and justice both matter.", "God does not abandon the people, but sin is not ignored."]],
      application: ["🧎 Confess honestly when you pray.", "📖 Look beyond human mediators to Christ.", "⚖️ Do not confuse mercy with God pretending sin is fine."],
    }),
  ],
);
...
BIBLE_READER_STUDY_SECTIONS.push(
  ...[
    makeCompactExodusStudySection({
      ...
      title: "A Land Without Presence Would Be Empty",
      icon: "🏜️",
    ...
    makeCompactExodusStudySection({
      ...
      title: "Moses Meets With God",
      icon: "⛺",
      summary: "Moses meets with the LORD at the tent of meeting, and the LORD speaks with him face to face.",
      movement: ["⛺ Moses pitches the tent outside the camp.", "☁️ The pillar of cloud descends.", "🙇 The people worship from their tent doors.", "🗣️ The LORD speaks with Moses face to face."],
      phrases: [["⛺ Without The Camp", "The tent outside the camp shows the damage sin has done. God's presence is still available, but the camp's fellowship has been disrupted."], ["☁️ The Cloudy Pillar Descended", "The cloud shows God's real presence meeting with Moses. This is not religious imagination; God is drawing near."], ["🗣️ Face To Face", "This means direct covenant communication, not that Moses sees all of God's essence. Moses has unusually close access with the LORD."]],
      truths: [["⛺ Sin affects the community's nearness to God.", "The tent is outside the camp."], ["☁️ God still makes a meeting place.", "Mercy is already visible in the cloud descending."], ["🗣️ Intercession grows from nearness.", "Moses can plead because he meets with God."]],
      application: ["⛺ Notice what sin disrupts.", "☁️ Seek the meeting place God provides.", "🗣️ Let prayer grow from real relationship with God."],
    }),
    makeCompactExodusStudySection({
      chapter: 33,
      startVerse: 12,
      ...
      movement: ["🙏 Moses asks to know God's ways.", "🧭 He refuses to go without God's presence.", "✨ Moses asks to see God's glory.", "🪨 God hides Moses in the cleft of the rock."],
      phrases: [["🧭 If Thy Presence Go Not With Me", "Moses knows the promised land is not enough without God. Presence is the real treasure."], ["✨ Shew Me Thy Glory", "Moses asks for deeper revelation. God answers by revealing His goodness and proclaiming His name."], ["🪨 A Clift Of The Rock", "God protects Moses while revealing Himself. Even Moses cannot handle the full unveiled glory of God."]],
      truths: [["🧭 God's presence is better than progress.", "Moses would rather stay than move forward without God."], ["✨ God's glory is tied to His character.", "God reveals goodness and His name."], ["🪨 God reveals and protects.", "He gives Moses what he can receive."]],
      application: ["🧭 Ask for presence, not just success.", "✨ Want to know God's character deeply.", "🪨 Be grateful God reveals Himself with mercy and protection."],
    }),
    makeCompactExodusStudySection({
      chapter: 34,
      startVerse: 1,
      ...
      movement: ["📜 God commands Moses to cut new tablets.", "☁️ The LORD descends in the cloud.", "📣 God proclaims His name.", "🙇 Moses bows and pleads for God to go with Israel."],
      phrases: [["📜 Hew Thee Two Tables Of Stone", "The new tablets show covenant renewal. The broken covenant is not ignored, but God is mercifully continuing the relationship."], ["📣 Merciful And Gracious", "This is one of the Bible's clearest descriptions of God's character. He is not pretending sin is small; He is revealing that mercy is truly in Him."], ["⚖️ That Will By No Means Clear The Guilty", "God's mercy is not moral laziness. He forgives, but He is also just."]],
      truths: [["📜 God can renew after failure.", "The tablets are given again."], ["📣 God's glory includes mercy.", "His name reveals compassion and patience."], ["⚖️ Mercy and justice belong together.", "God forgives without treating sin as nothing."]],
      application: ["📜 Do not assume failure ends God's work.", "📣 Anchor hope in God's revealed character.", "⚖️ Receive mercy without minimizing sin."],
    }),
    makeCompactExodusStudySection({
      chapter: 34,
      startVerse: 10,
    ...
    makeCompactExodusStudySection({
      ...
      title: "Sabbath And The Tabernacle Offering",
      icon: "🛑",
      summary: "Moses gathers Israel, repeats the Sabbath command, and calls for offerings and skilled work for the tabernacle.",
      movement: ["🛑 Moses repeats Sabbath before the work starts.", "🎁 Offerings are requested from willing hearts.", "🧵 Materials for the tabernacle are named.", "🛠️ Skilled workers are called to serve."],
      phrases: [["🛑 Six Days Shall Work Be Done", "Even holy work must honor God's rhythm. Building the tabernacle does not cancel Sabbath."], ["🎁 Whosoever Is Of A Willing Heart", "God's dwelling is not built through Pharaoh-style coercion. Willing hearts bring the offering."], ["🛠️ Every Wise Hearted Among You", "Skill is invited into worship. The tabernacle needs willing gifts and wise hands."]],
      truths: [["🛑 God's work must be done God's way.", "Sabbath comes before construction."], ["🎁 Worshipful giving is willing.", "The offering comes from moved hearts."], ["🛠️ Skill belongs in God's service.", "Craftsmanship is part of obedience."]],
      application: ["🛑 Do not use ministry as an excuse to ignore rest.", "🎁 Give from willingness, not pressure.", "🛠️ Offer your abilities to God's work."],
    }),
    makeCompactExodusStudySection({
      chapter: 35,
      startVerse: 20,
      ...
      title: "Willing Hearts Bring Gifts",
      icon: "💝",
      summary: "The people bring freewill offerings for the tabernacle with stirred hearts and willing spirits.",
      movement: ["💝 Stirred hearts bring offerings.", "💍 Jewelry and materials are given.", "🧵 Skilled women spin fabric.", "🫒 Leaders bring stones, spices, and oil."],
      phrases: [["💝 Whose Heart Stirred Him Up", "The offering comes from inner movement, not external force. God is forming generosity after covenant failure."], ["💍 Bracelets, And Earrings, And Rings", "Jewelry that could become another idol is now surrendered for God's dwelling. The direction of the heart changes the use of the gift."], ["🧵 All The Women That Were Wise Hearted", "Women are named as skilled contributors to the tabernacle work. Their craftsmanship matters in the building of holy space."]],
      truths: [["💝 Mercy can stir generosity.", "The people respond freely after renewal."], ["💍 Resources can be redirected.", "Gold can serve worship instead of idolatry."], ["🧵 God values hidden skill.", "The spinning and making matter."]],
      application: ["💝 Let your heart be stirred toward obedience.", "💍 Surrender resources that could become idols.", "🧵 Do not underestimate quiet skilled service."],
    }),
    makeCompactExodusStudySection({
      chapter: 35,
      startVerse: 30,
    ...
    makeCompactExodusStudySection({
      ...
      title: "The Tabernacle Begins To Take Shape",
      icon: "🏕️",
...
BIBLE_READER_STUDY_SECTIONS.push(
  ...[
    makeCompactExodusStudySection({
      ...
      title: "The Ark And Mercy Seat Are Made",
      icon: "📦",
      summary: "Bezalel makes the ark, cherubim, and mercy seat according to God's pattern.",
      movement: ["📦 Bezalel makes the ark.", "✨ Gold covers it inside and out.", "🪽 Cherubim are made over the mercy seat.", "🤲 Mercy sits at the center of worship."],
      phrases: [["📦 Bezalel Made The Ark", "The ark is the central object in the Most Holy Place. It holds the covenant testimony and points to God's throne-like presence among Israel."], ["🪽 The Mercy Seat", "The mercy seat sits above the ark as the meeting place connected with atonement. Mercy is not on the edge of Israel's worship; it is central."], ["🧭 Of One Piece Made He Them", "The cherubim and mercy seat are carefully made according to the pattern. This is obedient worship, not human invention."]],
      truths: [["📦 God's word belongs at the center.", "The testimony is kept in the ark."], ["🤲 Mercy is central to life with God.", "The mercy seat is the meeting place."], ["🧭 Worship follows God's pattern.", "The craftsmen do what God commanded."]],
      application: ["📦 Keep God's word central.", "🤲 Come to God through mercy.", "🧭 Let obedience shape worship."],
    }),
    makeCompactExodusStudySection({
      chapter: 37,
      startVerse: 10,
      ...
      title: "Bread, Light, And Incense",
      icon: "🕯️",
      summary: "The table, lampstand, altar of incense, anointing oil, and incense are made for tabernacle worship.",
      movement: ["🍞 The table is made for the bread.", "🕯️ The lampstand is made of pure gold.", "🌫️ The incense altar is made.", "🫒 Holy oil and incense are prepared."],
      phrases: [["🍞 The Table", "The table holds the bread of the Presence. It reminds Israel that life with God includes provision, fellowship, and covenant nearness."], ["🕯️ The Candlestick Of Pure Gold", "The lampstand brings light into the holy place. God's dwelling is marked by light, beauty, and life."], ["🌫️ The Incense Altar", "The incense altar stands near the veil. It points toward prayer-like nearness before the LORD."]],
      truths: [["🍞 God provides fellowship.", "Bread belongs before His presence."], ["🕯️ God's presence brings light.", "The holy place is not dark."], ["🌫️ Nearness is fragrant and ordered.", "Incense is offered God's way."]],
      application: ["🍞 Receive daily life as provision before God.", "🕯️ Let God's light shape your worship.", "🌫️ Keep prayer near the center."],
    }),
    makeCompactExodusStudySection({
      chapter: 38,
      startVerse: 1,
      ...
      title: "The Altar And Laver Are Made",
      icon: "🔥",
      summary: "The bronze altar and bronze laver are made for sacrifice and priestly washing.",
      movement: ["🔥 The bronze altar is made.", "🩸 Sacrifice will happen there.", "💧 The bronze laver is made.", "🪞 The laver uses mirrors from serving women."],
      phrases: [["🔥 The Altar Of Burnt Offering", "This altar stands before the holy place. Approach begins with sacrifice because sin must be dealt with."], ["💧 The Laver Of Brass", "The laver is for priestly washing. Holy service requires cleansing, not just holy clothing."], ["🪞 Lookingglasses Of The Women", "The mirrors are transformed into a tool for cleansing. Objects once used for seeing the self now serve purification before God."]],
      truths: [["🩸 Sacrifice comes before approach.", "The altar stands in the courtyard."], ["💧 Cleansing is necessary for service.", "Priests wash before ministry."], ["🪞 God can redirect ordinary objects for holy purpose.", "Mirrors become part of the laver."]],
      application: ["🩸 Do not bypass atonement.", "💧 Keep coming to God for cleansing.", "🪞 Let God repurpose what you have for holiness."],
    }),
    makeCompactExodusStudySection({
      chapter: 38,
      startVerse: 9,
      ...
      title: "The Courtyard Is Built",
      icon: "🏕️",
      summary: "The courtyard curtains, posts, sockets, entrance, and bronze equipment are made.",
      movement: ["🏕️ Curtains form the courtyard.", "🪵 Posts and sockets are set.", "🚪 The gate is made.", "🧭 Access is defined by God's pattern."],
      phrases: [["🏕️ The Court", "The courtyard creates sacred space around the tabernacle. Israel can approach, but approach is ordered."], ["🚪 The Gate Of The Court", "There is a real entrance. God's holiness creates boundaries, but His mercy provides a way in."], ["🧭 All The Pins Of The Tabernacle", "Even small pieces matter. Holy obedience includes details people might overlook."]],
      truths: [["🏕️ God's presence creates holy space.", "The courtyard marks nearness and boundary."], ["🚪 God provides access.", "There is a gate into the court."], ["🧭 Details matter in obedience.", "Even pins are counted and made."]],
      application: ["🏕️ Treat nearness to God with reverence.", "🚪 Be grateful God provides a way in.", "🧭 Do small acts of obedience faithfully."],
    }),
    makeCompactExodusStudySection({
      chapter: 38,
      startVerse: 21,
      ...
      movement: ["🧾 The tabernacle materials are counted.", "🥇 Gold is recorded.", "🥈 Silver is recorded.", "🥉 Bronze is recorded."],
      phrases: [["🧾 This Is The Sum", "The material count shows accountability. Worshipful generosity is handled openly and carefully."], ["📋 By The Hand Of Ithamar", "The Levites help oversee the work. Holy projects require trustworthy administration."], ["🥈 The Silver Of Them That Were Numbered", "The ransom silver becomes part of the sanctuary structure. Redeemed lives are connected to God's dwelling."]],
      truths: [["🧾 Stewardship matters.", "Generosity should not be handled carelessly."], ["📋 Holy work needs accountability.", "The materials are tracked."], ["🥈 Redemption supports worship.", "Ransom silver becomes sanctuary sockets and hooks."]],
      application: ["🧾 Handle gifts with integrity.", "📋 Value faithful administration.", "🥈 Let redemption support worship."],
    }),
    makeCompactExodusStudySection({
      chapter: 39,
      startVerse: 1,
      ...
      movement: ["👕 Priestly garments are made.", "💎 Stones carry Israel's names.", "🧡 The breastpiece carries the tribes over the heart.", "🕊️ The gold plate says Holy to the LORD."],
      phrases: [["💎 Stones Of Memorial", "The priest carries Israel's names before God. The tribes are remembered, represented, and borne in holy service."], ["🧡 The Breastplate", "The names are carried over the heart. Representation before God includes care, not just duty."], ["🕊️ Holiness To The LORD", "The gold plate marks the priest as belonging to God. Ministry is holy identity, not personal status."]],
      truths: [["👑 God's people need representation.", "The priest bears their names."], ["🧡 God remembers His people personally.", "The tribes are carried over the heart."], ["🕊️ Holy service belongs to the LORD.", "The priest is marked as set apart."]],
      application: ["👑 Be thankful for representation before God.", "🧡 Carry people with love.", "🕊️ Let holiness define service."],
    }),
    makeCompactExodusStudySection({
      chapter: 39,
      startVerse: 32,
      ...
      movement: ["📦 The completed pieces are brought to Moses.", "👀 Moses inspects the work.", "✅ Everything is done as the LORD commanded.", "🙌 Moses blesses the people."],
      phrases: [["✅ As The LORD Commanded Moses", "This repeated phrase is the opposite of the golden calf. Israel is no longer inventing worship; they are obeying God's word."], ["👀 Moses Did Look Upon All The Work", "Inspection matters because obedience is not vague intention. The work is examined and found faithful."], ["🙌 Moses Blessed Them", "The blessing comes after faithful obedience. The people's willing work has become worship."]],
      truths: [["✅ Obedience heals worship.", "The pattern is followed carefully."], ["👀 Faithful work can be inspected.", "The details match God's command."], ["🙌 Renewed obedience can follow failure.", "The people who failed are now blessed for faithful work."]],
      application: ["✅ Let your worship be shaped by God's word.", "👀 Make obedience concrete enough to inspect.", "🙌 Believe God can restore faithful work after failure."],
    }),
    makeCompactExodusStudySection({
      chapter: 40,
      startVerse: 1,
      ...
      movement: ["📅 God names the day to set up the tabernacle.", "📦 The ark and furniture are arranged.", "🫒 The sanctuary is anointed.", "🧼 Aaron and his sons are washed and clothed."],
      phrases: [["📅 The First Day Of The First Month", "The timing gives the setup a new-beginning feel. Israel's worship life is being ordered around God's dwelling."], ["🫒 Anoint The Tabernacle", "The tabernacle and its pieces are set apart for holy use. This is not ordinary furniture."], ["🧼 Wash Them With Water", "Even at the setup, priestly service begins with cleansing. Nearness to God requires preparation."]],
      truths: [["📅 God's presence marks a new beginning.", "The tabernacle is set up at the start of the month."], ["🫒 Holy things are set apart.", "The sanctuary is anointed."], ["🧼 Priestly service requires cleansing.", "Aaron and his sons are washed."]],
      application: ["📅 Let God's presence reorder your life.", "🫒 Treat what belongs to God as holy.", "🧼 Come to God for cleansing before service."],
    }),
    makeCompactExodusStudySection({
      chapter: 40,
      startVerse: 17,
      ...
      movement: ["🛠️ Moses raises the tabernacle.", "📦 The ark is placed behind the veil.", "🕯️ The table, lampstand, and altars are arranged.", "✅ Moses finishes the work."],
      phrases: [["✅ As The LORD Commanded Moses", "The phrase repeats again and again. Exodus slows down so we see careful obedience after the disorder of idolatry."], ["🚪 He Put Up The Vail", "The veil marks the Most Holy Place. God is near, but His holiness is still guarded."], ["🏁 So Moses Finished The Work", "The long process reaches completion. What began as instructions has become a dwelling prepared for glory."]],
      truths: [["✅ Obedience is repeated faithfulness.", "Moses does each part as commanded."], ["🚪 Nearness and holiness remain together.", "The veil is set in place."], ["🏁 God completes what He commanded.", "The work is finished."]],
      application: ["✅ Keep obeying in the details.", "🚪 Hold reverence and access together.", "🏁 Finish the work God gives you."],
    }),
    makeCompactExodusStudySection({
      chapter: 40,
      startVerse: 34,
      ...
      movement: ["☁️ The cloud covers the tent.", "✨ The glory of the LORD fills the tabernacle.", "🧍 Moses cannot enter because of the glory.", "🔥 Cloud and fire guide Israel's journeys."],
      phrases: [["✨ The Glory Of The LORD Filled The Tabernacle", "This is the climax of Exodus. The God who rescued Israel now dwells in the middle of the camp."], ["🧍 Moses Was Not Able To Enter", "God's glory is overwhelming. Even Moses cannot casually enter when the glory fills the tent."], ["🔥 In The Sight Of All The House Of Israel", "The cloud and fire are visible signs of guidance. Israel is still on a journey, but they are not alone."]],
      truths: [["✨ Redemption aims at presence.", "God rescues so He can dwell with His people."], ["🔥 God guides His people.", "The cloud and fire lead the journey."], ["🧍 Glory is weighty.", "God's nearness is not casual."]],
      application: ["✨ Make God's presence the goal, not just escape from trouble.", "🔥 Follow God's guidance one step at a time.", "🧍 Approach God's glory with reverence."],
    }),
  ],
);
...
BIBLE_READER_STUDY_SECTIONS.push(
  ...[
    makeCompactLeviticusStudySection({
      chapter: 1,
      startVerse: 1,
      endVerse: 17,
      ...
      movement: ["⛺ God speaks from the tent of meeting.", "🐂 The worshiper brings an animal offering.", "✋ The worshiper lays a hand on its head.", "🔥 The whole offering rises to the LORD."],
      phrases: [["⛺ The LORD Called Unto Moses", "Leviticus begins with God speaking from the tabernacle. Exodus ended with glory filling the tent; now God teaches Israel how to approach Him."], ["✋ Put His Hand Upon The Head", "The hand on the animal shows identification. The offering is connected to the worshiper and brought before God on the worshiper's behalf."], ["🔥 A Sweet Savour Unto The LORD", "This means the offering is accepted according to God's instruction. The point is not that God enjoys death, but that He receives the offering He provided."]],
      truths: [["⛺ God speaks from His dwelling.", "Leviticus flows directly out of Exodus."], ["🔥 Approach requires atonement.", "The altar stands between sinful people and holy presence."], ["🤲 Worship involves surrender.", "The whole burnt offering goes up to God."]],
      application: ["⛺ Read Leviticus as life near God's presence.", "🔥 Do not treat access to God casually.", "🤲 Bring God whole surrender, not leftovers."],
    }),
    makeCompactLeviticusStudySection({
      chapter: 2,
      startVerse: 1,
      ...
      movement: ["🌾 Fine flour is brought to the LORD.", "🫒 Oil and frankincense are added.", "🔥 A memorial portion is burned.", "🧂 Salt is required with the offering."],
      phrases: [["🌾 Fine Flour", "The grain offering comes from daily provision and human labor. Israel gives back to God from what He has provided."], ["🔥 Memorial Of It", "The burned portion represents the whole gift before God. It is a reminder offering lifted to the LORD."], ["🧂 Salt Of The Covenant", "Salt points to covenant faithfulness, preservation, and permanence. Israel's gratitude is tied to covenant relationship."]],
      truths: [["🌾 Daily provision belongs to God.", "The field and kitchen are part of worship."], ["🫒 Gratitude should be intentional.", "The offering is prepared and brought carefully."], ["🧂 Covenant faithfulness seasons worship.", "Salt is not optional in the offering."]],
      application: ["🌾 Offer God gratitude from ordinary provision.", "🫒 Bring care into worship.", "🧂 Let faithfulness mark what you give."],
    }),
    makeCompactLeviticusStudySection({
      chapter: 3,
      startVerse: 1,
      ...
      movement: ["🕊️ A peace offering is brought from herd or flock.", "✋ The worshiper lays a hand on the animal.", "🔥 The fat is burned to the LORD.", "🤝 The offering points to fellowship and wholeness."],
      phrases: [["🕊️ Sacrifice Of Peace Offering", "Peace means more than no conflict. It points to wholeness, well-being, and restored fellowship before God."], ["🔥 The Fat That Covereth", "The fat was considered a rich, best portion. It belongs to the LORD, teaching Israel not to treat the best casually."], ["📜 A Perpetual Statute", "This instruction becomes part of Israel's ongoing worship life. Fellowship with God is not a one-time idea."]],
      truths: [["🕊️ God provides fellowship, not only forgiveness.", "Peace with God includes communion."], ["🔥 The best belongs to the LORD.", "The fat is offered to Him."], ["🤝 Worship celebrates restored relationship.", "The peace offering teaches wholeness before God."]],
      application: ["🕊️ Seek fellowship with God, not just relief from guilt.", "🔥 Give God what is weighty and valuable.", "🤝 Let peace with God shape daily life."],
    }),
    makeCompactLeviticusStudySection({
      chapter: 4,
      startVerse: 1,
    ...
    makeCompactLeviticusStudySection({
      ...
      title: "When The Whole Congregation Sins",
      icon: "👥",
    ...
    makeCompactLeviticusStudySection({
      ...
      title: "When Any Person Sins",
      icon: "🧍",
      summary: "God gives instructions for ordinary people who sin unintentionally and need atonement.",
      movement: ["🧍 An ordinary person sins unintentionally.", "🐐 A goat or lamb is brought.", "✋ The person lays a hand on the offering.", "🤲 Atonement is made and forgiveness is promised."],
      phrases: [["🧍 Any One Of The Common People", "Atonement is not only for priests, leaders, or the whole congregation. Ordinary people need mercy too."], ["✋ Lay His Hand Upon The Head", "The worshiper identifies with the sacrifice. The offering is not detached from the person bringing it."], ["🤲 It Shall Be Forgiven Him", "This repeated promise is beautiful. God provides a way for guilt to be dealt with and forgiven."]],
      truths: [["🧍 Every person needs atonement.", "No ordinary life is outside God's holiness."], ["✋ Sin must be personally owned.", "The worshiper lays a hand on the offering."], ["🤲 Forgiveness is provided by God.", "The chapter ends with mercy, not despair."]],
      application: ["🧍 Do not treat your own sin as too ordinary to matter.", "✋ Own what God brings to light.", "🤲 Receive the forgiveness God provides."],
    }),
  ],
);
...
BIBLE_READER_STUDY_SECTIONS.push(
  ...[
    makeCompactLeviticusStudySection({
      ...
      title: "Confession And A Sin Offering",
      icon: "🗣️",
      summary: "God gives Israel a way to confess specific sins and receive forgiveness through the sin offering.",
      movement: ["🗣️ Everyday sins are named before God.", "🤲 The worshiper confesses the guilt.", "🐦 Offerings are adjusted for the poor.", "🕊️ Atonement is made and forgiveness is given."],
      phrases: [["🗣️ If A Soul Sin", "Leviticus names ordinary sins like failing to testify, touching uncleanness, or speaking rashly. These are not dramatic rebellion scenes, but God still teaches that everyday guilt matters."], ["🤲 He Shall Confess", "The worshiper must name the sin instead of hiding behind vague regret. The offering is not magic; it comes with honesty before God."], ["🐦 If He Be Not Able", "God makes provision for people who cannot afford larger offerings. The poor are not shut out from mercy, because forgiveness is based on God's provision, not personal wealth."]],
      truths: [["🗣️ Everyday sin matters.", "God names real-life guilt."], ["🤲 Confession brings guilt into the light.", "The worshiper must be honest before God."], ["🐦 Mercy reaches the poor.", "God provides access for those with little."]],
      application: ["🗣️ Do not ignore ordinary sins just because they seem small.", "🤲 Practice honest confession, not vague regret.", "🐦 Remember that God's mercy is not reserved for people with resources."],
    }),
    makeCompactLeviticusStudySection({
      chapter: 5,
      startVerse: 14,
      ...
      title: "The Guilt Offering For Holy Things",
      icon: "⚖️",
      summary: "God teaches Israel that misuse of holy things creates guilt that must be repaired.",
      movement: ["⚖️ A trespass is committed in holy things.", "🐏 A ram is brought as a guilt offering.", "➕ Restitution is made with an added fifth.", "🤲 The priest makes atonement."],
      phrases: [["⛺ In The Holy Things", "Holy things belong to the LORD and cannot be handled like common property. Even unintentional misuse of what belongs to God creates real guilt."], ["🛠️ Make Amends", "The person must repair what was wrong, not merely feel sorry. Leviticus teaches that repentance often has practical steps."], ["➕ Add The Fifth Part", "The extra fifth means twenty percent added to what was owed. This shows that sin creates damage, and repair should show responsibility, not the bare minimum."]],
      truths: [["⛺ Holy things matter.", "What belongs to God must not be treated casually."], ["🛠️ Repentance repairs.", "Guilt can require restitution."], ["🤲 Atonement is still needed.", "Restitution does not replace God's mercy."]],
      application: ["⛺ Treat what belongs to God with reverence.", "🛠️ Ask whether repentance requires repair.", "➕ Do more than the bare minimum when making something right."],
    }),
    makeCompactLeviticusStudySection({
      chapter: 6,
      startVerse: 1,
      ...
      title: "Restitution Toward Neighbor And God",
      icon: "🤝",
      summary: "God shows that sin against another person is also unfaithfulness against the LORD.",
      movement: ["🤝 A neighbor is wronged through deception or theft.", "📣 The sin is called a trespass against the LORD.", "🛠️ The guilty person restores what was taken.", "🐏 A guilt offering is brought."],
      phrases: [["📣 Trespass Against The LORD", "This is the surprise of the passage. A sin against a neighbor is also a sin against God because God cares about truth, justice, and how people are treated."], ["🛠️ Restore It In The Principal", "The person must return what was taken in full. Forgiveness does not cancel the responsibility to repair damage when repair is possible."], ["⏳ In The Day Of His Trespass Offering", "Restitution and worship belong together here. The person does not separate altar worship from making things right with the injured neighbor."]],
      truths: [["🤝 God cares how we treat people.", "Neighbor sins are Godward sins too."], ["🛠️ Justice belongs with worship.", "Repayment matters."], ["🐏 Mercy does not ignore damage.", "Atonement and restitution stand together."]],
      application: ["🤝 Do not separate devotion to God from honesty with people.", "🛠️ Repair what you can repair.", "📣 Let confession include truth, not image control."],
    }),
    makeCompactLeviticusStudySection({
      chapter: 6,
      startVerse: 8,
      ...
      title: "The Fire Kept Burning On The Altar",
      icon: "🔥",
      summary: "The priests are commanded to keep the altar fire burning continually before the LORD.",
      movement: ["🔥 The burnt offering remains on the altar overnight.", "👕 The priest changes garments to handle ashes.", "🪵 Wood is placed on the fire each morning.", "⏳ The fire must never go out."],
      phrases: [["🔥 Fire Shall Ever Be Burning", "The altar fire points to continual worship and priestly service. Israel's life is organized around God's presence, not around occasional religious moments."], ["🧺 Take Up The Ashes", "Even the ashes from the altar are handled carefully. Holy service includes details that may look ordinary but still belong to God."], ["🪵 Burn Wood On It Every Morning", "The priests must tend the altar daily. Worship near God's presence requires steady faithfulness, not only emotional intensity."]],
      truths: [["🔥 Worship is continual.", "The fire must not go out."], ["🧺 Holy service includes ordinary tasks.", "Ashes are handled with care."], ["🪵 Faithfulness is daily.", "The altar is tended morning by morning."]],
      application: ["🔥 Build rhythms that keep worship alive.", "🧺 Honor God in quiet tasks too.", "🪵 Do not wait for feelings before tending faithfulness."],
    }),
    makeCompactLeviticusStudySection({
      chapter: 6,
      startVerse: 14,
      ...
      title: "Priestly Instructions For Grain And Sin Offerings",
      icon: "🥖",
      summary: "God gives the priests careful instructions for handling grain offerings and sin offerings.",
      movement: ["🥖 The grain offering is handled by the priests.", "🔥 A memorial portion is burned to the LORD.", "⛺ Priestly portions are eaten in a holy place.", "🩸 The sin offering is treated as most holy."],
      phrases: [["🥖 Most Holy", "The offering is not casual food. Even when priests eat portions of the offering, they do so in holy space because it belongs to service before God."], ["🔥 The Priest Shall Make Atonement", "The priest stands in a mediating role for the worshiper. Israel needs someone appointed by God to handle sacrifice and atonement."], ["🩸 Whatsoever Shall Touch The Flesh Thereof Shall Be Holy", "Holiness is treated as powerful and weighty. Things connected to the sin offering are not ordinary once they touch what belongs to the altar."]],
      truths: [["🥖 Holy things require holy handling.", "The priests follow God's order."], ["🔥 Atonement is mediated.", "The priest serves the worshiper before God."], ["🩸 Holiness is weighty.", "What touches the offering is marked as holy."]],
      application: ["🥖 Do not treat God's things casually.", "🔥 Thank God for the way He provides atonement.", "🩸 Let holiness shape how you handle worship."],
    }),
    makeCompactLeviticusStudySection({
      chapter: 7,
      startVerse: 1,
      ...
      title: "The Guilt Offering Is Most Holy",
      icon: "🐏",
      summary: "God gives priestly instructions for the guilt offering and the portions that belong to the priests.",
      movement: ["🐏 The guilt offering is called most holy.", "🩸 Blood is applied around the altar.", "🔥 The fat portions are burned to the LORD.", "👥 The priest receives his assigned portion."],
      phrases: [["🐏 Law Of The Trespass Offering", "The guilt offering has order because guilt is not handled by human guesswork. God defines how guilt is brought to Him and dealt with."], ["🩸 It Is Most Holy", "Guilt is serious before God, but so is the mercy He provides. The offering belongs to holy space and holy handling."], ["👥 The Priest Shall Have It", "God provides portions for the priests through the offerings. Their life and work are tied to the holy service God assigned to them."]],
      truths: [["🐏 Guilt must be dealt with God's way.", "The offering has a law."], ["🩸 Mercy is holy.", "The guilt offering is most holy."], ["👥 God provides for His servants.", "Priestly portions are assigned."]],
      application: ["🐏 Bring guilt to God instead of managing it alone.", "🩸 Do not treat forgiveness as a small thing.", "👥 Respect the service God assigns to His people."],
    }),
    makeCompactLeviticusStudySection({
      chapter: 7,
      startVerse: 11,
      ...
      title: "Peace Offerings And Shared Fellowship",
      icon: "🕊️",
      summary: "God explains peace offerings for thanksgiving, vows, and freewill worship.",
      movement: ["🕊️ Peace offerings are brought for thanksgiving, vows, and freewill worship.", "🍞 Bread is included with the offering.", "🍽️ The meal is eaten within the appointed time.", "⚠️ Uncleanness must not enter the fellowship meal."],
      phrases: [["🙏 Sacrifice Of Thanksgiving", "The peace offering can become a way to say thank you to God. Worship includes gratitude, not only requests for forgiveness."], ["🤲 His Own Hands Shall Bring", "The worshiper personally participates in bringing the offering. Fellowship with God is not distant or mechanical."], ["⚠️ That Soul Shall Be Cut Off", "Joyful fellowship still has holy boundaries. Israel must not treat uncleanness as harmless in the presence of God."]],
      truths: [["🕊️ God provides fellowship.", "Peace offerings celebrate restored relationship."], ["🙏 Gratitude belongs in worship.", "Thanksgiving is part of sacrifice."], ["⚠️ Joy is not carelessness.", "Holy fellowship has boundaries."]],
      application: ["🙏 Let gratitude become part of your worship.", "🤲 Participate personally, not mechanically.", "⚠️ Do not confuse closeness to God with casualness."],
    }),
    makeCompactLeviticusStudySection({
      chapter: 7,
      startVerse: 22,
      ...
      title: "Blood, Fat, And Priestly Portions",
      icon: "🩸",
      summary: "God reserves the blood and fat for Himself and provides portions for the priests.",
      movement: ["🩸 Israel must not eat blood.", "🔥 The fat belongs to the LORD.", "🤲 The breast is waved before God.", "👕 The priests receive appointed portions."],
      phrases: [["🔥 Ye Shall Eat No Manner Of Fat", "The fat represents the rich, weighty portions reserved for the LORD. Israel is trained not to consume what God claims as His."], ["🩸 Ye Shall Eat No Manner Of Blood", "Blood represents life, and life belongs to God. This prepares Israel to understand atonement as costly life given before the LORD."], ["🤲 Wave Offering", "The wave offering is presented before God and then given as a priestly portion. It shows that even what the priest receives is first acknowledged before the LORD."]],
      truths: [["🩸 Life belongs to God.", "Blood is not common food."], ["🔥 The best belongs to God.", "The fat is reserved for Him."], ["🤲 Provision comes through worship.", "Priestly portions are given by God's command."]],
      application: ["🩸 Treat life as sacred.", "🔥 Give God what is weighty, not leftover.", "🤲 Receive provision as something held before God."],
    }),
    makeCompactLeviticusStudySection({
      chapter: 8,
      startVerse: 1,
      ...
      title: "Aaron And His Sons Are Washed And Clothed",
      icon: "👕",
      summary: "Moses publicly consecrates Aaron and his sons for priestly service.",
      movement: ["👥 The congregation gathers at the tent.", "💧 Aaron and his sons are washed.", "👕 Aaron is clothed in priestly garments.", "🫒 The tabernacle, altar, and Aaron are anointed."],
      phrases: [["👥 Gather All The Congregation", "Priesthood affects the whole people, so the ordination is public. Aaron does not privately appoint himself to holy service."], ["💧 Moses Washed Them", "The priests are cleansed before serving near God's presence. Their role begins with receiving cleansing, not proving personal greatness."], ["🫒 Anointed The Tabernacle", "The tabernacle, altar, utensils, and Aaron are set apart for God. Consecration marks people and places as belonging to holy service."]],
      truths: [["👥 Priesthood is public service.", "The congregation witnesses it."], ["💧 Priests need cleansing.", "They are washed before they serve."], ["🫒 God sets apart what belongs to Him.", "Anointing marks holy service."]],
      application: ["👥 Remember that spiritual service affects others.", "💧 Start with cleansing, not self-importance.", "🫒 Let God define what belongs to Him."],
    }),
    makeCompactLeviticusStudySection({
      chapter: 8,
      startVerse: 14,
      ...
      title: "Blood Marks The Priests For Service",
      icon: "👂",
      summary: "Aaron and his sons are ordained through sacrifices, blood, anointing oil, and seven days of consecration.",
      movement: ["🐂 A sin offering cleanses the priests.", "🔥 A burnt offering is made for surrender.", "👂 Blood marks ear, thumb, and toe.", "⏳ The priests remain seven days for ordination."],
      phrases: [["👂 Blood Upon The Tip Of Aaron's Right Ear", "The ear, thumb, and toe picture the whole life marked for God. The priest's hearing, serving, and walking are consecrated to the LORD."], ["⏳ Seven Days", "Seven often points to completion in Scripture. The priests remain at the tent until the ordination period is complete."], ["⚠️ That Ye Die Not", "Serving near God's presence is serious. The warning teaches that holy service must follow God's command, not human creativity."]],
      truths: [["👂 Consecration touches the whole life.", "Hearing, hands, and feet belong to God."], ["🐂 Priests need sacrifice too.", "They are not sinless mediators."], ["⚠️ Holiness is serious.", "Obedience protects life near God's presence."]],
      application: ["👂 Ask God to mark what you hear, do, and pursue.", "🐂 Remember that every servant still needs mercy.", "⚠️ Treat nearness to God with reverent obedience."],
    }),
  ],
);
...
BIBLE_READER_STUDY_SECTIONS.push(
  ...[
    makeCompactLeviticusStudySection({
      ...
      title: "Priests Begin And Glory Appears",
      icon: "✨",
      summary: "Aaron offers the first priestly sacrifices, and the glory of the LORD appears to the people.",
      movement: ["🗓️ The eighth day begins public priestly ministry.", "🐂 Aaron offers for himself first.", "🤲 Aaron offers for the people.", "✨ God's glory appears and fire consumes the offering."],
      phrases: [["🗓️ The Eighth Day", "The eighth day comes after seven days of ordination. It marks a new beginning as Aaron and his sons begin serving publicly."], ["🐂 Offer For Thyself", "Aaron is the high priest, but he still needs atonement. The priest who serves others must first receive mercy himself."], ["✨ The Glory Of The LORD Appeared", "God's visible glory shows that He is present and that the offering has been received. The ritual is not empty; God meets His people through the way He commanded."]],
      truths: [["✨ God receives obedient worship.", "His glory appears after the commanded offerings."], ["🐂 Priests need mercy too.", "Aaron offers for himself first."], ["🙇 Reverence belongs with joy.", "The people shout and fall on their faces."]],
      application: ["✨ Let worship be shaped by God's word.", "🐂 Remember every servant still needs mercy.", "🙇 Hold joy and reverence together before God."],
    }),
    makeCompactLeviticusStudySection({
      chapter: 10,
      startVerse: 1,
      ...
      title: "Nadab And Abihu Offer Strange Fire",
      icon: "⚠️",
      summary: "Aaron's sons Nadab and Abihu offer unauthorized fire before the LORD and die before Him.",
      movement: ["⚠️ Nadab and Abihu bring strange fire.", "🔥 God had not commanded it.", "⚖️ Fire comes from the LORD in judgment.", "🤐 Aaron holds his peace."],
      phrases: [["🔥 Strange Fire", "Strange fire means unauthorized fire, something foreign to God's command. The issue is approaching holy service by human impulse instead of God's instruction."], ["📜 Which He Commanded Them Not", "This phrase explains the problem. In the tabernacle, worship is not invented by the priests; it is received from the LORD."], ["⚖️ I Will Be Sanctified", "God will be treated as holy by those who come near Him. The closer the service, the greater the responsibility to honor His holiness."]],
      truths: [["🔥 Unauthorized worship is dangerous.", "Nearness to God is not casual."], ["📜 God's command matters.", "Sincerity does not replace obedience."], ["🤐 Holiness can leave us silent.", "Aaron's silence carries grief and reverence together."]],
      application: ["🔥 Do not confuse creativity with obedience in holy things.", "📜 Let God define worship.", "🤐 Make room for reverent silence before hard passages."],
    }),
    makeCompactLeviticusStudySection({
      chapter: 10,
      startVerse: 8,
      ...
      title: "Priests Must Teach The Difference",
      icon: "🧭",
      summary: "God commands the priests to distinguish holy from common and clean from unclean.",
      movement: ["🍷 Priests must not drink when entering the tent.", "🧭 They must distinguish holy and common.", "💧 They must distinguish clean and unclean.", "📖 They must teach Israel God's statutes."],
      phrases: [["🍷 Wine Nor Strong Drink", "Priests need clarity when serving near God's presence. Their work requires sober discernment, not dulled judgment."], ["🧭 Difference Between Holy And Unholy", "Holy means set apart to God; common means ordinary. Priests must help Israel understand what belongs near God's presence."], ["📖 Teach The Children Of Israel", "Priests are not only sacrifice workers. They are teachers who help the people understand God's ways."]],
      truths: [["🧭 Discernment is priestly work.", "Holy and common must be distinguished."], ["💧 Clean and unclean matter near the sanctuary.", "Access requires ordered holiness."], ["📖 God's people need teaching.", "The priests explain the statutes."]],
      application: ["🧭 Ask God for sharper discernment.", "💧 Do not blur what God separates.", "📖 Value teaching that helps you understand holiness."],
    }),
    makeCompactLeviticusStudySection({
      chapter: 11,
      startVerse: 1,
      ...
      movement: ["🐄 Clean land animals must fit God's marks.", "🐟 Clean water creatures have fins and scales.", "🦅 Certain birds are forbidden.", "🦗 Some winged insects are allowed."],
      phrases: [["🐄 Parteth The Hoof And Cheweth The Cud", "Clean land animals must meet both marks. Israel learns to think in categories of distinction, not personal preference."], ["🐟 Fins And Scales", "Water creatures also have ordered boundaries. The food laws train Israel to notice order, separation, and fitness."], ["🍽️ These Shall Ye Eat", "Every meal becomes a reminder that Israel belongs to the LORD. Holiness reaches the table, not only the tabernacle."]],
      truths: [["🍽️ Daily life can teach holiness.", "Food becomes part of formation."], ["🧭 God trains His people through distinctions.", "Clean and unclean categories shape identity."], ["👥 Israel is set apart.", "They do not eat like every nation around them."]],
      application: ["🍽️ Let ordinary habits remind you that you belong to God.", "🧭 Pay attention to the distinctions God teaches.", "👥 Do not treat set-apart identity as a burden."],
    }),
    makeCompactLeviticusStudySection({
      chapter: 11,
      startVerse: 24,
      ...
      movement: ["💀 Contact with carcasses brings uncleanness.", "🏺 Objects and vessels can become unclean.", "💧 Cleansing and waiting restore fitness.", "🕊️ Israel is called to be holy because God is holy."],
      phrases: [["💀 Whosoever Toucheth The Carcase", "Uncleanness often connects to death and disorder. It is not always personal sin, but it still affects access to holy space."], ["💧 Unclean Until The Even", "Uncleanness is often temporary and has a path back. God teaches boundaries without leaving His people hopeless."], ["🕊️ Ye Shall Be Holy; For I Am Holy", "This is the reason behind the laws. Israel lives differently because the LORD who rescued them is holy."]],
      truths: [["💀 Death does not belong in holy space.", "Uncleanness marks what needs cleansing."], ["💧 God provides a way back.", "Uncleanness is not the end of the story."], ["🕊️ Holiness is rooted in God's character.", "His people reflect Him."]],
      application: ["💀 Notice how seriously Scripture treats death and disorder.", "💧 Receive God's way back after uncleanness.", "🕊️ Let God's character shape your daily life."],
    }),
    makeCompactLeviticusStudySection({
      chapter: 12,
      startVerse: 1,
      ...
      movement: ["👶 A mother gives birth and enters a purification period.", "🩸 The law deals with blood and ritual impurity.", "🐑 Offerings are brought after purification.", "🐦 The poor may bring two birds."],
      phrases: [["👶 If A Woman Have Conceived Seed", "The chapter is about childbirth, but it is not calling babies evil or motherhood sinful. It deals with ritual impurity connected to blood, birth, and sanctuary access."], ["🩸 Blood Of Her Purifying", "Blood and bodily processes matter in Leviticus because Israel lives near holy space. Purification restores the mother to normal worship life."], ["🐦 Two Turtledoves, Or Two Young Pigeons", "This poor-person provision is the offering Mary brings after Jesus is born. It quietly shows that Jesus entered a humble, law-observing family."]],
      truths: [["👶 Childbirth is not treated as evil.", "The issue is ritual purification."], ["🩸 Bodies belong before God.", "Holiness touches ordinary human life."], ["🐦 God makes room for the poor.", "A smaller offering is accepted."]],
      application: ["👶 Read hard laws carefully before assuming the worst.", "🩸 Bring ordinary body-and-family life before God.", "🐦 Notice God's compassion for people with little."],
    }),
  ],
);
...
BIBLE_READER_STUDY_SECTIONS.push(
  ...[
    makeCompactLeviticusStudySection({
      ...
      title: "Skin Disease And Priestly Examination",
      icon: "🔎",
      summary: "God gives priests instructions for examining serious skin conditions and declaring clean or unclean.",
      movement: ["🔎 The priest examines visible skin conditions.", "⏳ Unclear cases are isolated and checked again.", "📣 The priest declares clean or unclean.", "🏕️ Serious uncleanness places someone outside the camp."],
      phrases: [["🔎 The Priest Shall Look", "The priest examines carefully instead of guessing. Holiness requires truthful discernment, patience, and attention to what is actually there."], ["⏳ Shut Up Seven Days", "Waiting gives time for the condition to become clear. Leviticus does not rush judgment when the evidence is uncertain."], ["🏕️ Without The Camp", "Outside the camp means outside normal community and sanctuary access. It is painful, but it protects life near God's holy presence."]],
      truths: [["🔎 Discernment matters.", "Clean and unclean are not declared carelessly."], ["⏳ Patience protects people.", "Unclear cases are examined again."], ["🏕️ God's presence shapes the camp.", "What visibly represents corruption is kept away from holy space."]],
      application: ["🔎 Let God teach you careful discernment.", "⏳ Do not rush judgment when things are unclear.", "🏕️ Remember that holiness affects community life."],
    }),
    makeCompactLeviticusStudySection({
      chapter: 13,
      startVerse: 47,
      ...
      title: "Contamination In Garments",
      icon: "🧥",
      summary: "God gives instructions for examining garments affected by spreading contamination.",
      movement: ["🧥 A mark appears in fabric or leather.", "🔎 The priest examines and isolates it.", "💧 The garment may be washed.", "🔥 Spreading contamination is burned."],
      phrases: [["🧥 Garment Also", "Uncleanness can affect the things people use and wear. Leviticus brings holiness into ordinary material life."], ["💧 It Shall Be Washed", "Washing is part of the process when restoration is possible. God provides steps before destruction is required."], ["🔥 Thou Shalt Burn That Wherein The Plague Is", "If contamination keeps spreading, it must be removed. The image teaches that some corruption cannot be managed forever."]],
      truths: [["🧥 Ordinary things matter before God.", "Clothing and objects are included."], ["💧 Cleansing is sought where possible.", "The garment is washed and reexamined."], ["🔥 Spreading corruption must be removed.", "Holiness does not pretend decay is harmless."]],
      application: ["🧥 Invite God into ordinary possessions and habits.", "💧 Look for cleansing where restoration is possible.", "🔥 Be honest about what keeps spreading damage."],
    }),
    makeCompactLeviticusStudySection({
      chapter: 14,
      startVerse: 1,
      ...
      title: "Cleansing The Restored Person",
      icon: "🕊️",
      summary: "God gives a cleansing process for someone healed from a serious skin disease.",
      movement: ["🏕️ The priest goes outside the camp.", "🕊️ Two birds are used in the cleansing ritual.", "💧 The person washes, shaves, and waits.", "🤲 Offerings restore the person to worship."],
      phrases: [["🏕️ Out Of The Camp", "The priest goes to the person who has been outside. Restoration begins where the unclean person actually is."], ["🕊️ The Living Bird", "One bird dies and the living bird is released into the open field. The picture feels like cleansing, release, and return to life."], ["🤲 He Shall Be Clean", "This is the hope of the chapter. Leviticus does not only declare uncleanness; it provides a way back."]],
      truths: [["🏕️ God provides restoration for outsiders.", "The priest goes outside the camp."], ["🕊️ Cleansing points toward release.", "The living bird flies free."], ["🤲 Worship access can be restored.", "The person returns through God's provided way."]],
      application: ["🏕️ Do not assume outside means forgotten.", "🕊️ Let cleansing lead to freedom, not ongoing shame.", "🤲 Trust that God can restore access and belonging."],
    }),
    makeCompactLeviticusStudySection({
      chapter: 14,
      startVerse: 33,
      ...
      title: "Cleansing A Contaminated House",
      icon: "🏠",
      summary: "God gives instructions for inspecting, cleansing, or tearing down a contaminated house in the land.",
      movement: ["🏠 The law anticipates houses in Canaan.", "🔎 The priest inspects the house.", "🧱 Contaminated stones may be removed.", "🕊️ A clean house receives a cleansing ritual."],
      phrases: [["🏠 When Ye Be Come Into The Land", "These laws look forward to settled life in Canaan. God is already teaching Israel how holiness will shape homes in the promised land."], ["🧱 They Shall Take Away The Stones", "The contaminated pieces are removed before the whole house is lost. The law aims at restoration when restoration is possible."], ["🏚️ He Shall Break Down The House", "If the contamination returns and spreads, the house is torn down. Some corruption cannot remain inside the community."]],
      truths: [["🏠 Holiness reaches the home.", "God's concern is not only the tabernacle."], ["🧱 Restoration can require removal.", "Damaged stones are taken out."], ["🏚️ Persistent corruption is serious.", "The house may be dismantled."]],
      application: ["🏠 Let God shape the atmosphere of your home.", "🧱 Remove what keeps contaminating the house.", "🏚️ Take persistent damage seriously."],
    }),
    makeCompactLeviticusStudySection({
      chapter: 15,
      startVerse: 1,
      ...
      title: "Bodily Discharges And Cleansing",
      icon: "💧",
      summary: "God gives laws about bodily discharges, impurity, washing, waiting, and restoration.",
      movement: ["💧 Bodily discharges create ritual impurity.", "🛏️ Contact can spread uncleanness.", "🚿 Washing and waiting restore ordinary cleanness.", "🤲 Some cases require offerings."],
      phrases: [["💧 Running Issue", "The chapter deals with bodily discharges, some abnormal and some ordinary. Leviticus brings even private body matters under God's holy order."], ["🚿 Bathe His Flesh In Water", "Washing marks the movement back toward cleanness. The body is not ignored in Israel's worship life."], ["🤲 The Priest Shall Make Atonement", "Some conditions require offerings after cleansing. The person is restored to worship through the way God provides."]],
      truths: [["💧 Bodies matter before God.", "Private life is not outside His care."], ["🚿 Cleansing includes embodied action.", "Washing and waiting matter."], ["🤲 God provides restoration.", "Impurity is not always permanent."]],
      application: ["💧 Do not split spiritual life from embodied life.", "🚿 Respect God's concern for hidden areas.", "🤲 Receive restoration without shame where God provides it."],
    }),
    makeCompactLeviticusStudySection({
      chapter: 16,
      startVerse: 1,
      ...
      title: "The Day Of Atonement Begins",
      icon: "🩸",
    ...
    makeCompactLeviticusStudySection({
      ...
      title: "Blood, Mercy Seat, And Scapegoat",
      icon: "🐐",
      summary: "The high priest makes atonement for himself, the sanctuary, the altar, and the people.",
      movement: ["🩸 Blood is brought behind the veil.", "☁️ Incense covers the mercy seat.", "🧼 The sanctuary and altar are cleansed.", "🐐 The live goat carries sins away."],
      phrases: [["🩸 Sprinkle It Upon The Mercy Seat", "The mercy seat is the cover of the ark in the Most Holy Place. Blood is brought to the deepest place of Israel's worship because atonement is needed there."], ["🧼 Because Of The Uncleanness Of The Children Of Israel", "The sanctuary is cleansed because Israel's sins and uncleanness affect holy space. Sin is not treated as a private issue only."], ["🐐 Bear Upon Him All Their Iniquities", "The scapegoat carries confessed sin away into the wilderness. The picture is removal: sin is not only covered, it is carried away."]],
      truths: [["🩸 Atonement reaches the deepest place.", "Blood is brought behind the veil."], ["🧼 Sin affects worship.", "The sanctuary itself is cleansed."], ["🐐 God removes sin.", "The live goat carries it away."]],
      application: ["🩸 Trust God's provision for deep cleansing.", "🧼 Do not treat sin as isolated from worship.", "🐐 Let God carry away what you keep trying to carry."],
    }),
    makeCompactLeviticusStudySection({
      chapter: 16,
      startVerse: 29,
      ...
      title: "A Sabbath Of Solemn Rest",
      icon: "🕯️",
