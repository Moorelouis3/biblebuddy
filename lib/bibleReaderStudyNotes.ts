...
import { GENESIS_EIGHT_PERSONAL_SECTIONS } from "./genesisEightSource";
import { GENESIS_NINE_PERSONAL_SECTIONS } from "./genesisNineSource";
import { GENESIS_SIX_PERSONAL_SECTIONS } from "./genesisSixSource";
import { GENESIS_SEVEN_PERSONAL_SECTIONS } from "./genesisSevenSource";
...
import { GENESIS_THIRTY_THREE_PERSONAL_SECTIONS } from "./genesisThirtyThreeSource";
import { GENESIS_THIRTY_FOUR_PERSONAL_SECTIONS } from "./genesisThirtyFourSource";
import { GENESIS_THIRTY_FIVE_PERSONAL_SECTIONS } from "./genesisThirtyFiveSource";
import { GENESIS_THIRTY_SIX_PERSONAL_SECTIONS } from "./genesisThirtySixSource";
import { GENESIS_THIRTY_SEVEN_PERSONAL_SECTIONS } from "./genesisThirtySevenSource";
...
import { EXODUS_TWENTY_TWO_PERSONAL_SECTIONS } from "./exodusTwentyTwoSource";
import { EXODUS_TWENTY_THREE_PERSONAL_SECTIONS } from "./exodusTwentyThreeSource";
import { EXODUS_TWENTY_FOUR_PERSONAL_SECTIONS } from "./exodusTwentyFourSource";
import { EXODUS_TWENTY_FIVE_PERSONAL_SECTIONS } from "./exodusTwentyFiveSource";
import { EXODUS_TWENTY_SIX_PERSONAL_SECTIONS } from "./exodusTwentySixSource";
import { EXODUS_TWENTY_SEVEN_PERSONAL_SECTIONS } from "./exodusTwentySevenSource";
import { EXODUS_TWENTY_EIGHT_PERSONAL_SECTIONS } from "./exodusTwentyEightSource";
import { EXODUS_TWENTY_NINE_PERSONAL_SECTIONS } from "./exodusTwentyNineSource";
import { EXODUS_THIRTY_PERSONAL_SECTIONS } from "./exodusThirtySource";
import { EXODUS_THIRTY_ONE_PERSONAL_SECTIONS } from "./exodusThirtyOneSource";
import { EXODUS_THIRTY_TWO_PERSONAL_SECTIONS } from "./exodusThirtyTwoSource";
import { EXODUS_THIRTY_THREE_PERSONAL_SECTIONS } from "./exodusThirtyThreeSource";
import { EXODUS_THIRTY_FOUR_PERSONAL_SECTIONS } from "./exodusThirtyFourSource";
import { EXODUS_THIRTY_FIVE_PERSONAL_SECTIONS } from "./exodusThirtyFiveSource";
import { EXODUS_THIRTY_SIX_PERSONAL_SECTIONS } from "./exodusThirtySixSource";
...
import { LEVITICUS_ONE_PERSONAL_SECTIONS } from "./leviticusOneSource";
import { LEVITICUS_TWO_PERSONAL_SECTIONS } from "./leviticusTwoSource";
import { LEVITICUS_THREE_PERSONAL_SECTIONS } from "./leviticusThreeSource";
import { LEVITICUS_FOUR_PERSONAL_SECTIONS } from "./leviticusFourSource";
...
import { NUMBERS_TWENTY_NINE_PERSONAL_SECTIONS } from "./numbersTwentyNineSource";
import { NUMBERS_THIRTY_PERSONAL_SECTIONS } from "./numbersThirtySource";
import { NUMBERS_THIRTY_ONE_PERSONAL_SECTIONS } from "./numbersThirtyOneSource";
import { NUMBERS_THIRTY_TWO_PERSONAL_SECTIONS } from "./numbersThirtyTwoSource";
import { NUMBERS_THIRTY_THREE_PERSONAL_SECTIONS } from "./numbersThirtyThreeSource";
import { NUMBERS_THIRTY_FOUR_PERSONAL_SECTIONS } from "./numbersThirtyFourSource";
import { NUMBERS_THIRTY_FIVE_PERSONAL_SECTIONS } from "./numbersThirtyFiveSource";
import { NUMBERS_THIRTY_SIX_PERSONAL_SECTIONS } from "./numbersThirtySixSource";
import { DEUTERONOMY_ONE_PERSONAL_SECTIONS } from "./deuteronomyOneSource";
import { DEUTERONOMY_TWO_PERSONAL_SECTIONS } from "./deuteronomyTwoSource";
import { DEUTERONOMY_THREE_PERSONAL_SECTIONS } from "./deuteronomyThreeSource";
import { DEUTERONOMY_FOUR_PERSONAL_SECTIONS } from "./deuteronomyFourSource";
import { DEUTERONOMY_FIVE_PERSONAL_SECTIONS } from "./deuteronomyFiveSource";
import { DEUTERONOMY_SIX_PERSONAL_SECTIONS } from "./deuteronomySixSource";
...
import { DEUTERONOMY_THIRTY_THREE_PERSONAL_SECTIONS } from "./deuteronomyThirtyThreeSource";
import { DEUTERONOMY_THIRTY_FOUR_PERSONAL_SECTIONS } from "./deuteronomyThirtyFourSource";
import { JOSHUA_ONE_PERSONAL_SECTIONS } from "./joshuaOneSource";
import { JOSHUA_TWO_PERSONAL_SECTIONS } from "./joshuaTwoSource";
import { JOSHUA_THREE_PERSONAL_SECTIONS } from "./joshuaThreeSource";
import { JOSHUA_FOUR_PERSONAL_SECTIONS } from "./joshuaFourSource";
import { JOSHUA_FIVE_PERSONAL_SECTIONS } from "./joshuaFiveSource";
import { JOSHUA_SIX_PERSONAL_SECTIONS } from "./joshuaSixSource";
import { JOSHUA_SEVEN_PERSONAL_SECTIONS } from "./joshuaSevenSource";
import { JOSHUA_EIGHT_PERSONAL_SECTIONS } from "./joshuaEightSource";
import { JOSHUA_NINE_PERSONAL_SECTIONS } from "./joshuaNineSource";
import { JOSHUA_TEN_PERSONAL_SECTIONS } from "./joshuaTenSource";
import { JOSHUA_ELEVEN_PERSONAL_SECTIONS } from "./joshuaElevenSource";
import { JOSHUA_TWELVE_PERSONAL_SECTIONS } from "./joshuaTwelveSource";
import { JOSHUA_THIRTEEN_PERSONAL_SECTIONS } from "./joshuaThirteenSource";
import { JOSHUA_FOURTEEN_PERSONAL_SECTIONS } from "./joshuaFourteenSource";
import { JOSHUA_FIFTEEN_PERSONAL_SECTIONS } from "./joshuaFifteenSource";
import { JOSHUA_SIXTEEN_PERSONAL_SECTIONS } from "./joshuaSixteenSource";
import { JOSHUA_SEVENTEEN_PERSONAL_SECTIONS } from "./joshuaSeventeenSource";
import { JOSHUA_EIGHTEEN_PERSONAL_SECTIONS } from "./joshuaEighteenSource";
import { JOSHUA_NINETEEN_PERSONAL_SECTIONS } from "./joshuaNineteenSource";
import { JOSHUA_TWENTY_PERSONAL_SECTIONS } from "./joshuaTwentySource";
import { JOSHUA_TWENTY_ONE_PERSONAL_SECTIONS } from "./joshuaTwentyOneSource";
import { JOSHUA_TWENTY_TWO_PERSONAL_SECTIONS } from "./joshuaTwentyTwoSource";
import { JOSHUA_TWENTY_THREE_PERSONAL_SECTIONS } from "./joshuaTwentyThreeSource";
import { JOSHUA_TWENTY_FOUR_PERSONAL_SECTIONS } from "./joshuaTwentyFourSource";
import { JUDGES_ONE_PERSONAL_SECTIONS } from "./judgesOneSource";
import { JUDGES_TWO_PERSONAL_SECTIONS } from "./judgesTwoSource";
import { JUDGES_THREE_PERSONAL_SECTIONS } from "./judgesThreeSource";
import { JUDGES_FOUR_PERSONAL_SECTIONS } from "./judgesFourSource";
import { JUDGES_FIVE_PERSONAL_SECTIONS } from "./judgesFiveSource";
import { JUDGES_SIX_PERSONAL_SECTIONS } from "./judgesSixSource";
import { JUDGES_SEVEN_PERSONAL_SECTIONS } from "./judgesSevenSource";
import { JUDGES_EIGHT_PERSONAL_SECTIONS } from "./judgesEightSource";
import { JUDGES_NINE_PERSONAL_SECTIONS } from "./judgesNineSource";
import { JUDGES_TEN_PERSONAL_SECTIONS } from "./judgesTenSource";
import { JUDGES_ELEVEN_PERSONAL_SECTIONS } from "./judgesElevenSource";
import { JUDGES_TWELVE_PERSONAL_SECTIONS } from "./judgesTwelveSource";
import { JUDGES_THIRTEEN_PERSONAL_SECTIONS } from "./judgesThirteenSource";
...
import { JUDGES_EIGHTEEN_PERSONAL_SECTIONS } from "./judgesEighteenSource";
import { JUDGES_NINETEEN_PERSONAL_SECTIONS } from "./judgesNineteenSource";
...
import { FIRST_SAMUEL_ONE_PERSONAL_SECTIONS } from "./firstSamuelOneSource";
import { FIRST_SAMUEL_TWO_PERSONAL_SECTIONS } from "./firstSamuelTwoSource";
import { FIRST_SAMUEL_THREE_PERSONAL_SECTIONS } from "./firstSamuelThreeSource";
import { FIRST_SAMUEL_FOUR_PERSONAL_SECTIONS } from "./firstSamuelFourSource";
import { FIRST_SAMUEL_FIVE_PERSONAL_SECTIONS } from "./firstSamuelFiveSource";
import { FIRST_SAMUEL_SIX_PERSONAL_SECTIONS } from "./firstSamuelSixSource";
import { FIRST_SAMUEL_SEVEN_PERSONAL_SECTIONS } from "./firstSamuelSevenSource";
import { FIRST_SAMUEL_EIGHT_PERSONAL_SECTIONS } from "./firstSamuelEightSource";
import { FIRST_SAMUEL_NINE_PERSONAL_SECTIONS } from "./firstSamuelNineSource";
import { FIRST_SAMUEL_TEN_PERSONAL_SECTIONS } from "./firstSamuelTenSource";
import { FIRST_SAMUEL_ELEVEN_PERSONAL_SECTIONS } from "./firstSamuelElevenSource";
import { FIRST_SAMUEL_TWELVE_PERSONAL_SECTIONS } from "./firstSamuelTwelveSource";
import { FIRST_SAMUEL_THIRTEEN_PERSONAL_SECTIONS } from "./firstSamuelThirteenSource";
import { FIRST_SAMUEL_FOURTEEN_PERSONAL_SECTIONS } from "./firstSamuelFourteenSource";
import { FIRST_SAMUEL_FIFTEEN_PERSONAL_SECTIONS } from "./firstSamuelFifteenSource";
import { FIRST_SAMUEL_SIXTEEN_PERSONAL_SECTIONS } from "./firstSamuelSixteenSource";
import { FIRST_SAMUEL_SEVENTEEN_PERSONAL_SECTIONS } from "./firstSamuelSeventeenSource";
import { FIRST_SAMUEL_EIGHTEEN_PERSONAL_SECTIONS } from "./firstSamuelEighteenSource";
import { FIRST_SAMUEL_NINETEEN_PERSONAL_SECTIONS } from "./firstSamuelNineteenSource";
import { FIRST_SAMUEL_TWENTY_PERSONAL_SECTIONS } from "./firstSamuelTwentySource";
import { FIRST_SAMUEL_TWENTY_ONE_PERSONAL_SECTIONS } from "./firstSamuelTwentyOneSource";
import { FIRST_SAMUEL_TWENTY_TWO_PERSONAL_SECTIONS } from "./firstSamuelTwentyTwoSource";
import { FIRST_SAMUEL_TWENTY_THREE_PERSONAL_SECTIONS } from "./firstSamuelTwentyThreeSource";
import { FIRST_SAMUEL_TWENTY_FOUR_PERSONAL_SECTIONS } from "./firstSamuelTwentyFourSource";
import { FIRST_SAMUEL_TWENTY_FIVE_PERSONAL_SECTIONS } from "./firstSamuelTwentyFiveSource";
import { FIRST_SAMUEL_TWENTY_SIX_PERSONAL_SECTIONS } from "./firstSamuelTwentySixSource";
import { FIRST_SAMUEL_TWENTY_SEVEN_PERSONAL_SECTIONS } from "./firstSamuelTwentySevenSource";
...
import { SECOND_SAMUEL_ONE_PERSONAL_SECTIONS } from "./secondSamuelOneSource";
import { SECOND_SAMUEL_TWO_PERSONAL_SECTIONS } from "./secondSamuelTwoSource";
import { SECOND_SAMUEL_THREE_PERSONAL_SECTIONS } from "./secondSamuelThreeSource";
import { SECOND_SAMUEL_FOUR_PERSONAL_SECTIONS } from "./secondSamuelFourSource";
import { SECOND_SAMUEL_FIVE_PERSONAL_SECTIONS } from "./secondSamuelFiveSource";
import { SECOND_SAMUEL_SIX_PERSONAL_SECTIONS } from "./secondSamuelSixSource";
import { SECOND_SAMUEL_SEVEN_PERSONAL_SECTIONS } from "./secondSamuelSevenSource";
import { SECOND_SAMUEL_EIGHT_PERSONAL_SECTIONS } from "./secondSamuelEightSource";
import { SECOND_SAMUEL_NINE_PERSONAL_SECTIONS } from "./secondSamuelNineSource";
import { SECOND_SAMUEL_TEN_PERSONAL_SECTIONS } from "./secondSamuelTenSource";
import { SECOND_SAMUEL_ELEVEN_PERSONAL_SECTIONS } from "./secondSamuelElevenSource";
import { SECOND_SAMUEL_TWELVE_PERSONAL_SECTIONS } from "./secondSamuelTwelveSource";
import { SECOND_SAMUEL_THIRTEEN_PERSONAL_SECTIONS } from "./secondSamuelThirteenSource";
import { SECOND_SAMUEL_FOURTEEN_PERSONAL_SECTIONS } from "./secondSamuelFourteenSource";
import { SECOND_SAMUEL_FIFTEEN_PERSONAL_SECTIONS } from "./secondSamuelFifteenSource";
...
import { SECOND_SAMUEL_TWENTY_PERSONAL_SECTIONS } from "./secondSamuelTwentySource";
import { SECOND_SAMUEL_TWENTY_ONE_PERSONAL_SECTIONS } from "./secondSamuelTwentyOneSource";
import { SECOND_SAMUEL_TWENTY_TWO_PERSONAL_SECTIONS } from "./secondSamuelTwentyTwoSource";
import { SECOND_SAMUEL_TWENTY_THREE_PERSONAL_SECTIONS } from "./secondSamuelTwentyThreeSource";
...
import { FIRST_KINGS_FOUR_PERSONAL_SECTIONS } from "./firstKingsFourSource";
import { FIRST_KINGS_FIVE_PERSONAL_SECTIONS } from "./firstKingsFiveSource";
import { FIRST_KINGS_SIX_PERSONAL_SECTIONS } from "./firstKingsSixSource";
import { FIRST_KINGS_SEVEN_PERSONAL_SECTIONS } from "./firstKingsSevenSource";
import { FIRST_KINGS_EIGHT_PERSONAL_SECTIONS } from "./firstKingsEightSource";
...
import { FIRST_KINGS_FIFTEEN_PERSONAL_SECTIONS } from "./firstKingsFifteenSource";
import { FIRST_KINGS_SIXTEEN_PERSONAL_SECTIONS } from "./firstKingsSixteenSource";
import { FIRST_KINGS_SEVENTEEN_PERSONAL_SECTIONS } from "./firstKingsSeventeenSource";
import { FIRST_KINGS_EIGHTEEN_PERSONAL_SECTIONS } from "./firstKingsEighteenSource";
import { FIRST_KINGS_NINETEEN_PERSONAL_SECTIONS } from "./firstKingsNineteenSource";
import { FIRST_KINGS_TWENTY_PERSONAL_SECTIONS } from "./firstKingsTwentySource";
import { FIRST_KINGS_TWENTY_ONE_PERSONAL_SECTIONS } from "./firstKingsTwentyOneSource";
import { FIRST_KINGS_TWENTY_TWO_PERSONAL_SECTIONS } from "./firstKingsTwentyTwoSource";
import { SECOND_KINGS_ONE_PERSONAL_SECTIONS } from "./secondKingsOneSource";
import { SECOND_KINGS_TWO_PERSONAL_SECTIONS } from "./secondKingsTwoSource";
import { SECOND_KINGS_THREE_PERSONAL_SECTIONS } from "./secondKingsThreeSource";
import { SECOND_KINGS_FOUR_PERSONAL_SECTIONS } from "./secondKingsFourSource";
import { SECOND_KINGS_FIVE_PERSONAL_SECTIONS } from "./secondKingsFiveSource";
import { SECOND_KINGS_SIX_PERSONAL_SECTIONS } from "./secondKingsSixSource";
import { SECOND_KINGS_SEVEN_PERSONAL_SECTIONS } from "./secondKingsSevenSource";
import { SECOND_KINGS_EIGHT_PERSONAL_SECTIONS } from "./secondKingsEightSource";
import { SECOND_KINGS_NINE_PERSONAL_SECTIONS } from "./secondKingsNineSource";
import { SECOND_KINGS_TEN_PERSONAL_SECTIONS } from "./secondKingsTenSource";
import { SECOND_KINGS_ELEVEN_PERSONAL_SECTIONS } from "./secondKingsElevenSource";
import { SECOND_KINGS_TWELVE_PERSONAL_SECTIONS } from "./secondKingsTwelveSource";
import { SECOND_KINGS_THIRTEEN_PERSONAL_SECTIONS } from "./secondKingsThirteenSource";
import { SECOND_KINGS_FOURTEEN_PERSONAL_SECTIONS } from "./secondKingsFourteenSource";
import { SECOND_KINGS_FIFTEEN_PERSONAL_SECTIONS } from "./secondKingsFifteenSource";
import { SECOND_KINGS_SIXTEEN_PERSONAL_SECTIONS } from "./secondKingsSixteenSource";
import { SECOND_KINGS_SEVENTEEN_PERSONAL_SECTIONS } from "./secondKingsSeventeenSource";
import { SECOND_KINGS_EIGHTEEN_PERSONAL_SECTIONS } from "./secondKingsEighteenSource";
import { SECOND_KINGS_NINETEEN_PERSONAL_SECTIONS } from "./secondKingsNineteenSource";
import { SECOND_KINGS_TWENTY_PERSONAL_SECTIONS } from "./secondKingsTwentySource";
import { SECOND_KINGS_TWENTY_ONE_PERSONAL_SECTIONS } from "./secondKingsTwentyOneSource";
import { SECOND_KINGS_TWENTY_TWO_PERSONAL_SECTIONS } from "./secondKingsTwentyTwoSource";
import { SECOND_KINGS_TWENTY_THREE_PERSONAL_SECTIONS } from "./secondKingsTwentyThreeSource";
import { SECOND_KINGS_TWENTY_FOUR_PERSONAL_SECTIONS } from "./secondKingsTwentyFourSource";
import { SECOND_KINGS_TWENTY_FIVE_PERSONAL_SECTIONS } from "./secondKingsTwentyFiveSource";
import { FIRST_CHRONICLES_ONE_PERSONAL_SECTIONS } from "./firstChroniclesOneSource";
import { FIRST_CHRONICLES_TWO_PERSONAL_SECTIONS } from "./firstChroniclesTwoSource";
import { FIRST_CHRONICLES_THREE_PERSONAL_SECTIONS } from "./firstChroniclesThreeSource";
import { FIRST_CHRONICLES_FOUR_PERSONAL_SECTIONS } from "./firstChroniclesFourSource";
import { FIRST_CHRONICLES_FIVE_PERSONAL_SECTIONS } from "./firstChroniclesFiveSource";
import { FIRST_CHRONICLES_SIX_PERSONAL_SECTIONS } from "./firstChroniclesSixSource";
import { FIRST_CHRONICLES_SEVEN_PERSONAL_SECTIONS } from "./firstChroniclesSevenSource";
import { FIRST_CHRONICLES_EIGHT_PERSONAL_SECTIONS } from "./firstChroniclesEightSource";
import { FIRST_CHRONICLES_NINE_PERSONAL_SECTIONS } from "./firstChroniclesNineSource";
import { FIRST_CHRONICLES_TEN_PERSONAL_SECTIONS } from "./firstChroniclesTenSource";
import { FIRST_CHRONICLES_ELEVEN_PERSONAL_SECTIONS } from "./firstChroniclesElevenSource";
import { FIRST_CHRONICLES_TWELVE_PERSONAL_SECTIONS } from "./firstChroniclesTwelveSource";
import { FIRST_CHRONICLES_THIRTEEN_PERSONAL_SECTIONS } from "./firstChroniclesThirteenSource";
import { FIRST_CHRONICLES_FOURTEEN_PERSONAL_SECTIONS } from "./firstChroniclesFourteenSource";
import { FIRST_CHRONICLES_FIFTEEN_PERSONAL_SECTIONS } from "./firstChroniclesFifteenSource";
import { FIRST_CHRONICLES_SIXTEEN_PERSONAL_SECTIONS } from "./firstChroniclesSixteenSource";
...
import { FIRST_CHRONICLES_TWENTY_FIVE_PERSONAL_SECTIONS } from "./firstChroniclesTwentyFiveSource";
import { FIRST_CHRONICLES_TWENTY_SIX_PERSONAL_SECTIONS } from "./firstChroniclesTwentySixSource";
import { FIRST_CHRONICLES_TWENTY_SEVEN_PERSONAL_SECTIONS } from "./firstChroniclesTwentySevenSource";
import { FIRST_CHRONICLES_TWENTY_EIGHT_PERSONAL_SECTIONS } from "./firstChroniclesTwentyEightSource";
import { FIRST_CHRONICLES_TWENTY_NINE_PERSONAL_SECTIONS } from "./firstChroniclesTwentyNineSource";
import { SECOND_CHRONICLES_ONE_PERSONAL_SECTIONS } from "./secondChroniclesOneSource";
import { SECOND_CHRONICLES_TWO_PERSONAL_SECTIONS } from "./secondChroniclesTwoSource";
import { SECOND_CHRONICLES_THREE_PERSONAL_SECTIONS } from "./secondChroniclesThreeSource";
import { SECOND_CHRONICLES_FOUR_PERSONAL_SECTIONS } from "./secondChroniclesFourSource";
import { SECOND_CHRONICLES_FIVE_PERSONAL_SECTIONS } from "./secondChroniclesFiveSource";
import { SECOND_CHRONICLES_SIX_PERSONAL_SECTIONS } from "./secondChroniclesSixSource";
...
import { SECOND_CHRONICLES_ELEVEN_PERSONAL_SECTIONS } from "./secondChroniclesElevenSource";
import { SECOND_CHRONICLES_TWELVE_PERSONAL_SECTIONS } from "./secondChroniclesTwelveSource";
import { SECOND_CHRONICLES_THIRTEEN_PERSONAL_SECTIONS } from "./secondChroniclesThirteenSource";
...
import { SECOND_CHRONICLES_EIGHTEEN_PERSONAL_SECTIONS } from "./secondChroniclesEighteenSource";
import { SECOND_CHRONICLES_NINETEEN_PERSONAL_SECTIONS } from "./secondChroniclesNineteenSource";
import { SECOND_CHRONICLES_TWENTY_PERSONAL_SECTIONS } from "./secondChroniclesTwentySource";
import { SECOND_CHRONICLES_TWENTY_ONE_PERSONAL_SECTIONS } from "./secondChroniclesTwentyOneSource";
import { SECOND_CHRONICLES_TWENTY_TWO_PERSONAL_SECTIONS } from "./secondChroniclesTwentyTwoSource";
import { SECOND_CHRONICLES_TWENTY_THREE_PERSONAL_SECTIONS } from "./secondChroniclesTwentyThreeSource";
import { SECOND_CHRONICLES_TWENTY_FOUR_PERSONAL_SECTIONS } from "./secondChroniclesTwentyFourSource";
...
import { SECOND_CHRONICLES_TWENTY_NINE_PERSONAL_SECTIONS } from "./secondChroniclesTwentyNineSource";
import { SECOND_CHRONICLES_THIRTY_PERSONAL_SECTIONS } from "./secondChroniclesThirtySource";
import { SECOND_CHRONICLES_THIRTY_ONE_PERSONAL_SECTIONS } from "./secondChroniclesThirtyOneSource";
import { SECOND_CHRONICLES_THIRTY_TWO_PERSONAL_SECTIONS } from "./secondChroniclesThirtyTwoSource";
...
import { EZRA_THREE_PERSONAL_SECTIONS } from "./ezraThreeSource";
import { EZRA_FOUR_PERSONAL_SECTIONS } from "./ezraFourSource";
import { EZRA_FIVE_PERSONAL_SECTIONS } from "./ezraFiveSource";
import { EZRA_SIX_PERSONAL_SECTIONS } from "./ezraSixSource";
import { EZRA_SEVEN_PERSONAL_SECTIONS } from "./ezraSevenSource";
import { EZRA_EIGHT_PERSONAL_SECTIONS } from "./ezraEightSource";
import { EZRA_NINE_PERSONAL_SECTIONS } from "./ezraNineSource";
import { EZRA_TEN_PERSONAL_SECTIONS } from "./ezraTenSource";
import { NEHEMIAH_ONE_PERSONAL_SECTIONS } from "./nehemiahOneSource";
import { NEHEMIAH_TWO_PERSONAL_SECTIONS } from "./nehemiahTwoSource";
import { NEHEMIAH_THREE_PERSONAL_SECTIONS } from "./nehemiahThreeSource";
import { NEHEMIAH_FOUR_PERSONAL_SECTIONS } from "./nehemiahFourSource";
import { NEHEMIAH_FIVE_PERSONAL_SECTIONS } from "./nehemiahFiveSource";
import { NEHEMIAH_SIX_PERSONAL_SECTIONS } from "./nehemiahSixSource";
import { NEHEMIAH_SEVEN_PERSONAL_SECTIONS } from "./nehemiahSevenSource";
...
import { NEHEMIAH_TWELVE_PERSONAL_SECTIONS } from "./nehemiahTwelveSource";
import { NEHEMIAH_THIRTEEN_PERSONAL_SECTIONS } from "./nehemiahThirteenSource";
import { ESTHER_ONE_PERSONAL_SECTIONS } from "./estherOneSource";
...
import { ESTHER_EIGHT_PERSONAL_SECTIONS } from "./estherEightSource";
import { ESTHER_NINE_PERSONAL_SECTIONS } from "./estherNineSource";
import { ESTHER_TEN_PERSONAL_SECTIONS } from "./estherTenSource";
...
import { JOB_FOUR_PERSONAL_SECTIONS } from "./jobFourSource";
import { JOB_FIVE_PERSONAL_SECTIONS } from "./jobFiveSource";
import { JOB_SIX_PERSONAL_SECTIONS } from "./jobSixSource";
import { JOB_SEVEN_PERSONAL_SECTIONS } from "./jobSevenSource";
...
import { JOB_THIRTEEN_PERSONAL_SECTIONS } from "./jobThirteenSource";
import { JOB_FOURTEEN_PERSONAL_SECTIONS } from "./jobFourteenSource";
import { JOB_FIFTEEN_PERSONAL_SECTIONS } from "./jobFifteenSource";
import { JOB_SIXTEEN_PERSONAL_SECTIONS } from "./jobSixteenSource";
import { JOB_SEVENTEEN_PERSONAL_SECTIONS } from "./jobSeventeenSource";
import { JOB_EIGHTEEN_PERSONAL_SECTIONS } from "./jobEighteenSource";
import { JOB_NINETEEN_PERSONAL_SECTIONS } from "./jobNineteenSource";
import { JOB_TWENTY_PERSONAL_SECTIONS } from "./jobTwentySource";
import { JOB_TWENTY_ONE_PERSONAL_SECTIONS } from "./jobTwentyOneSource";
import { JOB_TWENTY_TWO_PERSONAL_SECTIONS } from "./jobTwentyTwoSource";
import { JOB_TWENTY_THREE_PERSONAL_SECTIONS } from "./jobTwentyThreeSource";
...
import { JOB_TWENTY_EIGHT_PERSONAL_SECTIONS } from "./jobTwentyEightSource";
import { JOB_TWENTY_NINE_PERSONAL_SECTIONS } from "./jobTwentyNineSource";
import { JOB_THIRTY_PERSONAL_SECTIONS } from "./jobThirtySource";
import { JOB_THIRTY_ONE_PERSONAL_SECTIONS } from "./jobThirtyOneSource";
import { JOB_THIRTY_TWO_PERSONAL_SECTIONS } from "./jobThirtyTwoSource";
import { JOB_THIRTY_THREE_PERSONAL_SECTIONS } from "./jobThirtyThreeSource";
import { JOB_THIRTY_FOUR_PERSONAL_SECTIONS } from "./jobThirtyFourSource";
import { JOB_THIRTY_FIVE_PERSONAL_SECTIONS } from "./jobThirtyFiveSource";
import { JOB_THIRTY_SIX_PERSONAL_SECTIONS } from "./jobThirtySixSource";
import { JOB_THIRTY_SEVEN_PERSONAL_SECTIONS } from "./jobThirtySevenSource";
import { JOB_THIRTY_EIGHT_PERSONAL_SECTIONS } from "./jobThirtyEightSource";
import { JOB_THIRTY_NINE_PERSONAL_SECTIONS } from "./jobThirtyNineSource";
import { JOB_FORTY_PERSONAL_SECTIONS } from "./jobFortySource";
import { JOB_FORTY_ONE_PERSONAL_SECTIONS } from "./jobFortyOneSource";
import { JOB_FORTY_TWO_PERSONAL_SECTIONS } from "./jobFortyTwoSource";
...
import { PSALMS_ONE_PERSONAL_SECTIONS } from "./psalmsOneSource";
...
import { PSALMS_SIX_PERSONAL_SECTIONS } from "./psalmsSixSource";
import { PSALMS_SEVEN_PERSONAL_SECTIONS } from "./psalmsSevenSource";
import { PSALMS_EIGHT_PERSONAL_SECTIONS } from "./psalmsEightSource";
import { PSALMS_NINE_PERSONAL_SECTIONS } from "./psalmsNineSource";
import { PSALMS_TEN_PERSONAL_SECTIONS } from "./psalmsTenSource";
import { PSALMS_ELEVEN_PERSONAL_SECTIONS } from "./psalmsElevenSource";
import { PSALMS_TWELVE_PERSONAL_SECTIONS } from "./psalmsTwelveSource";
import { PSALMS_THIRTEEN_PERSONAL_SECTIONS } from "./psalmsThirteenSource";
import { PSALMS_FOURTEEN_PERSONAL_SECTIONS } from "./psalmsFourteenSource";
import { PSALMS_FIFTEEN_PERSONAL_SECTIONS } from "./psalmsFifteenSource";
import { PSALMS_SIXTEEN_PERSONAL_SECTIONS } from "./psalmsSixteenSource";
import { PSALMS_SEVENTEEN_PERSONAL_SECTIONS } from "./psalmsSeventeenSource";
import { PSALMS_EIGHTEEN_PERSONAL_SECTIONS } from "./psalmsEighteenSource";
import { PSALMS_NINETEEN_PERSONAL_SECTIONS } from "./psalmsNineteenSource";
import { PSALMS_TWENTY_PERSONAL_SECTIONS } from "./psalmsTwentySource";
import { PSALMS_TWENTY_ONE_PERSONAL_SECTIONS } from "./psalmsTwentyOneSource";
import { PSALMS_TWENTY_TWO_PERSONAL_SECTIONS } from "./psalmsTwentyTwoSource";
import { PSALMS_TWENTY_THREE_PERSONAL_SECTIONS } from "./psalmsTwentyThreeSource";
import { PSALMS_TWENTY_FOUR_PERSONAL_SECTIONS } from "./psalmsTwentyFourSource";
import { PSALMS_TWENTY_FIVE_PERSONAL_SECTIONS } from "./psalmsTwentyFiveSource";
import { PSALMS_TWENTY_SIX_PERSONAL_SECTIONS } from "./psalmsTwentySixSource";
import { PSALMS_TWENTY_SEVEN_PERSONAL_SECTIONS } from "./psalmsTwentySevenSource";
import { PSALMS_TWENTY_EIGHT_PERSONAL_SECTIONS } from "./psalmsTwentyEightSource";
import { PSALMS_TWENTY_NINE_PERSONAL_SECTIONS } from "./psalmsTwentyNineSource";
import { PSALMS_THIRTY_PERSONAL_SECTIONS } from "./psalmsThirtySource";
import { PSALMS_THIRTY_ONE_PERSONAL_SECTIONS } from "./psalmsThirtyOneSource";
import { PSALMS_THIRTY_TWO_PERSONAL_SECTIONS } from "./psalmsThirtyTwoSource";
import { PSALMS_THIRTY_THREE_PERSONAL_SECTIONS } from "./psalmsThirtyThreeSource";
import { PSALMS_THIRTY_FOUR_PERSONAL_SECTIONS } from "./psalmsThirtyFourSource";
import { PSALMS_THIRTY_FIVE_PERSONAL_SECTIONS } from "./psalmsThirtyFiveSource";
import { PSALMS_THIRTY_SIX_PERSONAL_SECTIONS } from "./psalmsThirtySixSource";
import { PSALMS_THIRTY_SEVEN_PERSONAL_SECTIONS } from "./psalmsThirtySevenSource";
import { PSALMS_THIRTY_EIGHT_PERSONAL_SECTIONS } from "./psalmsThirtyEightSource";
import { PSALMS_THIRTY_NINE_PERSONAL_SECTIONS } from "./psalmsThirtyNineSource";
import { PSALMS_FORTY_PERSONAL_SECTIONS } from "./psalmsFortySource";
import { PSALMS_FORTY_ONE_PERSONAL_SECTIONS } from "./psalmsFortyOneSource";
import { PSALMS_FORTY_TWO_PERSONAL_SECTIONS } from "./psalmsFortyTwoSource";
import { PSALMS_FORTY_THREE_PERSONAL_SECTIONS } from "./psalmsFortyThreeSource";
import { PSALMS_FORTY_FOUR_PERSONAL_SECTIONS } from "./psalmsFortyFourSource";
import { PSALMS_FORTY_FIVE_PERSONAL_SECTIONS } from "./psalmsFortyFiveSource";
import { PSALMS_FORTY_SIX_PERSONAL_SECTIONS } from "./psalmsFortySixSource";
import { PSALMS_FORTY_SEVEN_PERSONAL_SECTIONS } from "./psalmsFortySevenSource";
import { PSALMS_FORTY_EIGHT_PERSONAL_SECTIONS } from "./psalmsFortyEightSource";
import { PSALMS_FORTY_NINE_PERSONAL_SECTIONS } from "./psalmsFortyNineSource";
import { PSALMS_FIFTY_PERSONAL_SECTIONS } from "./psalmsFiftySource";
import { PSALMS_FIFTY_ONE_PERSONAL_SECTIONS } from "./psalmsFiftyOneSource";
import { PSALMS_FIFTY_TWO_PERSONAL_SECTIONS } from "./psalmsFiftyTwoSource";
import { PSALMS_FIFTY_THREE_PERSONAL_SECTIONS } from "./psalmsFiftyThreeSource";
import { PSALMS_FIFTY_FOUR_PERSONAL_SECTIONS } from "./psalmsFiftyFourSource";
import { PSALMS_FIFTY_FIVE_PERSONAL_SECTIONS } from "./psalmsFiftyFiveSource";
import { PSALMS_FIFTY_SIX_PERSONAL_SECTIONS } from "./psalmsFiftySixSource";
import { PSALMS_FIFTY_SEVEN_PERSONAL_SECTIONS } from "./psalmsFiftySevenSource";
import { PSALMS_FIFTY_EIGHT_PERSONAL_SECTIONS } from "./psalmsFiftyEightSource";
import { PSALMS_FIFTY_NINE_PERSONAL_SECTIONS } from "./psalmsFiftyNineSource";
import { PSALMS_SIXTY_PERSONAL_SECTIONS } from "./psalmsSixtySource";
import { PSALMS_SIXTY_ONE_PERSONAL_SECTIONS } from "./psalmsSixtyOneSource";
import { PSALMS_SIXTY_TWO_PERSONAL_SECTIONS } from "./psalmsSixtyTwoSource";
import { PSALMS_SIXTY_THREE_PERSONAL_SECTIONS } from "./psalmsSixtyThreeSource";
import { PSALMS_SIXTY_FOUR_PERSONAL_SECTIONS } from "./psalmsSixtyFourSource";
import { PSALMS_SIXTY_FIVE_PERSONAL_SECTIONS } from "./psalmsSixtyFiveSource";
import { PSALMS_SIXTY_SIX_PERSONAL_SECTIONS } from "./psalmsSixtySixSource";
import { PSALMS_SIXTY_SEVEN_PERSONAL_SECTIONS } from "./psalmsSixtySevenSource";
import { PSALMS_SIXTY_EIGHT_PERSONAL_SECTIONS } from "./psalmsSixtyEightSource";
import { PSALMS_SIXTY_NINE_PERSONAL_SECTIONS } from "./psalmsSixtyNineSource";
import { PSALMS_SEVENTY_PERSONAL_SECTIONS } from "./psalmsSeventySource";
import { PSALMS_SEVENTY_ONE_PERSONAL_SECTIONS } from "./psalmsSeventyOneSource";
import { PSALMS_SEVENTY_TWO_PERSONAL_SECTIONS } from "./psalmsSeventyTwoSource";
import { PSALMS_SEVENTY_THREE_PERSONAL_SECTIONS } from "./psalmsSeventyThreeSource";
import { PSALMS_SEVENTY_FOUR_PERSONAL_SECTIONS } from "./psalmsSeventyFourSource";
import { PSALMS_SEVENTY_FIVE_PERSONAL_SECTIONS } from "./psalmsSeventyFiveSource";
import { PSALMS_SEVENTY_SIX_PERSONAL_SECTIONS } from "./psalmsSeventySixSource";
import { PSALMS_SEVENTY_SEVEN_PERSONAL_SECTIONS } from "./psalmsSeventySevenSource";
import { PSALMS_SEVENTY_EIGHT_PERSONAL_SECTIONS } from "./psalmsSeventyEightSource";
import { PSALMS_SEVENTY_NINE_PERSONAL_SECTIONS } from "./psalmsSeventyNineSource";
import { PSALMS_EIGHTY_PERSONAL_SECTIONS } from "./psalmsEightySource";
import { PSALMS_EIGHTY_ONE_PERSONAL_SECTIONS } from "./psalmsEightyOneSource";
import { PSALMS_EIGHTY_TWO_PERSONAL_SECTIONS } from "./psalmsEightyTwoSource";
import { PSALMS_EIGHTY_THREE_PERSONAL_SECTIONS } from "./psalmsEightyThreeSource";
import { PSALMS_EIGHTY_FOUR_PERSONAL_SECTIONS } from "./psalmsEightyFourSource";
...
import { PSALMS_EIGHTY_NINE_PERSONAL_SECTIONS } from "./psalmsEightyNineSource";
import { PSALMS_NINETY_PERSONAL_SECTIONS } from "./psalmsNinetySource";
import { PSALMS_NINETY_ONE_PERSONAL_SECTIONS } from "./psalmsNinetyOneSource";
import { PSALMS_NINETY_TWO_PERSONAL_SECTIONS } from "./psalmsNinetyTwoSource";
import { PSALMS_NINETY_THREE_PERSONAL_SECTIONS } from "./psalmsNinetyThreeSource";
import { PSALMS_NINETY_FOUR_PERSONAL_SECTIONS } from "./psalmsNinetyFourSource";
import { PSALMS_NINETY_FIVE_PERSONAL_SECTIONS } from "./psalmsNinetyFiveSource";
import { PSALMS_NINETY_SIX_PERSONAL_SECTIONS } from "./psalmsNinetySixSource";
import { PSALMS_NINETY_SEVEN_PERSONAL_SECTIONS } from "./psalmsNinetySevenSource";
import { PSALMS_NINETY_EIGHT_PERSONAL_SECTIONS } from "./psalmsNinetyEightSource";
import { PSALMS_NINETY_NINE_PERSONAL_SECTIONS } from "./psalmsNinetyNineSource";
import { PSALMS_ONE_HUNDRED_PERSONAL_SECTIONS } from "./psalmsOneHundredSource";
import { PSALMS_ONE_HUNDRED_ONE_PERSONAL_SECTIONS } from "./psalmsOneHundredOneSource";
import { PSALMS_ONE_HUNDRED_TWO_PERSONAL_SECTIONS } from "./psalmsOneHundredTwoSource";
import { PSALMS_ONE_HUNDRED_THREE_PERSONAL_SECTIONS } from "./psalmsOneHundredThreeSource";
import { PSALMS_ONE_HUNDRED_FOUR_PERSONAL_SECTIONS } from "./psalmsOneHundredFourSource";
import { PSALMS_ONE_HUNDRED_FIVE_PERSONAL_SECTIONS } from "./psalmsOneHundredFiveSource";
import { PSALMS_ONE_HUNDRED_SIX_PERSONAL_SECTIONS } from "./psalmsOneHundredSixSource";
import { PSALMS_ONE_HUNDRED_SEVEN_PERSONAL_SECTIONS } from "./psalmsOneHundredSevenSource";
import { PSALMS_ONE_HUNDRED_EIGHT_PERSONAL_SECTIONS } from "./psalmsOneHundredEightSource";
import { PSALMS_ONE_HUNDRED_NINE_PERSONAL_SECTIONS } from "./psalmsOneHundredNineSource";
import { PSALMS_ONE_HUNDRED_TEN_PERSONAL_SECTIONS } from "./psalmsOneHundredTenSource";
import { PSALMS_ONE_HUNDRED_ELEVEN_PERSONAL_SECTIONS } from "./psalmsOneHundredElevenSource";
import { PSALMS_ONE_HUNDRED_TWELVE_PERSONAL_SECTIONS } from "./psalmsOneHundredTwelveSource";
import { PSALMS_ONE_HUNDRED_THIRTEEN_PERSONAL_SECTIONS } from "./psalmsOneHundredThirteenSource";
import { PSALMS_ONE_HUNDRED_FOURTEEN_PERSONAL_SECTIONS } from "./psalmsOneHundredFourteenSource";
...
import { PSALMS_ONE_HUNDRED_TWENTY_TWO_PERSONAL_SECTIONS } from "./psalmsOneHundredTwentyTwoSource";
import { PSALMS_ONE_HUNDRED_TWENTY_THREE_PERSONAL_SECTIONS } from "./psalmsOneHundredTwentyThreeSource";
import { PSALMS_ONE_HUNDRED_TWENTY_FOUR_PERSONAL_SECTIONS } from "./psalmsOneHundredTwentyFourSource";
import { PSALMS_ONE_HUNDRED_TWENTY_FIVE_PERSONAL_SECTIONS } from "./psalmsOneHundredTwentyFiveSource";
import { PSALMS_ONE_HUNDRED_TWENTY_SIX_PERSONAL_SECTIONS } from "./psalmsOneHundredTwentySixSource";
import { PSALMS_ONE_HUNDRED_TWENTY_SEVEN_PERSONAL_SECTIONS } from "./psalmsOneHundredTwentySevenSource";
import { PSALMS_ONE_HUNDRED_TWENTY_EIGHT_PERSONAL_SECTIONS } from "./psalmsOneHundredTwentyEightSource";
import { PSALMS_ONE_HUNDRED_TWENTY_NINE_PERSONAL_SECTIONS } from "./psalmsOneHundredTwentyNineSource";
import { PSALMS_ONE_HUNDRED_THIRTY_PERSONAL_SECTIONS } from "./psalmsOneHundredThirtySource";
import { PSALMS_ONE_HUNDRED_THIRTY_ONE_PERSONAL_SECTIONS } from "./psalmsOneHundredThirtyOneSource";
import { PSALMS_ONE_HUNDRED_THIRTY_TWO_PERSONAL_SECTIONS } from "./psalmsOneHundredThirtyTwoSource";
import { PSALMS_ONE_HUNDRED_THIRTY_THREE_PERSONAL_SECTIONS } from "./psalmsOneHundredThirtyThreeSource";
import { PSALMS_ONE_HUNDRED_THIRTY_FOUR_PERSONAL_SECTIONS } from "./psalmsOneHundredThirtyFourSource";
import { PSALMS_ONE_HUNDRED_THIRTY_FIVE_PERSONAL_SECTIONS } from "./psalmsOneHundredThirtyFiveSource";
import { PSALMS_ONE_HUNDRED_THIRTY_SIX_PERSONAL_SECTIONS } from "./psalmsOneHundredThirtySixSource";
import { PSALMS_ONE_HUNDRED_THIRTY_SEVEN_PERSONAL_SECTIONS } from "./psalmsOneHundredThirtySevenSource";
import { PSALMS_ONE_HUNDRED_THIRTY_EIGHT_PERSONAL_SECTIONS } from "./psalmsOneHundredThirtyEightSource";
import { PSALMS_ONE_HUNDRED_THIRTY_NINE_PERSONAL_SECTIONS } from "./psalmsOneHundredThirtyNineSource";
import { PSALMS_ONE_HUNDRED_FORTY_PERSONAL_SECTIONS } from "./psalmsOneHundredFortySource";
import { PSALMS_ONE_HUNDRED_FORTY_ONE_PERSONAL_SECTIONS } from "./psalmsOneHundredFortyOneSource";
import { PSALMS_ONE_HUNDRED_FORTY_TWO_PERSONAL_SECTIONS } from "./psalmsOneHundredFortyTwoSource";
import { PSALMS_ONE_HUNDRED_FORTY_THREE_PERSONAL_SECTIONS } from "./psalmsOneHundredFortyThreeSource";
import { PSALMS_ONE_HUNDRED_FORTY_FOUR_PERSONAL_SECTIONS } from "./psalmsOneHundredFortyFourSource";
import { PSALMS_ONE_HUNDRED_FORTY_FIVE_PERSONAL_SECTIONS } from "./psalmsOneHundredFortyFiveSource";
import { PSALMS_ONE_HUNDRED_FORTY_SIX_PERSONAL_SECTIONS } from "./psalmsOneHundredFortySixSource";
import { PSALMS_ONE_HUNDRED_FORTY_SEVEN_PERSONAL_SECTIONS } from "./psalmsOneHundredFortySevenSource";
import { PSALMS_ONE_HUNDRED_FORTY_EIGHT_PERSONAL_SECTIONS } from "./psalmsOneHundredFortyEightSource";
import { PSALMS_ONE_HUNDRED_FORTY_NINE_PERSONAL_SECTIONS } from "./psalmsOneHundredFortyNineSource";
import { PSALMS_ONE_HUNDRED_FIFTY_PERSONAL_SECTIONS } from "./psalmsOneHundredFiftySource";
...
import { PROVERBS_ONE_PERSONAL_SECTIONS } from "./proverbsOneSource";
import { PROVERBS_TWO_PERSONAL_SECTIONS } from "./proverbsTwoSource";
import { PROVERBS_THREE_PERSONAL_SECTIONS } from "./proverbsThreeSource";
import { PROVERBS_FOUR_PERSONAL_SECTIONS } from "./proverbsFourSource";
import { PROVERBS_FIVE_PERSONAL_SECTIONS } from "./proverbsFiveSource";
import { PROVERBS_SIX_PERSONAL_SECTIONS } from "./proverbsSixSource";
import { PROVERBS_SEVEN_PERSONAL_SECTIONS } from "./proverbsSevenSource";
...
import { PROVERBS_TEN_PERSONAL_SECTIONS } from "./proverbsTenSource";
import { PROVERBS_ELEVEN_PERSONAL_SECTIONS } from "./proverbsElevenSource";
import { PROVERBS_TWELVE_PERSONAL_SECTIONS } from "./proverbsTwelveSource";
import { PROVERBS_THIRTEEN_PERSONAL_SECTIONS } from "./proverbsThirteenSource";
...
import { PROVERBS_EIGHTEEN_PERSONAL_SECTIONS } from "./proverbsEighteenSource";
import { PROVERBS_NINETEEN_PERSONAL_SECTIONS } from "./proverbsNineteenSource";
import { PROVERBS_TWENTY_PERSONAL_SECTIONS } from "./proverbsTwentySource";
import { PROVERBS_TWENTY_ONE_PERSONAL_SECTIONS } from "./proverbsTwentyOneSource";
import { PROVERBS_TWENTY_TWO_PERSONAL_SECTIONS } from "./proverbsTwentyTwoSource";
import { PROVERBS_TWENTY_THREE_PERSONAL_SECTIONS } from "./proverbsTwentyThreeSource";
import { PROVERBS_TWENTY_FOUR_PERSONAL_SECTIONS } from "./proverbsTwentyFourSource";
import { PROVERBS_TWENTY_FIVE_PERSONAL_SECTIONS } from "./proverbsTwentyFiveSource";
import { PROVERBS_TWENTY_SIX_PERSONAL_SECTIONS } from "./proverbsTwentySixSource";
import { PROVERBS_TWENTY_SEVEN_PERSONAL_SECTIONS } from "./proverbsTwentySevenSource";
import { PROVERBS_TWENTY_EIGHT_PERSONAL_SECTIONS } from "./proverbsTwentyEightSource";
import { PROVERBS_TWENTY_NINE_PERSONAL_SECTIONS } from "./proverbsTwentyNineSource";
import { PROVERBS_THIRTY_PERSONAL_SECTIONS } from "./proverbsThirtySource";
import { PROVERBS_THIRTY_ONE_PERSONAL_SECTIONS } from "./proverbsThirtyOneSource";
...
import { ECCLESIASTES_ONE_PERSONAL_SECTIONS } from "./ecclesiastesOneSource";
import { ECCLESIASTES_TWO_PERSONAL_SECTIONS } from "./ecclesiastesTwoSource";
import { ECCLESIASTES_THREE_PERSONAL_SECTIONS } from "./ecclesiastesThreeSource";
import { ECCLESIASTES_FOUR_PERSONAL_SECTIONS } from "./ecclesiastesFourSource";
import { ECCLESIASTES_FIVE_PERSONAL_SECTIONS } from "./ecclesiastesFiveSource";
import { ECCLESIASTES_SIX_PERSONAL_SECTIONS } from "./ecclesiastesSixSource";
...
import { ECCLESIASTES_ELEVEN_PERSONAL_SECTIONS } from "./ecclesiastesElevenSource";
import { ECCLESIASTES_TWELVE_PERSONAL_SECTIONS } from "./ecclesiastesTwelveSource";
...
import { SONG_OF_SOLOMON_FIVE_PERSONAL_SECTIONS } from "./songOfSolomonFiveSource";
import { SONG_OF_SOLOMON_SIX_PERSONAL_SECTIONS } from "./songOfSolomonSixSource";
import { SONG_OF_SOLOMON_SEVEN_PERSONAL_SECTIONS } from "./songOfSolomonSevenSource";
import { SONG_OF_SOLOMON_EIGHT_PERSONAL_SECTIONS } from "./songOfSolomonEightSource";
...
import { ISAIAH_ONE_PERSONAL_SECTIONS } from "./isaiahOneSource";
...
import { ISAIAH_SIX_PERSONAL_SECTIONS } from "./isaiahSixSource";
import { ISAIAH_SEVEN_PERSONAL_SECTIONS } from "./isaiahSevenSource";
import { ISAIAH_EIGHT_PERSONAL_SECTIONS } from "./isaiahEightSource";
import { ISAIAH_NINE_PERSONAL_SECTIONS } from "./isaiahNineSource";
import { ISAIAH_TEN_PERSONAL_SECTIONS } from "./isaiahTenSource";
import { ISAIAH_ELEVEN_PERSONAL_SECTIONS } from "./isaiahElevenSource";
import { ISAIAH_TWELVE_PERSONAL_SECTIONS } from "./isaiahTwelveSource";
import { ISAIAH_THIRTEEN_PERSONAL_SECTIONS } from "./isaiahThirteenSource";
import { ISAIAH_FOURTEEN_PERSONAL_SECTIONS } from "./isaiahFourteenSource";
import { ISAIAH_FIFTEEN_PERSONAL_SECTIONS } from "./isaiahFifteenSource";
...
import { ISAIAH_TWENTY_PERSONAL_SECTIONS } from "./isaiahTwentySource";
import { ISAIAH_TWENTY_ONE_PERSONAL_SECTIONS } from "./isaiahTwentyOneSource";
import { ISAIAH_TWENTY_TWO_PERSONAL_SECTIONS } from "./isaiahTwentyTwoSource";
import { ISAIAH_TWENTY_THREE_PERSONAL_SECTIONS } from "./isaiahTwentyThreeSource";
import { ISAIAH_TWENTY_FOUR_PERSONAL_SECTIONS } from "./isaiahTwentyFourSource";
import { ISAIAH_TWENTY_FIVE_PERSONAL_SECTIONS } from "./isaiahTwentyFiveSource";
import { ISAIAH_TWENTY_SIX_PERSONAL_SECTIONS } from "./isaiahTwentySixSource";
import { ISAIAH_TWENTY_SEVEN_PERSONAL_SECTIONS } from "./isaiahTwentySevenSource";
import { ISAIAH_TWENTY_EIGHT_PERSONAL_SECTIONS } from "./isaiahTwentyEightSource";
import { ISAIAH_TWENTY_NINE_PERSONAL_SECTIONS } from "./isaiahTwentyNineSource";
import { ISAIAH_THIRTY_PERSONAL_SECTIONS } from "./isaiahThirtySource";
import { ISAIAH_THIRTY_ONE_PERSONAL_SECTIONS } from "./isaiahThirtyOneSource";
import { ISAIAH_THIRTY_TWO_PERSONAL_SECTIONS } from "./isaiahThirtyTwoSource";
import { ISAIAH_THIRTY_THREE_PERSONAL_SECTIONS } from "./isaiahThirtyThreeSource";
import { ISAIAH_THIRTY_FOUR_PERSONAL_SECTIONS } from "./isaiahThirtyFourSource";
import { ISAIAH_THIRTY_FIVE_PERSONAL_SECTIONS } from "./isaiahThirtyFiveSource";
import { ISAIAH_THIRTY_SIX_PERSONAL_SECTIONS } from "./isaiahThirtySixSource";
import { ISAIAH_THIRTY_SEVEN_PERSONAL_SECTIONS } from "./isaiahThirtySevenSource";
import { ISAIAH_THIRTY_EIGHT_PERSONAL_SECTIONS } from "./isaiahThirtyEightSource";
import { ISAIAH_THIRTY_NINE_PERSONAL_SECTIONS } from "./isaiahThirtyNineSource";
import { ISAIAH_FORTY_PERSONAL_SECTIONS } from "./isaiahFortySource";
import { ISAIAH_FORTY_ONE_PERSONAL_SECTIONS } from "./isaiahFortyOneSource";
import { ISAIAH_FORTY_TWO_PERSONAL_SECTIONS } from "./isaiahFortyTwoSource";
import { ISAIAH_FORTY_THREE_PERSONAL_SECTIONS } from "./isaiahFortyThreeSource";
import { ISAIAH_FORTY_FOUR_PERSONAL_SECTIONS } from "./isaiahFortyFourSource";
import { ISAIAH_FORTY_FIVE_PERSONAL_SECTIONS } from "./isaiahFortyFiveSource";
import { ISAIAH_FORTY_SIX_PERSONAL_SECTIONS } from "./isaiahFortySixSource";
import { ISAIAH_FORTY_SEVEN_PERSONAL_SECTIONS } from "./isaiahFortySevenSource";
import { ISAIAH_FORTY_EIGHT_PERSONAL_SECTIONS } from "./isaiahFortyEightSource";
import { ISAIAH_FORTY_NINE_PERSONAL_SECTIONS } from "./isaiahFortyNineSource";
import { ISAIAH_FIFTY_PERSONAL_SECTIONS } from "./isaiahFiftySource";
import { ISAIAH_FIFTY_ONE_PERSONAL_SECTIONS } from "./isaiahFiftyOneSource";
import { ISAIAH_FIFTY_TWO_PERSONAL_SECTIONS } from "./isaiahFiftyTwoSource";
import { ISAIAH_FIFTY_THREE_PERSONAL_SECTIONS } from "./isaiahFiftyThreeSource";
import { ISAIAH_FIFTY_FOUR_PERSONAL_SECTIONS } from "./isaiahFiftyFourSource";
import { ISAIAH_FIFTY_FIVE_PERSONAL_SECTIONS } from "./isaiahFiftyFiveSource";
import { ISAIAH_FIFTY_SIX_PERSONAL_SECTIONS } from "./isaiahFiftySixSource";
import { ISAIAH_FIFTY_SEVEN_PERSONAL_SECTIONS } from "./isaiahFiftySevenSource";
import { ISAIAH_FIFTY_EIGHT_PERSONAL_SECTIONS } from "./isaiahFiftyEightSource";
...
import { ISAIAH_SIXTY_THREE_PERSONAL_SECTIONS } from "./isaiahSixtyThreeSource";
import { ISAIAH_SIXTY_FOUR_PERSONAL_SECTIONS } from "./isaiahSixtyFourSource";
import { ISAIAH_SIXTY_FIVE_PERSONAL_SECTIONS } from "./isaiahSixtyFiveSource";
import { ISAIAH_SIXTY_SIX_PERSONAL_SECTIONS } from "./isaiahSixtySixSource";
...
import { JEREMIAH_ONE_PERSONAL_SECTIONS } from "./jeremiahOneSource";
import { JEREMIAH_TWO_PERSONAL_SECTIONS } from "./jeremiahTwoSource";
import { JEREMIAH_THREE_PERSONAL_SECTIONS } from "./jeremiahThreeSource";
import { JEREMIAH_FOUR_PERSONAL_SECTIONS } from "./jeremiahFourSource";
import { JEREMIAH_FIVE_PERSONAL_SECTIONS } from "./jeremiahFiveSource";
import { JEREMIAH_SIX_PERSONAL_SECTIONS } from "./jeremiahSixSource";
import { JEREMIAH_SEVEN_PERSONAL_SECTIONS } from "./jeremiahSevenSource";
import { JEREMIAH_EIGHT_PERSONAL_SECTIONS } from "./jeremiahEightSource";
import { JEREMIAH_NINE_PERSONAL_SECTIONS } from "./jeremiahNineSource";
import { JEREMIAH_TEN_PERSONAL_SECTIONS } from "./jeremiahTenSource";
import { JEREMIAH_ELEVEN_PERSONAL_SECTIONS } from "./jeremiahElevenSource";
import { JEREMIAH_TWELVE_PERSONAL_SECTIONS } from "./jeremiahTwelveSource";
import { JEREMIAH_THIRTEEN_PERSONAL_SECTIONS } from "./jeremiahThirteenSource";
...
function makeExodusStudySection(section: ReaderStudySectionInput): BibleReaderStudySection {
  return {
    ...makeGenesisStudySection(section),
    book: "exodus",
  };
}

function makeLeviticusStudySection(section: ReaderStudySectionInput): BibleReaderStudySection {
  return {
    ...makeGenesisStudySection(section),
    book: "leviticus",
  };
...
function makePersonalPhraseSectionForBook(section: PersonalPhraseSectionInput, book: string): BibleReaderStudySection {
  const preserveExactPhraseBodies =
    ...
    (normalizeBook(book) === "jeremiah" && (section.chapter === 1 || section.chapter === 2 || section.chapter === 3 || section.chapter === 4 || section.chapter === 5 || section.chapter === 6 || section.chapter === 7 || section.chapter === 8 || section.chapter === 9 || section.chapter === 10 || section.chapter === 11 || section.chapter === 12 || section.chapter === 13 || section.chapter === 14));
...
function applyPersonalJudgesTenStudySections() {
  replaceStudySectionsForBookRange("judges", 10, 10, JUDGES_TEN_PERSONAL_SECTIONS);
}

function applyPersonalJudgesElevenStudySections() {
  replaceStudySectionsForBookRange("judges", 11, 11, JUDGES_ELEVEN_PERSONAL_SECTIONS);
}

function applyPersonalJudgesTwelveStudySections() {
  replaceStudySectionsForBookRange("judges", 12, 12, JUDGES_TWELVE_PERSONAL_SECTIONS);
}

function applyPersonalJudgesThirteenStudySections() {
  replaceStudySectionsForBookRange("judges", 13, 13, JUDGES_THIRTEEN_PERSONAL_SECTIONS);
}

function applyPersonalJudgesFourteenStudySections() {
  replaceStudySectionsForBookRange("judges", 14, 14, JUDGES_FOURTEEN_PERSONAL_SECTIONS);
}

function applyPersonalJudgesFifteenStudySections() {
  replaceStudySectionsForBookRange("judges", 15, 15, JUDGES_FIFTEEN_PERSONAL_SECTIONS);
}
...
function applyPersonalJudgesEighteenStudySections() {
  replaceStudySectionsForBookRange("judges", 18, 18, JUDGES_EIGHTEEN_PERSONAL_SECTIONS);
}

function applyPersonalJudgesNineteenStudySections() {
  replaceStudySectionsForBookRange("judges", 19, 19, JUDGES_NINETEEN_PERSONAL_SECTIONS);
}

function applyPersonalJudgesTwentyStudySections() {
  replaceStudySectionsForBookRange("judges", 20, 20, JUDGES_TWENTY_PERSONAL_SECTIONS);
}

function applyPersonalJudgesTwentyOneStudySections() {
  replaceStudySectionsForBookRange("judges", 21, 21, JUDGES_TWENTY_ONE_PERSONAL_SECTIONS);
}
...
function applyPersonalSecondSamuelOneStudySections() {
  replaceStudySectionsForBookRange("2 samuel", 1, 1, SECOND_SAMUEL_ONE_PERSONAL_SECTIONS);
}

function applyPersonalSecondSamuelTwoStudySections() {
  replaceStudySectionsForBookRange("2 samuel", 2, 2, SECOND_SAMUEL_TWO_PERSONAL_SECTIONS);
}

function applyPersonalSecondSamuelThreeStudySections() {
  replaceStudySectionsForBookRange("2 samuel", 3, 3, SECOND_SAMUEL_THREE_PERSONAL_SECTIONS);
}

function applyPersonalSecondSamuelFourStudySections() {
  replaceStudySectionsForBookRange("2 samuel", 4, 4, SECOND_SAMUEL_FOUR_PERSONAL_SECTIONS);
}

function applyPersonalSecondSamuelFiveStudySections() {
  replaceStudySectionsForBookRange("2 samuel", 5, 5, SECOND_SAMUEL_FIVE_PERSONAL_SECTIONS);
}

function applyPersonalSecondSamuelSixStudySections() {
  replaceStudySectionsForBookRange("2 samuel", 6, 6, SECOND_SAMUEL_SIX_PERSONAL_SECTIONS);
}

function applyPersonalSecondSamuelSevenStudySections() {
  replaceStudySectionsForBookRange("2 samuel", 7, 7, SECOND_SAMUEL_SEVEN_PERSONAL_SECTIONS);
}

function applyPersonalSecondSamuelEightStudySections() {
  replaceStudySectionsForBookRange("2 samuel", 8, 8, SECOND_SAMUEL_EIGHT_PERSONAL_SECTIONS);
}

function applyPersonalSecondSamuelNineStudySections() {
  replaceStudySectionsForBookRange("2 samuel", 9, 9, SECOND_SAMUEL_NINE_PERSONAL_SECTIONS);
}

function applyPersonalSecondSamuelTenStudySections() {
  replaceStudySectionsForBookRange("2 samuel", 10, 10, SECOND_SAMUEL_TEN_PERSONAL_SECTIONS);
}

function applyPersonalSecondSamuelElevenStudySections() {
  replaceStudySectionsForBookRange("2 samuel", 11, 11, SECOND_SAMUEL_ELEVEN_PERSONAL_SECTIONS);
}

function applyPersonalSecondSamuelTwelveStudySections() {
  replaceStudySectionsForBookRange("2 samuel", 12, 12, SECOND_SAMUEL_TWELVE_PERSONAL_SECTIONS);
}

function applyPersonalSecondSamuelThirteenStudySections() {
  replaceStudySectionsForBookRange("2 samuel", 13, 13, SECOND_SAMUEL_THIRTEEN_PERSONAL_SECTIONS);
}

function applyPersonalSecondSamuelFourteenStudySections() {
  replaceStudySectionsForBookRange("2 samuel", 14, 14, SECOND_SAMUEL_FOURTEEN_PERSONAL_SECTIONS);
  replaceStudySectionsForBookRange("2 samuel", 15, 15, SECOND_SAMUEL_FIFTEEN_PERSONAL_SECTIONS);
  ...
  replaceStudySectionsForBookRange("2 samuel", 20, 20, SECOND_SAMUEL_TWENTY_PERSONAL_SECTIONS);
  replaceStudySectionsForBookRange("2 samuel", 21, 21, SECOND_SAMUEL_TWENTY_ONE_PERSONAL_SECTIONS);
  replaceStudySectionsForBookRange("2 samuel", 22, 22, SECOND_SAMUEL_TWENTY_TWO_PERSONAL_SECTIONS);
  replaceStudySectionsForBookRange("2 samuel", 23, 23, SECOND_SAMUEL_TWENTY_THREE_PERSONAL_SECTIONS);
  replaceStudySectionsForBookRange("2 samuel", 24, 24, SECOND_SAMUEL_TWENTY_FOUR_PERSONAL_SECTIONS);
}
...
function applyPersonalFirstKingsOneStudySections() {
  replaceStudySectionsForBookRange("1 kings", 1, 1, FIRST_KINGS_ONE_PERSONAL_SECTIONS);
}
...
function applyPersonalFirstKingsFourStudySections() {
  replaceStudySectionsForBookRange("1 kings", 4, 4, FIRST_KINGS_FOUR_PERSONAL_SECTIONS);
}

function applyPersonalFirstKingsFiveStudySections() {
  replaceStudySectionsForBookRange("1 kings", 5, 5, FIRST_KINGS_FIVE_PERSONAL_SECTIONS);
}

function applyPersonalFirstKingsSixStudySections() {
  replaceStudySectionsForBookRange("1 kings", 6, 6, FIRST_KINGS_SIX_PERSONAL_SECTIONS);
}

function applyPersonalFirstKingsSevenStudySections() {
  replaceStudySectionsForBookRange("1 kings", 7, 7, FIRST_KINGS_SEVEN_PERSONAL_SECTIONS);
}

function applyPersonalFirstKingsEightStudySections() {
  replaceStudySectionsForBookRange("1 kings", 8, 8, FIRST_KINGS_EIGHT_PERSONAL_SECTIONS);
}

function applyPersonalFirstKingsNineStudySections() {
  replaceStudySectionsForBookRange("1 kings", 9, 9, FIRST_KINGS_NINE_PERSONAL_SECTIONS);
}

function applyPersonalFirstKingsTenStudySections() {
  replaceStudySectionsForBookRange("1 kings", 10, 10, FIRST_KINGS_TEN_PERSONAL_SECTIONS);
}
...
function applyPersonalFirstKingsFifteenStudySections() {
  replaceStudySectionsForBookRange("1 kings", 15, 15, FIRST_KINGS_FIFTEEN_PERSONAL_SECTIONS);
}
...
function applyPersonalFirstKingsSixteenStudySections() {
  replaceStudySectionsForBookRange("1 kings", 16, 16, FIRST_KINGS_SIXTEEN_PERSONAL_SECTIONS);
}

function applyPersonalFirstKingsSeventeenStudySections() {
  replaceStudySectionsForBookRange("1 kings", 17, 17, FIRST_KINGS_SEVENTEEN_PERSONAL_SECTIONS);
}

function applyPersonalFirstKingsEighteenStudySections() {
  replaceStudySectionsForBookRange("1 kings", 18, 18, FIRST_KINGS_EIGHTEEN_PERSONAL_SECTIONS);
}

function applyPersonalFirstKingsNineteenStudySections() {
  replaceStudySectionsForBookRange("1 kings", 19, 19, FIRST_KINGS_NINETEEN_PERSONAL_SECTIONS);
}

function applyPersonalFirstKingsTwentyStudySections() {
  replaceStudySectionsForBookRange("1 kings", 20, 20, FIRST_KINGS_TWENTY_PERSONAL_SECTIONS);
  replaceStudySectionsForBookRange("1 kings", 21, 21, FIRST_KINGS_TWENTY_ONE_PERSONAL_SECTIONS);
  replaceStudySectionsForBookRange("1 kings", 22, 22, FIRST_KINGS_TWENTY_TWO_PERSONAL_SECTIONS);
}
...
function applyPersonalSecondKingsOneStudySections() {
  replaceStudySectionsForBookRange("2 kings", 1, 1, SECOND_KINGS_ONE_PERSONAL_SECTIONS);
}

function applyPersonalSecondKingsTwoStudySections() {
  replaceStudySectionsForBookRange("2 kings", 2, 2, SECOND_KINGS_TWO_PERSONAL_SECTIONS);
}

function applyPersonalSecondKingsThreeStudySections() {
  replaceStudySectionsForBookRange("2 kings", 3, 3, SECOND_KINGS_THREE_PERSONAL_SECTIONS);
}

function applyPersonalSecondKingsFourStudySections() {
  replaceStudySectionsForBookRange("2 kings", 4, 4, SECOND_KINGS_FOUR_PERSONAL_SECTIONS);
}

function applyPersonalSecondKingsFiveStudySections() {
  replaceStudySectionsForBookRange("2 kings", 5, 5, SECOND_KINGS_FIVE_PERSONAL_SECTIONS);
}

function applyPersonalSecondKingsSixStudySections() {
  replaceStudySectionsForBookRange("2 kings", 6, 6, SECOND_KINGS_SIX_PERSONAL_SECTIONS);
}

function applyPersonalSecondKingsSevenStudySections() {
  replaceStudySectionsForBookRange("2 kings", 7, 7, SECOND_KINGS_SEVEN_PERSONAL_SECTIONS);
}

function applyPersonalSecondKingsEightStudySections() {
  replaceStudySectionsForBookRange("2 kings", 8, 8, SECOND_KINGS_EIGHT_PERSONAL_SECTIONS);
}

function applyPersonalSecondKingsNineStudySections() {
  replaceStudySectionsForBookRange("2 kings", 9, 9, SECOND_KINGS_NINE_PERSONAL_SECTIONS);
}

function applyPersonalSecondKingsTenStudySections() {
  replaceStudySectionsForBookRange("2 kings", 10, 10, SECOND_KINGS_TEN_PERSONAL_SECTIONS);
}

function applyPersonalSecondKingsElevenStudySections() {
  replaceStudySectionsForBookRange("2 kings", 11, 11, SECOND_KINGS_ELEVEN_PERSONAL_SECTIONS);
}

function applyPersonalSecondKingsTwelveStudySections() {
  replaceStudySectionsForBookRange("2 kings", 12, 12, SECOND_KINGS_TWELVE_PERSONAL_SECTIONS);
}

function applyPersonalSecondKingsThirteenStudySections() {
  replaceStudySectionsForBookRange("2 kings", 13, 13, SECOND_KINGS_THIRTEEN_PERSONAL_SECTIONS);
}

function applyPersonalSecondKingsFourteenStudySections() {
  replaceStudySectionsForBookRange("2 kings", 14, 14, SECOND_KINGS_FOURTEEN_PERSONAL_SECTIONS);
}

function applyPersonalSecondKingsFifteenStudySections() {
  replaceStudySectionsForBookRange("2 kings", 15, 15, SECOND_KINGS_FIFTEEN_PERSONAL_SECTIONS);
}

function applyPersonalSecondKingsSixteenStudySections() {
  replaceStudySectionsForBookRange("2 kings", 16, 16, SECOND_KINGS_SIXTEEN_PERSONAL_SECTIONS);
}

function applyPersonalSecondKingsSeventeenStudySections() {
  replaceStudySectionsForBookRange("2 kings", 17, 17, SECOND_KINGS_SEVENTEEN_PERSONAL_SECTIONS);
}

function applyPersonalSecondKingsEighteenStudySections() {
  replaceStudySectionsForBookRange("2 kings", 18, 18, SECOND_KINGS_EIGHTEEN_PERSONAL_SECTIONS);
}

function applyPersonalSecondKingsNineteenStudySections() {
  replaceStudySectionsForBookRange("2 kings", 19, 19, SECOND_KINGS_NINETEEN_PERSONAL_SECTIONS);
}

function applyPersonalSecondKingsTwentyStudySections() {
  replaceStudySectionsForBookRange("2 kings", 20, 20, SECOND_KINGS_TWENTY_PERSONAL_SECTIONS);
}

function applyPersonalSecondKingsTwentyOneStudySections() {
  replaceStudySectionsForBookRange("2 kings", 21, 21, SECOND_KINGS_TWENTY_ONE_PERSONAL_SECTIONS);
}

function applyPersonalSecondKingsTwentyTwoStudySections() {
  replaceStudySectionsForBookRange("2 kings", 22, 22, SECOND_KINGS_TWENTY_TWO_PERSONAL_SECTIONS);
}

function applyPersonalSecondKingsTwentyThreeStudySections() {
  replaceStudySectionsForBookRange("2 kings", 23, 23, SECOND_KINGS_TWENTY_THREE_PERSONAL_SECTIONS);
}

function applyPersonalSecondKingsTwentyFourStudySections() {
  replaceStudySectionsForBookRange("2 kings", 24, 24, SECOND_KINGS_TWENTY_FOUR_PERSONAL_SECTIONS);
}

function applyPersonalSecondKingsTwentyFiveStudySections() {
  replaceStudySectionsForBookRange("2 kings", 25, 25, SECOND_KINGS_TWENTY_FIVE_PERSONAL_SECTIONS);
}
...
function applyPersonalFirstChroniclesOneStudySections() {
  replaceStudySectionsForBookRange("1 chronicles", 1, 1, FIRST_CHRONICLES_ONE_PERSONAL_SECTIONS);
}

function applyPersonalFirstChroniclesTwoStudySections() {
  replaceStudySectionsForBookRange("1 chronicles", 2, 2, FIRST_CHRONICLES_TWO_PERSONAL_SECTIONS);
}

function applyPersonalFirstChroniclesThreeStudySections() {
  replaceStudySectionsForBookRange("1 chronicles", 3, 3, FIRST_CHRONICLES_THREE_PERSONAL_SECTIONS);
}

function applyPersonalFirstChroniclesFourStudySections() {
  replaceStudySectionsForBookRange("1 chronicles", 4, 4, FIRST_CHRONICLES_FOUR_PERSONAL_SECTIONS);
}

function applyPersonalFirstChroniclesFiveStudySections() {
  replaceStudySectionsForBookRange("1 chronicles", 5, 5, FIRST_CHRONICLES_FIVE_PERSONAL_SECTIONS);
}

function applyPersonalFirstChroniclesSixStudySections() {
  replaceStudySectionsForBookRange("1 chronicles", 6, 6, FIRST_CHRONICLES_SIX_PERSONAL_SECTIONS);
}

function applyPersonalFirstChroniclesSevenStudySections() {
  replaceStudySectionsForBookRange("1 chronicles", 7, 7, FIRST_CHRONICLES_SEVEN_PERSONAL_SECTIONS);
}

function applyPersonalFirstChroniclesEightStudySections() {
  replaceStudySectionsForBookRange("1 chronicles", 8, 8, FIRST_CHRONICLES_EIGHT_PERSONAL_SECTIONS);
}

function applyPersonalFirstChroniclesNineStudySections() {
  replaceStudySectionsForBookRange("1 chronicles", 9, 9, FIRST_CHRONICLES_NINE_PERSONAL_SECTIONS);
}

function applyPersonalFirstChroniclesTenStudySections() {
  replaceStudySectionsForBookRange("1 chronicles", 10, 10, FIRST_CHRONICLES_TEN_PERSONAL_SECTIONS);
}

function applyPersonalFirstChroniclesElevenStudySections() {
  replaceStudySectionsForBookRange("1 chronicles", 11, 11, FIRST_CHRONICLES_ELEVEN_PERSONAL_SECTIONS);
}

function applyPersonalFirstChroniclesTwelveStudySections() {
  replaceStudySectionsForBookRange("1 chronicles", 12, 12, FIRST_CHRONICLES_TWELVE_PERSONAL_SECTIONS);
}

function applyPersonalFirstChroniclesThirteenStudySections() {
  replaceStudySectionsForBookRange("1 chronicles", 13, 13, FIRST_CHRONICLES_THIRTEEN_PERSONAL_SECTIONS);
}

function applyPersonalFirstChroniclesFourteenStudySections() {
  replaceStudySectionsForBookRange("1 chronicles", 14, 14, FIRST_CHRONICLES_FOURTEEN_PERSONAL_SECTIONS);
}

function applyPersonalFirstChroniclesFifteenStudySections() {
  replaceStudySectionsForBookRange("1 chronicles", 15, 15, FIRST_CHRONICLES_FIFTEEN_PERSONAL_SECTIONS);
}

function applyPersonalFirstChroniclesSixteenStudySections() {
  replaceStudySectionsForBookRange("1 chronicles", 16, 16, FIRST_CHRONICLES_SIXTEEN_PERSONAL_SECTIONS);
}

function applyPersonalFirstChroniclesSeventeenStudySections() {
  replaceStudySectionsForBookRange("1 chronicles", 17, 17, FIRST_CHRONICLES_SEVENTEEN_PERSONAL_SECTIONS);
}

function applyPersonalFirstChroniclesEighteenStudySections() {
  replaceStudySectionsForBookRange("1 chronicles", 18, 18, FIRST_CHRONICLES_EIGHTEEN_PERSONAL_SECTIONS);
}
...
function applyPersonalFirstChroniclesTwentyOneStudySections() {
  replaceStudySectionsForBookRange("1 chronicles", 21, 21, FIRST_CHRONICLES_TWENTY_ONE_PERSONAL_SECTIONS);
}

function applyPersonalFirstChroniclesTwentyTwoStudySections() {
  replaceStudySectionsForBookRange("1 chronicles", 22, 22, FIRST_CHRONICLES_TWENTY_TWO_PERSONAL_SECTIONS);
}
...
function applyPersonalFirstChroniclesTwentyFiveStudySections() {
  replaceStudySectionsForBookRange("1 chronicles", 25, 25, FIRST_CHRONICLES_TWENTY_FIVE_PERSONAL_SECTIONS);
}

function applyPersonalFirstChroniclesTwentySixStudySections() {
  replaceStudySectionsForBookRange("1 chronicles", 26, 26, FIRST_CHRONICLES_TWENTY_SIX_PERSONAL_SECTIONS);
}

function applyPersonalFirstChroniclesTwentySevenStudySections() {
  replaceStudySectionsForBookRange("1 chronicles", 27, 27, FIRST_CHRONICLES_TWENTY_SEVEN_PERSONAL_SECTIONS);
}

function applyPersonalFirstChroniclesTwentyEightStudySections() {
  replaceStudySectionsForBookRange("1 chronicles", 28, 28, FIRST_CHRONICLES_TWENTY_EIGHT_PERSONAL_SECTIONS);
  replaceStudySectionsForBookRange("1 chronicles", 29, 29, FIRST_CHRONICLES_TWENTY_NINE_PERSONAL_SECTIONS);
}
...
function applyPersonalSecondChroniclesOneStudySections() {
  replaceStudySectionsForBookRange("2 chronicles", 1, 1, SECOND_CHRONICLES_ONE_PERSONAL_SECTIONS);
}

function applyPersonalSecondChroniclesTwoStudySections() {
  replaceStudySectionsForBookRange("2 chronicles", 2, 2, SECOND_CHRONICLES_TWO_PERSONAL_SECTIONS);
}

function applyPersonalSecondChroniclesThreeStudySections() {
  replaceStudySectionsForBookRange("2 chronicles", 3, 3, SECOND_CHRONICLES_THREE_PERSONAL_SECTIONS);
}

function applyPersonalSecondChroniclesFourStudySections() {
  replaceStudySectionsForBookRange("2 chronicles", 4, 4, SECOND_CHRONICLES_FOUR_PERSONAL_SECTIONS);
}

function applyPersonalSecondChroniclesFiveStudySections() {
  replaceStudySectionsForBookRange("2 chronicles", 5, 5, SECOND_CHRONICLES_FIVE_PERSONAL_SECTIONS);
}

function applyPersonalSecondChroniclesSixStudySections() {
  replaceStudySectionsForBookRange("2 chronicles", 6, 6, SECOND_CHRONICLES_SIX_PERSONAL_SECTIONS);
}

function applyPersonalSecondChroniclesSevenStudySections() {
...
function applyPersonalSecondChroniclesElevenStudySections() {
  replaceStudySectionsForBookRange("2 chronicles", 11, 11, SECOND_CHRONICLES_ELEVEN_PERSONAL_SECTIONS);
}

function applyPersonalSecondChroniclesTwelveStudySections() {
  replaceStudySectionsForBookRange("2 chronicles", 12, 12, SECOND_CHRONICLES_TWELVE_PERSONAL_SECTIONS);
}

function applyPersonalSecondChroniclesThirteenStudySections() {
  replaceStudySectionsForBookRange("2 chronicles", 13, 13, SECOND_CHRONICLES_THIRTEEN_PERSONAL_SECTIONS);
}

function applyPersonalSecondChroniclesFourteenStudySections() {
  ...
  replaceStudySectionsForBookRange("2 chronicles", 18, 18, SECOND_CHRONICLES_EIGHTEEN_PERSONAL_SECTIONS);
  replaceStudySectionsForBookRange("2 chronicles", 19, 19, SECOND_CHRONICLES_NINETEEN_PERSONAL_SECTIONS);
}
...
function applyPersonalSecondChroniclesTwentyStudySections() {
  replaceStudySectionsForBookRange("2 chronicles", 20, 20, SECOND_CHRONICLES_TWENTY_PERSONAL_SECTIONS);
}

function applyPersonalSecondChroniclesTwentyOneStudySections() {
  replaceStudySectionsForBookRange("2 chronicles", 21, 21, SECOND_CHRONICLES_TWENTY_ONE_PERSONAL_SECTIONS);
}

function applyPersonalSecondChroniclesTwentyTwoStudySections() {
  replaceStudySectionsForBookRange("2 chronicles", 22, 22, SECOND_CHRONICLES_TWENTY_TWO_PERSONAL_SECTIONS);
}

function applyPersonalSecondChroniclesTwentyThreeStudySections() {
  replaceStudySectionsForBookRange("2 chronicles", 23, 23, SECOND_CHRONICLES_TWENTY_THREE_PERSONAL_SECTIONS);
}

function applyPersonalSecondChroniclesTwentyFourStudySections() {
  replaceStudySectionsForBookRange("2 chronicles", 24, 24, SECOND_CHRONICLES_TWENTY_FOUR_PERSONAL_SECTIONS);
}

function applyPersonalSecondChroniclesTwentyFiveStudySections() {
  replaceStudySectionsForBookRange("2 chronicles", 25, 25, SECOND_CHRONICLES_TWENTY_FIVE_PERSONAL_SECTIONS);
}

function applyPersonalSecondChroniclesTwentySixStudySections() {
  replaceStudySectionsForBookRange("2 chronicles", 26, 26, SECOND_CHRONICLES_TWENTY_SIX_PERSONAL_SECTIONS);
}
...
function applyPersonalSecondChroniclesTwentySevenStudySections() {
  ...
  replaceStudySectionsForBookRange("2 chronicles", 29, 29, SECOND_CHRONICLES_TWENTY_NINE_PERSONAL_SECTIONS);
  replaceStudySectionsForBookRange("2 chronicles", 30, 30, SECOND_CHRONICLES_THIRTY_PERSONAL_SECTIONS);
}

function applyPersonalSecondChroniclesThirtyOneStudySections() {
  replaceStudySectionsForBookRange("2 chronicles", 31, 31, SECOND_CHRONICLES_THIRTY_ONE_PERSONAL_SECTIONS);
}

function applyPersonalSecondChroniclesThirtyTwoStudySections() {
  replaceStudySectionsForBookRange("2 chronicles", 32, 32, SECOND_CHRONICLES_THIRTY_TWO_PERSONAL_SECTIONS);
}

function applyPersonalSecondChroniclesThirtyThreeStudySections() {
  replaceStudySectionsForBookRange("2 chronicles", 33, 33, SECOND_CHRONICLES_THIRTY_THREE_PERSONAL_SECTIONS);
}

function applyPersonalSecondChroniclesThirtyFourStudySections() {
  replaceStudySectionsForBookRange("2 chronicles", 34, 34, SECOND_CHRONICLES_THIRTY_FOUR_PERSONAL_SECTIONS);
}
...
function applyPersonalEzraOneStudySections() {
  ...
  replaceStudySectionsForBookRange("ezra", 3, 3, EZRA_THREE_PERSONAL_SECTIONS);
}
...
function applyPersonalEzraFourStudySections() {
  replaceStudySectionsForBookRange("ezra", 4, 4, EZRA_FOUR_PERSONAL_SECTIONS);
}

function applyPersonalEzraFiveStudySections() {
  replaceStudySectionsForBookRange("ezra", 5, 5, EZRA_FIVE_PERSONAL_SECTIONS);
}

function applyPersonalEzraSixStudySections() {
  replaceStudySectionsForBookRange("ezra", 6, 6, EZRA_SIX_PERSONAL_SECTIONS);
}

function applyPersonalEzraSevenStudySections() {
  replaceStudySectionsForBookRange("ezra", 7, 7, EZRA_SEVEN_PERSONAL_SECTIONS);
}

function applyPersonalEzraEightStudySections() {
  replaceStudySectionsForBookRange("ezra", 8, 8, EZRA_EIGHT_PERSONAL_SECTIONS);
}

function applyPersonalEzraNineStudySections() {
  replaceStudySectionsForBookRange("ezra", 9, 9, EZRA_NINE_PERSONAL_SECTIONS);
}

function applyPersonalEzraTenStudySections() {
  replaceStudySectionsForBookRange("ezra", 10, 10, EZRA_TEN_PERSONAL_SECTIONS);
}

function applyPersonalNehemiahOneStudySections() {
  replaceStudySectionsForBookRange("nehemiah", 1, 1, NEHEMIAH_ONE_PERSONAL_SECTIONS);
}

function applyPersonalNehemiahTwoStudySections() {
  replaceStudySectionsForBookRange("nehemiah", 2, 2, NEHEMIAH_TWO_PERSONAL_SECTIONS);
}

function applyPersonalNehemiahThreeStudySections() {
  replaceStudySectionsForBookRange("nehemiah", 3, 3, NEHEMIAH_THREE_PERSONAL_SECTIONS);
}

function applyPersonalNehemiahFourStudySections() {
  replaceStudySectionsForBookRange("nehemiah", 4, 4, NEHEMIAH_FOUR_PERSONAL_SECTIONS);
}

function applyPersonalNehemiahFiveStudySections() {
  replaceStudySectionsForBookRange("nehemiah", 5, 5, NEHEMIAH_FIVE_PERSONAL_SECTIONS);
}

function applyPersonalNehemiahSixStudySections() {
  replaceStudySectionsForBookRange("nehemiah", 6, 6, NEHEMIAH_SIX_PERSONAL_SECTIONS);
}

function applyPersonalNehemiahSevenStudySections() {
  replaceStudySectionsForBookRange("nehemiah", 7, 7, NEHEMIAH_SEVEN_PERSONAL_SECTIONS);
}

function applyPersonalNehemiahEightStudySections() {
  replaceStudySectionsForBookRange("nehemiah", 8, 8, NEHEMIAH_EIGHT_PERSONAL_SECTIONS);
}

function applyPersonalNehemiahNineStudySections() {
  replaceStudySectionsForBookRange("nehemiah", 9, 9, NEHEMIAH_NINE_PERSONAL_SECTIONS);
}
...
function applyPersonalNehemiahTwelveStudySections() {
  replaceStudySectionsForBookRange("nehemiah", 12, 12, NEHEMIAH_TWELVE_PERSONAL_SECTIONS);
}

function applyPersonalNehemiahThirteenStudySections() {
  replaceStudySectionsForBookRange("nehemiah", 13, 13, NEHEMIAH_THIRTEEN_PERSONAL_SECTIONS);
}

function applyPersonalEstherOneChapterStudySections() {
  replaceStudySectionsForBookRange("esther", 1, 1, ESTHER_ONE_PERSONAL_SECTIONS);
}

function applyPersonalEstherTwoChapterStudySections() {
  replaceStudySectionsForBookRange("esther", 2, 2, ESTHER_TWO_PERSONAL_SECTIONS);
}

function applyPersonalEstherThreeChapterStudySections() {
  replaceStudySectionsForBookRange("esther", 3, 3, ESTHER_THREE_PERSONAL_SECTIONS);
}
...
function applyPersonalEstherEightChapterStudySections() {
  replaceStudySectionsForBookRange("esther", 8, 8, ESTHER_EIGHT_PERSONAL_SECTIONS);
}

function applyPersonalEstherNineChapterStudySections() {
  replaceStudySectionsForBookRange("esther", 9, 9, ESTHER_NINE_PERSONAL_SECTIONS);
}

function applyPersonalEstherTenChapterStudySections() {
  replaceStudySectionsForBookRange("esther", 10, 10, ESTHER_TEN_PERSONAL_SECTIONS);
}
...
function applyPersonalJobOneChapterStudySections() {
  replaceStudySectionsForBookRange("job", 1, 1, JOB_ONE_PERSONAL_SECTIONS);
}
...
function applyPersonalJobFourChapterStudySections() {
  replaceStudySectionsForBookRange("job", 4, 4, JOB_FOUR_PERSONAL_SECTIONS);
}

function applyPersonalJobFiveChapterStudySections() {
  replaceStudySectionsForBookRange("job", 5, 5, JOB_FIVE_PERSONAL_SECTIONS);
}

function applyPersonalJobSixChapterStudySections() {
  replaceStudySectionsForBookRange("job", 6, 6, JOB_SIX_PERSONAL_SECTIONS);
}

function applyPersonalJobSevenChapterStudySections() {
  replaceStudySectionsForBookRange("job", 7, 7, JOB_SEVEN_PERSONAL_SECTIONS);
}

function applyPersonalJobEightChapterStudySections() {
  replaceStudySectionsForBookRange("job", 8, 8, JOB_EIGHT_PERSONAL_SECTIONS);
}

function applyPersonalJobNineChapterStudySections() {
  replaceStudySectionsForBookRange("job", 9, 9, JOB_NINE_PERSONAL_SECTIONS);
}

function applyPersonalJobTenChapterStudySections() {
  replaceStudySectionsForBookRange("job", 10, 10, JOB_TEN_PERSONAL_SECTIONS);
}
...
function applyPersonalJobThirteenChapterStudySections() {
  replaceStudySectionsForBookRange("job", 13, 13, JOB_THIRTEEN_PERSONAL_SECTIONS);
}

function applyPersonalJobFourteenChapterStudySections() {
  replaceStudySectionsForBookRange("job", 14, 14, JOB_FOURTEEN_PERSONAL_SECTIONS);
}

function applyPersonalJobFifteenChapterStudySections() {
  replaceStudySectionsForBookRange("job", 15, 15, JOB_FIFTEEN_PERSONAL_SECTIONS);
}

function applyPersonalJobSixteenChapterStudySections() {
  replaceStudySectionsForBookRange("job", 16, 16, JOB_SIXTEEN_PERSONAL_SECTIONS);
}

function applyPersonalJobSeventeenChapterStudySections() {
  replaceStudySectionsForBookRange("job", 17, 17, JOB_SEVENTEEN_PERSONAL_SECTIONS);
}

function applyPersonalJobEighteenChapterStudySections() {
  replaceStudySectionsForBookRange("job", 18, 18, JOB_EIGHTEEN_PERSONAL_SECTIONS);
}

function applyPersonalJobNineteenChapterStudySections() {
  replaceStudySectionsForBookRange("job", 19, 19, JOB_NINETEEN_PERSONAL_SECTIONS);
}

function applyPersonalJobTwentyChapterStudySections() {
  replaceStudySectionsForBookRange("job", 20, 20, JOB_TWENTY_PERSONAL_SECTIONS);
}

function applyPersonalJobTwentyOneChapterStudySections() {
  replaceStudySectionsForBookRange("job", 21, 21, JOB_TWENTY_ONE_PERSONAL_SECTIONS);
}

function applyPersonalJobTwentyTwoChapterStudySections() {
  replaceStudySectionsForBookRange("job", 22, 22, JOB_TWENTY_TWO_PERSONAL_SECTIONS);
}

function applyPersonalJobTwentyThreeChapterStudySections() {
  replaceStudySectionsForBookRange("job", 23, 23, JOB_TWENTY_THREE_PERSONAL_SECTIONS);
}

function applyPersonalJobTwentyFourChapterStudySections() {
  replaceStudySectionsForBookRange("job", 24, 24, JOB_TWENTY_FOUR_PERSONAL_SECTIONS);
}
...
function applyPersonalJobTwentyFiveChapterStudySections() {
  ...
  replaceStudySectionsForBookRange("job", 28, 28, JOB_TWENTY_EIGHT_PERSONAL_SECTIONS);
  replaceStudySectionsForBookRange("job", 29, 29, JOB_TWENTY_NINE_PERSONAL_SECTIONS);
  replaceStudySectionsForBookRange("job", 30, 30, JOB_THIRTY_PERSONAL_SECTIONS);
}
...
function applyPersonalJobThirtyOneChapterStudySections() {
  replaceStudySectionsForBookRange("job", 31, 31, JOB_THIRTY_ONE_PERSONAL_SECTIONS);
}

function applyPersonalJobThirtyTwoChapterStudySections() {
  replaceStudySectionsForBookRange("job", 32, 32, JOB_THIRTY_TWO_PERSONAL_SECTIONS);
}

function applyPersonalJobThirtyThreeChapterStudySections() {
  replaceStudySectionsForBookRange("job", 33, 33, JOB_THIRTY_THREE_PERSONAL_SECTIONS);
}

function applyPersonalJobThirtyFourChapterStudySections() {
  replaceStudySectionsForBookRange("job", 34, 34, JOB_THIRTY_FOUR_PERSONAL_SECTIONS);
}

function applyPersonalJobThirtyFiveChapterStudySections() {
  replaceStudySectionsForBookRange("job", 35, 35, JOB_THIRTY_FIVE_PERSONAL_SECTIONS);
}

function applyPersonalJobThirtySixChapterStudySections() {
  replaceStudySectionsForBookRange("job", 36, 36, JOB_THIRTY_SIX_PERSONAL_SECTIONS);
}

function applyPersonalJobThirtySevenChapterStudySections() {
  replaceStudySectionsForBookRange("job", 37, 37, JOB_THIRTY_SEVEN_PERSONAL_SECTIONS);
}

function applyPersonalJobThirtyEightChapterStudySections() {
  replaceStudySectionsForBookRange("job", 38, 38, JOB_THIRTY_EIGHT_PERSONAL_SECTIONS);
}

function applyPersonalJobThirtyNineChapterStudySections() {
  replaceStudySectionsForBookRange("job", 39, 39, JOB_THIRTY_NINE_PERSONAL_SECTIONS);
}

function applyPersonalJobFortyChapterStudySections() {
  replaceStudySectionsForBookRange("job", 40, 40, JOB_FORTY_PERSONAL_SECTIONS);
}

function applyPersonalJobFortyOneChapterStudySections() {
  replaceStudySectionsForBookRange("job", 41, 41, JOB_FORTY_ONE_PERSONAL_SECTIONS);
}

function applyPersonalJobFortyTwoChapterStudySections() {
  replaceStudySectionsForBookRange("job", 42, 42, JOB_FORTY_TWO_PERSONAL_SECTIONS);
}
...
function applyPersonalPsalmsOneChapterStudySections() {
  replaceStudySectionsForBookRange("psalms", 1, 1, PSALMS_ONE_PERSONAL_SECTIONS);
}

function applyPersonalPsalmsTwoStudySections() {
  replaceStudySectionsForBookRange("psalms", 2, 2, PSALMS_TWO_PERSONAL_SECTIONS);
}

function applyPersonalPsalmsThreeStudySections() {
  replaceStudySectionsForBookRange("psalms", 3, 3, PSALMS_THREE_PERSONAL_SECTIONS);
}
...
function applyPersonalPsalmsSixStudySections() {
  replaceStudySectionsForBookRange("psalms", 6, 6, PSALMS_SIX_PERSONAL_SECTIONS);
}
...
function applyPersonalPsalmsSevenStudySections() {
  replaceStudySectionsForBookRange("psalms", 7, 7, PSALMS_SEVEN_PERSONAL_SECTIONS);
}

function applyPersonalPsalmsEightStudySections() {
  replaceStudySectionsForBookRange("psalms", 8, 8, PSALMS_EIGHT_PERSONAL_SECTIONS);
}

function applyPersonalPsalmsNineStudySections() {
  replaceStudySectionsForBookRange("psalms", 9, 9, PSALMS_NINE_PERSONAL_SECTIONS);
}

function applyPersonalPsalmsTenStudySections() {
  replaceStudySectionsForBookRange("psalms", 10, 10, PSALMS_TEN_PERSONAL_SECTIONS);
}

function applyPersonalPsalmsElevenStudySections() {
  replaceStudySectionsForBookRange("psalms", 11, 11, PSALMS_ELEVEN_PERSONAL_SECTIONS);
}

function applyPersonalPsalmsTwelveStudySections() {
  replaceStudySectionsForBookRange("psalms", 12, 12, PSALMS_TWELVE_PERSONAL_SECTIONS);
}

function applyPersonalPsalmsThirteenStudySections() {
  replaceStudySectionsForBookRange("psalms", 13, 13, PSALMS_THIRTEEN_PERSONAL_SECTIONS);
}

function applyPersonalPsalmsFourteenStudySections() {
  replaceStudySectionsForBookRange("psalms", 14, 14, PSALMS_FOURTEEN_PERSONAL_SECTIONS);
}

function applyPersonalPsalmsFifteenStudySections() {
  replaceStudySectionsForBookRange("psalms", 15, 15, PSALMS_FIFTEEN_PERSONAL_SECTIONS);
}

function applyPersonalPsalmsSixteenStudySections() {
  replaceStudySectionsForBookRange("psalms", 16, 16, PSALMS_SIXTEEN_PERSONAL_SECTIONS);
}

function applyPersonalPsalmsSeventeenStudySections() {
  replaceStudySectionsForBookRange("psalms", 17, 17, PSALMS_SEVENTEEN_PERSONAL_SECTIONS);
}

function applyPersonalPsalmsEighteenStudySections() {
  replaceStudySectionsForBookRange("psalms", 18, 18, PSALMS_EIGHTEEN_PERSONAL_SECTIONS);
}

function applyPersonalPsalmsNineteenStudySections() {
  replaceStudySectionsForBookRange("psalms", 19, 19, PSALMS_NINETEEN_PERSONAL_SECTIONS);
}

function applyPersonalPsalmsTwentyStudySections() {
  replaceStudySectionsForBookRange("psalms", 20, 20, PSALMS_TWENTY_PERSONAL_SECTIONS);
}

function applyPersonalPsalmsTwentyOneStudySections() {
  replaceStudySectionsForBookRange("psalms", 21, 21, PSALMS_TWENTY_ONE_PERSONAL_SECTIONS);
}

function applyPersonalPsalmsTwentyTwoStudySections() {
  replaceStudySectionsForBookRange("psalms", 22, 22, PSALMS_TWENTY_TWO_PERSONAL_SECTIONS);
}

function applyPersonalPsalmsTwentyThreeStudySections() {
  replaceStudySectionsForBookRange("psalms", 23, 23, PSALMS_TWENTY_THREE_PERSONAL_SECTIONS);
}

function applyPersonalPsalmsTwentyFourStudySections() {
  replaceStudySectionsForBookRange("psalms", 24, 24, PSALMS_TWENTY_FOUR_PERSONAL_SECTIONS);
}

function applyPersonalPsalmsTwentyFiveStudySections() {
  replaceStudySectionsForBookRange("psalms", 25, 25, PSALMS_TWENTY_FIVE_PERSONAL_SECTIONS);
}

function applyPersonalPsalmsTwentySixStudySections() {
  replaceStudySectionsForBookRange("psalms", 26, 26, PSALMS_TWENTY_SIX_PERSONAL_SECTIONS);
}

function applyPersonalPsalmsTwentySevenStudySections() {
  replaceStudySectionsForBookRange("psalms", 27, 27, PSALMS_TWENTY_SEVEN_PERSONAL_SECTIONS);
}

function applyPersonalPsalmsTwentyEightStudySections() {
  replaceStudySectionsForBookRange("psalms", 28, 28, PSALMS_TWENTY_EIGHT_PERSONAL_SECTIONS);
}

function applyPersonalPsalmsTwentyNineStudySections() {
  replaceStudySectionsForBookRange("psalms", 29, 29, PSALMS_TWENTY_NINE_PERSONAL_SECTIONS);
}

function applyPersonalPsalmsThirtyStudySections() {
  replaceStudySectionsForBookRange("psalms", 30, 30, PSALMS_THIRTY_PERSONAL_SECTIONS);
}

function applyPersonalPsalmsThirtyOneStudySections() {
  replaceStudySectionsForBookRange("psalms", 31, 31, PSALMS_THIRTY_ONE_PERSONAL_SECTIONS);
}

function applyPersonalPsalmsThirtyTwoStudySections() {
  replaceStudySectionsForBookRange("psalms", 32, 32, PSALMS_THIRTY_TWO_PERSONAL_SECTIONS);
}

function applyPersonalPsalmsThirtyThreeStudySections() {
  replaceStudySectionsForBookRange("psalms", 33, 33, PSALMS_THIRTY_THREE_PERSONAL_SECTIONS);
}

function applyPersonalPsalmsThirtyFourStudySections() {
  replaceStudySectionsForBookRange("psalms", 34, 34, PSALMS_THIRTY_FOUR_PERSONAL_SECTIONS);
}

function applyPersonalPsalmsThirtyFiveStudySections() {
  replaceStudySectionsForBookRange("psalms", 35, 35, PSALMS_THIRTY_FIVE_PERSONAL_SECTIONS);
}

function applyPersonalPsalmsThirtySixStudySections() {
  replaceStudySectionsForBookRange("psalms", 36, 36, PSALMS_THIRTY_SIX_PERSONAL_SECTIONS);
}

function applyPersonalPsalmsThirtySevenStudySections() {
  replaceStudySectionsForBookRange("psalms", 37, 37, PSALMS_THIRTY_SEVEN_PERSONAL_SECTIONS);
}

function applyPersonalPsalmsThirtyEightStudySections() {
  replaceStudySectionsForBookRange("psalms", 38, 38, PSALMS_THIRTY_EIGHT_PERSONAL_SECTIONS);
}

function applyPersonalPsalmsThirtyNineStudySections() {
  replaceStudySectionsForBookRange("psalms", 39, 39, PSALMS_THIRTY_NINE_PERSONAL_SECTIONS);
}

function applyPersonalPsalmsFortyStudySections() {
  replaceStudySectionsForBookRange("psalms", 40, 40, PSALMS_FORTY_PERSONAL_SECTIONS);
}

function applyPersonalPsalmsFortyOneStudySections() {
  replaceStudySectionsForBookRange("psalms", 41, 41, PSALMS_FORTY_ONE_PERSONAL_SECTIONS);
  replaceStudySectionsForBookRange("psalms", 42, 42, PSALMS_FORTY_TWO_PERSONAL_SECTIONS);
  replaceStudySectionsForBookRange("psalms", 43, 43, PSALMS_FORTY_THREE_PERSONAL_SECTIONS);
  replaceStudySectionsForBookRange("psalms", 44, 44, PSALMS_FORTY_FOUR_PERSONAL_SECTIONS);
  replaceStudySectionsForBookRange("psalms", 45, 45, PSALMS_FORTY_FIVE_PERSONAL_SECTIONS);
  replaceStudySectionsForBookRange("psalms", 46, 46, PSALMS_FORTY_SIX_PERSONAL_SECTIONS);
  replaceStudySectionsForBookRange("psalms", 47, 47, PSALMS_FORTY_SEVEN_PERSONAL_SECTIONS);
  replaceStudySectionsForBookRange("psalms", 48, 48, PSALMS_FORTY_EIGHT_PERSONAL_SECTIONS);
  replaceStudySectionsForBookRange("psalms", 49, 49, PSALMS_FORTY_NINE_PERSONAL_SECTIONS);
  replaceStudySectionsForBookRange("psalms", 50, 50, PSALMS_FIFTY_PERSONAL_SECTIONS);
  replaceStudySectionsForBookRange("psalms", 51, 51, PSALMS_FIFTY_ONE_PERSONAL_SECTIONS);
}
...
function applyPersonalPsalmsFiftyTwoStudySections() {
  replaceStudySectionsForBookRange("psalms", 52, 52, PSALMS_FIFTY_TWO_PERSONAL_SECTIONS);
}

function applyPersonalPsalmsFiftyThreeStudySections() {
  replaceStudySectionsForBookRange("psalms", 53, 53, PSALMS_FIFTY_THREE_PERSONAL_SECTIONS);
}

function applyPersonalPsalmsFiftyFourStudySections() {
  replaceStudySectionsForBookRange("psalms", 54, 54, PSALMS_FIFTY_FOUR_PERSONAL_SECTIONS);
}

function applyPersonalPsalmsFiftyFiveStudySections() {
  replaceStudySectionsForBookRange("psalms", 55, 55, PSALMS_FIFTY_FIVE_PERSONAL_SECTIONS);
}

function applyPersonalPsalmsFiftySixStudySections() {
  replaceStudySectionsForBookRange("psalms", 56, 56, PSALMS_FIFTY_SIX_PERSONAL_SECTIONS);
}

function applyPersonalPsalmsFiftySevenStudySections() {
  replaceStudySectionsForBookRange("psalms", 57, 57, PSALMS_FIFTY_SEVEN_PERSONAL_SECTIONS);
}

function applyPersonalPsalmsFiftyEightStudySections() {
  replaceStudySectionsForBookRange("psalms", 58, 58, PSALMS_FIFTY_EIGHT_PERSONAL_SECTIONS);
}

function applyPersonalPsalmsFiftyNineStudySections() {
  replaceStudySectionsForBookRange("psalms", 59, 59, PSALMS_FIFTY_NINE_PERSONAL_SECTIONS);
}

function applyPersonalPsalmsSixtyStudySections() {
  replaceStudySectionsForBookRange("psalms", 60, 60, PSALMS_SIXTY_PERSONAL_SECTIONS);
}

function applyPersonalPsalmsSixtyOneStudySections() {
  replaceStudySectionsForBookRange("psalms", 61, 61, PSALMS_SIXTY_ONE_PERSONAL_SECTIONS);
}

function applyPersonalPsalmsSixtyTwoStudySections() {
  replaceStudySectionsForBookRange("psalms", 62, 62, PSALMS_SIXTY_TWO_PERSONAL_SECTIONS);
}

function applyPersonalPsalmsSixtyThreeStudySections() {
  replaceStudySectionsForBookRange("psalms", 63, 63, PSALMS_SIXTY_THREE_PERSONAL_SECTIONS);
}

function applyPersonalPsalmsSixtyFourStudySections() {
  replaceStudySectionsForBookRange("psalms", 64, 64, PSALMS_SIXTY_FOUR_PERSONAL_SECTIONS);
}

function applyPersonalPsalmsSixtyFiveStudySections() {
  replaceStudySectionsForBookRange("psalms", 65, 65, PSALMS_SIXTY_FIVE_PERSONAL_SECTIONS);
}

function applyPersonalPsalmsSixtySixStudySections() {
  replaceStudySectionsForBookRange("psalms", 66, 66, PSALMS_SIXTY_SIX_PERSONAL_SECTIONS);
}

function applyPersonalPsalmsSixtySevenStudySections() {
  replaceStudySectionsForBookRange("psalms", 67, 67, PSALMS_SIXTY_SEVEN_PERSONAL_SECTIONS);
}

function applyPersonalPsalmsSixtyEightStudySections() {
  replaceStudySectionsForBookRange("psalms", 68, 68, PSALMS_SIXTY_EIGHT_PERSONAL_SECTIONS);
}

function applyPersonalPsalmsSixtyNineStudySections() {
  replaceStudySectionsForBookRange("psalms", 69, 69, PSALMS_SIXTY_NINE_PERSONAL_SECTIONS);
}

function applyPersonalPsalmsSeventyStudySections() {
  replaceStudySectionsForBookRange("psalms", 70, 70, PSALMS_SEVENTY_PERSONAL_SECTIONS);
}

function applyPersonalPsalmsSeventyOneStudySections() {
  replaceStudySectionsForBookRange("psalms", 71, 71, PSALMS_SEVENTY_ONE_PERSONAL_SECTIONS);
}

function applyPersonalPsalmsSeventyTwoStudySections() {
  replaceStudySectionsForBookRange("psalms", 72, 72, PSALMS_SEVENTY_TWO_PERSONAL_SECTIONS);
}

function applyPersonalPsalmsSeventyThreeStudySections() {
  replaceStudySectionsForBookRange("psalms", 73, 73, PSALMS_SEVENTY_THREE_PERSONAL_SECTIONS);
}

function applyPersonalPsalmsSeventyFourStudySections() {
  replaceStudySectionsForBookRange("psalms", 74, 74, PSALMS_SEVENTY_FOUR_PERSONAL_SECTIONS);
}

function applyPersonalPsalmsSeventyFiveStudySections() {
  replaceStudySectionsForBookRange("psalms", 75, 75, PSALMS_SEVENTY_FIVE_PERSONAL_SECTIONS);
}

function applyPersonalPsalmsSeventySixStudySections() {
  replaceStudySectionsForBookRange("psalms", 76, 76, PSALMS_SEVENTY_SIX_PERSONAL_SECTIONS);
}

function applyPersonalPsalmsSeventySevenStudySections() {
  replaceStudySectionsForBookRange("psalms", 77, 77, PSALMS_SEVENTY_SEVEN_PERSONAL_SECTIONS);
}

function applyPersonalPsalmsSeventyEightStudySections() {
  replaceStudySectionsForBookRange("psalms", 78, 78, PSALMS_SEVENTY_EIGHT_PERSONAL_SECTIONS);
}

function applyPersonalPsalmsSeventyNineStudySections() {
  replaceStudySectionsForBookRange("psalms", 79, 79, PSALMS_SEVENTY_NINE_PERSONAL_SECTIONS);
}

function applyPersonalPsalmsEightyStudySections() {
  replaceStudySectionsForBookRange("psalms", 80, 80, PSALMS_EIGHTY_PERSONAL_SECTIONS);
}

function applyPersonalPsalmsEightyOneStudySections() {
  replaceStudySectionsForBookRange("psalms", 81, 81, PSALMS_EIGHTY_ONE_PERSONAL_SECTIONS);
}

function applyPersonalPsalmsEightyTwoStudySections() {
  replaceStudySectionsForBookRange("psalms", 82, 82, PSALMS_EIGHTY_TWO_PERSONAL_SECTIONS);
}

function applyPersonalPsalmsEightyThreeStudySections() {
  replaceStudySectionsForBookRange("psalms", 83, 83, PSALMS_EIGHTY_THREE_PERSONAL_SECTIONS);
}

function applyPersonalPsalmsEightyFourStudySections() {
  replaceStudySectionsForBookRange("psalms", 84, 84, PSALMS_EIGHTY_FOUR_PERSONAL_SECTIONS);
}

function applyPersonalPsalmsEightyFiveStudySections() {
  replaceStudySectionsForBookRange("psalms", 85, 85, PSALMS_EIGHTY_FIVE_PERSONAL_SECTIONS);
}

function applyPersonalPsalmsEightySixStudySections() {
  replaceStudySectionsForBookRange("psalms", 86, 86, PSALMS_EIGHTY_SIX_PERSONAL_SECTIONS);
}
...
function applyPersonalPsalmsEightyNineStudySections() {
  replaceStudySectionsForBookRange("psalms", 89, 89, PSALMS_EIGHTY_NINE_PERSONAL_SECTIONS);
}

function applyPersonalPsalmsNinetyStudySections() {
  replaceStudySectionsForBookRange("psalms", 90, 90, PSALMS_NINETY_PERSONAL_SECTIONS);
}

function applyPersonalPsalmsNinetyOneStudySections() {
  replaceStudySectionsForBookRange("psalms", 91, 91, PSALMS_NINETY_ONE_PERSONAL_SECTIONS);
}

function applyPersonalPsalmsNinetyTwoStudySections() {
  replaceStudySectionsForBookRange("psalms", 92, 92, PSALMS_NINETY_TWO_PERSONAL_SECTIONS);
}

function applyPersonalPsalmsNinetyThreeStudySections() {
  replaceStudySectionsForBookRange("psalms", 93, 93, PSALMS_NINETY_THREE_PERSONAL_SECTIONS);
}

function applyPersonalPsalmsNinetyFourStudySections() {
  replaceStudySectionsForBookRange("psalms", 94, 94, PSALMS_NINETY_FOUR_PERSONAL_SECTIONS);
}

function applyPersonalPsalmsNinetyFiveStudySections() {
  replaceStudySectionsForBookRange("psalms", 95, 95, PSALMS_NINETY_FIVE_PERSONAL_SECTIONS);
}

function applyPersonalPsalmsNinetySixStudySections() {
  replaceStudySectionsForBookRange("psalms", 96, 96, PSALMS_NINETY_SIX_PERSONAL_SECTIONS);
}
...
function applyPersonalPsalmsNinetySevenStudySections() {
  replaceStudySectionsForBookRange("psalms", 97, 97, PSALMS_NINETY_SEVEN_PERSONAL_SECTIONS);
}

function applyPersonalPsalmsNinetyEightStudySections() {
  replaceStudySectionsForBookRange("psalms", 98, 98, PSALMS_NINETY_EIGHT_PERSONAL_SECTIONS);
}

function applyPersonalPsalmsNinetyNineStudySections() {
  replaceStudySectionsForBookRange("psalms", 99, 99, PSALMS_NINETY_NINE_PERSONAL_SECTIONS);
}

function applyPersonalPsalmsOneHundredStudySections() {
  replaceStudySectionsForBookRange("psalms", 100, 100, PSALMS_ONE_HUNDRED_PERSONAL_SECTIONS);
  replaceStudySectionsForBookRange("psalms", 101, 101, PSALMS_ONE_HUNDRED_ONE_PERSONAL_SECTIONS);
  replaceStudySectionsForBookRange("psalms", 102, 102, PSALMS_ONE_HUNDRED_TWO_PERSONAL_SECTIONS);
  replaceStudySectionsForBookRange("psalms", 103, 103, PSALMS_ONE_HUNDRED_THREE_PERSONAL_SECTIONS);
  replaceStudySectionsForBookRange("psalms", 104, 104, PSALMS_ONE_HUNDRED_FOUR_PERSONAL_SECTIONS);
  replaceStudySectionsForBookRange("psalms", 105, 105, PSALMS_ONE_HUNDRED_FIVE_PERSONAL_SECTIONS);
  replaceStudySectionsForBookRange("psalms", 106, 106, PSALMS_ONE_HUNDRED_SIX_PERSONAL_SECTIONS);
  replaceStudySectionsForBookRange("psalms", 107, 107, PSALMS_ONE_HUNDRED_SEVEN_PERSONAL_SECTIONS);
  replaceStudySectionsForBookRange("psalms", 108, 108, PSALMS_ONE_HUNDRED_EIGHT_PERSONAL_SECTIONS);
  replaceStudySectionsForBookRange("psalms", 109, 109, PSALMS_ONE_HUNDRED_NINE_PERSONAL_SECTIONS);
  replaceStudySectionsForBookRange("psalms", 110, 110, PSALMS_ONE_HUNDRED_TEN_PERSONAL_SECTIONS);
  replaceStudySectionsForBookRange("psalms", 111, 111, PSALMS_ONE_HUNDRED_ELEVEN_PERSONAL_SECTIONS);
  replaceStudySectionsForBookRange("psalms", 112, 112, PSALMS_ONE_HUNDRED_TWELVE_PERSONAL_SECTIONS);
  replaceStudySectionsForBookRange("psalms", 113, 113, PSALMS_ONE_HUNDRED_THIRTEEN_PERSONAL_SECTIONS);
  replaceStudySectionsForBookRange("psalms", 114, 114, PSALMS_ONE_HUNDRED_FOURTEEN_PERSONAL_SECTIONS);
  ...
  replaceStudySectionsForBookRange("psalms", 122, 122, PSALMS_ONE_HUNDRED_TWENTY_TWO_PERSONAL_SECTIONS);
  replaceStudySectionsForBookRange("psalms", 123, 123, PSALMS_ONE_HUNDRED_TWENTY_THREE_PERSONAL_SECTIONS);
  replaceStudySectionsForBookRange("psalms", 124, 124, PSALMS_ONE_HUNDRED_TWENTY_FOUR_PERSONAL_SECTIONS);
  replaceStudySectionsForBookRange("psalms", 125, 125, PSALMS_ONE_HUNDRED_TWENTY_FIVE_PERSONAL_SECTIONS);
  replaceStudySectionsForBookRange("psalms", 126, 126, PSALMS_ONE_HUNDRED_TWENTY_SIX_PERSONAL_SECTIONS);
}
...
function applyPersonalPsalmsOneHundredTwentySevenStudySections() {
  replaceStudySectionsForBookRange("psalms", 127, 127, PSALMS_ONE_HUNDRED_TWENTY_SEVEN_PERSONAL_SECTIONS);
}

function applyPersonalPsalmsOneHundredTwentyEightStudySections() {
  replaceStudySectionsForBookRange("psalms", 128, 128, PSALMS_ONE_HUNDRED_TWENTY_EIGHT_PERSONAL_SECTIONS);
}

function applyPersonalPsalmsOneHundredTwentyNineStudySections() {
  replaceStudySectionsForBookRange("psalms", 129, 129, PSALMS_ONE_HUNDRED_TWENTY_NINE_PERSONAL_SECTIONS);
}

function applyPersonalPsalmsOneHundredThirtyStudySections() {
  replaceStudySectionsForBookRange("psalms", 130, 130, PSALMS_ONE_HUNDRED_THIRTY_PERSONAL_SECTIONS);
}

function applyPersonalPsalmsOneHundredThirtyOneStudySections() {
  replaceStudySectionsForBookRange("psalms", 131, 131, PSALMS_ONE_HUNDRED_THIRTY_ONE_PERSONAL_SECTIONS);
}

function applyPersonalPsalmsOneHundredThirtyTwoStudySections() {
  replaceStudySectionsForBookRange("psalms", 132, 132, PSALMS_ONE_HUNDRED_THIRTY_TWO_PERSONAL_SECTIONS);
  replaceStudySectionsForBookRange("psalms", 133, 133, PSALMS_ONE_HUNDRED_THIRTY_THREE_PERSONAL_SECTIONS);
}

function applyPersonalPsalmsOneHundredThirtyFourStudySections() {
  replaceStudySectionsForBookRange("psalms", 134, 134, PSALMS_ONE_HUNDRED_THIRTY_FOUR_PERSONAL_SECTIONS);
}

function applyPersonalPsalmsOneHundredThirtyFiveStudySections() {
  replaceStudySectionsForBookRange("psalms", 135, 135, PSALMS_ONE_HUNDRED_THIRTY_FIVE_PERSONAL_SECTIONS);
}

function applyPersonalPsalmsOneHundredThirtySixStudySections() {
  replaceStudySectionsForBookRange("psalms", 136, 136, PSALMS_ONE_HUNDRED_THIRTY_SIX_PERSONAL_SECTIONS);
}

function applyPersonalPsalmsOneHundredThirtySevenStudySections() {
  replaceStudySectionsForBookRange("psalms", 137, 137, PSALMS_ONE_HUNDRED_THIRTY_SEVEN_PERSONAL_SECTIONS);
}

function applyPersonalPsalmsOneHundredThirtyEightStudySections() {
  replaceStudySectionsForBookRange("psalms", 138, 138, PSALMS_ONE_HUNDRED_THIRTY_EIGHT_PERSONAL_SECTIONS);
}

function applyPersonalPsalmsOneHundredThirtyNineStudySections() {
  replaceStudySectionsForBookRange("psalms", 139, 139, PSALMS_ONE_HUNDRED_THIRTY_NINE_PERSONAL_SECTIONS);
}

function applyPersonalPsalmsOneHundredFortyStudySections() {
  replaceStudySectionsForBookRange("psalms", 140, 140, PSALMS_ONE_HUNDRED_FORTY_PERSONAL_SECTIONS);
}

function applyPersonalPsalmsOneHundredFortyOneStudySections() {
  replaceStudySectionsForBookRange("psalms", 141, 141, PSALMS_ONE_HUNDRED_FORTY_ONE_PERSONAL_SECTIONS);
}

function applyPersonalPsalmsOneHundredFortyTwoStudySections() {
  replaceStudySectionsForBookRange("psalms", 142, 142, PSALMS_ONE_HUNDRED_FORTY_TWO_PERSONAL_SECTIONS);
}

function applyPersonalPsalmsOneHundredFortyThreeStudySections() {
  replaceStudySectionsForBookRange("psalms", 143, 143, PSALMS_ONE_HUNDRED_FORTY_THREE_PERSONAL_SECTIONS);
}

function applyPersonalPsalmsOneHundredFortyFourStudySections() {
  replaceStudySectionsForBookRange("psalms", 144, 144, PSALMS_ONE_HUNDRED_FORTY_FOUR_PERSONAL_SECTIONS);
}

function applyPersonalPsalmsOneHundredFortyFiveStudySections() {
  replaceStudySectionsForBookRange("psalms", 145, 145, PSALMS_ONE_HUNDRED_FORTY_FIVE_PERSONAL_SECTIONS);
}

function applyPersonalPsalmsOneHundredFortySixStudySections() {
  replaceStudySectionsForBookRange("psalms", 146, 146, PSALMS_ONE_HUNDRED_FORTY_SIX_PERSONAL_SECTIONS);
}

function applyPersonalPsalmsOneHundredFortySevenStudySections() {
  replaceStudySectionsForBookRange("psalms", 147, 147, PSALMS_ONE_HUNDRED_FORTY_SEVEN_PERSONAL_SECTIONS);
}

function applyPersonalPsalmsOneHundredFortyEightStudySections() {
  replaceStudySectionsForBookRange("psalms", 148, 148, PSALMS_ONE_HUNDRED_FORTY_EIGHT_PERSONAL_SECTIONS);
}

function applyPersonalPsalmsOneHundredFortyNineStudySections() {
  replaceStudySectionsForBookRange("psalms", 149, 149, PSALMS_ONE_HUNDRED_FORTY_NINE_PERSONAL_SECTIONS);
}

function applyPersonalPsalmsOneHundredFiftyStudySections() {
  replaceStudySectionsForBookRange("psalms", 150, 150, PSALMS_ONE_HUNDRED_FIFTY_PERSONAL_SECTIONS);
}
...
function applyPersonalProverbsOneStudySections() {
  replaceStudySectionsForBookRange("proverbs", 1, 1, PROVERBS_ONE_PERSONAL_SECTIONS);
}

function applyPersonalProverbsTwoStudySections() {
  replaceStudySectionsForBookRange("proverbs", 2, 2, PROVERBS_TWO_PERSONAL_SECTIONS);
}

function applyPersonalProverbsThreeStudySections() {
  replaceStudySectionsForBookRange("proverbs", 3, 3, PROVERBS_THREE_PERSONAL_SECTIONS);
}

function applyPersonalProverbsFourStudySections() {
  replaceStudySectionsForBookRange("proverbs", 4, 4, PROVERBS_FOUR_PERSONAL_SECTIONS);
}

function applyPersonalProverbsFiveStudySections() {
  replaceStudySectionsForBookRange("proverbs", 5, 5, PROVERBS_FIVE_PERSONAL_SECTIONS);
}

function applyPersonalProverbsSixStudySections() {
  replaceStudySectionsForBookRange("proverbs", 6, 6, PROVERBS_SIX_PERSONAL_SECTIONS);
}

function applyPersonalProverbsSevenStudySections() {
  replaceStudySectionsForBookRange("proverbs", 7, 7, PROVERBS_SEVEN_PERSONAL_SECTIONS);
}

function applyPersonalProverbsEightStudySections() {
  replaceStudySectionsForBookRange("proverbs", 8, 8, PROVERBS_EIGHT_PERSONAL_SECTIONS);
}

function applyPersonalProverbsNineStudySections() {
  replaceStudySectionsForBookRange("proverbs", 9, 9, PROVERBS_NINE_PERSONAL_SECTIONS);
}

function applyPersonalProverbsTenStudySections() {
  replaceStudySectionsForBookRange("proverbs", 10, 10, PROVERBS_TEN_PERSONAL_SECTIONS);
  replaceStudySectionsForBookRange("proverbs", 11, 11, PROVERBS_ELEVEN_PERSONAL_SECTIONS);
  replaceStudySectionsForBookRange("proverbs", 12, 12, PROVERBS_TWELVE_PERSONAL_SECTIONS);
  replaceStudySectionsForBookRange("proverbs", 13, 13, PROVERBS_THIRTEEN_PERSONAL_SECTIONS);
  ...
  replaceStudySectionsForBookRange("proverbs", 18, 18, PROVERBS_EIGHTEEN_PERSONAL_SECTIONS);
  replaceStudySectionsForBookRange("proverbs", 19, 19, PROVERBS_NINETEEN_PERSONAL_SECTIONS);
  replaceStudySectionsForBookRange("proverbs", 20, 20, PROVERBS_TWENTY_PERSONAL_SECTIONS);
  replaceStudySectionsForBookRange("proverbs", 21, 21, PROVERBS_TWENTY_ONE_PERSONAL_SECTIONS);
  replaceStudySectionsForBookRange("proverbs", 22, 22, PROVERBS_TWENTY_TWO_PERSONAL_SECTIONS);
  replaceStudySectionsForBookRange("proverbs", 23, 23, PROVERBS_TWENTY_THREE_PERSONAL_SECTIONS);
  replaceStudySectionsForBookRange("proverbs", 24, 24, PROVERBS_TWENTY_FOUR_PERSONAL_SECTIONS);
  replaceStudySectionsForBookRange("proverbs", 25, 25, PROVERBS_TWENTY_FIVE_PERSONAL_SECTIONS);
  replaceStudySectionsForBookRange("proverbs", 26, 26, PROVERBS_TWENTY_SIX_PERSONAL_SECTIONS);
  replaceStudySectionsForBookRange("proverbs", 27, 27, PROVERBS_TWENTY_SEVEN_PERSONAL_SECTIONS);
  replaceStudySectionsForBookRange("proverbs", 28, 28, PROVERBS_TWENTY_EIGHT_PERSONAL_SECTIONS);
  replaceStudySectionsForBookRange("proverbs", 29, 29, PROVERBS_TWENTY_NINE_PERSONAL_SECTIONS);
  replaceStudySectionsForBookRange("proverbs", 30, 30, PROVERBS_THIRTY_PERSONAL_SECTIONS);
  replaceStudySectionsForBookRange("proverbs", 31, 31, PROVERBS_THIRTY_ONE_PERSONAL_SECTIONS);
}
...
function applyPersonalEcclesiastesOneStudySections() {
  replaceStudySectionsForBookRange("ecclesiastes", 1, 1, ECCLESIASTES_ONE_PERSONAL_SECTIONS);
}

function applyPersonalEcclesiastesTwoStudySections() {
  replaceStudySectionsForBookRange("ecclesiastes", 2, 2, ECCLESIASTES_TWO_PERSONAL_SECTIONS);
}

function applyPersonalEcclesiastesThreeStudySections() {
  replaceStudySectionsForBookRange("ecclesiastes", 3, 3, ECCLESIASTES_THREE_PERSONAL_SECTIONS);
}

function applyPersonalEcclesiastesFourStudySections() {
  replaceStudySectionsForBookRange("ecclesiastes", 4, 4, ECCLESIASTES_FOUR_PERSONAL_SECTIONS);
}

function applyPersonalEcclesiastesFiveStudySections() {
  replaceStudySectionsForBookRange("ecclesiastes", 5, 5, ECCLESIASTES_FIVE_PERSONAL_SECTIONS);
}

function applyPersonalEcclesiastesSixStudySections() {
  replaceStudySectionsForBookRange("ecclesiastes", 6, 6, ECCLESIASTES_SIX_PERSONAL_SECTIONS);
}

function applyPersonalEcclesiastesSevenStudySections() {
  replaceStudySectionsForBookRange("ecclesiastes", 7, 7, ECCLESIASTES_SEVEN_PERSONAL_SECTIONS);
}

function applyPersonalEcclesiastesEightStudySections() {
  replaceStudySectionsForBookRange("ecclesiastes", 8, 8, ECCLESIASTES_EIGHT_PERSONAL_SECTIONS);
}
...
function applyPersonalEcclesiastesElevenStudySections() {
  replaceStudySectionsForBookRange("ecclesiastes", 11, 11, ECCLESIASTES_ELEVEN_PERSONAL_SECTIONS);
}

function applyPersonalEcclesiastesTwelveStudySections() {
  replaceStudySectionsForBookRange("ecclesiastes", 12, 12, ECCLESIASTES_TWELVE_PERSONAL_SECTIONS);
}
...
function applyPersonalSongOfSolomonOneStudySections() {
  replaceStudySectionsForBookRange("song of solomon", 1, 1, SONG_OF_SOLOMON_ONE_PERSONAL_SECTIONS);
}

function applyPersonalSongOfSolomonTwoStudySections() {
  replaceStudySectionsForBookRange("song of solomon", 2, 2, SONG_OF_SOLOMON_TWO_PERSONAL_SECTIONS);
}
...
function applyPersonalSongOfSolomonFiveStudySections() {
  replaceStudySectionsForBookRange("song of solomon", 5, 5, SONG_OF_SOLOMON_FIVE_PERSONAL_SECTIONS);
}

function applyPersonalSongOfSolomonSixStudySections() {
  replaceStudySectionsForBookRange("song of solomon", 6, 6, SONG_OF_SOLOMON_SIX_PERSONAL_SECTIONS);
}

function applyPersonalSongOfSolomonSevenStudySections() {
  replaceStudySectionsForBookRange("song of solomon", 7, 7, SONG_OF_SOLOMON_SEVEN_PERSONAL_SECTIONS);
}

function applyPersonalSongOfSolomonEightStudySections() {
  replaceStudySectionsForBookRange("song of solomon", 8, 8, SONG_OF_SOLOMON_EIGHT_PERSONAL_SECTIONS);
}
...
function applyPersonalIsaiahOneStudySections() {
  replaceStudySectionsForBookRange("isaiah", 1, 1, ISAIAH_ONE_PERSONAL_SECTIONS);
}

function applyPersonalIsaiahTwoStudySections() {
  replaceStudySectionsForBookRange("isaiah", 2, 2, ISAIAH_TWO_PERSONAL_SECTIONS);
}

function applyPersonalIsaiahThreeStudySections() {
  replaceStudySectionsForBookRange("isaiah", 3, 3, ISAIAH_THREE_PERSONAL_SECTIONS);
}
...
function applyPersonalIsaiahSixStudySections() {
  replaceStudySectionsForBookRange("isaiah", 6, 6, ISAIAH_SIX_PERSONAL_SECTIONS);
}

function applyPersonalIsaiahSevenStudySections() {
  replaceStudySectionsForBookRange("isaiah", 7, 7, ISAIAH_SEVEN_PERSONAL_SECTIONS);
}

function applyPersonalIsaiahEightStudySections() {
  replaceStudySectionsForBookRange("isaiah", 8, 8, ISAIAH_EIGHT_PERSONAL_SECTIONS);
}

function applyPersonalIsaiahNineStudySections() {
  replaceStudySectionsForBookRange("isaiah", 9, 9, ISAIAH_NINE_PERSONAL_SECTIONS);
}

function applyPersonalIsaiahTenStudySections() {
  replaceStudySectionsForBookRange("isaiah", 10, 10, ISAIAH_TEN_PERSONAL_SECTIONS);
}

function applyPersonalIsaiahElevenStudySections() {
  replaceStudySectionsForBookRange("isaiah", 11, 11, ISAIAH_ELEVEN_PERSONAL_SECTIONS);
}

function applyPersonalIsaiahTwelveStudySections() {
  replaceStudySectionsForBookRange("isaiah", 12, 12, ISAIAH_TWELVE_PERSONAL_SECTIONS);
}

function applyPersonalIsaiahThirteenStudySections() {
  replaceStudySectionsForBookRange("isaiah", 13, 13, ISAIAH_THIRTEEN_PERSONAL_SECTIONS);
}

function applyPersonalIsaiahFourteenStudySections() {
  replaceStudySectionsForBookRange("isaiah", 14, 14, ISAIAH_FOURTEEN_PERSONAL_SECTIONS);
}

function applyPersonalIsaiahFifteenStudySections() {
  replaceStudySectionsForBookRange("isaiah", 15, 15, ISAIAH_FIFTEEN_PERSONAL_SECTIONS);
}

function applyPersonalIsaiahSixteenStudySections() {
  replaceStudySectionsForBookRange("isaiah", 16, 16, ISAIAH_SIXTEEN_PERSONAL_SECTIONS);
}

function applyPersonalIsaiahSeventeenStudySections() {
  replaceStudySectionsForBookRange("isaiah", 17, 17, ISAIAH_SEVENTEEN_PERSONAL_SECTIONS);
}
...
function applyPersonalIsaiahTwentyStudySections() {
  replaceStudySectionsForBookRange("isaiah", 20, 20, ISAIAH_TWENTY_PERSONAL_SECTIONS);
}

function applyPersonalIsaiahTwentyOneStudySections() {
  replaceStudySectionsForBookRange("isaiah", 21, 21, ISAIAH_TWENTY_ONE_PERSONAL_SECTIONS);
}

function applyPersonalIsaiahTwentyTwoStudySections() {
  replaceStudySectionsForBookRange("isaiah", 22, 22, ISAIAH_TWENTY_TWO_PERSONAL_SECTIONS);
}

function applyPersonalIsaiahTwentyThreeStudySections() {
  replaceStudySectionsForBookRange("isaiah", 23, 23, ISAIAH_TWENTY_THREE_PERSONAL_SECTIONS);
}

function applyPersonalIsaiahTwentyFourStudySections() {
  replaceStudySectionsForBookRange("isaiah", 24, 24, ISAIAH_TWENTY_FOUR_PERSONAL_SECTIONS);
}

function applyPersonalIsaiahTwentyFiveStudySections() {
  replaceStudySectionsForBookRange("isaiah", 25, 25, ISAIAH_TWENTY_FIVE_PERSONAL_SECTIONS);
}

function applyPersonalIsaiahTwentySixStudySections() {
  replaceStudySectionsForBookRange("isaiah", 26, 26, ISAIAH_TWENTY_SIX_PERSONAL_SECTIONS);
  replaceStudySectionsForBookRange("isaiah", 27, 27, ISAIAH_TWENTY_SEVEN_PERSONAL_SECTIONS);
  replaceStudySectionsForBookRange("isaiah", 28, 28, ISAIAH_TWENTY_EIGHT_PERSONAL_SECTIONS);
  replaceStudySectionsForBookRange("isaiah", 29, 29, ISAIAH_TWENTY_NINE_PERSONAL_SECTIONS);
  replaceStudySectionsForBookRange("isaiah", 30, 30, ISAIAH_THIRTY_PERSONAL_SECTIONS);
  replaceStudySectionsForBookRange("isaiah", 31, 31, ISAIAH_THIRTY_ONE_PERSONAL_SECTIONS);
  replaceStudySectionsForBookRange("isaiah", 32, 32, ISAIAH_THIRTY_TWO_PERSONAL_SECTIONS);
  replaceStudySectionsForBookRange("isaiah", 33, 33, ISAIAH_THIRTY_THREE_PERSONAL_SECTIONS);
  replaceStudySectionsForBookRange("isaiah", 34, 34, ISAIAH_THIRTY_FOUR_PERSONAL_SECTIONS);
  replaceStudySectionsForBookRange("isaiah", 35, 35, ISAIAH_THIRTY_FIVE_PERSONAL_SECTIONS);
  replaceStudySectionsForBookRange("isaiah", 36, 36, ISAIAH_THIRTY_SIX_PERSONAL_SECTIONS);
  replaceStudySectionsForBookRange("isaiah", 37, 37, ISAIAH_THIRTY_SEVEN_PERSONAL_SECTIONS);
  replaceStudySectionsForBookRange("isaiah", 38, 38, ISAIAH_THIRTY_EIGHT_PERSONAL_SECTIONS);
  replaceStudySectionsForBookRange("isaiah", 39, 39, ISAIAH_THIRTY_NINE_PERSONAL_SECTIONS);
  replaceStudySectionsForBookRange("isaiah", 40, 40, ISAIAH_FORTY_PERSONAL_SECTIONS);
  replaceStudySectionsForBookRange("isaiah", 41, 41, ISAIAH_FORTY_ONE_PERSONAL_SECTIONS);
  replaceStudySectionsForBookRange("isaiah", 42, 42, ISAIAH_FORTY_TWO_PERSONAL_SECTIONS);
  replaceStudySectionsForBookRange("isaiah", 43, 43, ISAIAH_FORTY_THREE_PERSONAL_SECTIONS);
  replaceStudySectionsForBookRange("isaiah", 44, 44, ISAIAH_FORTY_FOUR_PERSONAL_SECTIONS);
  replaceStudySectionsForBookRange("isaiah", 45, 45, ISAIAH_FORTY_FIVE_PERSONAL_SECTIONS);
  replaceStudySectionsForBookRange("isaiah", 46, 46, ISAIAH_FORTY_SIX_PERSONAL_SECTIONS);
  replaceStudySectionsForBookRange("isaiah", 47, 47, ISAIAH_FORTY_SEVEN_PERSONAL_SECTIONS);
  replaceStudySectionsForBookRange("isaiah", 48, 48, ISAIAH_FORTY_EIGHT_PERSONAL_SECTIONS);
  replaceStudySectionsForBookRange("isaiah", 49, 49, ISAIAH_FORTY_NINE_PERSONAL_SECTIONS);
  replaceStudySectionsForBookRange("isaiah", 50, 50, ISAIAH_FIFTY_PERSONAL_SECTIONS);
  replaceStudySectionsForBookRange("isaiah", 51, 51, ISAIAH_FIFTY_ONE_PERSONAL_SECTIONS);
  replaceStudySectionsForBookRange("isaiah", 52, 52, ISAIAH_FIFTY_TWO_PERSONAL_SECTIONS);
  replaceStudySectionsForBookRange("isaiah", 53, 53, ISAIAH_FIFTY_THREE_PERSONAL_SECTIONS);
  replaceStudySectionsForBookRange("isaiah", 54, 54, ISAIAH_FIFTY_FOUR_PERSONAL_SECTIONS);
  replaceStudySectionsForBookRange("isaiah", 55, 55, ISAIAH_FIFTY_FIVE_PERSONAL_SECTIONS);
  replaceStudySectionsForBookRange("isaiah", 56, 56, ISAIAH_FIFTY_SIX_PERSONAL_SECTIONS);
  replaceStudySectionsForBookRange("isaiah", 57, 57, ISAIAH_FIFTY_SEVEN_PERSONAL_SECTIONS);
  replaceStudySectionsForBookRange("isaiah", 58, 58, ISAIAH_FIFTY_EIGHT_PERSONAL_SECTIONS);
  ...
  replaceStudySectionsForBookRange("isaiah", 63, 63, ISAIAH_SIXTY_THREE_PERSONAL_SECTIONS);
  replaceStudySectionsForBookRange("isaiah", 64, 64, ISAIAH_SIXTY_FOUR_PERSONAL_SECTIONS);
  replaceStudySectionsForBookRange("isaiah", 65, 65, ISAIAH_SIXTY_FIVE_PERSONAL_SECTIONS);
  replaceStudySectionsForBookRange("isaiah", 66, 66, ISAIAH_SIXTY_SIX_PERSONAL_SECTIONS);
}
...
function applyPersonalJeremiahOneStudySections() {
  replaceStudySectionsForBookRange("jeremiah", 1, 1, JEREMIAH_ONE_PERSONAL_SECTIONS);
}

function applyPersonalJeremiahTwoStudySections() {
  replaceStudySectionsForBookRange("jeremiah", 2, 2, JEREMIAH_TWO_PERSONAL_SECTIONS);
}

function applyPersonalJeremiahFourStudySections() {
  replaceStudySectionsForBookRange("jeremiah", 4, 4, JEREMIAH_FOUR_PERSONAL_SECTIONS);
}

function applyPersonalJeremiahFiveStudySections() {
  replaceStudySectionsForBookRange("jeremiah", 5, 5, JEREMIAH_FIVE_PERSONAL_SECTIONS);
}

function applyPersonalJeremiahSixStudySections() {
  replaceStudySectionsForBookRange("jeremiah", 6, 6, JEREMIAH_SIX_PERSONAL_SECTIONS);
}

function applyPersonalJeremiahSevenStudySections() {
  replaceStudySectionsForBookRange("jeremiah", 7, 7, JEREMIAH_SEVEN_PERSONAL_SECTIONS);
}

function applyPersonalJeremiahEightStudySections() {
  replaceStudySectionsForBookRange("jeremiah", 8, 8, JEREMIAH_EIGHT_PERSONAL_SECTIONS);
}

function applyPersonalJeremiahNineStudySections() {
  replaceStudySectionsForBookRange("jeremiah", 9, 9, JEREMIAH_NINE_PERSONAL_SECTIONS);
}

function applyPersonalJeremiahTenStudySections() {
  replaceStudySectionsForBookRange("jeremiah", 10, 10, JEREMIAH_TEN_PERSONAL_SECTIONS);
}

function applyPersonalJeremiahElevenStudySections() {
  replaceStudySectionsForBookRange("jeremiah", 11, 11, JEREMIAH_ELEVEN_PERSONAL_SECTIONS);
}

function applyPersonalJeremiahTwelveStudySections() {
  replaceStudySectionsForBookRange("jeremiah", 12, 12, JEREMIAH_TWELVE_PERSONAL_SECTIONS);
}

function applyPersonalJeremiahThirteenStudySections() {
  replaceStudySectionsForBookRange("jeremiah", 13, 13, JEREMIAH_THIRTEEN_PERSONAL_SECTIONS);
}

function applyPersonalJeremiahFourteenStudySections() {
  replaceStudySectionsForBookRange("jeremiah", 14, 14, JEREMIAH_FOURTEEN_PERSONAL_SECTIONS);
}

function applyPersonalJeremiahThreeStudySections() {
  replaceStudySectionsForBookRange("jeremiah", 3, 3, JEREMIAH_THREE_PERSONAL_SECTIONS);
}
...
?? The section ends with the words "and he died," proving that God's warning in Eden was real.
...
That is why human life should still be treated with seriousness and honor.`,
        `?? Death is now part of human history.
...
?? Death is real, and the Bible does not pretend it is small.
...
?? More time is not the same as eternal life.
...
??? This prepares us for Noah, because Genesis 6 will also say Noah walked with God.
...
??? One faithful life can prepare the way for another.
...
??? Lands and coastlands are named, showing humanity spreading geographically.
??? Languages are mentioned, preparing us for Babel in Genesis 11.
??? Families become peoples, and peoples become nations.
...
??? God knows the map of humanity.
??? Nations begin with families, not statistics.
??? Language and culture matter in the biblical story.
...
??? Egypt and Canaan come into view, both becoming major places in Israel's future story.
?? Nimrod is singled out as a mighty figure connected with early kingdoms.
??? Babel appears here before Genesis 11 explains the tower.
?? Human power is rising again after the flood.
...
Babel will become a Bible symbol for proud human society resisting God.`,
      ...
      truths: [
        `??? Human culture grows after judgment.
...
The question is whether power will serve God or exalt itself.`,
        `?? Power can become dangerous quickly.
...
??? Places in genealogies become places of promise, danger, and rescue later.
?? Human might needs humility under God.
??? Babel's shadow appears before the tower is explained.
...
??? Families, languages, lands, and nations are repeated.
...
God breaks the project to protect the world from a worse unity.`,
      ...
      truths: [
        `??? Unity is not automatically holy.
...
??? Sometimes God disrupts what would destroy us.
...
??? Terah's family leaves Ur and heads toward Canaan.
?? The journey stops in Haran before the call of Genesis 12.
...
The story is setting us up to see that the promise depends on God.`,
        `??? They Went Forth To Go Into Canaan
...
Faith will have to depend on God's word.`,
        `?? Calling can begin from unfinished places.
...
??? An unfinished road can become the place where God speaks.
?? Stopping short is not stronger than God's ability to call again.
...
??? God protects Sarai and afflicts Pharaoh's house.
...
Chosen people still need formation.`,
        `??? God's promise is stronger than human failure.
...
??? God can preserve His promise even when we make a mess.
...
?? The land cannot support them together, and strife begins between their herdsmen.
...
?? Conflict should be handled before it becomes deeper damage.
...
?? Genesis warns that Sodom's people are wicked before the Lord.
...
??? Moving toward danger is still dangerous.
...
function makeCompactExodusStudySection(section: CompactReaderStudySectionInput) {
  const genesisSection = makeCompactGenesisStudySection(section);
  return {
    ...genesisSection,
    book: "exodus",
  };
...
function makeCompactLeviticusStudySection(section: CompactReaderStudySectionInput) {
  const genesisSection = makeCompactGenesisStudySection(section);
  return {
    ...genesisSection,
    book: "leviticus",
...
BIBLE_READER_STUDY_SECTIONS.push(
  ...[
    ...
    makeCompactExodusStudySection({
      ...
      movement: ["?? God does not lead Israel by the nearest road.", "?? Moses carries Joseph's bones out of Egypt.", "?? The LORD leads by cloud in the day.", "?? The LORD leads by fire at night."],
    ...
    makeCompactExodusStudySection({
      ...
      movement: ["?? Israel camps near the sea.", "?? Pharaoh regrets releasing the people.", "?? Egypt pursues with horses and chariots.", "?? God says He will get glory over Pharaoh."],
    ...
    makeCompactExodusStudySection({
      ...
      movement: ["?? Israel sees Pharaoh's army and becomes afraid.", "??? The people accuse Moses of bringing them out to die.", "??? Moses tells them to fear not.", "?? They are told to stand still and see the salvation of the LORD."],
    ...
    makeCompactExodusStudySection({
      ...
      movement: ["?? God tells Israel to go forward.", "?? The cloud moves between Israel and Egypt.", "??? A strong east wind divides the sea.", "?? Israel walks through on dry ground."],
    ...
    makeCompactExodusStudySection({
      ...
      movement: ["?? Egypt follows into the sea.", "?? Chariot wheels come off and the army panics.", "?? The waters return over Pharaoh's forces.", "?? Israel fears the LORD and believes Him."],
    ...
    makeCompactExodusStudySection({
      ...
      movement: ["?? Israel sings after the sea crossing.", "?? The LORD is praised as strength and salvation.", "?? Horse and rider are thrown into the sea.", "??? God's breath overwhelms the enemy."],
    ...
    makeCompactExodusStudySection({
      ...
      movement: ["?? Israel asks who is like the LORD.", "??? God leads the people He redeemed.", "?? Nations will hear and tremble.", "??? God will bring His people to His holy dwelling."],
    ...
    makeCompactExodusStudySection({
      ...
      movement: ["??? Israel goes three days into the wilderness.", "?? The water at Marah is bitter.", "?? God shows Moses a tree that makes the water sweet.", "?? Israel reaches Elim with springs and palm trees."],
    ...
    makeCompactExodusStudySection({
      ...
      movement: ["??? Israel reaches the wilderness of Sin.", "?? The congregation murmurs against Moses and Aaron.", "?? Egypt begins to look better in their memory.", "??? Hunger becomes the next test of trust."],
    ...
    makeCompactExodusStudySection({
      ...
      movement: ["?? Quail cover the camp in the evening.", "??? Manna appears with the dew in the morning.", "? Israel asks, What is it?", "?? Each person gathers according to need."],
...
BIBLE_READER_STUDY_SECTIONS.push(
  ...[
    makeCompactGenesisStudySection({
      ...
      movement: ["?? A regional war breaks out among kings and alliances.", "??? Sodom is caught inside the conflict.", "?? Lot is captured because he has settled near danger.", "?? Goods and people are taken as spoils of war."],
      phrases: [["?? Four Kings Against Five", "Genesis suddenly moves from tents and altars into international conflict. Abram's family story is now touching the larger political world around him."], ["??? Sodom", "Lot chose the well-watered plain near Sodom in Genesis 13. Now that direction has consequences because Sodom's trouble becomes Lot's trouble."], ["?? They Took Lot", "Lot is not the main villain here, but his location matters. Genesis is quietly showing that where we pitch our tents can place us near dangers we did not expect."]],
      truths: [["?? Direction matters.", "Lot's earlier choice keeps shaping his story. A decision that looked good by sight has moved him closer to harm."], ["?? Faith lives in a violent world.", "Abram's story is not protected from political chaos. God's promise moves through a real world with kings, war, and loss."], ["?? Consequences can arrive later.", "Genesis 13 looked like a land choice. Genesis 14 shows the cost of that direction. The Bible teaches us to think past the first impression."]],
      application: ["?? Ask where a choice is taking you, not only how it looks today.", "??? Getting close to danger can make danger feel normal.", "?? God's people still need wisdom in a broken world.", "?? Mercy may be needed even after foolish direction."],
    }),
    makeCompactGenesisStudySection({
      chapter: 14,
      startVerse: 13,
    ...
    makeCompactGenesisStudySection({
      ...
      movement: ["?? Melchizedek brings bread and wine.", "?? He is king of Salem and priest of God Most High.", "?? He blesses Abram.", "??? He says God delivered Abram's enemies into his hand."],
    ...
    makeCompactGenesisStudySection({
      ...
      application: ["?? Bring the real ache to God.", "??? Remember that God Himself is better than any reward He gives.", "?? Let God's promise stretch your imagination beyond what you can count.", "? Faith rests on the One who speaks."],
    }),
    makeCompactGenesisStudySection({
      chapter: 15,
      startVerse: 7,
      ...
      application: ["? Ask honest questions without turning away from God.", "?? Let God's covenant faithfulness be stronger than your uncertainty.", "??? Guard hope when discouragement tries to land on it.", "? Assurance does not always remove waiting."],
    }),
    makeCompactGenesisStudySection({
      chapter: 15,
      startVerse: 12,
      ...
      movement: ["?? Darkness falls over Abram.", "?? God reveals future affliction in another land.", "?? God promises to judge the oppressor.", "??? Abram is promised peace, and his descendants will return."],
      phrases: [["?? Horror Of Great Darkness", "The covenant promise includes a heavy vision. God's plan is true, but it will pass through suffering."], ["?? A Stranger In A Land", "This points ahead to Israel's bondage in Egypt. Genesis is already preparing the Exodus story."], ["? The Iniquity Of The Amorites", "God's timing includes justice and patience. The land promise waits while God gives time before judgment is full."]],
      truths: [["? Promise does not mean instant.", "God's promise is sure, but the road will be long. Faith must learn time."], ["?? God sees oppression.", "The affliction of Abram's descendants will not be ignored. God promises judgment and deliverance."], ["??? God can tell hard truth with mercy.", "Abram hears about suffering, but also peace, deliverance, and return. God does not abandon the future to darkness."]],
      application: ["? Do not confuse delay with denial.", "?? Some promises pass through dark seasons.", "?? God sees oppression even before deliverance arrives.", "??? The long road can still be held by God."],
    }),
    makeCompactGenesisStudySection({
      chapter: 15,
      startVerse: 17,
...
BIBLE_READER_STUDY_SECTIONS.push(
  ...[
    makeCompactGenesisStudySection({
      ...
      movement: ["?? Dinah goes out to see the women of the land.", "?? Shechem takes and violates her.", "?? Shechem speaks tenderly but does not erase the harm.", "?? Jacob's sons are grieved and furious."],
      phrases: [["?? Dinah", "Dinah is Jacob and Leah's daughter. Genesis names her because her suffering matters, not because she is a side detail."], ["?? Took Her", "The wording is forceful and painful. The Bible is showing violation, not a harmless romance."], ["?? Wrought Folly In Israel", "This phrase means a disgraceful evil has been done among God's covenant people. It names the act morally, not casually."]],
      truths: [["?? The Bible does not ignore harm.", "Genesis includes this painful chapter because God sees what happens to vulnerable people."], ["?? Tender words cannot undo violation.", "Shechem's later affection does not make his action righteous."], ["?? Anger over injustice is understandable.", "Jacob's sons are furious because a real wrong has happened. The question becomes what they will do with that anger."]],
      application: ["?? Do not minimize harm because the story is uncomfortable.", "?? Let truth name wrong clearly.", "?? Bring anger under God's wisdom before it becomes destructive.", "?? Remember that people wounded in the story are not footnotes."],
    }),
    makeCompactGenesisStudySection({
      chapter: 34,
      startVerse: 8,
      ...
      movement: ["?? Hamor asks for intermarriage and trade.", "??? Shechem offers bride price and gifts.", "?? Jacob's sons demand circumcision.", "??? The city agrees because they expect gain."],
      ...
      truths: [["?? Sacred things can be misused by angry hearts.", "A covenant sign becomes a weapon when separated from covenant faithfulness."], ["?? Restitution cannot replace repentance.", "Money and gifts do not automatically heal what was done."], ["??? Self-interest can blind whole communities.", "The men of Shechem agree partly because they expect Jacob's wealth to become theirs."]],
      application: ["?? Do not use spiritual language as a cover for revenge.", "?? Do not confuse payment with true repair.", "??? Watch how self-interest can make people approve what they should question.", "?? Seek justice without corrupting what belongs to God."],
    }),
    makeCompactGenesisStudySection({
      chapter: 34,
      startVerse: 25,
      ...
      movement: ["?? Simeon and Levi attack the weakened city.", "??? The men are killed.", "?? The brothers plunder the city.", "?? Jacob fears retaliation.", "??? The brothers answer with Dinah's dishonor."],
      phrases: [["?? Slew All The Males", "Their anger is connected to a real wrong, but the response becomes excessive and devastating. Simeon and Levi are reacting to what happened to Dinah, so Genesis does not ask readers to pretend there was no evil. But killing all the males of the city turns vengeance into a wider bloodshed. The phrase matters because it shows how a real wound can become a doorway to sinful retaliation. Later, Jacob will remember this violence when he blesses his sons in Genesis 49. The story teaches that justice and revenge are not the same thing."], ["?? Spoiled The City", "The revenge expands into plunder. The brothers take wealth, livestock, women, and children."], ["?? Ye Have Troubled Me", "Jacob sees the danger of retaliation from surrounding peoples. His concern is survival, but the moral damage is also serious."]],
      truths: [["?? Revenge can multiply evil.", "Simeon and Levi respond to wickedness, but their method spreads more violence."], ["?? Anger needs righteousness, not just intensity.", "Being angry about a real wrong does not make every response right."], ["?? Family damage can shape future generations.", "This moment will be remembered later when Jacob speaks over Simeon and Levi in Genesis 49."]],
      application: ["?? Refuse revenge that becomes its own evil.", "?? Ask God to govern anger before anger governs you.", "?? Remember that today's reactions can become tomorrow's family legacy.", "?? Care about justice and holiness together."],
    }),
    makeCompactGenesisStudySection({
      chapter: 35,
      startVerse: 1,
    ...
    makeCompactGenesisStudySection({
      ...
      movement: ["? God appears to Jacob again.", "??? God repeats the name Israel.", "?? God promises fruitfulness, nations, kings, and land.", "?? Jacob sets up a pillar and worships."],
      phrases: [["??? Thy Name Shall Not Be Called Any More Jacob", "God repeats the name change from Genesis 32. Jacob's identity is not built on old grasping but on God's transforming word."], ["?? Kings Shall Come Out Of Thy Loins", "The promise looks beyond Jacob's immediate family toward future royal lines. God is not only promising that Jacob will have children; He is saying kings will come from him. That matters because Genesis keeps moving from family promise toward nation promise. Israel will later have kings, and the Bible's royal hope will eventually focus on the Messiah. This phrase helps readers see that God's covenant is larger than one household argument or one generation. The future of the Bible's kingdom story is already being planted here."], ["?? A Pillar Of Stone", "Jacob marks the place where God spoke. Worship creates memory so the promise is not forgotten."]],
      ...
      application: ["? Let God repeat truth over you when life shakes you.", "?? Do not measure God's promise only by today's family chaos.", "?? Build habits that help you remember God's word.", "??? Live from the name God gives, not only the pattern you came from."],
    }),
    makeCompactGenesisStudySection({
      chapter: 35,
      startVerse: 16,
      ...
      movement: ["?? Benjamin is born through hard labor.", "?? Rachel dies on the way.", "?? Reuben sins with Bilhah.", "?? Jacob's sons are listed.", "?? Isaac dies and is buried by Jacob and Esau."],
      phrases: [["?? Ben-Oni And Benjamin", "Rachel names the child son of my sorrow, but Jacob calls him son of the right hand. The two names hold grief and future together."], ["?? Reuben Went And Lay With Bilhah", "This is more than sexual sin; in the ancient family world it challenges honor and authority inside Jacob's household. Bilhah was Rachel's servant and Jacob's concubine, so Reuben's act attacks the order of his father's house. As the firstborn, Reuben should have protected the family, but instead he brings shame into it. The phrase matters because it explains why Reuben later loses firstborn honor in Genesis 49. This moment is not random family scandal. It affects the future leadership story among Jacob's sons."], ["?? Esau And Jacob Buried Him", "The brothers stand together at Isaac's burial. Their relationship is not simple, but the hatred of Genesis 27 is no longer the final scene."]],
      truths: [["?? Promise does not remove grief.", "Bethel renewal is followed by Rachel's death. Faith and sorrow can sit close together."], ["?? Sin inside the family still matters.", "Reuben's act will affect his future standing."], ["?? Reconciliation can show up quietly.", "Jacob and Esau bury Isaac together after years of conflict."]],
      application: ["?? Do not assume grief means God has stopped working.", "?? Take hidden family sin seriously.", "?? Notice small signs of healing, even when the story is not perfect.", "?? Let God hold sorrow and future together."],
    }),
    makeCompactGenesisStudySection({
      chapter: 36,
      startVerse: 1,
      ...
      movement: ["?? Esau's generations are introduced.", "??????????? His wives and children are named.", "?? His possessions are great.", "??? Esau settles in Mount Seir."],
      phrases: [["?? Esau, Who Is Edom", "Genesis connects Esau with Edom because his descendants become the Edomites, a later people group connected to Israel's history. Edom will become a nation living near Israel, often with tension between the two peoples. This phrase helps readers understand that Genesis is not throwing away Esau's story. It is showing where another family line goes after Jacob receives the covenant focus. Esau is outside the chosen line, but he is not outside history. His descendants will keep appearing in the larger Bible story."], ["?? Their Riches Were More Than That They Might Dwell Together", "The separation is practical. Both brothers have become too large to share the same space."], ["??? Mount Seir", "Seir becomes Esau's settled territory. The family conflict is becoming geography."]],
      truths: [["?? God remembers more than the main covenant line.", "Esau is not the chosen heir, but his story is still recorded."], ["??? Separation can become part of history.", "Jacob and Esau part into different territories and peoples."], ["?? Blessing can create new limits.", "Their growth means they can no longer live together in the same land."]],
      application: ["?? Do not skip genealogies; they often explain later Bible history.", "??? Accept that some peaceful separations still matter.", "?? Recognize when growth requires new boundaries.", "?? Watch how family stories become larger histories."],
    }),
    makeCompactGenesisStudySection({
      chapter: 36,
      startVerse: 9,
...
BIBLE_READER_STUDY_SECTIONS.push(
  ...[
    makeCompactGenesisStudySection({
      ...
      movement: ["?? Sarai still has no child.", "?? Hagar is brought into the promise problem.", "? The delay feels unbearable.", "?? The household chooses a shortcut God did not command."],
      phrases: [["?? Bare Him No Children", "This is not a small detail. Sarai's barrenness sits directly against the promise of descendants."], ["?? My Maid", "Hagar is treated as a solution to someone else's ache. Genesis wants us to feel the human cost of control."], ["?? Abram Hearkened", "Abram listens to Sarai's plan instead of leading the household back to God's promise. The echo of Eden is hard to miss."]],
      truths: [["? Waiting can tempt people to control.", "The promise has not arrived, so Sarai tries to force an outcome."], ["?? Shortcuts can use people.", "Hagar becomes part of a plan that treats her like a tool, not merely a person."], ["?? Practical does not always mean faithful.", "The plan may have made cultural sense, but it was not what God commanded."]],
      application: ["? Delayed promises can expose where we want control.", "?? Never treat people like tools for your fear.", "?? A practical shortcut can still wound a household.", "?? Waiting should drive faith toward God, not manipulation."],
    }),
    makeCompactGenesisStudySection({
      chapter: 16,
      startVerse: 4,
    ...
    makeCompactGenesisStudySection({
      ...
      movement: ["??? Hagar is alone in the wilderness.", "??? The angel of the Lord finds her.", "? God asks where she came from and where she is going.", "?? Her son is named Ishmael because the Lord hears affliction."],
      phrases: [["??? Found Her", "Hagar is not the one searching for God in the scene. God finds her first."], ["? Whence Camest Thou", "The question gives Hagar dignity. God lets her speak her story."], ["?? Ishmael", "Ishmael means God hears. The child's name becomes a living reminder that Hagar's affliction reached God."]],
      truths: [["?? God sees the mistreated.", "Hagar is vulnerable, but not invisible. God meets her in the wilderness."], ["?? God hears affliction.", "The name Ishmael turns Hagar's pain into testimony. Her suffering has reached heaven."], ["??? God speaks future to the wounded.", "Hagar receives a word about her son's future. God does not treat her as a side character."]],
      application: ["?? Being overlooked by people is not the same as being unseen by God.", "?? Your affliction is not silent before Him.", "? God can meet you with questions that restore dignity.", "??? The wilderness can become a place of encounter."],
    }),
    makeCompactGenesisStudySection({
      chapter: 16,
      startVerse: 13,
      ...
      application: ["?? Let God's seeing speak louder than people's misuse.", "?? Remember the places where God met you.", "? Do not mistake a shortcut outcome for the promised fulfillment.", "??? God can show compassion inside a complicated story."],
    }),
    makeCompactGenesisStudySection({
      chapter: 17,
      startVerse: 1,
    ...
    makeCompactGenesisStudySection({
      ...
      movement: ["?? God commands Abraham to keep the covenant.", "?? Circumcision is given as the sign.", "?? The sign reaches future generations.", "?? The covenant sign is treated seriously."],
      phrases: [["?? Circumcised", "The covenant is marked in the body. God's promise is not just an idea Abraham thinks about; it marks the household."], ["?? Eight Days Old", "The sign is generational. Children are brought under the covenant identity from the beginning."], ["?? Cut Off", "The warning shows that covenant membership is serious. God's promise should not be treated casually."]],
      truths: [["?? Covenant creates belonging.", "The sign marks Abraham's household as set apart under God's promise."], ["?? Faith has visible obedience.", "The covenant is not only believed inwardly. It is obeyed outwardly."], ["?? God's promise thinks generationally.", "The sign reaches beyond Abraham into the future family line."]],
      application: ["?? Belonging to God should shape visible life.", "?? Do not treat covenant signs like empty symbols.", "?? God's work often reaches generations beyond us.", "?? Holy things should be handled seriously."],
    }),
    makeCompactGenesisStudySection({
      chapter: 17,
      startVerse: 15,
...
BIBLE_READER_STUDY_SECTIONS.push(
  ...[
    makeCompactGenesisStudySection({
      ...
      movement: ["??? Abraham sits by the tent in the heat of the day.", "?? Three visitors appear.", "?? Abraham runs to welcome them.", "?? A meal is prepared, and holy promise comes near ordinary hospitality."],
      phrases: [["??? The Lord Appeared", "The passage begins by telling us more than Abraham can fully see at first. This visit is more than ordinary company."], ["?? Ran To Meet Them", "Abraham's welcome is eager and humble. He does not treat the moment casually."], ["?? A Morsel Of Bread", "Abraham speaks modestly, but prepares generously. Hospitality becomes the setting where God's promise will be heard again."]],
      truths: [["??? God can meet people in ordinary spaces.", "The scene is a tent, a meal, and a hot day. God brings promise near normal life."], ["?? Hospitality can become holy ground.", "Abraham's welcome opens a space where divine conversation unfolds."], ["?? Reverence can look practical.", "Water, rest, bread, and a meal become expressions of honor."]],
      application: ["??? Do not despise ordinary places where God may meet you.", "?? Hospitality is more spiritual than we often think.", "?? Eagerness to honor others matters.", "? Promise can arrive in the middle of daily life."],
    }),
    makeCompactGenesisStudySection({
      chapter: 18,
      startVerse: 9,
    ...
    makeCompactGenesisStudySection({
      ...
      movement: ["?? The visitors look toward Sodom.", "?? Abraham is brought into the conversation.", "?? The cry against Sodom and Gomorrah is great.", "?? God judges with knowledge, not rumor."],
      phrases: [["?? Shall I Hide From Abraham", "God draws Abraham into His purposes. Covenant relationship includes knowing God's heart for righteousness and justice."], ["?? The Cry Of Sodom", "The cry suggests suffering and grievous evil reaching God. Judgment is connected to real wrong, not divine moodiness."], ["??? I Will Go Down Now And See", "This language shows careful judgment. God is not careless or uninformed."]],
      truths: [["?? God judges with perfect knowledge.", "Sodom is not judged by gossip or exaggeration. God sees truly."], ["?? Evil creates a cry before God.", "Human wickedness is not invisible. The suffering it causes reaches heaven."], ["?? Covenant people learn God's justice.", "Abraham is being formed to understand righteousness, justice, and mercy."]],
      application: ["?? Trust that God's judgment is never careless.", "?? The cries of victims matter to Him.", "?? Knowing God should shape our concern for righteousness.", "?? Cities and cultures are accountable to God."],
    }),
    makeCompactGenesisStudySection({
      chapter: 18,
      startVerse: 22,
      ...
      movement: ["?? Abraham stands before the Lord.", "?? He asks whether the Judge of all the earth will do right.", "?? He pleads from fifty down to ten.", "?? His prayer is bold but humble."],
      ...
      truths: [["?? Intercession is bold humility.", "Abraham draws near, but he does not command God. True prayer can be both courageous and reverent."], ["?? God's justice is the foundation of mercy.", "Abraham's hope rests on the Judge doing right."], ["??? Mercy is worth asking for.", "Abraham keeps pleading because he knows God is righteous and merciful."]],
      application: ["?? Draw near for others, not only yourself.", "?? Anchor prayer in God's character.", "?? Boldness and humility belong together.", "??? Keep asking for mercy while honoring justice."],
    }),
    makeCompactGenesisStudySection({
      chapter: 19,
      startVerse: 1,
      ...
      movement: ["?? Two angels arrive in Sodom.", "?? Lot brings them into his house.", "?? The men of the city surround the house.", "??? The attackers are struck with blindness."],
      phrases: [["?? Lot Sat In The Gate", "The gate was a place of influence. Lot is not just near Sodom anymore; he is woven into city life."], ["?? Both Old And Young", "The language shows widespread corruption. The city is not being judged for one private mistake."], ["??? Smote The Men With Blindness", "The physical blindness matches the moral blindness already on display. The city cannot find the door because it has already lost its way."]],
      truths: [["?? Wickedness can become communal.", "Sodom's sin is public and aggressive. Genesis shows a culture united around violence."], ["?? Compromise can entangle a household.", "Lot is in the gate and his family is inside the city. His location has shaped his household's danger."], ["??? God exposes what a city is.", "The visitors reveal the truth of Sodom's condition before judgment falls."]],
      application: ["?? Do not normalize a violent culture because it feels familiar.", "?? Where you settle can shape your household.", "??? Moral blindness can be worse than physical blindness.", "??? God can protect His messengers in hostile places."],
    }),
    makeCompactGenesisStudySection({
      chapter: 19,
      startVerse: 12,
    ...
    makeCompactGenesisStudySection({
      ...
      movement: ["?? Lot reaches Zoar as the sun rises.", "?? Fire and brimstone fall on Sodom and Gomorrah.", "?? Lot's wife looks back and becomes a warning.", "?? God remembers Abraham and sends Lot out."],
      ...
      truths: [["?? Judgment is real.", "Sodom's fall shows that God does not ignore grievous evil forever."], ["?? The heart can remain attached to what the body leaves.", "Lot's wife warns us that escape requires more than movement."], ["?? Mercy remembers covenant.", "God remembers Abraham and rescues Lot. Judgment does not erase mercy."]],
      application: ["?? Take evil seriously because God does.", "?? Do not keep longing for what God is rescuing you from.", "?? Prayer for others matters more than we may see.", "?? Mercy and judgment can appear in the same story."],
    }),
    makeCompactGenesisStudySection({
      chapter: 19,
      startVerse: 30,
    ...
    makeCompactGenesisStudySection({
      ...
      movement: ["?? Abraham repeats the sister lie in Gerar.", "?? Abimelech takes Sarah.", "?? God warns Abimelech in a dream.", "??? Sarah is protected before Isaac is born."],
      phrases: [["?? She Is My Sister", "Abraham repeats an old fear pattern from Egypt. Growth is real in his life, but weakness is still present."], ["?? God Came In A Dream", "God intervenes with Abimelech directly. The promise is too important to leave unprotected."], ["??? He Is A Prophet", "God still calls Abraham a prophet even while correcting the situation. Calling does not erase accountability."]],
      truths: [["?? Old fears can return.", "Abraham has walked with God for years, but fear still resurfaces. Scripture is honest about repeated weakness."], ["??? God protects the promise.", "Sarah must be protected because Isaac is coming. God's plan is not fragile."], ["?? Grace can include correction.", "God corrects Abimelech and Abraham's situation. Mercy does not pretend the lie was harmless."]],
      application: ["?? Pay attention to old fear patterns that repeat.", "??? God's promise is stronger than your weakness.", "?? Correction can be mercy.", "?? God can protect others from the damage our fear might cause."],
    }),
  ],
);
...
BIBLE_READER_STUDY_SECTIONS.push(
  ...[
    ...
    makeCompactGenesisStudySection({
      ...
      icon: "\u{1F4D6}",
      summary: "Sarah sees Ishmael mocking, the family tension breaks open, and God tells Abraham to listen to Sarah.",
      movement: ["Isaac grows and the family celebrates.", "Sarah sees Ishmael mocking Isaac.", "The conflict exposes the pressure between promise and flesh.", "God confirms that Isaac is the covenant line."],
      phrases: [["Sarah Saw The Son Of Hagar Mocking", "This phrase shows the family conflict becoming public and painful. The promise child is now present, but the earlier shortcut with Hagar still affects the household."], ["Cast Out This Bondwoman And Her Son", "Sarah's words sound harsh because the situation is deeply broken. Genesis is showing the painful consequences of trying to force God's promise by human planning."], ["In Isaac Shall Thy Seed Be Called", "God makes the covenant line clear. Ishmael matters to God, but Isaac carries the specific promise given to Abraham and Sarah."]],
      truths: [["God keeps the covenant line clear.", "Isaac is not chosen because the family is tidy. He is chosen because God promised."], ["Human shortcuts can create lasting pain.", "The Hagar and Ishmael conflict did not disappear when Isaac was born."], ["God can give direction inside painful family situations.", "Abraham is grieved, but God speaks into the confusion."]],
      application: ["Do not pretend old choices have no consequences.", "Let God define calling instead of family pressure.", "Painful clarity can still be mercy.", "God sees people even when the promise line is specific."],
    }),
    makeCompactGenesisStudySection({
      chapter: 21,
      startVerse: 14,
      ...
      title: "God Hears Ishmael In The Wilderness",
      icon: "\u{1F4D6}",
      summary: "Hagar and Ishmael are sent away, but God hears the boy and opens Hagar's eyes to water.",
      movement: ["Hagar and Ishmael enter the wilderness.", "The water runs out and Hagar despairs.", "God hears the boy's voice.", "God opens Hagar's eyes to a well."],
      phrases: [["God Heard The Voice Of The Lad", "Ishmael's name means God hears, and this moment shows that name becoming reality again. He is not the covenant son, but he is not invisible to God."], ["God Opened Her Eyes", "The well was there, but Hagar could not see it in her despair. Sometimes mercy is near, but grief and fear make it hard to recognize."], ["I Will Make Him A Great Nation", "God repeats His promise over Ishmael. Isaac carries the covenant line, but Ishmael still receives a future because God keeps His word."]],
      truths: [["God hears people outside the main covenant line.", "The story does not abandon Hagar and Ishmael."], ["Wilderness is not the same as abandonment.", "God meets Hagar in the place where she thinks hope is gone."], ["God can reveal provision that despair hides.", "Opening Hagar's eyes is part of the rescue."]],
      application: ["Remember that God hears cries other people overlook.", "Ask God to open your eyes to provision nearby.", "Do not confuse wilderness with being forgotten.", "God can be faithful to more than one promise at once."],
    }),
    makeCompactGenesisStudySection({
      chapter: 21,
      startVerse: 22,
      endVerse: 24,
      reference: "Genesis 21:22-24",
      title: "Abimelech Sees God With Abraham",
      icon: "\u{1F4D6}",
      summary: "Abimelech recognizes God's hand on Abraham and asks for a covenant of peace.",
      movement: ["Abimelech approaches Abraham with Phichol.", "He admits that God is with Abraham.", "He asks Abraham not to deal falsely with him.", "Abraham agrees to peace."],
      phrases: [["God Is With Thee In All That Thou Doest", "An outsider can see God's blessing on Abraham's life. The promise is becoming visible, not only privately believed."], ["Swear Unto Me Here By God", "Abimelech wants a stable agreement because Abraham's God-backed future feels weighty. Ancient covenants gave clarity where trust was fragile."]],
      truths: [["God's presence can become visible to outsiders.", "Abimelech sees that Abraham is not alone."], ["Faithfulness includes honest dealings.", "Abraham's calling does not remove the need for integrity."]],
      application: ["Live so God's hand is not hidden by dishonesty.", "Make peace with clarity when possible.", "Let blessing make you humble, not careless."],
    }),
    makeCompactGenesisStudySection({
      chapter: 21,
      startVerse: 25,
      endVerse: 30,
      reference: "Genesis 21:25-30",
      title: "The Well Becomes A Witness",
      icon: "\u{1F4D6}",
      summary: "Abraham confronts a well dispute and uses seven lambs as a public witness.",
      movement: ["Abraham reproves Abimelech over a seized well.", "Abimelech says he did not know.", "They make a covenant.", "Seven ewe lambs witness Abraham's claim."],
      phrases: [["Abraham Reproved Abimelech", "Abraham does not ignore injustice to keep false peace. He names the problem clearly."], ["A Well Of Water", "In a dry land, a well meant survival, settlement, and future. This is not a small property issue."], ["Seven Ewe Lambs", "The lambs act like legal testimony. They publicly mark that Abraham dug and owns the well."]],
      truths: [["Peace should not require hiding the truth.", "Abraham makes peace while still addressing the wrong."], ["Small land details matter in the promise story.", "A well is not the whole land, but it is a real foothold."]],
      application: ["Handle conflict with truth and clarity.", "Do not despise small footholds God gives.", "Let agreements be clear enough to protect peace."],
    }),
    makeCompactGenesisStudySection({
      chapter: 21,
      startVerse: 31,
      ...
      icon: "\u{1F4D6}",
      summary: "Abraham names Beersheba, plants a tree, and worships the everlasting God while still living as a sojourner.",
      movement: ["The place is named Beersheba.", "Abraham plants a tree.", "He calls on the everlasting God.", "He continues living in the land as a sojourner."],
      phrases: [["Beersheba", "The name is tied to oath and seven, marking the covenant made at the well. The place becomes a memory marker in the promise land."], ["Planted A Grove", "Planting a tree suggests settled hope. Abraham still owns little land, but he acts like God's promise has a future."], ["The Everlasting God", "Abraham worships God as the One whose faithfulness outlasts his temporary situation. His life is brief, but God's promise is not."]],
      truths: [["Worship belongs in waiting.", "Abraham still sojourns, but he calls on God."], ["Memory markers can strengthen faith.", "Beersheba remembers oath, provision, and peace."]],
      application: ["Mark places where God has been faithful.", "Worship before everything is fully settled.", "Trust the everlasting God with temporary seasons."],
    }),
    makeCompactGenesisStudySection({
      chapter: 22,
      startVerse: 1,
      ...
      icon: "\u{1F4D6}",
      summary: "God tests Abraham by asking for Isaac, and Abraham walks toward Moriah with the son of promise.",
      movement: ["God calls Abraham by name.", "Isaac is named as the beloved son.", "Abraham goes to Moriah.", "Isaac asks where the lamb is."],
      phrases: [["God Did Test Abraham", "This is a test, not God tempting Abraham to evil. The test exposes whether Abraham trusts the giver more than the gift."], ["Thine Only Son Isaac", "The phrase presses the emotional weight of the command. Isaac is the son through whom the promise is supposed to continue."], ["God Will Provide Himself A Lamb", "Abraham's answer carries the heart of the chapter. He does not know how God will provide, but he believes provision belongs to God."]],
      truths: [["Faith can be tested at the place of deepest promise.", "The test touches Isaac, not something small."], ["God's promise must be trusted back to God.", "Abraham cannot control the covenant future by holding Isaac tightly."]],
      application: ["Bring your deepest promise back under God's authority.", "Obedience may begin before you understand the outcome.", "Look for the God who provides."],
    }),
    makeCompactGenesisStudySection({
      chapter: 22,
      startVerse: 9,
      ...
      icon: "\u{1F4D6}",
      summary: "Abraham raises the knife, God stops him, and a ram is provided in Isaac's place.",
      movement: ["Abraham builds the altar.", "Isaac is bound and placed on the wood.", "The angel of the Lord stops Abraham.", "A ram is offered instead of Isaac."],
      phrases: [["Bound Isaac His Son", "This is the most painful moment in the test. The promised son is placed on the altar, making the reader feel the impossible tension."], ["Lay Not Thine Hand Upon The Lad", "God stops the sacrifice. Isaac is spared because God never intended child sacrifice as the fulfillment of the promise."], ["A Ram Caught In A Thicket", "The ram becomes the substitute. Isaac lives because another offering is provided in his place."]],
      truths: [["God provides the substitute.", "The center of the story is not Abraham's loss, but God's provision."], ["The Lord sees the altar before we do.", "The ram is already there when the moment comes."]],
      application: ["Trust God's provision when obedience feels costly.", "Do not miss the substitute God provides.", "Let this story teach reverence, not careless confidence."],
    }),
    makeCompactGenesisStudySection({
      chapter: 22,
      startVerse: 15,
      ...
      icon: "\u{1F4D6}",
      summary: "After the test, God repeats the promise of seed, blessing, victory, and blessing to the nations.",
      movement: ["The angel of the Lord calls again.", "God swears by Himself.", "The promise of many descendants is repeated.", "The nations will be blessed through Abraham's seed."],
      phrases: [["By Myself Have I Sworn", "God swears by Himself because there is no higher authority. The promise rests on God's own character."], ["As The Stars Of The Heaven", "The promise returns to the picture of countless descendants. God's word to Abraham has not shrunk after the test."], ["In Thy Seed Shall All The Nations Be Blessed", "The promise is bigger than Abraham's family. God intends blessing to reach the nations through Abraham's seed."]],
      truths: [["God's covenant rests on His own faithfulness.", "The promise is secured by God's oath."], ["Testing does not cancel promise.", "After Moriah, God repeats the blessing."]],
      application: ["Let God's repeated word steady you after testing.", "Remember that obedience is part of a larger story.", "Look for how God's blessing moves beyond one family."],
    }),
    makeCompactGenesisStudySection({
      chapter: 23,
      startVerse: 1,
      ...
      title: "Sarah Dies",
      icon: "\u{1F4D6}",
      summary: "Sarah dies in Canaan, and Abraham mourns and weeps for her.",
      movement: ["Sarah's age is recorded.", "She dies in the promised land.", "Abraham comes to mourn.", "Faith makes room for tears."],
      phrases: [["Sarah Was An Hundred And Seven And Twenty Years Old", "Sarah is the only woman in Scripture whose age at death is recorded this way. Genesis honors her place in the covenant story."], ["Abraham Came To Mourn For Sarah", "Abraham is the father of faith, but he still grieves. Trusting God does not make death painless."]],
      truths: [["Faith grieves honestly.", "Abraham's tears are not treated as unbelief."], ["Promise does not erase loss.", "Sarah dies in the land connected to God's promise."]],
      application: ["Let grief be honest before God.", "Do not shame tears as lack of faith.", "Remember that loved people matter in the story."],
    }),
    makeCompactGenesisStudySection({
      chapter: 23,
      startVerse: 3,
      endVerse: 7,
      reference: "Genesis 23:3-7",
      title: "Abraham Asks For A Burial Place",
      icon: "\u{1F4D6}",
      summary: "Abraham calls himself a stranger and sojourner and asks for a burial possession.",
      movement: ["Abraham rises from mourning.", "He speaks to the sons of Heth.", "He calls himself a stranger and sojourner.", "He asks for a burial place."],
      phrases: [["A Stranger And A Sojourner", "Abraham lives in the promised land, but he does not fully possess it yet. He belongs to God's promise while still waiting."], ["A Possession Of A Buryingplace", "Abraham asks for a secure burial place, not a temporary favor. Burial connected family, memory, land, and future hope."]],
      truths: [["Promise can coexist with waiting.", "Abraham has God's word but still must buy a grave."], ["Faith handles practical needs.", "Mourning leads to real arrangements, not denial."]],
      application: ["Be honest about living between promise and possession.", "Handle grief with both sorrow and responsibility.", "Let practical faithfulness matter."],
    }),
    makeCompactGenesisStudySection({
      chapter: 23,
      startVerse: 8,
      endVerse: 12,
      reference: "Genesis 23:8-12",
      title: "The Cave Of Machpelah",
      icon: "\u{1F4D6}",
      summary: "Abraham asks for the cave of Machpelah and begins a public negotiation.",
      movement: ["Abraham asks the people to speak to Ephron.", "He identifies the cave of Machpelah.", "He offers full price.", "The negotiation happens publicly."],
      phrases: [["The Cave Of Machpelah", "Machpelah becomes a family burial place for Sarah, Abraham, Isaac, Rebekah, Leah, and Jacob. It becomes a memory anchor for the patriarchs."], ["For As Much Money As It Is Worth", "Abraham wants the purchase to be clean and undisputed. He is not trying to use pressure or status to get the land cheaply."]],
      truths: [["Integrity matters in waiting.", "Abraham acts honorably even though God promised the land."], ["Places can hold covenant memory.", "Machpelah becomes tied to grief, family, and hope."]],
      application: ["Do business with integrity.", "Do not manipulate what God promised.", "Notice places where grief and hope meet."],
    }),
    makeCompactGenesisStudySection({
      chapter: 23,
      startVerse: 13,
      endVerse: 16,
      reference: "Genesis 23:13-16",
      title: "Abraham Pays The Full Price",
      icon: "\u{1F4D6}",
      summary: "Abraham insists on paying the full public price for the field and cave.",
      movement: ["Ephron names the price.", "Abraham listens publicly.", "The silver is weighed.", "The purchase becomes legally clear."],
      phrases: [["Four Hundred Shekels Of Silver", "The price is named and weighed so the transaction is official. Genesis wants the reader to know Abraham truly bought this land."], ["Current Money With The Merchant", "The detail shows a recognized public standard. This is careful legal language, not vague family memory."]],
      truths: [["Faith does not need shady shortcuts.", "Abraham pays openly."], ["Legal clarity can protect future peace.", "The field cannot easily be disputed later."]],
      application: ["Pay what is right when integrity matters.", "Let public clarity protect private promises.", "Do not confuse faith with entitlement."],
    }),
    makeCompactGenesisStudySection({
      chapter: 23,
      startVerse: 17,
      ...
      title: "Sarah Is Buried In Machpelah",
      icon: "\u{1F4D6}",
      summary: "The field and cave are secured, and Sarah is buried in the promised land.",
      movement: ["The field, cave, and trees are listed.", "The purchase is confirmed before witnesses.", "Sarah is buried in Machpelah.", "The first owned foothold in Canaan is a grave."],
      phrases: [["Made Sure Unto Abraham", "The wording means the property is legally confirmed to Abraham. The promise now has a small, real foothold in the land."], ["Before All That Went In At The Gate", "The city gate was where public business and legal witness happened. This purchase was not hidden."], ["Abraham Buried Sarah His Wife", "The chapter ends with love, grief, and promise together. Sarah's burial place becomes part of the family's future memory."]],
      truths: [["The first owned land is a burial place.", "The promise takes root through grief before full possession."], ["Death does not cancel God's promise.", "Sarah is buried, but the covenant story continues."]],
      application: ["Let grief and hope stand together.", "Remember that small footholds can matter.", "Trust God when the promise begins quietly."],
    }),
    makeCompactGenesisStudySection({
      chapter: 24,
      startVerse: 1,
      endVerse: 5,
      reference: "Genesis 24:1-5",
      title: "Abraham Sends His Servant",
      icon: "\u{1F4D6}",
      summary: "Abraham is old, Isaac needs a wife, and the promise must be carried into the next generation.",
      movement: ["Abraham's life is nearing its final stage.", "He gives a trusted servant a serious oath.", "Isaac must not marry into the Canaanite household world.", "The servant asks what should happen if the woman will not come."],
      phrases: [["Abraham Was Old", "Genesis starts the chapter by showing that Abraham's part of the journey is nearing its close. The promise cannot stop with him, so Isaac's future matters deeply."], ["Put Your Hand Under My Thigh", "This sounds strange today, but it was an ancient oath gesture tied to family, descendants, and covenant seriousness. Abraham is not treating Isaac's marriage like a casual preference."], ["Not Take A Wife From The Daughters Of The Canaanites", "Abraham is protecting covenant identity. The issue is not romance only; marriage will shape worship, household direction, children, and the future of the promise."]],
      truths: [["God's promise moves through generations.", "Abraham will not live forever, but God's covenant will continue through Isaac."], ["Covenant responsibility can include practical decisions.", "The servant is given a real task that affects the future of the promise."], ["Faith sometimes needs clear boundaries.", "Abraham knows the covenant family must not be absorbed into the surrounding culture."]],
      application: ["Think about what faithfulness passes forward, not only what it receives.", "Treat decisions that shape a household with spiritual seriousness.", "Some boundaries protect calling, worship, and future obedience.", "Faith can ask practical questions without rejecting God."],
    }),
    makeCompactGenesisStudySection({
      chapter: 24,
      startVerse: 6,
      endVerse: 9,
      reference: "Genesis 24:6-9",
      title: "Isaac Must Not Go Back",
      icon: "\u{1F4D6}",
      summary: "Abraham insists that Isaac must not return to the old land, because the promise is tied to Canaan.",
      movement: ["Abraham warns the servant not to take Isaac back.", "Abraham remembers the God who called him out.", "He trusts that God will send His angel ahead.", "The servant accepts the oath."],
      phrases: [["Bring Not My Son Thither Again", "Abraham is very clear that Isaac must not reverse the journey God began. Isaac belongs to the promise land even before the family fully possesses it."], ["The Lord God Of Heaven", "Abraham grounds this mission in the God who rules heaven and earth. The future of Isaac's family is not being decided apart from God's authority."], ["He Shall Send His Angel Before Thee", "Abraham believes God's guidance will go ahead of the servant. That does not remove responsibility; it gives confidence while the servant obeys."]],
      truths: [["Promise has a direction.", "Isaac must move forward in the land God promised, not backward into Abraham's old life."], ["Remembered calling shapes present choices.", "Abraham gives instructions based on what God already said."], ["Guidance and obedience belong together.", "The servant must go, and God must guide."]],
      application: ["Do not return to what God called you out of just because the next step is hard.", "Let God's past faithfulness shape today's decisions.", "Pray for guidance while still taking obedient steps.", "Make commitments clear when the future matters."],
    }),
    makeCompactGenesisStudySection({
      chapter: 24,
      startVerse: 10,
      endVerse: 14,
      reference: "Genesis 24:10-14",
      title: "The Servant Prays At The Well",
      icon: "\u{1F4D6}",
      summary: "The servant reaches the well and prays for God to reveal the right woman through generous character.",
      movement: ["The servant travels with Abraham's camels and goods.", "He stops at the well when women come to draw water.", "He asks the Lord for guidance.", "The sign he asks for will reveal kindness and service."],
      phrases: [["Ten Camels", "The camels show Abraham's wealth and the seriousness of the mission. They also make the coming test meaningful because watering camels takes real work."], ["The Well Of Water", "Wells were important places of provision and meeting in the ancient world. In Genesis, important marriage stories often begin around wells."], ["Send Me Good Speed This Day", "The servant is asking for successful guidance, not selfish luck. He knows this mission depends on God's kindness to Abraham."]],
      truths: [["Prayer belongs before major decisions.", "The servant does not trust only travel plans, wealth, or strategy."], ["God can guide through ordinary places.", "The well is normal daily life, but God uses it for covenant direction."], ["Character matters more than appearance.", "The sign is about generosity, not surface-level beauty."]],
      application: ["Pray before decisions that affect your future.", "Pay attention to what ordinary moments reveal.", "Look for character that serves when no one forces it.", "Practical details can become part of God's guidance."],
    }),
    makeCompactGenesisStudySection({
      chapter: 24,
      startVerse: 15,
      ...
      icon: "\u{1F4D6}",
      summary: "Before the servant finishes praying, Rebekah comes to the well and shows generous hospitality.",
      movement: ["Rebekah appears before the prayer is finished.", "She gives the servant water.", "She offers to water the camels too.", "She runs and keeps drawing until the work is done."],
      phrases: [["Before He Had Done Speaking", "Genesis wants the reader to notice providence. The answer is already arriving while the servant is still praying."], ["Rebekah Came Out", "Rebekah is introduced by name and family line because she is connected to Abraham's kin. This matters for the mission Abraham gave the servant."], ["I Will Draw Water For Thy Camels Also", "This is exactly the sign the servant prayed for, but it is also costly service. Rebekah does not do the minimum; she gives strength and time."]],
      truths: [["God can already be moving while we pray.", "The servant's answer is not late; it is arriving as he speaks."], ["Generosity reveals character.", "Rebekah's actions show the kind of person she is."], ["Faithful character often looks practical.", "She serves through water, effort, speed, and follow-through."]],
      application: ["Remember that God may be working before you see the answer.", "Notice generosity in ordinary actions.", "Do not despise practical service; it can reveal deep character.", "Going beyond the minimum matters."],
    }),
    makeCompactGenesisStudySection({
      chapter: 24,
      startVerse: 21,
      endVerse: 27,
      reference: "Genesis 24:21-27",
      title: "The Servant Worships",
      icon: "\u{1F4D6}",
      summary: "The servant watches carefully, confirms Rebekah's family, and worships the Lord for His guidance.",
      movement: ["The servant watches in silence.", "He gives Rebekah gold gifts.", "He asks about her family and lodging.", "He worships when he sees the Lord has led him."],
      phrases: [["Wondering At Her Held His Peace", "The servant does not rush the moment even after the sign begins. He watches carefully to discern whether the Lord has prospered the journey."], ["Golden Earring And Two Bracelets", "The gifts show honor and seriousness. This is moving toward a formal family conversation, not a random meeting at the well."], ["Blessed Be Yahweh", "The servant turns guidance into worship. He recognizes that mercy and truth, not luck, have led him to Abraham's family."]],
      truths: [["Discernment includes patience.", "The servant prays, then watches instead of grabbing at the first sign."], ["Guidance should lead to worship.", "He gives God credit when the path becomes clear."], ["God leads with precision.", "The prayer sign and family connection come together."]],
      application: ["Do not rush discernment just because something looks promising.", "Thank God when guidance becomes visible.", "Treat people with honor when decisions involve them.", "Look for confirmation that fits God's purpose, not just your preference."],
    }),
    makeCompactGenesisStudySection({
      chapter: 24,
      startVerse: 28,
      ...
      title: "The Family Receives The Servant",
      icon: "\u{1F4D6}",
      summary: "Rebekah tells her household, Laban welcomes the servant, and the servant keeps the mission first.",
      movement: ["Rebekah runs to tell her family.", "Laban notices the gifts and comes to the well.", "The servant and camels are welcomed.", "??? The servant refuses to eat until he explains his mission."],
      phrases: [["Rebekah Ran", "Rebekah keeps appearing as active, energetic, and responsive. She serves, speaks, moves, and later chooses."], ["Laban Saw The Earring And Bracelets", "Laban's attention to the jewelry may hint at his interest in wealth. That detail matters later when Jacob meets Laban."], ["??? I Will Not Eat Until I Have Told Mine Errand", "The servant stays focused. Hospitality is good, but he will not let comfort distract him from the covenant mission."]],
      truths: [["Hospitality opens a door for testimony.", "The family receives the servant and now gets to hear what God has done."], ["??? Mission can come before comfort.", "The servant keeps the main thing first."], ["Small details can reveal character.", "Laban's interest in the gifts may prepare readers for later stories."]],
      application: ["Let hospitality make room for meaningful conversation.", "??? Do not let comfort make you forget the mission.", "Pay attention to what people notice first.", "Good character often moves quickly to serve."],
    }),
    makeCompactGenesisStudySection({
      chapter: 24,
      startVerse: 34,
      endVerse: 41,
      reference: "Genesis 24:34-41",
      title: "The Servant Tells Abraham's Story",
      icon: "\u{1F4D6}",
      summary: "The servant explains who Abraham is, how God blessed him, and why this mission matters.",
      movement: ["The servant identifies himself as Abraham's servant.", "He tells how the Lord blessed Abraham.", "He explains Isaac's special place as heir.", "He repeats the oath and Abraham's confidence in God's guidance."],
      phrases: [["I Am Abraham's Servant", "The servant does not center himself. He is there as a representative carrying Abraham's business."], ["The Lord Hath Blessed My Master Greatly", "The servant lists Abraham's wealth, but the greatest blessing is Isaac. Isaac is the promised son and heir."], ["My Master Made Me Swear", "The repeated oath shows that the mission is careful and serious. The servant is not making up his own plan."]],
      truths: [["Faithful service represents another well.", "The servant speaks accurately and humbly for Abraham."], ["The covenant heir matters.", "Isaac's marriage is about the continuation of God's promise."], ["Serious callings deserve clear retelling.", "The servant repeats the mission so the family understands what is at stake."]],
      application: ["Be faithful when carrying responsibility for someone else.", "Remember that future generations can be shaped by today's obedience.", "Speak clearly when a decision is spiritually serious.", "Blessing should point back to the Lord who gave it."],
    }),
    makeCompactGenesisStudySection({
      chapter: 24,
      startVerse: 42,
      ...
      title: "The Servant Explains The Prayer",
      icon: "\u{1F4D6}",
      summary: "The servant retells the prayer at the well and asks Rebekah's family for a clear answer.",
      movement: ["The servant explains his prayer.", "He tells how Rebekah appeared before he finished.", "He describes her exact generous response.", "??? He asks the family to answer kindly and truly."],
      phrases: [["I Came This Day Unto The Well", "The servant retells the well scene so the family can see God's guidance step by step. The well becomes evidence, not just scenery."], ["Before I Had Done Speaking In Mine Heart", "God heard the servant's inward prayer. The answer came before the prayer was even finished."], ["??? If Ye Will Deal Kindly And Truly", "The servant asks for a clear answer. He is not manipulating the family; he asks them to respond honestly."]],
      truths: [["??? Testimony helps others recognize God's guidance.", "The servant retells the story so the family can understand why this matters."], ["God hears even quiet prayer.", "The prayer in his heart was not hidden from God."], ["Clear answers matter.", "Faithful guidance still calls people to respond."]],
      application: ["??? Tell the story of God's guidance clearly, not dramatically.", "Take comfort that God hears prayers no one else hears.", "Ask for honest answers instead of manipulating outcomes.", "Let character, not pressure, confirm the path."],
    }),
    makeCompactGenesisStudySection({
      chapter: 24,
      startVerse: 50,
      ...
      title: "The Family Recognizes The Lord",
      icon: "\u{1F4D6}",
      summary: "Rebekah's family recognizes the Lord's hand, agrees to the marriage, and the servant worships again.",
      movement: ["Laban and Bethuel say the matter is from the Lord.", "They agree that Rebekah should become Isaac's wife.", "The servant bows and worships.", "Gifts and a meal mark the agreement."],
      phrases: [["The Thing Proceedeth From The Lord", "The family recognizes that the servant's story is not random. Prayer, timing, family connection, and Rebekah's character all point to the Lord's hand."], ["Let Her Be Thy Master's Son's Wife", "Marriage here is connected to family, covenant, blessing, and God's direction. Rebekah is being brought into the Abraham promise story."], ["He Worshipped The Lord", "The servant worships again because answered guidance should not be treated casually. He gives the Lord credit before moving forward."]],
      truths: [["Providence should be recognized.", "The family sees enough to say the matter is from the Lord."], ["Marriage can shape covenant future.", "Rebekah's marriage to Isaac matters for the next generation."], ["Gratitude belongs after guidance.", "The servant worships when God opens the way."]],
      application: ["When God's hand is clear, acknowledge it.", "Treat life-shaping relationships with spiritual seriousness.", "Do not move past answered prayer without worship.", "Celebrate guidance with gratitude, not pride."],
    }),
    makeCompactGenesisStudySection({
      chapter: 24,
      startVerse: 55,
      ...
      icon: "\u{1F4D6}",
      summary: "Rebekah is asked directly, chooses to go, receives a blessing, and leaves for Isaac.",
      movement: ["Her family asks for delay.", "??? Rebekah is asked if she will go.", "She answers, 'I will go.'", "Her family blesses her future descendants."],
      phrases: [["Let The Damsel Abide With Us A Few Days", "The delay request is understandable because Rebekah is leaving home. But the servant sees the Lord's guidance and wants to complete the mission."], ["??? We Will Call The Damsel", "Rebekah's voice matters in the story. She is asked directly instead of being treated like property moved between households."], ["I Will Go", "This is one of the strongest lines in the chapter. Like Abraham, Rebekah leaves what she knows and steps into the promise story by faith."]],
      truths: [["Faith can require leaving familiar places.", "Rebekah's yes moves her into an unknown future tied to God's promise."], ["??? Willing response matters.", "Her family asks her, and her answer confirms the path."], ["Blessing looks toward future generations.", "The words over Rebekah echo the larger promise themes of descendants and victory."]],
      application: ["Courage may sound simple: 'I will go.'", "??? Do not ignore the voice of the person most affected by a decision.", "Do not delay obedience once the path is clear.", "Remember that one faithful yes can shape generations."],
    }),
    makeCompactGenesisStudySection({
      chapter: 24,
      startVerse: 62,
      ...
      icon: "\u{1F4D6}",
      summary: "Isaac meets Rebekah, receives the servant's report, marries her, loves her, and is comforted.",
      movement: ["Isaac is in the field at evening.", "Isaac and Rebekah see one another.", "Rebekah covers herself with a veil.", "Isaac receives Rebekah and is comforted after Sarah's death."],
      phrases: [["Isaac Went Out To Meditate", "Isaac appears in a quiet, reflective scene. After the trauma of Moriah and the grief of Sarah's death, the story slows down."], ["She Took A Vail", "Rebekah's veil fits the modesty and marriage customs of the setting. She recognizes the seriousness of meeting Isaac."], ["Isaac Was Comforted After His Mother's Death", "Rebekah does not erase Sarah's death, but her arrival brings new love and comfort. Genesis connects covenant continuity with real human healing."]],
      truths: [["God can bring comfort after grief.", "Isaac receives Rebekah after Sarah's death, and the chapter ends tenderly."], ["The promise continues through real family life.", "The covenant moves forward through marriage, love, and the next generation."], ["Testimony should be passed on.", "The servant tells Isaac all that happened, so Isaac hears how God guided the journey."]],
      application: ["New comfort does not dishonor old grief.", "God's promise moves through ordinary human relationships.", "Tell the story of God's guidance to those who need to hear it.", "Watch how God can turn a season of loss toward a new chapter."],
    }),
  ],
);
...
BIBLE_READER_STUDY_SECTIONS.push(
  ...[
    ...
    makeCompactGenesisStudySection({
      ...
      movement: ["?? Famine comes in Isaac's day.", "??? God tells Isaac not to go to Egypt.", "?? God repeats the Abrahamic promise.", "?? Isaac says Rebekah is his sister out of fear."],
      phrases: [["?? There Was A Famine", "Isaac faces a test similar to Abraham's. The next generation has to learn trust personally."], ["??? Go Not Down Into Egypt", "God gives Isaac a specific command for this famine. Trust means staying where God says stay."], ["?? She Is My Sister", "Isaac repeats Abraham's fear pattern. Family weaknesses can echo if they are not healed."]],
      ...
      application: ["?? Famine moments reveal where trust lives.", "?? Watch for family fear patterns repeating in you.", "??? Stay where God says, even when Egypt looks safer.", "?? God's promise must become personal in each generation."],
    }),
    makeCompactGenesisStudySection({
      chapter: 26,
      startVerse: 12,
    ...
    makeCompactGenesisStudySection({
      ...
      application: ["?? Do not use deception to help God's promise.", "???????? Favoritism can poison a family.", "?? Blessing should not be handled through secrecy and manipulation.", "?? God's faithfulness does not make our methods harmless."],
    }),
    makeCompactGenesisStudySection({
      chapter: 27,
      startVerse: 30,
      ...
      movement: ["?? Esau returns and discovers the blessing is gone.", "?? Isaac trembles greatly.", "?? Esau plans to kill Jacob.", "?? Rebekah sends Jacob away to Haran."],
      ...
      truths: [["?? Sin leaves grief behind.", "The blessing scene ends with tears, trembling, anger, and exile."], ["?? Getting the blessing wrongly can still bring consequences.", "Jacob carries the promise, but he must flee. God's plan continues through painful discipline."], ["?? Family wounds can become dangerous.", "Esau's grief turns toward murder. The family fracture is severe."]],
      application: ["?? Do not ignore the grief deception causes.", "?? A gained advantage can still come with painful loss.", "?? Deal with family wounds before anger becomes violence.", "?? God's promise continues, but sin still scars the journey."],
    }),
  ],
);
...
BIBLE_READER_STUDY_SECTIONS.push(
  ...[
    ...
    makeCompactGenesisStudySection({
      ...
      movement: ["?? Esau sees that Canaanite wives displease Isaac.", "?? He reacts after watching Jacob be sent away.", "?? He marries into Ishmael's family line.", "?? His response is religious-looking, but still confused."],
      ...
      truths: [["?? Reaction is not the same as repentance.", "Esau responds to family disapproval, but Genesis does not show him humbly seeking God's promise."], ["?? Religious-looking choices can still miss the point.", "A move can look closer to the family of Abraham and still not be covenant faith."], ["?? Delayed attention has consequences.", "Esau cared about the birthright too late. Genesis keeps warning us not to treat holy things as small." ]],
      application: ["?? Ask whether you are changing because you see truth or only because you feel consequences.", "?? Do not cover old disobedience with a new religious-looking decision.", "?? Pay attention before loss teaches the lesson harder.", "?? The outside move matters less than the heart behind it."],
    }),
    makeCompactGenesisStudySection({
      chapter: 28,
      startVerse: 10,
      ...
      movement: ["?? Jacob sleeps outside with a stone for a pillow.", "?? He sees a stairway between earth and heaven.", "?? Angels ascend and descend on it.", "??? God promises land, offspring, blessing, presence, protection, and return."],
      phrases: [["?? Ladder Set Up On The Earth", "The stairway shows heaven and earth connected by God's initiative. Jacob is not climbing up to find God; God is revealing access and presence to Jacob."], ["?? Angels Ascending And Descending", "The messengers show that Jacob's lonely road is not empty. God's world is active even where Jacob only sees wilderness."], ["??? I Am With Thee", "This is the heart of the dream. God does not only promise land and descendants; He promises His presence on the road until Jacob returns." ]],
      truths: [["?? God meets people before they are polished.", "Jacob has not become a mature hero yet. God meets him while he is running from a damaged home."], ["?? Heaven is nearer than Jacob realized.", "The wilderness looks ordinary, but God opens Jacob's eyes to spiritual reality."], ["??? God's promise becomes personal.", "Jacob has heard of Abraham and Isaac's God. Now the Lord speaks the promise directly over Jacob." ]],
      application: ["?? A lonely place can become a meeting place with God.", "?? You do not have to climb into God's attention; He comes down in mercy.", "??? Hold tightly to God's presence when the road is uncertain.", "?? There may be more happening around your life than your eyes can see."],
    }),
    makeCompactGenesisStudySection({
      chapter: 28,
      startVerse: 16,
      ...
      movement: ["?? Jacob wakes with awe and fear.", "?? He calls the place the house of God.", "?? He sets up the stone as a pillar.", "??? He pours oil on it and makes a vow."],
      phrases: [["?? I Knew It Not", "Jacob thought he was simply stopping for the night. The line teaches readers that God can be present in places we did not recognize as holy."], ["?? Bethel", "Bethel means house of God. Jacob renames the place because God's presence changed the meaning of the location."], ["??? Poured Oil Upon The Top Of It", "Pouring oil marks the stone as set apart. Jacob is responding physically to a spiritual encounter he does not want to forget." ]],
      ...
      application: ["?? Ask God to help you notice where He has been present.", "?? Mark the moments you do not want your soul to forget.", "?? An ordinary place can become holy because God met you there.", "??? Let worship respond when God wakes you up spiritually."],
    }),
    makeCompactGenesisStudySection({
      chapter: 29,
      startVerse: 1,
    ...
    makeCompactGenesisStudySection({
      ...
      movement: ["?? Laban asks Jacob to name his wages.", "?? Jacob asks to serve for Rachel.", "? He serves seven years.", "?? The years seem like a few days because of his love."],
      phrases: [["?? What Shall Thy Wages Be", "Laban sounds fair, but readers should stay alert. His questions often serve his own advantage."], ["?? I Will Serve Thee Seven Years", "Jacob names a costly commitment. His love is not only emotion; it becomes years of labor."], ["?? But A Few Days", "Genesis gives us one of its tender lines here. Love changes how Jacob experiences the weight of time, even though seven years is still a long sacrifice." ]],
      truths: [["?? Love is shown through costly patience.", "Jacob's love for Rachel takes the shape of years, not only words."], ["? Waiting can be filled with purpose.", "These seven years are not empty time. Jacob is working toward a covenant future."], ["?? Tender moments can still sit near danger.", "The sweetness of Jacob's love is real, but Laban's character is about to turn the scene painful." ]],
      application: ["?? Real love can serve without needing everything instantly.", "? A long wait can still have meaning.", "?? Be wise when someone else controls the terms.", "?? Let love make sacrifice faithful, not foolish."],
    }),
    makeCompactGenesisStudySection({
      chapter: 29,
      startVerse: 21,
      ...
      movement: ["??? Laban makes a feast.", "?? In the evening, Leah is brought to Jacob.", "?? In the morning, Jacob sees the deception.", "?? Laban uses custom to justify manipulation."],
      ...
      truths: [["?? Deception teaches pain from the other side.", "Jacob now feels what it is like to be manipulated by someone close."], ["?? Sin can echo through consequences.", "This does not mean every hard thing is payback, but Genesis clearly links Jacob's deceptive past with this painful reversal."], ["?? People can be used inside someone else's scheme.", "Leah and Rachel are not just plot pieces. Laban's manipulation wounds both daughters too." ]],
      application: ["?? Do not excuse manipulation because it gets a desired result.", "?? Notice who gets hurt when powerful people scheme.", "?? Let painful consequences teach humility, not bitterness.", "?? What is done in darkness still comes into morning."],
    }),
    makeCompactGenesisStudySection({
      chapter: 29,
      startVerse: 31,
      ...
      movement: ["??? Yahweh sees that Leah is unloved.", "?? Leah bears sons while Rachel is barren.", "?? Leah names sons out of pain and longing.", "?? Judah is born, and his line will become deeply important."],
      phrases: [["??? When The Lord Saw", "This is the comfort of the passage. Leah may feel unseen by Jacob, but she is not unseen by Yahweh."], ["?? Hated", "The word can mean unloved or rejected by comparison. Leah lives inside a marriage where she knows she is not the chosen love."], ["?? Judah", "Judah's birth is easy to pass over, but it is huge. Kings will come through Judah, and ultimately Jesus will be called the Lion of Judah." ]],
      truths: [["??? God sees the overlooked.", "Leah's pain is visible to God even when her husband fails to love her rightly."], ["?? Fruitfulness does not erase emotional pain.", "Leah has children, but her names show she still longs to be loved."], ["?? God can bring major purpose through an unloved person.", "Judah comes from Leah, not Rachel. Genesis keeps showing God lifting the overlooked." ]],
      application: ["??? Being overlooked by people does not make you invisible to God.", "?? Let God tell the truth about pain instead of pretending blessing fixes everything.", "?? Do not assume your hidden story cannot carry future purpose.", "?? Worship can grow even from a wounded place."],
    }),
    makeCompactGenesisStudySection({
      chapter: 30,
      startVerse: 1,
      ...
      movement: ["?? Rachel envies Leah because she has no children.", "?? Bilhah is brought into the rivalry.", "?? Leah answers through Zilpah.", "?? Children are born inside competition instead of peace."],
      phrases: [["?? Rachel Envied Her Sister", "Rachel has Jacob's love, but Leah has children. Each sister has something the other longs for, and envy turns their pain against each other."], ["?? Bilhah My Maid", "Bilhah is pulled into Rachel's pain as a solution. Genesis is showing family growth, but not pretending this system is healthy."], ["?? With Great Wrestlings", "Rachel describes the family as a wrestling match. The language reveals the emotional combat happening inside the household." ]],
      truths: [["?? Envy can make blessing feel invisible.", "Rachel is loved by Jacob, but envy over Leah's children consumes her."], ["?? Broken systems often use vulnerable people.", "Bilhah and Zilpah are caught in a rivalry they did not create."], ["?? Family growth is not always family health.", "More children are born, but the household is full of competition and pain." ]],
      application: ["?? Do not let someone else's blessing erase what God has given you.", "?? Watch who gets used when your pain starts making decisions.", "?? Winning a rivalry is not the same as healing a heart.", "?? Bring envy to God before it starts shaping the house."],
    }),
    makeCompactGenesisStudySection({
      chapter: 30,
      startVerse: 14,
      ...
      movement: ["?? Mandrakes become part of the sister conflict.", "?? God listens to Leah.", "??? God remembers Rachel.", "?? Joseph is born, and the Genesis story turns toward its next major figure."],
      phrases: [["?? Mandrakes", "Mandrakes were associated in the ancient world with fertility and desire. The scene shows how desperate and transactional the sisters' relationship has become."], ["?? God Hearkened Unto Leah", "Leah is still heard by God. Even inside an unhealthy household, the Lord listens to the overlooked wife."], ["??? God Remembered Rachel", "Remembered does not mean God had forgotten. In the Bible, it often means God turns toward someone in faithful action." ]],
      truths: [["??? God's timing is not forgetfulness.", "Rachel waits painfully, but the text says God remembers her. Delay is not proof of abandonment."], ["?? God hears complicated people.", "Leah and Rachel are both wounded and flawed, but God is still active toward them."], ["?? One birth can turn the story.", "Joseph's arrival will eventually carry Genesis toward preservation, Egypt, and a much larger rescue." ]],
      application: ["??? Do not confuse waiting with being forgotten.", "?? God can hear you even when your household story is messy.", "?? Be careful when desperation makes people transactional.", "?? Small beginnings may become major turning points later."],
    }),
    makeCompactGenesisStudySection({
      chapter: 30,
      startVerse: 25,
    ...
    makeCompactGenesisStudySection({
      ...
      movement: ["?? Laban's sons resent Jacob's increase.", "?? God tells Jacob to return to his fathers' land.", "?? Jacob explains Laban's unfair treatment.", "?? Rachel and Leah agree that it is time to go."],
      phrases: [["?? Laban's Countenance", "Jacob can read the change in Laban's face. Sometimes a relationship shifts before anyone says the truth out loud."], ["?? Return Unto The Land", "God's command reconnects Jacob to the promise. Leaving Laban is not only escape; it is obedience toward covenant direction."], ["?? Changed My Wages Ten Times", "Jacob names years of manipulation. The number emphasizes repeated unfairness, not a one-time misunderstanding." ]],
      truths: [["?? God calls His people in the right time.", "Jacob did not leave the moment things got hard. God speaks when it is time to return."], ["?? God sees unfair treatment.", "Jacob says God saw what Laban was doing. Human exploitation is not hidden from the Lord."], ["?? Shared clarity can confirm the next step.", "Rachel and Leah recognize their father's treatment and agree with Jacob's direction." ]],
      application: ["?? Move when God calls, not only when frustration peaks.", "?? Trust that God sees repeated unfairness.", "?? Pay attention when the face of a situation changes.", "?? Wise agreement can help a family step into obedience together."],
    }),
    makeCompactGenesisStudySection({
      chapter: 31,
      startVerse: 17,
    ...
    makeCompactGenesisStudySection({
      ...
      movement: ["?? Laban chases Jacob for seven days.", "?? God warns Laban in a dream.", "?? Laban confronts Jacob with accusation.", "?? Rachel hides the stolen idols."],
      phrases: [["?? Take Heed", "God steps between Laban and Jacob before the confrontation. The warning limits what Laban can do."], ["?? Wherefore Didst Thou Flee Secretly", "Laban's question sounds wounded, but readers know he has been controlling and unfair. Manipulative people can still sound offended when control is broken."], ["?? The Images", "The search for the idols exposes hidden trouble in Jacob's camp. Jacob does not even know Rachel has brought them." ]],
      truths: [["?? God can restrain powerful people.", "Laban catches up, but God has already warned him. Jacob's safety is not resting on Laban's kindness."], ["?? Accusations can hide control.", "Laban frames himself as wronged, but Genesis has already shown his pattern."], ["?? Hidden sin can travel with the family.", "Rachel's theft creates danger Jacob does not see. Secret actions can put others at risk." ]],
      application: ["?? Trust God to set limits on people who want control.", "?? Listen carefully when an accusation comes from someone losing power over you.", "?? Hidden choices can endanger the whole camp.", "?? Ask God to expose what needs to be dealt with before it grows."],
    }),
    makeCompactGenesisStudySection({
      chapter: 31,
      startVerse: 36,
      ...
      movement: ["?? Jacob becomes angry and answers Laban.", "?? He names heat, frost, lost sleep, and hard labor.", "?? He says Laban changed his wages again and again.", "??? He says God saw his affliction and protected him."],
      phrases: [["?? Drought Consumed Me, And The Frost By Night", "Jacob's speech shows the physical cost of those years. This was not an easy success story; it was exhausting labor."], ["?? Changed My Wages Ten Times", "Laban's unfairness was repeated. Jacob is naming a pattern, not complaining about one inconvenience."], ["??? God Hath Seen Mine Affliction", "Jacob's confidence is that God noticed what Laban tried to take. This is the same God who saw Hagar and Leah." ]],
      truths: [["?? Naming injustice can be right.", "Jacob finally speaks plainly about what happened. Honesty is not always bitterness."], ["??? God sees exploited labor.", "The Lord noticed Jacob's hard years and protected him from leaving empty."], ["?? Anger needs truth, not revenge.", "Jacob confronts Laban with facts and God's protection, not violence." ]],
      application: ["?? Tell the truth about patterns of unfairness.", "??? Let God's seeing steady you when people rewrite the story.", "?? Do not minimize what hard seasons cost you.", "?? Confrontation should aim at truth, not uncontrolled revenge."],
    }),
    makeCompactGenesisStudySection({
      chapter: 31,
      startVerse: 43,
      ...
      movement: ["??? Laban still talks possessively about the family and flocks.", "?? Jacob sets up a pillar and stones as witness.", "?? They make a covenant boundary.", "?? Laban leaves, and Jacob keeps moving toward the promise."],
...
BIBLE_READER_STUDY_SECTIONS.push(
  ...[
    makeCompactGenesisStudySection({
      ...
      movement: ["?? God's messengers meet Jacob.", "??? Jacob names the place Mahanaim.", "??? God's camp is present before Jacob faces Esau."],
      phrases: [["?? Angels Of God", "Jacob is reminded that he is not traveling alone."], ["??? Mahanaim", "The name means two camps."], ["??? Met Him", "God's messengers meet Jacob before Jacob meets Esau."]],
      truths: [["?? God meets His people before fear does.", "Jacob sees God's messengers before hearing the next threat."], ["??? There is more than one camp in the story.", "Jacob's camp is not the only presence on the road."], ["??? God's protection can be unseen before it is understood.", "Jacob is being guarded before he fully grasps it."]],
      application: ["?? Remember that God may already be ahead of the hard meeting.", "??? Look for God's presence before counting threats.", "??? Let God's unseen care steady visible fear."],
    }),
    makeCompactGenesisStudySection({
      chapter: 32,
      startVerse: 3,
      ...
      movement: ["?? Jacob sends messengers.", "?? Esau comes with four hundred men.", "?? Jacob is afraid.", "??? Jacob divides the camp."],
      phrases: [["?? My Lord Esau", "Jacob speaks humbly to the brother he wronged."], ["?? Four Hundred Men", "The number sounds like a fighting force."], ["?? Greatly Afraid", "Jacob's old wound becomes present fear."]],
    ...
    makeCompactGenesisStudySection({
      ...
      movement: ["?? Jacob is left alone.", "?? A man wrestles him until daybreak.", "?? Jacob's hip is touched.", "??? Jacob is renamed Israel.", "?? Jacob limps away blessed."],
      phrases: [["?? Wrestled", "Jacob's inner struggle becomes physical."], ["??? Israel", "Jacob receives a new name."], ["?? Limped", "The blessing leaves him marked by weakness."]],
      truths: [["?? God meets Jacob in struggle.", "The night becomes transformation."], ["??? God can rename a person beyond their old pattern.", "Jacob is no longer only Jacob."], ["?? Blessing can leave a limp.", "Weakness and blessing travel together."]],
      application: ["?? Do not assume struggle means God is absent.", "??? Let God tell you who you are becoming.", "?? Do not despise the limp that came with blessing."],
    }),
    makeCompactGenesisStudySection({
      chapter: 33,
      startVerse: 1,
      ...
      truths: [["??? Mercy can surprise fear.", "Esau is not what Jacob expected."], ["?? Humility helps reconciliation.", "Jacob comes low, not proud."], ["?? Receiving grace changes how we see others.", "Jacob sees mercy in Esau's face."]],
      application: ["??? Leave room for mercy to surprise you.", "?? Approach repair with humility.", "?? Notice grace when it comes through a person you feared."],
    }),
    makeCompactGenesisStudySection({
      chapter: 33,
      startVerse: 12,
      ...
      movement: ["??? Esau offers to travel together.", "?? Jacob asks to move slowly.", "?? Esau returns to Seir.", "??? Jacob goes to Succoth."],
      phrases: [["?? The Flocks And Herds Are Nursing", "Jacob considers the vulnerable pace of his household."], ["??? Lead On Slowly", "Jacob chooses careful movement."], ["??? Succoth", "Jacob builds booths and pauses."]],
      truths: [["?? Wise leadership considers the vulnerable.", "Jacob will not drive the household too hard."], ["??? Peace does not always require immediate closeness.", "The brothers part without revenge."], ["??? Moving forward may still happen slowly.", "Jacob's journey continues by stages."]],
      application: ["?? Let care set the pace.", "??? Do not force closeness faster than wisdom allows.", "??? Give fragile peace room to breathe."],
    }),
    makeCompactGenesisStudySection({
      chapter: 33,
      startVerse: 18,
...
function enforceStudySectionVerseLimit(maxVerses = 10) {
  const expandedSections: BibleReaderStudySection[] = [];

  for (const section of BIBLE_READER_STUDY_SECTIONS) {
    const verseCount = section.endVerse - section.startVerse + 1;
    ...
    let part = 1;
    for (let startVerse = section.startVerse; startVerse <= section.endVerse; startVerse += maxVerses) {
      const endVerse = Math.min(section.endVerse, startVerse + maxVerses - 1);
      const reference = `${section.book.charAt(0).toUpperCase()}${section.book.slice(1)} ${section.chapter}:${startVerse}-${endVerse}`;
...
function applyApprovedGenesisOneStudySections() {
  const approvedGenesisOneSections = new Map(
    GENESIS_1_PERSONAL_SECTIONS.map((section) => [section.reference, section] as const),
  );

  for (const section of BIBLE_READER_STUDY_SECTIONS) {
    const approvedSection = approvedGenesisOneSections.get(section.reference);
    if (!approvedSection) continue;

    section.title = approvedSection.title;
    section.icon = approvedSection.icon;
    section.summary = "";
    section.categories = [
      {
        id: "key-phrases",
        icon: "💬",
        title: "Key Phrases",
        content: approvedSection.phrases.map(([heading, body]) =>
          formatBibleYearPhraseCard(heading, body, section.reference),
        ),
      },
    ];
...
??? The ground has no human worker
...
??? Dress it means tend or work it
...
?? Good and evil are not self-defined
...
?? The danger begins in conversation
...
?? Temptation starts by blurring truth
...
?? The wording becomes less exact
...
?? Good and evil are moral categories
...
?? Dependence on God is being rejected
...
?? Beauty is being detached from truth
...
?? Desire is reaching past obedience
...
?? Disobedience spreads relationally
...
??? The promise partly comes true
?? The result is painful
?? Sin reveals, but it also wounds
...
?? The response is self-protection
...
?? Blame replaces honest confession
...
?? Life in the fallen world becomes harder
...
?? Blessing and sorrow are now intertwined
...
?? The relationship is now touched by the fall
...
?? Their own covering was not enough
...
??? Work remains part of human life
...
?? God's judgment reaches the worshiper and the gift
...
?? The heart issue is being named
...
??? A right response is still possible
...
?? Sin must not rule him
??? Responsibility is laid on him
...
?? The scene is moving toward violence
...
?? The place becomes the setting of violence
...
?? The crime has been absorbed into the earth
...
?? The consequence feels too heavy
...
?? Favor is lost
?? The judgment is relational too
...
7?? Sevenfold means full judgment
?? Vengeance belongs to God
??? Cain is not to be killed casually
...
??? Cain is preserved from immediate death
...
??? Human settlement is developing
??? Cain builds despite his curse
...
?? Naming marks legacy
??? Family identity enters public life
...
??? He is linked with tent-dwelling
...
??? Brass and iron point to metalwork
...
??? His speech is meant to sound important
...
?? A killing is being boasted about
?? Violence has escalated in Cain's line
?? Revenge is now part of the speech
...
?? Husband and wife are united again
...
??? Worship becomes openly expressed
...
?? Adam's whole lifespan is counted
...
?? Sin's consequence keeps showing
...
?? The consequence of sin remains
...
?? Death remains universal in the line
...
?? Death still marks the human line
...
applyPersonalJudgesTenStudySections();
applyPersonalJudgesElevenStudySections();
applyPersonalJudgesTwelveStudySections();
applyPersonalJudgesThirteenStudySections();
applyPersonalJudgesFourteenStudySections();
...
applyPersonalJudgesEighteenStudySections();
applyPersonalJudgesNineteenStudySections();
applyPersonalJudgesTwentyStudySections();
...
applyPersonalSecondSamuelOneStudySections();
applyPersonalSecondSamuelTwoStudySections();
applyPersonalSecondSamuelThreeStudySections();
applyPersonalSecondSamuelFourStudySections();
applyPersonalSecondSamuelFiveStudySections();
applyPersonalSecondSamuelSixStudySections();
applyPersonalSecondSamuelSevenStudySections();
applyPersonalSecondSamuelEightStudySections();
applyPersonalSecondSamuelNineStudySections();
applyPersonalSecondSamuelTenStudySections();
applyPersonalSecondSamuelElevenStudySections();
applyPersonalSecondSamuelTwelveStudySections();
applyPersonalSecondSamuelThirteenStudySections();
applyPersonalSecondSamuelFourteenStudySections();
...
applyPersonalFirstKingsFourStudySections();
applyPersonalFirstKingsFiveStudySections();
applyPersonalFirstKingsSixStudySections();
applyPersonalFirstKingsSevenStudySections();
applyPersonalFirstKingsEightStudySections();
...
applyPersonalFirstKingsFifteenStudySections();
applyPersonalFirstKingsSixteenThroughTwentyTwoStudySections();
applyPersonalFirstKingsSixteenStudySections();
applyPersonalFirstKingsSeventeenStudySections();
applyPersonalFirstKingsEighteenStudySections();
applyPersonalFirstKingsNineteenStudySections();
applyPersonalFirstKingsTwentyStudySections();
applyPersonalSecondKingsOneThroughTwentyFiveStudySections();
applyPersonalSecondKingsOneStudySections();
applyPersonalSecondKingsTwoStudySections();
applyPersonalSecondKingsThreeStudySections();
applyPersonalSecondKingsFourStudySections();
applyPersonalSecondKingsFiveStudySections();
applyPersonalSecondKingsSixStudySections();
applyPersonalSecondKingsSevenStudySections();
applyPersonalSecondKingsEightStudySections();
applyPersonalSecondKingsNineStudySections();
applyPersonalSecondKingsTenStudySections();
applyPersonalSecondKingsElevenStudySections();
applyPersonalSecondKingsTwelveStudySections();
applyPersonalSecondKingsThirteenStudySections();
applyPersonalSecondKingsFourteenStudySections();
applyPersonalSecondKingsFifteenStudySections();
applyPersonalSecondKingsSixteenStudySections();
applyPersonalSecondKingsSeventeenStudySections();
applyPersonalSecondKingsEighteenStudySections();
applyPersonalSecondKingsNineteenStudySections();
applyPersonalSecondKingsTwentyStudySections();
applyPersonalSecondKingsTwentyOneStudySections();
applyPersonalSecondKingsTwentyTwoStudySections();
applyPersonalSecondKingsTwentyThreeStudySections();
applyPersonalSecondKingsTwentyFourStudySections();
applyPersonalSecondKingsTwentyFiveStudySections();
applyPersonalFirstChroniclesOneThroughEightStudySections();
applyPersonalFirstChroniclesOneStudySections();
applyPersonalFirstChroniclesTwoStudySections();
applyPersonalFirstChroniclesThreeStudySections();
applyPersonalFirstChroniclesFourStudySections();
applyPersonalFirstChroniclesFiveStudySections();
applyPersonalFirstChroniclesSixStudySections();
applyPersonalFirstChroniclesSevenStudySections();
applyPersonalFirstChroniclesEightStudySections();
applyPersonalFirstChroniclesNineThroughTwentyNineStudySections();
applyPersonalFirstChroniclesNineStudySections();
applyPersonalFirstChroniclesTenStudySections();
applyPersonalFirstChroniclesElevenStudySections();
applyPersonalFirstChroniclesTwelveStudySections();
applyPersonalFirstChroniclesThirteenStudySections();
applyPersonalFirstChroniclesFourteenStudySections();
applyPersonalFirstChroniclesFifteenStudySections();
applyPersonalFirstChroniclesSixteenStudySections();
...
applyPersonalFirstChroniclesTwentyFiveStudySections();
applyPersonalFirstChroniclesTwentySixStudySections();
applyPersonalFirstChroniclesTwentySevenStudySections();
applyPersonalFirstChroniclesTwentyEightStudySections();
applyPersonalSecondChroniclesOneThroughNineteenStudySections();
applyPersonalSecondChroniclesOneStudySections();
applyPersonalSecondChroniclesTwoStudySections();
applyPersonalSecondChroniclesThreeStudySections();
applyPersonalSecondChroniclesFourStudySections();
applyPersonalSecondChroniclesFiveStudySections();
applyPersonalSecondChroniclesSixStudySections();
applyPersonalSecondChroniclesSevenStudySections();
applyPersonalSecondChroniclesElevenStudySections();
applyPersonalSecondChroniclesTwelveStudySections();
applyPersonalSecondChroniclesThirteenStudySections();
applyPersonalSecondChroniclesFourteenStudySections();
applyPersonalSecondChroniclesTwentyThroughThirtySixStudySections();
applyPersonalSecondChroniclesTwentyStudySections();
applyPersonalSecondChroniclesTwentyOneStudySections();
applyPersonalSecondChroniclesTwentyTwoStudySections();
applyPersonalSecondChroniclesTwentyThreeStudySections();
applyPersonalSecondChroniclesTwentyFourStudySections();
applyPersonalSecondChroniclesTwentyFiveStudySections();
applyPersonalSecondChroniclesTwentySixStudySections();
applyPersonalSecondChroniclesTwentySevenStudySections();
applyPersonalSecondChroniclesThirtyOneStudySections();
applyPersonalSecondChroniclesThirtyTwoStudySections();
...
applyPersonalEzraOneStudySections();
applyPersonalEzraFourThroughTenStudySections();
applyPersonalEzraFourStudySections();
applyPersonalEzraFiveStudySections();
applyPersonalEzraSixStudySections();
applyPersonalEzraSevenStudySections();
applyPersonalEzraEightStudySections();
applyPersonalEzraNineStudySections();
applyPersonalEzraTenStudySections();
applyPersonalNehemiahOneThroughThirteenStudySections();
applyPersonalNehemiahOneStudySections();
applyPersonalNehemiahTwoStudySections();
applyPersonalNehemiahThreeStudySections();
applyPersonalNehemiahFourStudySections();
applyPersonalNehemiahFiveStudySections();
applyPersonalNehemiahSixStudySections();
applyPersonalNehemiahSevenStudySections();
...
applyPersonalNehemiahTwelveStudySections();
applyPersonalNehemiahThirteenStudySections();
applyPersonalEstherOneThroughTenStudySections();
applyPersonalEstherOneChapterStudySections();
...
applyPersonalEstherEightChapterStudySections();
applyPersonalEstherNineChapterStudySections();
applyPersonalEstherTenChapterStudySections();
...
applyPersonalJobFourChapterStudySections();
applyPersonalJobFiveChapterStudySections();
applyPersonalJobSixChapterStudySections();
applyPersonalJobSevenChapterStudySections();
applyPersonalJobEightChapterStudySections();
...
applyPersonalJobThirteenChapterStudySections();
applyPersonalJobFourteenChapterStudySections();
applyPersonalJobFifteenChapterStudySections();
applyPersonalJobSixteenChapterStudySections();
applyPersonalJobSeventeenChapterStudySections();
applyPersonalJobEighteenChapterStudySections();
applyPersonalJobNineteenChapterStudySections();
applyPersonalJobTwentyChapterStudySections();
applyPersonalJobTwentyOneChapterStudySections();
applyPersonalJobTwentyTwoChapterStudySections();
applyPersonalJobTwentyThreeChapterStudySections();
applyPersonalJobTwentyFourChapterStudySections();
applyPersonalJobTwentyFiveChapterStudySections();
applyPersonalJobThirtyOneThroughFortyTwoStudySections();
applyPersonalJobThirtyOneChapterStudySections();
applyPersonalJobThirtyTwoChapterStudySections();
applyPersonalJobThirtyThreeChapterStudySections();
applyPersonalJobThirtyFourChapterStudySections();
applyPersonalJobThirtyFiveChapterStudySections();
applyPersonalJobThirtySixChapterStudySections();
applyPersonalJobThirtySevenChapterStudySections();
applyPersonalJobThirtyEightChapterStudySections();
applyPersonalJobThirtyNineChapterStudySections();
applyPersonalJobFortyChapterStudySections();
applyPersonalJobFortyOneChapterStudySections();
applyPersonalJobFortyTwoChapterStudySections();
applyPersonalPsalmsOneThroughSixStudySections();
applyPersonalPsalmsOneChapterStudySections();
...
applyPersonalPsalmsSixStudySections();
applyPersonalPsalmsSevenThroughTwentyOneStudySections();
applyPersonalPsalmsSevenStudySections();
applyPersonalPsalmsEightStudySections();
applyPersonalPsalmsNineStudySections();
applyPersonalPsalmsTenStudySections();
applyPersonalPsalmsElevenStudySections();
applyPersonalPsalmsTwelveStudySections();
applyPersonalPsalmsThirteenStudySections();
applyPersonalPsalmsFourteenStudySections();
applyPersonalPsalmsFifteenStudySections();
applyPersonalPsalmsSixteenStudySections();
applyPersonalPsalmsSeventeenStudySections();
applyPersonalPsalmsEighteenStudySections();
applyPersonalPsalmsNineteenStudySections();
applyPersonalPsalmsTwentyStudySections();
applyPersonalPsalmsTwentyOneStudySections();
applyPersonalPsalmsTwentyTwoThroughThirtySixStudySections();
applyPersonalPsalmsTwentyTwoStudySections();
applyPersonalPsalmsTwentyThreeStudySections();
applyPersonalPsalmsTwentyFourStudySections();
applyPersonalPsalmsTwentyFiveStudySections();
applyPersonalPsalmsTwentySixStudySections();
applyPersonalPsalmsTwentySevenStudySections();
applyPersonalPsalmsTwentyEightStudySections();
applyPersonalPsalmsTwentyNineStudySections();
applyPersonalPsalmsThirtyStudySections();
applyPersonalPsalmsThirtyOneStudySections();
applyPersonalPsalmsThirtyTwoStudySections();
applyPersonalPsalmsThirtyThreeStudySections();
applyPersonalPsalmsThirtyFourStudySections();
applyPersonalPsalmsThirtyFiveStudySections();
applyPersonalPsalmsThirtySixStudySections();
applyPersonalPsalmsThirtySevenThroughFiftyOneStudySections();
applyPersonalPsalmsThirtySevenStudySections();
applyPersonalPsalmsThirtyEightStudySections();
applyPersonalPsalmsThirtyNineStudySections();
applyPersonalPsalmsFortyStudySections();
applyPersonalPsalmsFortyOneStudySections();
applyPersonalPsalmsFiftyTwoThroughSixtySixStudySections();
applyPersonalPsalmsFiftyTwoStudySections();
applyPersonalPsalmsFiftyThreeStudySections();
applyPersonalPsalmsFiftyFourStudySections();
applyPersonalPsalmsFiftyFiveStudySections();
applyPersonalPsalmsFiftySixStudySections();
applyPersonalPsalmsFiftySevenStudySections();
applyPersonalPsalmsFiftyEightStudySections();
applyPersonalPsalmsFiftyNineStudySections();
applyPersonalPsalmsSixtyStudySections();
applyPersonalPsalmsSixtyOneStudySections();
applyPersonalPsalmsSixtyTwoStudySections();
applyPersonalPsalmsSixtyThreeStudySections();
applyPersonalPsalmsSixtyFourStudySections();
applyPersonalPsalmsSixtyFiveStudySections();
applyPersonalPsalmsSixtySixStudySections();
applyPersonalPsalmsSixtySevenThroughNinetySixStudySections();
applyPersonalPsalmsSixtySevenStudySections();
applyPersonalPsalmsSixtyEightStudySections();
applyPersonalPsalmsSixtyNineStudySections();
applyPersonalPsalmsSeventyStudySections();
applyPersonalPsalmsSeventyOneStudySections();
applyPersonalPsalmsSeventyTwoStudySections();
applyPersonalPsalmsSeventyThreeStudySections();
applyPersonalPsalmsSeventyFourStudySections();
applyPersonalPsalmsSeventyFiveStudySections();
applyPersonalPsalmsSeventySixStudySections();
applyPersonalPsalmsSeventySevenStudySections();
applyPersonalPsalmsSeventyEightStudySections();
applyPersonalPsalmsSeventyNineStudySections();
applyPersonalPsalmsEightyStudySections();
applyPersonalPsalmsEightyOneStudySections();
applyPersonalPsalmsEightyTwoStudySections();
applyPersonalPsalmsEightyThreeStudySections();
applyPersonalPsalmsEightyFourStudySections();
...
applyPersonalPsalmsEightyNineStudySections();
applyPersonalPsalmsNinetyStudySections();
applyPersonalPsalmsNinetyOneStudySections();
applyPersonalPsalmsNinetyTwoStudySections();
applyPersonalPsalmsNinetyThreeStudySections();
applyPersonalPsalmsNinetyFourStudySections();
applyPersonalPsalmsNinetyFiveStudySections();
applyPersonalPsalmsNinetySixStudySections();
applyPersonalPsalmsNinetySevenThroughOneTwentySixStudySections();
applyPersonalPsalmsNinetySevenStudySections();
applyPersonalPsalmsNinetyEightStudySections();
applyPersonalPsalmsNinetyNineStudySections();
applyPersonalPsalmsOneHundredStudySections();
applyPersonalPsalmsOneTwentySevenThroughOneFiftyStudySections();
applyPersonalPsalmsOneHundredTwentySevenStudySections();
applyPersonalPsalmsOneHundredTwentyEightStudySections();
applyPersonalPsalmsOneHundredTwentyNineStudySections();
applyPersonalPsalmsOneHundredThirtyStudySections();
applyPersonalPsalmsOneHundredThirtyOneStudySections();
applyPersonalPsalmsOneHundredThirtyTwoStudySections();
applyPersonalPsalmsOneHundredThirtyFourStudySections();
applyPersonalPsalmsOneHundredThirtyFiveStudySections();
applyPersonalPsalmsOneHundredThirtySixStudySections();
applyPersonalPsalmsOneHundredThirtySevenStudySections();
applyPersonalPsalmsOneHundredThirtyEightStudySections();
applyPersonalPsalmsOneHundredThirtyNineStudySections();
applyPersonalPsalmsOneHundredFortyStudySections();
applyPersonalPsalmsOneHundredFortyOneStudySections();
applyPersonalPsalmsOneHundredFortyTwoStudySections();
applyPersonalPsalmsOneHundredFortyThreeStudySections();
applyPersonalPsalmsOneHundredFortyFourStudySections();
applyPersonalPsalmsOneHundredFortyFiveStudySections();
applyPersonalPsalmsOneHundredFortySixStudySections();
applyPersonalPsalmsOneHundredFortySevenStudySections();
applyPersonalPsalmsOneHundredFortyEightStudySections();
applyPersonalPsalmsOneHundredFortyNineStudySections();
applyPersonalPsalmsOneHundredFiftyStudySections();
applyPersonalProverbsOneThroughSixStudySections();
applyPersonalProverbsSevenThroughThirtyOneStudySections();
applyPersonalProverbsOneStudySections();
applyPersonalProverbsTwoStudySections();
applyPersonalProverbsThreeStudySections();
applyPersonalProverbsFourStudySections();
applyPersonalProverbsFiveStudySections();
applyPersonalProverbsSixStudySections();
applyPersonalProverbsSevenStudySections();
applyPersonalProverbsEightStudySections();
applyPersonalProverbsNineStudySections();
applyPersonalProverbsTenStudySections();
applyPersonalEcclesiastesOneThroughFiveStudySections();
applyPersonalEcclesiastesSixThroughTwelveStudySections();
applyPersonalEcclesiastesOneStudySections();
applyPersonalEcclesiastesTwoStudySections();
applyPersonalEcclesiastesThreeStudySections();
applyPersonalEcclesiastesFourStudySections();
applyPersonalEcclesiastesFiveStudySections();
applyPersonalEcclesiastesSixStudySections();
...
applyPersonalEcclesiastesElevenStudySections();
applyPersonalEcclesiastesTwelveStudySections();
...
applyPersonalSongOfSolomonFiveStudySections();
applyPersonalSongOfSolomonSixStudySections();
applyPersonalSongOfSolomonSevenStudySections();
applyPersonalSongOfSolomonEightStudySections();
applyPersonalIsaiahOneThroughFifteenStudySections();
applyPersonalIsaiahSixteenThroughSixtySixStudySections();
applyPersonalIsaiahOneStudySections();
...
applyPersonalIsaiahSixStudySections();
applyPersonalIsaiahSevenStudySections();
applyPersonalIsaiahEightStudySections();
applyPersonalIsaiahNineStudySections();
applyPersonalIsaiahTenStudySections();
applyPersonalIsaiahElevenStudySections();
applyPersonalIsaiahTwelveStudySections();
applyPersonalIsaiahThirteenStudySections();
applyPersonalIsaiahFourteenStudySections();
applyPersonalIsaiahFifteenStudySections();
...
applyPersonalIsaiahTwentyStudySections();
applyPersonalIsaiahTwentyOneStudySections();
applyPersonalIsaiahTwentyTwoStudySections();
applyPersonalIsaiahTwentyThreeStudySections();
applyPersonalIsaiahTwentyFourStudySections();
applyPersonalIsaiahTwentyFiveStudySections();
applyPersonalIsaiahTwentySixStudySections();
applyPersonalJeremiahOneThroughNineStudySections();
applyPersonalJeremiahTenThroughFiftyTwoStudySections();
applyPersonalJeremiahOneStudySections();
applyPersonalJeremiahTwoStudySections();
applyPersonalJeremiahThreeStudySections();
applyPersonalJeremiahFourStudySections();
applyPersonalJeremiahFiveStudySections();
applyPersonalJeremiahSixStudySections();
applyPersonalJeremiahSevenStudySections();
applyPersonalJeremiahEightStudySections();
applyPersonalJeremiahNineStudySections();
applyPersonalJeremiahTenStudySections();
applyPersonalJeremiahElevenStudySections();
applyPersonalJeremiahTwelveStudySections();
applyPersonalJeremiahThirteenStudySections();
...
type ApprovedGenesisSevenSectionMeta = {
  reference: string;
  title: string;
  icon: string;
  summary: string;
...
const APPROVED_GENESIS_SEVEN_SECTION_META: ApprovedGenesisSevenSectionMeta[] = [
  {
...
function extractApprovedGenesisSevenSectionMarkdown(reference: string) {
  const pattern = buildApprovedGenesisSevenReferencePattern(reference);
...
function stripBoldMarkdown(line: string) {
  return line.replace(/^\*\*|\*\*$/g, "").trim();
}

function parseApprovedGenesisSevenPhraseBlocks(markdown: string) {
  ...
  for (const rawLine of lines) {
    ...
    if (/^\*\*.*\*\*$/.test(trimmed)) {
      const heading = stripBoldMarkdown(trimmed);
...
function applyApprovedGenesisSevenReaderSections() {
  for (let index = BIBLE_READER_STUDY_SECTIONS.length - 1; index >= 0; index -= 1) {
    const section = BIBLE_READER_STUDY_SECTIONS[index];
...
replaceStudySectionsForBookRange("genesis", 7, 7, GENESIS_SEVEN_PERSONAL_SECTIONS);
replaceStudySectionsForBookRange("genesis", 8, 8, GENESIS_EIGHT_PERSONAL_SECTIONS);
replaceStudySectionsForBookRange("genesis", 9, 9, GENESIS_NINE_PERSONAL_SECTIONS);
...
replaceStudySectionsForBookRange("genesis", 18, 18, GENESIS_EIGHTEEN_PERSONAL_SECTIONS);
...
replaceStudySectionsForBookRange(
  ...
  33,
  33,
  GENESIS_THIRTY_THREE_PERSONAL_SECTIONS,
);
replaceStudySectionsForBookRange(
  "genesis",
  34,
  34,
  GENESIS_THIRTY_FOUR_PERSONAL_SECTIONS,
);
replaceStudySectionsForBookRange(
  "genesis",
  35,
  35,
  GENESIS_THIRTY_FIVE_PERSONAL_SECTIONS,
);
replaceStudySectionsForBookRange(
  "genesis",
  36,
  36,
  GENESIS_THIRTY_SIX_PERSONAL_SECTIONS,
);
replaceStudySectionsForBookRange(
  "genesis",
  37,
  37,
  GENESIS_THIRTY_SEVEN_PERSONAL_SECTIONS,
);
replaceStudySectionsForBookRange(
  "genesis",
  38,
  38,
  GENESIS_THIRTY_EIGHT_PERSONAL_SECTIONS,
);
replaceStudySectionsForBookRange(
  "genesis",
  39,
...
replaceStudySectionsForBookRange(
  ...
  22,
  22,
  EXODUS_TWENTY_TWO_PERSONAL_SECTIONS,
);
replaceStudySectionsForBookRange(
  "exodus",
  23,
  23,
  EXODUS_TWENTY_THREE_PERSONAL_SECTIONS,
);
replaceStudySectionsForBookRange(
  "exodus",
  24,
  24,
  EXODUS_TWENTY_FOUR_PERSONAL_SECTIONS,
);
replaceStudySectionsForBookRange(
  "exodus",
  25,
  25,
  EXODUS_TWENTY_FIVE_PERSONAL_SECTIONS,
);
replaceStudySectionsForBookRange(
  "exodus",
  26,
  26,
  EXODUS_TWENTY_SIX_PERSONAL_SECTIONS,
);
replaceStudySectionsForBookRange(
  "exodus",
  27,
  27,
  EXODUS_TWENTY_SEVEN_PERSONAL_SECTIONS,
);
replaceStudySectionsForBookRange(
  "exodus",
  28,
  28,
  EXODUS_TWENTY_EIGHT_PERSONAL_SECTIONS,
);
replaceStudySectionsForBookRange(
  "exodus",
  29,
  29,
  EXODUS_TWENTY_NINE_PERSONAL_SECTIONS,
);
replaceStudySectionsForBookRange(
  "exodus",
  30,
  30,
  EXODUS_THIRTY_PERSONAL_SECTIONS,
);
replaceStudySectionsForBookRange(
  "exodus",
  31,
  31,
  EXODUS_THIRTY_ONE_PERSONAL_SECTIONS,
);
replaceStudySectionsForBookRange(
  "exodus",
  32,
  32,
  EXODUS_THIRTY_TWO_PERSONAL_SECTIONS,
);
replaceStudySectionsForBookRange(
  "exodus",
  33,
  33,
  EXODUS_THIRTY_THREE_PERSONAL_SECTIONS,
);
replaceStudySectionsForBookRange(
  "exodus",
  34,
  34,
  EXODUS_THIRTY_FOUR_PERSONAL_SECTIONS,
);
replaceStudySectionsForBookRange(
  "exodus",
  35,
  35,
  EXODUS_THIRTY_FIVE_PERSONAL_SECTIONS,
);
replaceStudySectionsForBookRange(
  "exodus",
  36,
  36,
  EXODUS_THIRTY_SIX_PERSONAL_SECTIONS,
);
replaceStudySectionsForBookRange(
  "exodus",
  37,
  37,
  EXODUS_THIRTY_SEVEN_PERSONAL_SECTIONS,
);
replaceStudySectionsForBookRange(
  "exodus",
  38,
  38,
  EXODUS_THIRTY_EIGHT_PERSONAL_SECTIONS,
);
replaceStudySectionsForBookRange(
  "exodus",
  39,
...
replaceStudySectionsForBookRange(
  ...
  1,
  1,
  LEVITICUS_ONE_PERSONAL_SECTIONS,
);
replaceStudySectionsForBookRange(
  "leviticus",
  2,
  2,
  LEVITICUS_TWO_PERSONAL_SECTIONS,
);
replaceStudySectionsForBookRange(
  "leviticus",
  3,
  3,
  LEVITICUS_THREE_PERSONAL_SECTIONS,
);
replaceStudySectionsForBookRange(
  "leviticus",
  4,
  4,
  LEVITICUS_FOUR_PERSONAL_SECTIONS,
);
replaceStudySectionsForBookRange(
  "leviticus",
  5,
  5,
  LEVITICUS_FIVE_PERSONAL_SECTIONS,
);
replaceStudySectionsForBookRange(
  "leviticus",
  6,
  6,
  LEVITICUS_SIX_PERSONAL_SECTIONS,
);
replaceStudySectionsForBookRange(
  "leviticus",
  7,
  7,
  LEVITICUS_SEVEN_PERSONAL_SECTIONS,
);
replaceStudySectionsForBookRange(
  "leviticus",
  8,
  8,
  LEVITICUS_EIGHT_PERSONAL_SECTIONS,
);
replaceStudySectionsForBookRange(
  "leviticus",
  9,
  9,
  LEVITICUS_NINE_PERSONAL_SECTIONS,
);
replaceStudySectionsForBookRange(
  "leviticus",
  10,
...
replaceStudySectionsForBookRange(
  ...
  29,
  29,
  NUMBERS_TWENTY_NINE_PERSONAL_SECTIONS,
);
replaceStudySectionsForBookRange(
  "numbers",
  30,
...
replaceStudySectionsForBookRange(
  ...
  31,
  31,
  NUMBERS_THIRTY_ONE_PERSONAL_SECTIONS,
);
replaceStudySectionsForBookRange(
  "numbers",
  32,
  32,
  NUMBERS_THIRTY_TWO_PERSONAL_SECTIONS,
);
replaceStudySectionsForBookRange(
  "numbers",
  33,
  33,
  NUMBERS_THIRTY_THREE_PERSONAL_SECTIONS,
);
replaceStudySectionsForBookRange(
  "numbers",
  34,
  34,
  NUMBERS_THIRTY_FOUR_PERSONAL_SECTIONS,
);
replaceStudySectionsForBookRange(
  "numbers",
  35,
  35,
  NUMBERS_THIRTY_FIVE_PERSONAL_SECTIONS,
);
replaceStudySectionsForBookRange(
  "numbers",
  36,
  36,
  NUMBERS_THIRTY_SIX_PERSONAL_SECTIONS,
);
replaceStudySectionsForBookRange(
  "deuteronomy",
  1,
  1,
  DEUTERONOMY_ONE_PERSONAL_SECTIONS,
);
replaceStudySectionsForBookRange(
  "deuteronomy",
  2,
  2,
  DEUTERONOMY_TWO_PERSONAL_SECTIONS,
);
replaceStudySectionsForBookRange(
  "deuteronomy",
  3,
  3,
  DEUTERONOMY_THREE_PERSONAL_SECTIONS,
);
replaceStudySectionsForBookRange(
  "deuteronomy",
  4,
  4,
  DEUTERONOMY_FOUR_PERSONAL_SECTIONS,
);
replaceStudySectionsForBookRange(
  "deuteronomy",
  5,
  5,
  DEUTERONOMY_FIVE_PERSONAL_SECTIONS,
);
replaceStudySectionsForBookRange(
  "deuteronomy",
  6,
  6,
  DEUTERONOMY_SIX_PERSONAL_SECTIONS,
);
replaceStudySectionsForBookRange(
  "deuteronomy",
  7,
  7,
  DEUTERONOMY_SEVEN_PERSONAL_SECTIONS,
);
replaceStudySectionsForBookRange(
  "deuteronomy",
  8,
  8,
  DEUTERONOMY_EIGHT_PERSONAL_SECTIONS,
);
replaceStudySectionsForBookRange(
  "deuteronomy",
  9,
...
replaceStudySectionsForBookRange(
  ...
  33,
  33,
  DEUTERONOMY_THIRTY_THREE_PERSONAL_SECTIONS,
);
replaceStudySectionsForBookRange(
  "deuteronomy",
  34,
  34,
  DEUTERONOMY_THIRTY_FOUR_PERSONAL_SECTIONS,
);
replaceStudySectionsForBookRange(
  "joshua",
  1,
  1,
  JOSHUA_ONE_PERSONAL_SECTIONS,
);
replaceStudySectionsForBookRange(
  "joshua",
  2,
  2,
  JOSHUA_TWO_PERSONAL_SECTIONS,
);
replaceStudySectionsForBookRange(
  "joshua",
  3,
  3,
  JOSHUA_THREE_PERSONAL_SECTIONS,
);
replaceStudySectionsForBookRange(
  "joshua",
  4,
  4,
  JOSHUA_FOUR_PERSONAL_SECTIONS,
);
replaceStudySectionsForBookRange(
  "joshua",
  5,
  5,
  JOSHUA_FIVE_PERSONAL_SECTIONS,
);
replaceStudySectionsForBookRange(
  "joshua",
  6,
  6,
  JOSHUA_SIX_PERSONAL_SECTIONS,
);
replaceStudySectionsForBookRange(
  "joshua",
  7,
  7,
  JOSHUA_SEVEN_PERSONAL_SECTIONS,
);
replaceStudySectionsForBookRange(
  "joshua",
  8,
  8,
  JOSHUA_EIGHT_PERSONAL_SECTIONS,
);
replaceStudySectionsForBookRange(
  "joshua",
  9,
  9,
  JOSHUA_NINE_PERSONAL_SECTIONS,
);
replaceStudySectionsForBookRange(
  "joshua",
  10,
  10,
  JOSHUA_TEN_PERSONAL_SECTIONS,
);
replaceStudySectionsForBookRange(
  "joshua",
  11,
  11,
  JOSHUA_ELEVEN_PERSONAL_SECTIONS,
);
replaceStudySectionsForBookRange(
  "joshua",
  12,
  12,
  JOSHUA_TWELVE_PERSONAL_SECTIONS,
);
replaceStudySectionsForBookRange(
  "joshua",
  13,
  13,
  JOSHUA_THIRTEEN_PERSONAL_SECTIONS,
);
replaceStudySectionsForBookRange(
  "joshua",
  14,
  14,
  JOSHUA_FOURTEEN_PERSONAL_SECTIONS,
);
replaceStudySectionsForBookRange(
  "joshua",
  15,
  15,
  JOSHUA_FIFTEEN_PERSONAL_SECTIONS,
);
replaceStudySectionsForBookRange(
  "joshua",
  16,
  16,
  JOSHUA_SIXTEEN_PERSONAL_SECTIONS,
);
replaceStudySectionsForBookRange(
  "joshua",
  17,
  17,
  JOSHUA_SEVENTEEN_PERSONAL_SECTIONS,
);
replaceStudySectionsForBookRange(
  "joshua",
  18,
  18,
  JOSHUA_EIGHTEEN_PERSONAL_SECTIONS,
);
replaceStudySectionsForBookRange(
  "joshua",
  19,
  19,
  JOSHUA_NINETEEN_PERSONAL_SECTIONS,
);
replaceStudySectionsForBookRange(
  "joshua",
  20,
  20,
  JOSHUA_TWENTY_PERSONAL_SECTIONS,
);
replaceStudySectionsForBookRange(
  "joshua",
  21,
  21,
  JOSHUA_TWENTY_ONE_PERSONAL_SECTIONS,
);
replaceStudySectionsForBookRange(
  "joshua",
  22,
  22,
  JOSHUA_TWENTY_TWO_PERSONAL_SECTIONS,
);
replaceStudySectionsForBookRange(
  "joshua",
  23,
  23,
  JOSHUA_TWENTY_THREE_PERSONAL_SECTIONS,
);
replaceStudySectionsForBookRange(
  "joshua",
  24,
  24,
  JOSHUA_TWENTY_FOUR_PERSONAL_SECTIONS,
);
replaceStudySectionsForBookRange(
  "judges",
  1,
  1,
  JUDGES_ONE_PERSONAL_SECTIONS,
);
replaceStudySectionsForBookRange(
  "judges",
  2,
  2,
  JUDGES_TWO_PERSONAL_SECTIONS,
);
replaceStudySectionsForBookRange(
  "judges",
  3,
  3,
  JUDGES_THREE_PERSONAL_SECTIONS,
);
replaceStudySectionsForBookRange(
  "judges",
  4,
  4,
  JUDGES_FOUR_PERSONAL_SECTIONS,
);
replaceStudySectionsForBookRange(
  "judges",
  5,
  5,
  JUDGES_FIVE_PERSONAL_SECTIONS,
);
replaceStudySectionsForBookRange(
  "judges",
  6,
  6,
  JUDGES_SIX_PERSONAL_SECTIONS,
);
replaceStudySectionsForBookRange(
  "judges",
  7,
  7,
  JUDGES_SEVEN_PERSONAL_SECTIONS,
);
replaceStudySectionsForBookRange(
  "judges",
  8,
  8,
  JUDGES_EIGHT_PERSONAL_SECTIONS,
);
replaceStudySectionsForBookRange(
  "judges",
  9,
  9,
  JUDGES_NINE_PERSONAL_SECTIONS,
);
replaceStudySectionsForBookRange(
  "1 samuel",
  1,
  1,
  FIRST_SAMUEL_ONE_PERSONAL_SECTIONS,
);
replaceStudySectionsForBookRange(
  "1 samuel",
  2,
  2,
  FIRST_SAMUEL_TWO_PERSONAL_SECTIONS,
);
replaceStudySectionsForBookRange(
  "1 samuel",
  3,
  3,
  FIRST_SAMUEL_THREE_PERSONAL_SECTIONS,
);
replaceStudySectionsForBookRange(
  "1 samuel",
  4,
  4,
  FIRST_SAMUEL_FOUR_PERSONAL_SECTIONS,
);
replaceStudySectionsForBookRange(
  "1 samuel",
  5,
  5,
  FIRST_SAMUEL_FIVE_PERSONAL_SECTIONS,
);
replaceStudySectionsForBookRange(
  "1 samuel",
  6,
  6,
  FIRST_SAMUEL_SIX_PERSONAL_SECTIONS,
);
replaceStudySectionsForBookRange(
  "1 samuel",
  7,
  7,
  FIRST_SAMUEL_SEVEN_PERSONAL_SECTIONS,
);
replaceStudySectionsForBookRange(
  "1 samuel",
  8,
  8,
  FIRST_SAMUEL_EIGHT_PERSONAL_SECTIONS,
);
replaceStudySectionsForBookRange(
  "1 samuel",
  9,
  9,
  FIRST_SAMUEL_NINE_PERSONAL_SECTIONS,
);
replaceStudySectionsForBookRange(
  "1 samuel",
  10,
  10,
  FIRST_SAMUEL_TEN_PERSONAL_SECTIONS,
);
replaceStudySectionsForBookRange(
  "1 samuel",
  11,
  11,
  FIRST_SAMUEL_ELEVEN_PERSONAL_SECTIONS,
);
replaceStudySectionsForBookRange(
  "1 samuel",
  12,
  12,
  FIRST_SAMUEL_TWELVE_PERSONAL_SECTIONS,
);
replaceStudySectionsForBookRange(
  "1 samuel",
  13,
  13,
  FIRST_SAMUEL_THIRTEEN_PERSONAL_SECTIONS,
);
replaceStudySectionsForBookRange(
  "1 samuel",
  14,
  14,
  FIRST_SAMUEL_FOURTEEN_PERSONAL_SECTIONS,
);
replaceStudySectionsForBookRange(
  "1 samuel",
  15,
  15,
  FIRST_SAMUEL_FIFTEEN_PERSONAL_SECTIONS,
);
replaceStudySectionsForBookRange(
  "1 samuel",
  16,
  16,
  FIRST_SAMUEL_SIXTEEN_PERSONAL_SECTIONS,
);
replaceStudySectionsForBookRange(
  "1 samuel",
  17,
  17,
  FIRST_SAMUEL_SEVENTEEN_PERSONAL_SECTIONS,
);
replaceStudySectionsForBookRange(
  "1 samuel",
  18,
  18,
  FIRST_SAMUEL_EIGHTEEN_PERSONAL_SECTIONS,
);
replaceStudySectionsForBookRange(
  "1 samuel",
  19,
  19,
  FIRST_SAMUEL_NINETEEN_PERSONAL_SECTIONS,
);
replaceStudySectionsForBookRange(
  "1 samuel",
  20,
  20,
  FIRST_SAMUEL_TWENTY_PERSONAL_SECTIONS,
);
replaceStudySectionsForBookRange(
  "1 samuel",
  21,
  21,
  FIRST_SAMUEL_TWENTY_ONE_PERSONAL_SECTIONS,
);
replaceStudySectionsForBookRange(
  "1 samuel",
  22,
  22,
  FIRST_SAMUEL_TWENTY_TWO_PERSONAL_SECTIONS,
);
replaceStudySectionsForBookRange(
  "1 samuel",
  23,
  23,
  FIRST_SAMUEL_TWENTY_THREE_PERSONAL_SECTIONS,
);
replaceStudySectionsForBookRange(
  "1 samuel",
  24,
  24,
  FIRST_SAMUEL_TWENTY_FOUR_PERSONAL_SECTIONS,
);
replaceStudySectionsForBookRange(
  "1 samuel",
  25,
  25,
  FIRST_SAMUEL_TWENTY_FIVE_PERSONAL_SECTIONS,
);
replaceStudySectionsForBookRange(
  "1 samuel",
  26,
  26,
  FIRST_SAMUEL_TWENTY_SIX_PERSONAL_SECTIONS,
);
replaceStudySectionsForBookRange(
  "1 samuel",
  27,
  27,
  FIRST_SAMUEL_TWENTY_SEVEN_PERSONAL_SECTIONS,
);
replaceStudySectionsForBookRange(
  "1 samuel",
  28,
  28,
  FIRST_SAMUEL_TWENTY_EIGHT_PERSONAL_SECTIONS,
);
replaceStudySectionsForBookRange(
  "1 samuel",
  29,
  29,
  FIRST_SAMUEL_TWENTY_NINE_PERSONAL_SECTIONS,
);
replaceStudySectionsForBookRange(
  "1 samuel",
  30,
  30,
  FIRST_SAMUEL_THIRTY_PERSONAL_SECTIONS,
);
