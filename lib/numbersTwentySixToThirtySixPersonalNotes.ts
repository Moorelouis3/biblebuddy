...
function explainDay45NumbersAt95(section: (typeof generatedNumbersTwentySixToThirtySixPersonalSections)[number], cleanTitle: string) {
  ...
  else if (/children of korah died not|died not/.test(lower)) opening = ["Korah's children did not die with the rebels.", "Judgment was real, but God did not erase the whole family line."];
  ...
  else if (/families of the sons of ephraim/.test(lower)) opening = ["Ephraim's families are brought into one total.", "The census ties future land to actual households."];
  ...
  else if (/forty and five thousand/.test(lower)) opening = ["This is Benjamin's counted total.", "The number records the tribe's strength before Canaan."];
  ...
  else if (/two lambs/.test(lower)) opening = ["Two lambs are required for the daily burnt offering.", "Each day begins and ends with worship before the LORD."];
  ...
  else if (/morning/.test(lower)) opening = ["The morning lamb begins the day's worship.", "Israel's day opens with an offering to the LORD."];
  ...
  else if (/two young bullocks/.test(lower)) opening = ["Young bullocks are young bulls offered in worship.", "The monthly offering is larger than the daily sacrifice."];
  else if (/one ram/.test(lower)) opening = ["A ram is a male sheep.", "It is added to the new month offering as part of the commanded worship."];
...
function explainDay46NumbersAt95(section: (typeof generatedNumbersTwentySixToThirtySixPersonalSections)[number], cleanTitle: string) {
  ...
  else if (/had at all an husband/.test(lower)) opening = ["The phrase means she is married.", "The law now explains vows within a husband's household."];
  ...
  else if (/vows shall stand/.test(lower)) opening = ["A vow standing means it remains binding.", "If the husband hears and does not object, the promise stays in force."];
  ...
  else if (/as the lord commanded/.test(lower)) opening = ["The battle follows the LORD's command.", "Obedience, not revenge, is meant to control Israel's action."];
  ...
  else if (/counsel of balaam/.test(lower)) opening = ["Counsel means advice or strategy.", "Balaam's plan used temptation to make Israel sin against the LORD."];
  ...
  else if (/sheep/.test(lower) && /six hundred/.test(lower)) opening = ["The sheep total shows the size of the spoil.", "The count prepares for dividing and giving tribute."];
  ...
  else if (/fenced cities/.test(lower)) opening = ["The rebuilt cities are fortified.", "The families east of Jordan need protected places while warriors cross over."];
  ...
  else if (/gave gilead/.test(lower)) opening = ["Moses grants Gilead to Machir's family.", "The conquered territory is assigned as inheritance."];
  ...
  else if (/not drive out/.test(lower)) opening = ["Refusing to drive out the inhabitants would leave danger inside the land.", "Partial obedience would become long-term trouble."];
...
function explainDay47NumbersAt95(section: (typeof generatedNumbersTwentySixToThirtySixPersonalSections)[number], cleanTitle: string) {
  ...
  else if (/two thousand cubits/.test(lower)) opening = ["Two thousand cubits marks the wider measured area around the city.", "The Levite towns receive ordered land for use, not random leftover ground."];
  ...
  else if (/lying in wait/.test(lower)) opening = ["Lying in wait means hiding in order to attack.", "Planned violence is treated as murder."];
  ...
  else if (/revenger of blood/.test(lower)) opening = ["The revenger of blood is the family representative seeking justice for the dead.", "Even that role must operate inside God's law, not outside it."];
  else if (/without enmity/.test(lower)) opening = ["Without enmity means without hatred or hostility.", "This describes a death that was not driven by personal malice."];
  else if (/without seeing/.test(lower)) opening = ["Without seeing him describes an accidental action.", "The person did not aim at someone he knew was there."];
  ...
  else if (/throughout your generations/.test(lower)) opening = ["Throughout your generations means for Israel's descendants after them.", "The law is not a temporary wilderness rule."];
  ...
  else if (/land cannot be cleansed/.test(lower)) opening = ["The land cannot be cleansed by ignoring murder.", "Bloodguilt requires justice, not silence or payment."];
  ...
  else if (/wherein i dwell/.test(lower)) opening = ["Wherein I dwell means the LORD lives among Israel there.", "Justice matters because the land is His dwelling place with His people."];
  else if (/chief fathers/.test(lower)) opening = ["The chief fathers are family heads from Manasseh.", "They bring a tribal inheritance concern to Moses and the leaders."];
