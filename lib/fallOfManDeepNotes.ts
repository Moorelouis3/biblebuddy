    ...
    sections: [
      ...
      },
      {
        ...
        notes: [
          ...
          "Then God names the real issue: `Have you eaten from the tree?`",
      ...
      },
      {
        ...
        notes: [
          ...
          "`You will bear children in pain` means grief, hardship, and struggle will now be connected to bringing life into the world.",
