...
function explainDay36PhraseAt95(section: PersonalLeviticusPhraseSectionInput, cleanTitle: string) {
  ...
  else if (/lord your god/.test(lower) && section.chapter === 18) opening = ["I am the LORD your God reminds Israel who owns their obedience.", "The commands about Egypt, Canaan, and family boundaries come from their covenant God."];
  ...
  else if (/^i am the lord$/i.test(cleanTitle)) opening = ["I am the LORD closes the boundary command with God's authority.", "The family law rests on who God is, not on human preference."];
  ...
  else if (/lord spake|hath commanded/.test(lower)) opening = ["The command begins with the LORD's own speech.", "Israel is not building holiness from custom, fear, or personal preference."];
  ...
  else if (/shall ye not do/.test(lower)) opening = ["Shall ye not do means Israel must refuse those practices.", "Holiness includes saying no to customs God forbids."];
  ...
  else if (/live in them/.test(lower)) opening = ["He shall live in them means God's commands form the path of covenant life.", "Obedience is not random restriction; it teaches life with God."];
  ...
  else if (/ram for a trespass offering/.test(lower)) opening = ["A ram for a trespass offering deals with guilt that requires atonement.", "The wrong is not ignored; it is brought before God with sacrifice."];
  ...
  else if (/his blood shall be upon him/.test(lower)) opening = ["His blood shall be upon him means he bears the guilt and consequence of the sin.", "The judgment is not blamed on someone else."];
  else if (/their blood shall be upon them/.test(lower)) opening = ["Their blood shall be upon them means the guilty ones bear the consequence together.", "Leviticus treats the act as accountable before God."];
  else if (/fountain of her blood/.test(lower)) opening = ["The fountain of her blood refers to a woman's flow of blood.", "The command treats sexual sin during that condition as uncleanness before God."];
  ...
  else if (/life of the flesh is in the blood/.test(lower)) opening = ["The life of the flesh is in the blood means blood represents living life.", "That is why Israel must never treat blood as common food."];
  ...
  else if (/if a stranger sojourn/.test(lower)) opening = ["If a stranger sojourn with thee means a foreigner lives among Israel.", "God commands Israel to treat that person with love, not suspicion."];
  ...
  else if (/set my face against/.test(lower)) opening = ["Set my face against means the LORD personally opposes that person.", "The warning shows that blood and worship are not small matters."];
  ...
  else if (/father's nakedness/.test(lower)) opening = ["Father's nakedness means a sexual violation that dishonors the father's marriage bed.", "The phrase protects both parent and household covenant."];
  else if (/theirs is thine own nakedness/.test(lower)) opening = ["Thine own nakedness means the relation is too close to be sexualized.", "God protects family identity from confusion and shame."];
  else if (/uncovered his father's nakedness/.test(lower)) opening = ["Uncovered his father's nakedness means violating a forbidden family boundary tied to the father.", "The sin dishonors both marriage and household order."];
  ...
  else if (/near of kin/.test(lower)) opening = ["Near of kin means close family relations.", "God protects family closeness from becoming sexual violation."];
  ...
  else if (/woman and her daughter/.test(lower)) opening = ["A woman and her daughter names a forbidden family combination.", "The command prevents desire from tearing generations of a family apart."];
  else if (/thy neighbour's wife/.test(lower)) opening = ["Thy neighbour's wife is another man's marriage partner.", "The command protects the neighbor's covenant from adultery."];
  ...
  else if (/wife and her mother/.test(lower)) opening = ["A wife and her mother names a forbidden family combination.", "The command prevents sexual sin from corrupting a household."];
  ...
  else if (/near kin/.test(lower)) opening = ["Near kin means close relatives.", "Leviticus treats close family bonds as protected boundaries."];
  ...
  else if (/abominable customs/.test(lower)) opening = ["Abominable customs are detestable practices from the surrounding nations.", "Israel must not inherit the habits that defiled the land."];
  else if (/it is abomination/.test(lower)) opening = ["It is abomination means God calls the act detestable.", "Israel must reject what corrupts holy life."];
  else if (/committeth any of these abominations/.test(lower)) opening = ["Committing these abominations means practicing the sins God just named.", "The warning gathers the whole forbidden list together."];
  ...
  else if (/committed an abomination/.test(lower)) opening = ["Committed an abomination means doing what God calls detestable.", "The act is named as something that cannot belong among God's holy people."];
  ...
  else if (/wickedness/.test(lower)) opening = ["Wickedness names an act as morally twisted before God.", "Leviticus is not treating these boundaries as mere social preference."];
  else if (/vex her/.test(lower)) opening = ["To vex her means to create rivalry, grief, or distress in the household.", "God forbids desire that tears family relationships apart."];
  ...
  else if (/defile not yourselves therein/.test(lower)) opening = ["Defile not yourselves therein means do not become unclean by joining those customs.", "The warning closes the section by guarding Israel from the same corruption."];
  ...
  else if (/nations are defiled/.test(lower)) opening = ["The nations are defiled means their practices have made them unclean before God.", "Israel must not copy what brought judgment on those nations."];
  else if (/land is defiled/.test(lower)) opening = ["The land is defiled means human sin pollutes the place where people live.", "Leviticus treats moral evil as something that damages the land."];
  else if (/land spue you not out/.test(lower)) opening = ["The land spuing Israel out means the land rejecting them for defilement.", "God warns Israel not to repeat the sins of the nations."];
  ...
  else if (/ye shall be holy/.test(lower)) opening = ["Ye shall be holy means Israel must live as a people set apart to God.", "Holiness reaches worship, family, justice, and daily choices."];
  ...
  else if (/eaten the same day/.test(lower)) opening = ["Eaten the same day means the peace offering meal has a time limit.", "Holy food cannot be handled however the worshiper prefers."];
  ...
  else if (/unrighteousness in judgment/.test(lower)) opening = ["Unrighteousness in judgment means unfair decisions in court or community life.", "Holiness requires justice that does not bend the truth."];
  else if (/person of the poor/.test(lower)) opening = ["Respecting the person of the poor means favoring someone only because they are poor.", "God commands compassion without twisting justice."];
  ...
  else if (/keep my statutes/.test(lower)) opening = ["Keeping God's statutes means obeying His fixed commands.", "Holiness is practiced in real boundaries, not vague intentions."];
  ...
  else if (/prostitute thy daughter|whoredom/.test(lower)) opening = ["The command forbids exploiting a daughter sexually.", "God protects families and the land from corrupt gain."];
  ...
  else if (/^familiar spirits$/i.test(cleanTitle)) opening = ["Familiar spirits are forbidden spirit-guides or occult powers.", "Turning to them is spiritual unfaithfulness to the LORD."];
  else if (/^wizards$/i.test(cleanTitle)) opening = ["Wizards are people connected with forbidden occult practice.", "Israel must reject their guidance because holiness belongs to the LORD."];
  ...
  else if (/stone him|put to death|blood shall be upon|blood shall be upon them/.test(lower)) opening = ["The judgment language treats covenant sin as life-and-death serious.", "Leviticus guards the people from evil that destroys worship, family, and community."];
  ...
  else if (/that ye should be mine/.test(lower)) opening = ["That ye should be mine means Israel belongs to the LORD.", "Separation from the nations is about belonging to God."];
