...
function explainDay41NumbersAt95(section: (typeof generatedNumbersTenToTwentyFivePersonalSections)[number], cleanTitle: string) {
  ...
  else if (/lord heard/.test(lower) && section.reference === "Numbers 11:1-3") opening = ["The LORD hears the people's open complaint in the wilderness.", "Their grumbling is directed against the care He has been giving them."];
  else if (/lord heard it/.test(lower) && section.reference === "Numbers 12:1-2") opening = ["The LORD hears Miriam and Aaron speaking against Moses.", "What sounded like private criticism is fully heard by God."];
  ...
  else if (/anger of the lord/.test(lower) && section.reference === "Numbers 11:10-15") opening = ["The LORD's anger burns because the people's craving has become rebellion.", "They are rejecting His provision rather than trusting His care."];
  ...
  else if (/seventy men/.test(lower) && section.reference === "Numbers 11:16-17") opening = ["The seventy men are elders chosen to help Moses lead Israel.", "God is about to share the burden that one man cannot carry alone."];
  else if (/seventy men/.test(lower) && section.reference === "Numbers 11:24-29") opening = ["These seventy men are the elders Moses has gathered at the tabernacle.", "Their public gathering prepares for the Spirit to rest on them."];
  ...
  else if (/brought quails/.test(lower)) opening = ["Quails are brought into the camp by the wind the LORD sends.", "The meat arrives exactly because God said it would."];
  else if (/gathered the quails/.test(lower)) opening = ["The people collect the quails spread around the camp.", "Their frantic gathering shows how strongly craving has taken hold of them."];
  ...
  else if (/miriam became leprous/.test(lower)) opening = ["Miriam is struck with leprosy as God's judgment.", "Her uncleanness becomes visible before the whole camp."];
  else if (/white as snow/.test(lower)) opening = ["White as snow describes how obvious Miriam's leprosy becomes.", "The judgment cannot be hidden or softened."];
  ...
  else if (/cried unto the lord/.test(lower)) opening = ["Moses cries out to the LORD on Miriam's behalf.", "The brother who was challenged now becomes her intercessor."];
  else if (/heal her/.test(lower)) opening = ["Heal her now is Moses' short plea for Miriam's healing.", "His prayer is urgent and merciful."];
  ...
  else if (/called oshea jehoshua/.test(lower)) opening = ["Moses changes Oshea's name to Jehoshua here.", "The renamed spy is the man later known as Joshua."];
  else if (/oshea/.test(lower) && section.reference === "Numbers 13:16-16") opening = ["Oshea is the earlier name of the man later known as Joshua.", "The text pauses to identify him before the mission begins."];
  else if (/jehoshua/.test(lower)) opening = ["Jehoshua is the new name Moses gives this spy.", "That new name is the form later known in English as Joshua."];
  ...
  else if (/anak/.test(lower) && section.reference === "Numbers 13:21-24") opening = ["The children of Anak are powerful people living in the land being explored.", "Their presence shows Canaan will not be entered without conflict."];
  else if (/anak/.test(lower) && section.reference === "Numbers 13:28-29") opening = ["The children of Anak are named again as part of the spies' fearful report.", "They become one reason the people feel overwhelmed."];
...
function explainDay42NumbersAt95(section: (typeof generatedNumbersTenToTwentyFivePersonalSections)[number], cleanTitle: string) {
  ...
  else if (/carcases/.test(lower) && section.reference === "Numbers 14:26-31") opening = ["Carcases means dead bodies left in the wilderness.", "God is saying the unbelieving generation will die before entering the land."];
  else if (/carcases/.test(lower) && section.reference === "Numbers 14:32-35") opening = ["Carcases again means their dead bodies will fall in the wilderness.", "The sentence is repeated to confirm that the judgment will surely happen."];
  ...
  else if (/sweet savour/.test(lower) && section.reference === "Numbers 15:1-3") opening = ["A sweet savour is an offering received with pleasure before the LORD.", "The phrase describes worship God accepts from His people."];
  else if (/sweet savour/.test(lower) && section.reference === "Numbers 15:10-12") opening = ["A sweet savour again means an offering pleasing to the LORD.", "The repeated phrase ties these measured offerings to accepted worship."];
  ...
  else if (/drink offering/.test(lower) && section.reference === "Numbers 15:4-9") opening = ["A drink offering is wine poured out beside the sacrifice.", "It completes the offering pattern God gives for worship."];
  else if (/drink offering/.test(lower) && section.reference === "Numbers 15:10-12") opening = ["The drink offering is the measured wine added with each larger sacrifice.", "Its amount changes with the animal, showing ordered worship."];
  ...
  else if (/burnt offering/.test(lower) && section.reference === "Numbers 15:4-9") opening = ["A burnt offering is an animal sacrifice burned on the altar for the LORD.", "It is paired here with flour and wine in an ordered offering pattern."];
  else if (/burnt offering/.test(lower) && section.reference === "Numbers 15:22-26") opening = ["The burnt offering here is part of atonement for the congregation's unintentional sin.", "This sacrifice is tied to forgiveness, not only general dedication."];
  ...
  else if (/forgiven them/.test(lower)) opening = ["Forgiven them means the congregation's guilt is released by God's mercy.", "The sacrifice makes restoration possible after unintentional sin."];
  else if (/forgiven him/.test(lower)) opening = ["Forgiven him means one person's guilt is released by God's mercy.", "God provides a way back even for the individual sinner."];
  ...
  else if (/two hundred and fifty/.test(lower) && section.reference === "Numbers 16:1-3") opening = ["The two hundred fifty men are well-known leaders joining Korah's rebellion.", "Their influence makes the challenge to Moses and Aaron more serious."];
  else if (/two hundred and fifty/.test(lower) && section.reference === "Numbers 16:35-40") opening = ["These are the same two hundred fifty men who offered unlawful incense.", "Their deaths become a warning against seizing priestly privilege."];
  ...
  else if (/too much upon you/.test(lower) && section.reference === "Numbers 16:1-3") opening = ["The rebels claim Moses and Aaron have taken too much authority.", "Their accusation attacks the leadership roles God appointed."];
  else if (/too much upon you/.test(lower) && section.reference === "Numbers 16:4-7") opening = ["Moses turns their accusation back on Korah's company.", "He shows that their complaint is really being driven by their own ambition."];
  ...
  else if (/put fire therein/.test(lower) && section.reference === "Numbers 16:4-7") opening = ["Putting fire in the censers prepares Korah's company to offer incense before the LORD.", "The test will show whom God actually accepts for priestly service."];
  else if (/put fire therein/.test(lower) && section.reference === "Numbers 16:46-50") opening = ["Aaron must quickly put altar fire in the censer for atoning incense.", "This time the censer is used lawfully to stop judgment, not to challenge God."];
  ...
  else if (/glory of the lord appeared/.test(lower) && section.reference === "Numbers 16:15-19") opening = ["The LORD's glory appears as Korah's company stands with their censers.", "God Himself answers the challenge over priesthood."];
  else if (/glory of the lord appeared/.test(lower) && section.reference === "Numbers 16:41-45") opening = ["The LORD's glory appears again when the congregation murmurs after the judgment.", "The new complaint brings the people back into immediate danger."];
  ...
  else if (/consume them.*moment/.test(lower) && section.reference === "Numbers 16:20-22") opening = ["I may consume them in a moment means God is ready to destroy the congregation at once.", "Moses and Aaron fall down because only mercy can stop this judgment."];
  else if (/consume them.*moment/.test(lower) && section.reference === "Numbers 16:41-45") opening = ["As in a moment means the threatened destruction could come immediately again.", "The people's fresh murmuring has reopened the danger."];
  ...
  else if (/write.*name/.test(lower) && /aaron/.test(lower)) opening = ["Aaron's name is written on Levi's rod to mark that tribe's claim clearly.", "The test will show whether Levi's priestly line is truly chosen by God."];
  else if (/write.*name/.test(lower)) opening = ["Writing each leader's name on a rod identifies which tribe it represents.", "The test removes guesswork and personal campaigning."];
...
function explainDay43NumbersAt95(section: (typeof generatedNumbersTenToTwentyFivePersonalSections)[number], cleanTitle: string) {
  ...
  else if (/wash his clothes/.test(lower) && section.reference === "Numbers 19:7-10") opening = ["The priest washes his clothes after handling the red heifer ritual.", "Even the cleansing ceremony leaves him unclean until evening."];
  else if (/wash his clothes/.test(lower) && section.reference === "Numbers 19:21-22") opening = ["The one who sprinkles the water must also wash his clothes afterward.", "Handling purification water still involves contact with uncleanness."];
  ...
  else if (/water of separation/.test(lower) && section.reference === "Numbers 19:7-10") opening = ["The water of separation is the cleansing water later made from these ashes.", "This ritual is preparing what Israel will need for death-uncleanness."];
  else if (/water of separation/.test(lower) && section.reference === "Numbers 19:11-13") opening = ["The water of separation is the cleansing water that must be sprinkled on the defiled person.", "Without it, death-uncleanness remains on them."];
  ...
  else if (/purification for sin/.test(lower) && section.reference === "Numbers 19:7-10") opening = ["Purification for sin here means the ritual cleansing prepared through the red heifer.", "It provides a remedy for defilement connected with death."];
  else if (/purification for sin/.test(lower) && section.reference === "Numbers 19:17-19") opening = ["Purification for sin here refers to the ashes kept for cleansing the unclean.", "The earlier sacrifice continues to serve later acts of purification."];
  ...
  else if (/lord spake unto moses/.test(lower) && section.reference === "Numbers 20:7-8") opening = ["The LORD answers the people's thirst by speaking to Moses.", "Provision begins with God's instruction, not Moses' frustration."];
  else if (/lord spake unto moses/.test(lower) && section.reference === "Numbers 20:22-24") opening = ["The LORD speaks to Moses and Aaron about Aaron's coming death.", "The journey turns from the water crisis to a priestly transition."];
  ...
  else if (/mount hor/.test(lower) && section.reference === "Numbers 20:22-24") opening = ["Mount Hor is the place where God announces Aaron will die.", "The journey reaches a solemn turning point for Israel's priesthood."];
  else if (/mount hor/.test(lower) && section.reference === "Numbers 20:25-29") opening = ["Mount Hor is the mountain where Aaron is taken up to die.", "The priestly garments will be transferred there to Eleazar."];
  ...
  else if (/serpent of brass/.test(lower) && /he lived/.test(lower)) opening = ["The serpent of brass is the bronze sign God tells Moses to raise up.", "Looking at that sign becomes the way the bitten person lives."];
  ...
  else if (/arnon/.test(lower) && section.reference === "Numbers 21:10-13") opening = ["Arnon is the river marking the border near Moab.", "Israel camps by a real frontier as the journey advances."];
  else if (/arnon/.test(lower) && section.reference === "Numbers 21:14-16") opening = ["The brooks of Arnon are the ravines connected with that border river.", "The song and place-name root Israel's travel in actual geography."];
...
function explainDay44NumbersAt95(section: (typeof generatedNumbersTenToTwentyFivePersonalSections)[number], cleanTitle: string) {
  ...
  else if (/god came unto balaam at night/.test(lower)) opening = ["God comes to Balaam at night with permission that still includes strict limits.", "Balaam may go, but only under the LORD's words."];
  ...
  else if (/house full of silver and gold/.test(lower) && section.reference === "Numbers 22:18-19") opening = ["A house full of silver and gold pictures a massive reward Balak could offer Balaam.", "Balaam says money cannot give him authority to disobey God's word."];
  else if (/house full of silver and gold/.test(lower) && section.reference === "Numbers 24:12-14") opening = ["Balaam repeats the image of a house full of silver and gold to remind Balak of his earlier warning.", "He is saying again that payment cannot change what God makes him speak."];
  ...
  else if (/god's anger was kindled because he went/.test(lower)) opening = ["God's anger burns because Balaam goes with a heart still drawn toward reward.", "The permission to travel is not permission to chase Balak's evil purpose."];
  else if (/balak's anger was kindled/.test(lower)) opening = ["Balak's anger burns because Balaam blesses Israel instead of cursing them.", "The king is enraged that his plan has failed again."];
  else if (/anger was kindled/.test(lower)) opening = ["Anger flares because the speaker's will is being opposed.", "The phrase marks a moment of heated reaction in the story."];
  ...
  else if (/put a word in balaam/.test(lower)) opening = ["The LORD gives Balaam the exact words he must speak on this first attempt.", "Balaam's message will come from God, not from Balak's payment."];
  else if (/put a word in his mouth/.test(lower)) opening = ["The LORD again gives Balaam the words for the next oracle.", "Each blessing is controlled by God from start to finish."];
  ...
  else if (/curse mine enemies/.test(lower) && section.reference === "Numbers 23:11-12") opening = ["Balak calls Israel his enemies after Balaam's first blessing.", "He hired Balaam to harm Israel, not to bless them."];
  else if (/curse mine enemies/.test(lower) && section.reference === "Numbers 24:10-11") opening = ["Balak again calls Israel his enemies as he lashes out at Balaam.", "His anger shows he still sees God's people as targets to be cursed."];
  ...
  else if (/heard the words of god/.test(lower) && section.reference === "Numbers 24:3-4") opening = ["Balaam says he has heard words that come from God.", "He presents this oracle as revealed speech, not guesswork."];
  else if (/heard the words of god/.test(lower) && section.reference === "Numbers 24:15-17") opening = ["Balaam repeats that he has heard words from God before giving the later oracle.", "The repeated claim stresses that the message still comes from revelation."];
