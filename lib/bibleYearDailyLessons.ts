  ...
  sections: [
    {
      ...
      teaching: [
        "The serpent does not begin by attacking God directly.",
        "He begins with a question.",
        "Has God really said?",
        "That matters.",
        "Temptation often starts by making God's word feel unclear.",
        "Not always by saying, Reject God.",
        "Sometimes it starts softer.",
        "Are you sure God meant that?",
        "Is God really being fair?",
        "Maybe God is holding something back from you.",
        "The serpent takes a garden full of yes and makes Eve focus on the one no.",
        "God gave them every tree for food except one.",
        "But the serpent makes the boundary sound like deprivation.",
        "The real temptation is not just fruit.",
        "It is whether humanity will trust God's definition of good and evil, or try to define it apart from Him.",
        "That is still the question underneath so much of human life.",
        "Will I trust God?",
        "Or will I decide for myself what is good, even when God has already spoken?",
      ],
    },
    {
      ...
      teaching: [
        ...
        "That is important because sin does not always look ugly at first.",
        "Sometimes sin looks like freedom.",
        "Sometimes it looks like control.",
        "Sometimes it looks like finally getting what you deserve.",
        "Eve eats.",
        "Then she gives some to Adam.",
        "And Adam eats too.",
        "The text says he was with her.",
        "That means Adam is not far away somewhere else. He is present, silent, and responsible.",
        "Then their eyes open.",
        "But they do not become free.",
        "They become ashamed.",
        "The serpent promised glory.",
        "Sin delivered hiding.",
        "Before this moment, they were naked and not ashamed.",
        "Now they are exposed and afraid.",
        "The first thing humans do after sin is cover themselves.",
        "That is still what shame does.",
        "It makes us hide.",
        "It makes us manage appearances.",
        "It makes us cover what we are afraid someone else will see.",
      ],
    },
    {
      ...
      teaching: [
        ...
        "He is not confused.",
        "He is not looking around the garden like He lost Adam.",
        "God is drawing Adam out of hiding.",
        "That question is mercy before judgment.",
        "Adam answers with fear.",
        "I was afraid.",
        "That is one of the saddest turns in the Bible.",
        "The God who gave him life is now the God he hides from.",
        "Then blame begins.",
        "Adam blames Eve.",
        "And if you listen closely, he also blames God.",
    ...
    },
    {
      ...
      teaching: [
        "God judges the serpent first.",
        "But inside the judgment, God gives hope.",
        "Genesis 3:15 is one of the most important verses in the Bible.",
        "God says there will be hostility between the serpent and the woman, between the serpent's offspring and her offspring.",
        "Then comes the promise.",
        "The serpent will bruise his heel.",
        "But he will bruise the serpent's head.",
        "That means the promised seed will be wounded, but the serpent will be crushed.",
        "Before Adam and Eve ever leave Eden, God already speaks rescue.",
        "Before the story gets worse, God plants hope.",
        "This is where the Bible starts pointing forward.",
        "Eventually, the story will lead to Jesus.",
        "The one who is wounded, but who defeats evil.",
        "The one who enters human pain, but crushes the power of sin and death.",
        "The garden is broken.",
        "But God is already promising redemption.",
      ],
    },
    {
      ...
      teaching: [
        ...
        "That name is hopeful.",
        "It means life.",
        "Even after judgment, Adam believes life will continue.",
        "Then God makes garments of skin and clothes them.",
        "Adam and Eve made fig leaves.",
        "God gives a better covering.",
        "That is mercy.",
        "They sinned, but God still covers them.",
        "They are sent out of Eden, and that feels severe. But even that has mercy in it.",
        "God does not allow humanity to live forever in a broken state.",
        "The tree of life is guarded.",
        "The garden is closed.",
        "But the promise remains open.",
        "This is not the end of the story.",
        "It is the beginning of the rescue story.",
      ],
    },
    {
      ...
      teaching: [
        "Genesis 4 moves from the garden into the family.",
        "Adam and Eve have sons.",
        "Cain works the ground.",
        "Abel keeps sheep.",
        "Both bring offerings.",
        "But Cain becomes angry when Abel's offering is received and his is not.",
        "The text does not tell us every detail, but it shows us Cain's heart.",
        "His face falls.",
        "His anger grows.",
        "And God warns him before the violence happens.",
        "That matters.",
        "God does not wait until Cain destroys his brother to speak.",
        "He comes to Cain while there is still time.",
        "Sin crouches at the door.",
        "That image is powerful.",
        "Sin is pictured like a predator waiting outside.",
        "Not passive.",
        "Not harmless.",
        "Crouching.",
        "Ready.",
        "Wanting Cain.",
        "God tells Cain he must rule over it.",
        "Cain still has a choice.",
        "The murder begins before the field.",
    ...
    },
    {
      ...
      teaching: [
        ...
        "He kills Abel.",
        "The first death recorded after Eden is not old age.",
        "It is murder.",
        "Brother kills brother.",
        "Then God asks another question.",
        "Where is Abel, your brother?",
        "That echoes Genesis 3.",
        "Where are you?",
        "Again, God is not confused.",
        "He is confronting sin.",
        "Cain lies.",
        "Then he says, Am I my brother's keeper?",
        "That sentence is cold.",
        "He refuses responsibility for the brother he killed.",
        "But Abel's blood cries from the ground.",
        "Hidden violence is not hidden from God.",
        "Cain is judged.",
        "But God also marks Cain so revenge does not multiply without limit.",
        "Even here, judgment and mercy stand together.",
      ],
    },
    {
      ...
      teaching: [
        "Cain's line builds.",
        "A city appears.",
        "Livestock work develops.",
        "Music appears.",
        "Tools are made.",
        "This matters because fallen humans are still creative.",
        "Sin does not erase human ability.",
        "People can build cities, make music, develop technology, and shape culture.",
        "But brokenness is still there.",
        "Lamech takes two wives, bending the one-flesh pattern from Genesis 2.",
        "Then he brags about violence.",
        "Cain tried to hide murder.",
        "Lamech boasts in it.",
        "This is the world after Eden.",
        "Gifted and broken.",
        "Creative and violent.",
        "Capable of beauty, but bent toward pride.",
        "Genesis is showing us the truth about humanity.",
        "We can build incredible things.",
        "And still need rescue.",
      ],
    },
    {
      ...
      teaching: [
        "Genesis 4 does not end with Lamech bragging.",
        "It returns to Adam and Eve.",
        "Another son is born.",
        "His name is Seth.",
        "Eve says God has appointed another child.",
        "That matters because Abel is dead and Cain is exiled.",
        "But the promise has not died.",
        "Genesis 3 promised the seed of the woman.",
        "Genesis 4 shows hope still moving forward.",
        "Then people begin to call on Yahweh's name.",
