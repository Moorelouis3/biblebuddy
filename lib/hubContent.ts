...
export const HUB_CONTENT: HubCategoryStatic[] = [
  {
    ...
    color: "#ddeeff",
    items: [
      { id: "bi-1", type: "article", title: "🛡️ How to Defend the Bible", subtitle: "How to respond when people say it was changed, written by men, or fake.", emoji: "🛡️", path: "/blog/how-to-defend-the-bible", display_order: 1 },
      { id: "bi-2", type: "article", title: "📖 What Is the Bible?", subtitle: "Understanding its origin, structure, authors, and why it matters.", emoji: "📖", path: "/blog/what-is-the-bible", display_order: 2 },
      { id: "bi-3", type: "article", title: "📚 Why So Many Bible Translations?", subtitle: "Understanding your modern Bible version.", emoji: "📚", path: "/blog/why-so-many-bible-translations", display_order: 3 },
  ...
  },
  {
    ...
    color: "#fef9c3",
    items: [
      { id: "bst-1", type: "article", title: "🧠 Why Bible Study Is Hard", subtitle: "5 reasons studying the Bible is hard.", emoji: "🧠", path: "/blog/why-bible-study-is-hard", display_order: 1 },
      { id: "bst-2", type: "article", title: "📖 How to Read the Bible", subtitle: "A simple way to study Scripture.", emoji: "📖", path: "/blog/how-to-read-the-bible", display_order: 2 },
      { id: "bst-3", type: "article", title: "🖍️ A Simple Bible Highlighting System", subtitle: "How to highlight with purpose.", emoji: "🖍️", path: "/blog/a-simple-bible-highlighting-system", display_order: 3 },
  ...
  },
  {
    ...
    color: "#ede9fe",
    items: [
      { id: "cf-1", type: "article", title: "🔥 What Is Hell", subtitle: "Understanding Hell biblically.", emoji: "🔥", path: "/blog/what-is-hell", display_order: 1 },
      { id: "cf-2", type: "article", title: "✨ What Is Heaven", subtitle: "Understanding Heaven biblically.", emoji: "✨", path: "/blog/what-is-heaven", display_order: 2 },
      { id: "cf-3", type: "article", title: "🌎 Why So Many Denominations", subtitle: "Understanding Christian divisions.", emoji: "🌎", path: "/blog/why-so-many-denominations", display_order: 3 },
  ...
  },
  {
    ...
    color: "#d1fae5",
    items: [
      { id: "vb-1", type: "article", title: "🏛️ Your Body Is a Temple", subtitle: "1 Corinthians 6:19 to 20.", emoji: "🏛️", path: "/blog/your-body-is-a-temple", display_order: 1 },
      { id: "vb-2", type: "article", title: "🧑‍🦱 Building Self Control", subtitle: "Proverbs 25:28 explained.", emoji: "🧑‍🦱", path: "/blog/building-self-control", display_order: 2 },
      { id: "vb-3", type: "article", title: "🧂 Salt and Light", subtitle: "Matthew 5:13 to 16.", emoji: "🧂", path: "/blog/salt-and-light", display_order: 3 },
  ...
  },
  {
    ...
    color: "#dbeafe",
    items: [
      { id: "cs-1", type: "article", title: "👤 Luke", subtitle: "The Gentile doctor, Gospel writer, and companion of Paul.", emoji: "👤", path: "/blog/luke", display_order: 1 },
      { id: "cs-2", type: "article", title: "🔥 Moses", subtitle: "The man God drew out to draw His people out.", emoji: "🔥", path: "/blog/moses", display_order: 2 },
      { id: "cs-3", type: "article", title: "🧔 Paul", subtitle: "From persecutor to missionary apostle.", emoji: "🧔", path: "/blog/paul", display_order: 3 },
  ...
  },
  {
    ...
    color: "#fff7ed",
    items: [
      { id: "ch-1", type: "article", title: "🏛️ The Man Who Legalized Christianity", subtitle: "Constantine and the turning point of the Church.", emoji: "🏛️", path: "/blog/the-man-who-legalized-christianity", display_order: 1 },
      { id: "ch-2", type: "article", title: "🍀 St. Patrick", subtitle: "He who brought Christianity to Ireland.", emoji: "🍀", path: "/blog/st-patrick", display_order: 2 },
      { id: "ch-3", type: "article", title: "❤️ St. Valentine", subtitle: "The martyr behind the modern holiday.", emoji: "❤️", path: "/blog/st-valentine", display_order: 3 },
