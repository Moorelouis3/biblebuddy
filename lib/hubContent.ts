...
// Used by Hope Nation group to display articles/questions inline (no DB needed)
...
export type HubItemStatic = {
  ...
  subtitle: string;
  emoji: string;
  path: string; // existing Next.js page path
...
export const HUB_CONTENT: HubCategoryStatic[] = [
  ...
  },
  {
    ...
    color: "#fef9c3",
    items: [
      { id: "bst-q1", type: "question", title: "💡 What's Your Best Study Tip?", subtitle: "Share what helps you most.",              emoji: "💡", path: "/bible-study-hub/bible-study-tips/whats-your-best-study-tip",   display_order: 1 },
      { id: "bst-q2", type: "question", title: "📝 How Do You Take Notes?",      subtitle: "Everyone studies a little differently.", emoji: "📝", path: "/bible-study-hub/bible-study-tips/how-do-you-take-notes",       display_order: 2 },
      { id: "bst-q3", type: "question", title: "🔥 What Keeps You Consistent?",  subtitle: "Staying disciplined is not easy.",       emoji: "🔥", path: "/bible-study-hub/bible-study-tips/what-keeps-you-consistent", display_order: 3 },
    ],
  },
  {
