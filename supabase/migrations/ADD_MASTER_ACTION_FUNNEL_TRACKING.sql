...
create index if not exists master_actions_session_created_idx
  on public.master_actions (session_id, created_at desc);

create index if not exists master_actions_type_created_idx
  on public.master_actions (action_type, created_at desc);

create index if not exists master_actions_journey_day_idx
  on public.master_actions (journey_day, created_at desc);
