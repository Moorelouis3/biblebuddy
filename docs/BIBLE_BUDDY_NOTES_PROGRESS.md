...
- Done under this log: 50 chapters (Genesis 41, 43, 44, 45, 46, 47, 48, 49, 50; Exodus 1-40; Leviticus 1)
- Done before this log (pre-existing gold standard): 41 chapters (Genesis 1-40, 42)
- Total done: 91 / 1,189 (7.7%)
- Remaining: 1,098
- Currently on: Leviticus (1 of 27 chapters done — chapter 1)
