...
- Done under this log: 49 chapters (Genesis 41, 43, 44, 45, 46, 47, 48, 49, 50; Exodus 1-40)
- Done before this log (pre-existing gold standard): 41 chapters (Genesis 1-40, 42)
- Total done: 90 / 1,189 (7.6%)
- Remaining: 1,099
- Currently on: Leviticus (up next, 27 chapters total, 0 done)
