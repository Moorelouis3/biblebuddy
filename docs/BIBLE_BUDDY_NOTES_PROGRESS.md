...
- Done under this log: 48 chapters (Genesis 41, 43, 44, 45, 46, 47, 48, 49, 50; Exodus 1-39)
- Done before this log (pre-existing gold standard): 41 chapters (Genesis 1-40, 42)
- Total done: 89 / 1,189 (7.5%)
- Remaining: 1,100
- Currently on: Exodus (40 chapters total, 38 done, 2 to go)
