...
- Done under this log: 53 chapters (Genesis 41, 43, 44, 45, 46, 47, 48, 49, 50; Exodus 1-40; Leviticus 1-4)
- Done before this log (pre-existing gold standard): 41 chapters (Genesis 1-40, 42)
- Total done: 94 / 1,189 (7.9%)
- Remaining: 1,095
- Currently on: Leviticus (4 of 27 chapters done — chapters 1-4)
