...
export default async function EcclesiastesTriviaChapterPage({
  params,
}: {
  ...
  const book = getTriviaBook("ecclesiastes");
  const chapterPack = getTriviaChapter("ecclesiastes", chapterNumber);
