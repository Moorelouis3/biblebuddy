...
export async function POST(request: NextRequest) {
  ...
  try {
      ...
      messages: [
        {
          role: "system",
          content:
            "You write short, natural reply drafts for a Christian app host. " +
        ...
        },
        {
          ...
          content:
            ...
            `Original post content:\n${clip(stripHtml(originalPostContent || "No extra context provided."), 1400)}\n\n` +
    ...
    console.error("[AUTO_REPLY_SHARED] Failed to generate reply draft", error);
