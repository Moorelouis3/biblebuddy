...
const ALLOWED_EVENTS = new Set([
  ...
  // Printed Wisdom of Proverbs books (2026-09-22). Event-page banner ->
  // /books/wisdom-of-proverbs -> Amazon. Metadata: {source, placement, utm_*,
  // referrer_host, product}.
  "wisdom_book_banner_viewed",
  "wisdom_book_banner_clicked",
  "wisdom_book_page_viewed",
  "wisdom_hardcover_amazon_clicked",
  "wisdom_paperback_amazon_clicked",
  "wisdom_journal_amazon_clicked",
  // One-time "New Book Live!" popup for Proverbs members / devotional readers.
  ...
  "votd_card_click",
  "votd_read_breakdown_click",
  "votd_breakdown_open",
  "votd_breakdown_complete",
  "votd_bookmark",
  "votd_share",
  "votd_open_in_bible",
  "votd_page_view",
  ...
  "home_see_all_click",
  "home_trivia_click",
  "home_scrambled_click",
  "home_group_click",
  "home_trivia_impression",
  "home_scrambled_impression",
  "home_group_impression",
  "landing_page_visit",
