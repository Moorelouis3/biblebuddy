  ...
  return (
    <div className="min-h-screen bg-[#f7f7f4] pb-14">
      <div className="mx-auto flex max-w-5xl flex-col gap-8 px-4 pt-8 sm:px-6 lg:px-8">
        <div className="rounded-[30px] border border-[#eadfcf] bg-gradient-to-br from-[#fffaf2] via-white to-[#f8efe4] p-6 shadow-sm sm:p-8">
        ...
        <div className="grid gap-5 md:grid-cols-2">
          <Link href="/bible-trivia" className="rounded-[28px] border border-emerald-200 bg-gradient-to-br from-emerald-50 via-white to-teal-50 p-6 shadow-sm transition hover:-translate-y-0.5 hover:shadow-md">
            ...
            <div className="mt-6 rounded-2xl border border-white/80 bg-white/80 px-4 py-3 text-sm font-semibold text-emerald-700">
              Open Trivia -&gt;
            </div>
          </Link>

          <Link href="/bible-study-games/scrambled" className="rounded-[28px] border border-rose-200 bg-gradient-to-br from-rose-50 via-white to-orange-50 p-6 shadow-sm transition hover:-translate-y-0.5 hover:shadow-md">
            ...
            <div className="mt-6 rounded-2xl border border-white/80 bg-white/80 px-4 py-3 text-sm font-semibold text-[#9b4d3b]">
              Play Scrambled -&gt;
            </div>
          </Link>
        </div>
